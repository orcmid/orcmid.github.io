...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /A2HostingWeb/orcmid/BlunderDome/clueless/2007_04_08_clu-chive.asp 1     08-10-07 14:29 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: 2007-04-08</title>
...
I’ve become a regula...</a><br />
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="2007-04-11" href="#2007-04-11">
          <font color="#660000">2007-04-11</font></a></h3>
   	

	<div class="posts">
	<a name="5642764910680708662"></a>
    
    
    <p>
	<div style="clear:both;"></div><h2>What Is Object-Oriented Design?</h2>
<p>I have noticed that many treatments of object-oriented technologies (e.g., practically any text on Java or C#) seem to gloss over the hard-won principles around coupling, cohesion, separation of concerns, and those qualities that have software be confirmable (testable), maintainable, robust, and durable.&nbsp; And any of those others, like secure, stable, dependable, as well.</p>
<p>Well, I may have simply not been looking in the good places.&nbsp; </p>
<p>Today, Uncle Bob (<a href="http://objectmentor.com/omTeam/martin_r.html">this guy</a>, I think) published a column on &ldquo;<a href="http://blog.objectmentor.com/articles/2007/04/11/what-is-soa-really">What Is SOA, Really?</a>&rdquo; the first of a series.&nbsp; Now, it seems to me that Service-Oriented Architecture (SOA) is wearing out its next-big-thing luster, and I find myself glazing over by the growing crop of ungrounded testimonials to it.&nbsp; That isn&rsquo;t what Uncle Bob is doing.&nbsp; And I appreciate that this is being related to what happens in business practices and situated activities farther out than the innards of Object-Oriented Technologies (OOT to you).</p>
<p>But the greatest bonus of all was the articles link to the collection of principles on &ldquo;<a href="http://www.objectmentor.com/omSolutions/oops_what.html">What Is OO Design?</a>&rdquo;&nbsp; (<em>a.k.a.</em> OOPSwhat?).</p>
<p>I went looking&nbsp;into the Common Closure Principle Principle[<em>?</em>], and found a comprehensive treatment on granularity.&nbsp; Some of the other three-letter acronyms for principles are also recounted under&nbsp;cover of an article on stability.&nbsp; </p>
<p>I love this stuff.&nbsp; I don&rsquo;t know how solidly it relates to&nbsp;what I attempt in my <em>ad hoc</em> nano-ISV projects, but I am going to give this material a closer look.&nbsp; I&rsquo;m expecting a&nbsp;terrific way to calibrate my development approaches and course-correct toward these principled qualities.&nbsp; I might even start using UML.</p>
<hr>

<p><small>This is my on-line marker for that material.&nbsp; I grabbed the PDFs and filed them all neatly in a folder I keep on architetto\Methodologies where Windows Desktop Search is going to give me text-search access into them.</small></p><div class="bjtags">Tags:  <a rel="tag" href="http://technorati.com/tag/orcmid">orcmid</a>, <a rel="tag" href="http://technorati.com/tag/object-oriented+design">object-oriented+design</a>, <a rel="tag" href="http://technorati.com/tag/object-oriented+technologies">object-oriented+technologies</a>, <a rel="tag" href="http://technorati.com/tag/design+principles">design+principles</a>, <a rel="tag" href="http://technorati.com/tag/Robert+Martin">Robert+Martin</a></div><div style="clear:both; padding-bottom:0.25em"></div>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2007/04/what-is-object-oriented-design-i-have.asp">4/11/2007 09:25:00 AM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2007/04/what-is-object-oriented-design-i-have.asp">
        ...
        <a class="comment-link" href="http://www2.blogger.com/comment.g?blogID=7336679&postID=5642764910680708662">Post a Comment</a>
		</div>
