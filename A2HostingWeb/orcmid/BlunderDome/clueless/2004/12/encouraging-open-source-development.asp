...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2004/12/encouraging-open-source-development.asp 1     05-01-22 13:42 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: Encouraging Open-Source Development</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<div class="posts">
	<a name="109841136750060091"></a>
    
    <h2><font color="#000080"><!-- 2004-08-31 -->
    <a href="http://www.acm.org/technews/articles/2004-6/1020w.html#item9"
                    title="external link">
    ...
    <p>
	<a href="http://www.acm.org/technews/articles/2004-6/1020w.html#item9">ACM News Service: Red Hat Exec Talks of Challenges to Open Source</a>.&nbsp; 2004-10-21: I have a little trouble parsing this.&nbsp; According to Michael Tiemann, there's a paucity of open-source developers and it is important to have more people take an interest in open-source development.&nbsp; Tiemann's thinking is that open-source can scale by having more projects, since 80% of a typical project is controlled by 10 to 15 developers.&nbsp; Apparently forking is not a problem if more developers come to a project, but having a different project would magnify the appeal and the availability of developers.&nbsp; There is a tacit assumption, it seems to me, that this will attract different developers, not recycle and overwork the same senior developers.&nbsp; Well, OK for now.<br /><br />There are also comments about evolving the Linux Standards Base from 2.0 to 3.0 so that more vendors can play and there is presumably then more room for portability across the different supported Linux platforms.<br /><br />John Ribeiro's 2004-10-18 <a href="http://www.infoworld.com/article/04/10/18/HNredhatqanda_1.html">IDG New Service article</a> lays it out plainly, with more on the advantage of promoting open-source in Asia and elsewhere.<blockquote><small>So I have peeled off another ten days of backlog.&nbsp; I am not sure how I let this happen, apart from being pre-occupied with school work right now.&nbsp; I think the habit of making backlogs of drafts started when I had a downtime at the end of July where I had locked down my blogs against new posts until I could be satisfied that I had an incident response procedure in place against corrupted postings from Blogger.&nbsp; But the backlog is still there.&nbsp; This is something to eliminate by the end of the month and before embarking on the new year.</small></blockquote>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2004/12/encouraging-open-source-development.asp">12/1/2004 07:06:57 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2004/12/encouraging-open-source-development.asp">
        ...
        <a href="http://www.blogger.com/comment.g?blogID=7336679&postID=109841136750060091">Post a Comment</a>
		</div>
