...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2004/12/legitimizing-p2p-maybe.asp 1     05-01-22 13:42 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: Legitimizing P2P, Maybe?</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="Sunday, December 26, 2004" href="#Sunday, December 26, 2004">
          <font color="#660000">Sunday, December 26, 2004</font></a></h3>
   	

	<div class="posts">
	<a name="110412921711357749"></a>
    
    <h2><font color="#000080"><!-- 2004-08-31 -->
    <a href="http://www.acm.org/technews/articles/2004-6/1217f.html#item1"
                    title="external link">
    ...
    <p>
	<a href="http://www.acm.org/technews/articles/2004-6/1217f.html#item1">ACM News Service: P2P Battle Reaches FTC</a>.&nbsp; I stepped over this blurb the first time, and saw it again because there is no 2004-12-24 edition of ACM News Service.&nbsp; It landed differently one week later.<br /><br />There is the possibility of a form of P2P responsibility based on FTC regulations for truth in labeling and some additional practices around discouraging IP-violations and extra- if not illegal activity.&nbsp; Although there is no result from the U.S. Supreme Court examination of the Grokster case, the FTC involvement might provide an appropriate level of warning and compliance to permit <em>ad hoc</em> P2P to continue to flourish for lawful purposes.&nbsp; That matters to me because I see P2P and distributed overlay discovery as important for use of distributed objects in the long run.<br /><br />Michael Grebb's 2004-12-16 <a href="http://www.wired.com/news/politics/0,1283,66051,00.html"><em>Wired News</em> article</a> gives more flavor to the proceedings of the two-day FTC workshop held on December 15-16.&nbsp; It seems that everyone is worried about the previous decision that requires substantial non-infringing use, with publishers looking at what the usage actually is, the P2P providers countering how application-neutral the technology is.&nbsp; There is also a little gaming that went on, when I saw a number of blogs encouraging the publishing and downloading of public-domain materials via popular P2P services as a way of demonstrating that neutrality in practice.&nbsp; (My sense is that this sort of thing rarely works and it demonstrates a kind of <em>prima facie</em> guilty knowledge.)<br /><br />I would like to see P2P find a way into the light, and I don't know that will be possible.&nbsp; For my interests, it means being able to work with high-performance P2P privately but maybe have to use a Web Services model for the broader public case, assuming that this allows individual services to be dealt with, if they deliver illegal or misappropriated content, without the entire Web Service infrastructure being threatened.<h3>Legitimizing Peer-to-Peer</h3><a href="http://www.acm.org/technews/articles/2004-6/1008f.html#item4">ACM News Service: Peer-to-Peer Comes Clean</a>.&nbsp; 2004-10-09: There are many positive approaches to P2P and the article described here indicates a number of them.&nbsp; One of interest to me is LionShare from Penn State University, at least in terms of the idea of exchanging scholarly information among networks of academics.<br /><br />I'm not sure about distributed hash tables as an interesting activity, but I am certainly enrolled in approaches to automatic discovery that "store data redundantly on numerous machines, shield information with encryption and digital signatures, and sustain participants' motivation and honesty by supporting distributed reputation, trust, and payment systems."<br /><br />Simson Garfinkel's 2004-10-06 <a href="http://www.technologyreview.com/articles/04/10/wo_garfinkel100704.asp"><em>Technology Review</em> article</a> provides a link to the September 2003 LionShare proposal.  Other useful links provide the Microsoft P2P Development kit, the August 2004 <a href="http://femto.org/p2p2004/">Fourth IEEE International Conference on Peer-to-Peer Computing</a>, and something I need here on the Centrale LAN, <a href="http://www.pensamos.com/mmb/">Magic Mirror Backup</a>.&nbsp; Of course, it will take something before I give anything like that local-network privileges inside my residential firewall and router.
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2004/12/legitimizing-p2p-maybe.asp">12/26/2004 10:43:08 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2004/12/legitimizing-p2p-maybe.asp">
        ...
        <a href="http://www.blogger.com/comment.g?blogID=7336679&postID=110412921711357749">Post a Comment</a>
		</div>
