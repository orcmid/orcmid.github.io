...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2004/12/when-to-optimize-when-to-tune.asp 1     05-01-22 13:42 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: When to Optimize, When to Tune</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<div class="posts">
	<a name="109928128897098927"></a>
    
    <h2><font color="#000080"><!-- 2004-08-31 -->
    <a href="http://www.acm.org/technews/articles/2004-6/1029f.html#item17"
                    title="external link">
    ...
    <p>
	<a href="http://www.acm.org/technews/articles/2004-6/1029f.html#item17">ACM News Service: Think Like a Customer, Use Your Stopwatch</a>.&nbsp; 2004-10-31: This is a highly-pragmatic and practical set of views, especially with regard to where to tune and when to find an algorithmic optimization.<br /><br />Geoff Koch's 2004-10-15 <a href="http://www.sdtimes.com/news/112/special1.htm"><em>SD Times</em> article</a> carries a more-careful, progressive presentation of how tools are used and the sensibilities that are applied when searching for improved performance.&nbsp; There are some interesting tips, including the importance of making sure that optimized code is not unmaintainable.<br /><br />Randy Camp of Musicmatch uses an approach that is interesting to me because he talks about focusing on the place where the greatest performance loss occurs.&nbsp; Also, there is a reference implementation created to provide a framework for assessing improvements.&nbsp; Since I am building a reference implementation for a project, it will be useful to consider how it could be used to optimize for a simple production version based on that design.<br /><br />The article has some fanciful ideas at the end, including having appropriate algorithms be automatically selected based on conditions at hand.&nbsp; This is in fact something functional programming is set up to do, and I'll tuck that thought away too.
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2004/12/when-to-optimize-when-to-tune.asp">12/1/2004 06:28:59 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2004/12/when-to-optimize-when-to-tune.asp">
        ...
        <a href="http://www.blogger.com/comment.g?blogID=7336679&postID=109928128897098927">Post a Comment</a>
		</div>
