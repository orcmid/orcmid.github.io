...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2004/09/ending-madness-deja-triple-vu.asp 3     05-01-22 13:40 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: Ending the Madness: Deja Triple Vu</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
    ...
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2004/06/linking-atom-feeds.asp">Linking the Atom Feeds</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2004/06/button-button-wheres-update.asp">Button, Button, Where's the Update?</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2004/06/do-we-have-firewall-or-development-web.asp">Do We Have a Firewall or a Development Web?</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2004/06/attack-of-naughty-bees.asp">Attack of the Naughty Bees</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2004/06/what-do-you-do-when-security-software.asp">What Do You Do When Security Software Cocks-It-Up?</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2004/06/all-right-now-what.asp">All Right, Now What?</a><br />
    </p>
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="Wednesday, September 01, 2004" href="#Wednesday, September 01, 2004">
          <font color="#660000">Wednesday, September 01, 2004</font></a></h3>
   	

	<div class="posts">
	<a name="109410403307409781"></a>
    ...
    <p>
	I gave up on the nice new XHTML-strict templates that Blogger has been providing as an easy way to look nice and be sharp.&#160; I couldn't stand the way the sidebar and the body column <a href="http://nfocentrale.net/orcmid/BlunderDome/clueless/2004_06_20_clu-chive.asp">fought for the available width</a> and squeezed one or the other to the bottom of a very long page.&#160; There may be a way around that, but I knew it would work if I committed the small sacrilege of reverting to HTML 4.01 with a modest use of tables.&#160; This is strictly a case of what works <em>now</em>, and I remind the markup bigots that depricated is not the same as forbidden; practice will determine when anything I'm using here truly disappears from browser support.<br /><br />Also, I hate rigid pages, and the new template had the page controlled down to the <em>pixel</em>.&#160; Since many of the pretty-pretties were accomplished by wedging rounded-corner images over there, and tucking a box under here, I couldn't see myself figuring out how to get around the massive nesting of styles to make it do what I wanted.&#160; Although Douglas Bowman's Rounders are very appealing.&#160; I learned that wasn't simple enough for all I want to do.<br /><br />The simplified look inaugurated with this post is borrowed from the old-standby <em><a href="http://orcmid.com/blog/">Orcmid's Lair</a></em> and <em><a href="http://miser-theory/astraendo/pn/">Numbering Peano</a></em> layouts.&#160; I can dress it up more later.&#160; For now, I have the content laid out the way I want with images and screen shots inserted the way I want them.&#160; My one regret is that the user can't control body flow and line width by adjusting the browser when there are wide images on the page.&#160; That I am willing to figure out.&#160; I'll even take advice on how to accomplish that.<br /><br />Making this change also means that we'll be <a href="http://nfocentrale.net/orcmid/blog/2004_08_29_lair-chive.asp#2004-08-30">seeing double</a> some <a href="http://nfocentrale.net/miser/astraendo/pn/2004_08_29_pn-chive.asp#2004-08-31">more</a>.&#160; It was already that way, just not so noticeable amid the glitz.
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2004/09/ending-madness-deja-triple-vu.asp">9/1/2004 10:34:26 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2004/09/ending-madness-deja-triple-vu.asp">
        ...
        <a href="http://www.blogger.com/comment.g?blogID=7336679&postID=109410403307409781">Post a Comment</a>
		</div>
