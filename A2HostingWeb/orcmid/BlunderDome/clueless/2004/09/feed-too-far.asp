...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2004/09/feed-too-far.asp 3     05-01-22 13:40 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: A Feed Too Far</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="Monday, September 06, 2004" href="#Monday, September 06, 2004">
          <font color="#660000">Monday, September 06, 2004</font></a></h3>
   	

	<div class="posts">
	<a name="109451249502902377"></a>
    
    <h2><font color="#000080"><!-- 2004-08-31 -->
    <a href="http://orcmid.com/sostegno/X040901.htm"
                    title="external link">
    A Feed Too Far
    </a>
    </font></h2>
    ...
    <p>
	I just corrected a problem of my own making around the recurring disappearance of "<a href="http://orcmid.com/BlunderDome/clueless/2004/07/why-learn-assembly-language.asp">Why Learn Assembly Language?</a>"&#160; Unfortunately, the cure to that problem caused my Atom site feed to be updated.<br /><br />If you subscribe to the feed, you'll likely see that the feed reader presented several articles as updated, not merely the one I touched.&nbsp; If you look closely, you'll see that the consistent difference is that the links to the actual posts are messed up in the "updated" feed entries.&nbsp; This is the problem discussed under "<a href="http://orcmid.com/blog/2004/09/honey-whered-you-put-bloggo.asp">Honey, Where'd You Put the Bloggo?</a>"&nbsp; Not every feed reader need do this, but don't be surprised if yours does. <br /><br />When the problem is eventually corrected, you'll see apparent updates of several entries once again.&nbsp;  This might not catch them all, because the feed is only regenerated for a number of recent posts, something like the current population of the blog's <a href="http://orcmid.com/Blunderdome/clueless/">default page</a>.<br /><br />I have the following prophylaxis to recommend.&nbsp; If your feed reader shows you several entries for the same article, some marked newer than others, keep ones with proper specific URLs for the article location and discard the ones that don't use specific URLs for the articles.&nbsp; The non-specific URLs are something like <a href="http://orcmid.com/BlunderDome/clueless/2004_08_29_clu-chive.asp">http://orcmid.com/BlunderDome/clueless/2004_08_29_clu-chive.asp</a> instead of the specific link <a href="http://orcmid.com/BlunderDome/clueless/2004/09/security-is-programming-problem.asp">http://orcmid.com/BlunderDome/clueless/2004/09/security-is-programming-problem.asp</a>.&nbsp; Keep the feed entries with specific links (assuming you want to keep the entry in the first place).<br /><br />We now return you to regularly-scheduled programming.<br /><br />
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2004/09/feed-too-far.asp">9/6/2004 03:45:20 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2004/09/feed-too-far.asp">
        ...
        <a href="http://www.blogger.com/comment.g?blogID=7336679&postID=109451249502902377">Post a Comment</a>
		</div>
