...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2004/09/security-is-programming-problem.asp 3     05-01-22 13:41 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: Security is a Programming Problem?</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
    ...
    <p>
	<a href="http://acmqueue.com/modules.php?name=Content&amp;pa=showpage&amp;pid=160">ACM Queue: Why is it we can't seem to produce secure, high-quality code?</a>&nbsp; This article in ACM Queue managed to be <a href="http://slashdot.org/article.pl?sid=04/06/28/170245">slash-dotted</a>.&#160; I can see why.&#160; Author Marcus Ranum claims that security is a programming problem.&#160; I beg to differ.&#160; Bugs and security vulnerabilities are not the same thing.<br /><br />It seems to be part of the magical thinking around computer-based systems that if we could just get the software right, problems with security would vanish.&#160; I have no objection to getting the software right (or way better, at least).&#160; But seeing elimination of bugs as the silver bullet of security strikes me as near-delusional.&#160; It's also the hard way of getting to improved security.&#160; Think of all the bugs and related defects that <em>don't</em> create openings for exploits.&#160; And consider that serious problems like spam, while exacerbated by exploits, don't depend on hidden defects by which programs fail to meet the measurable requirements set for them.<br /><br />It is not about programming.&#160; It is often about system engineering, operations management, and business practice.<br /><br />It is a mystery for me what value is found in scapegoating programming.&#160; The marvel of it all is that software developers (want to) believe it too.&#160; Why?&#160; What is it we want so badly to be distracted from that we buy into this?
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2004/09/security-is-programming-problem.asp">9/1/2004 11:58:13 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2004/09/security-is-programming-problem.asp">
        ...
        <a href="http://www.blogger.com/comment.g?blogID=7336679&postID=108844866476271000">Post a Comment</a>
		</div>
