...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2004/06/all-right-now-what.asp 3     05-01-22 13:40 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: All Right, Now What?</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="Wednesday, June 16, 2004" href="#Wednesday, June 16, 2004">
          <font color="#660000">Wednesday, June 16, 2004</font></a></h3>
   	

	<div class="posts">
	<a name="108743152423004140"></a>
    ...
    <p>
	<h3>All Right, Now What?</h3>This is the inaugural posting to <strong><em>Professor von Clueless in the Blunder Dome</em></strong>.<br /><br /><strong>Professor What?</strong>&nbsp; The cleverest album title I know is <em>Baron von Tollbooth and the Chromium Nun</em>.&nbsp; So, when I had the itch to move my clueless exploits to their own blog, it seemed like the right thing.<br /><br /><strong>Blunder Dome?</strong>&nbsp; There are two reasons for that choice.&nbsp; The first has to do with Mad Max and my admiration for <a href="http://www.tina-turner.com/">Tina Turner</a>'s music.&nbsp; Although I once thought of signing up for a MTV raffle for a date with Tina in London, the <a href="http://nfocentrale.net/orcmid/blog/2004/06/inner-dork-hero-in-my-own-mind.asp">inner dork</a> raised the obvious question: What if you win?&nbsp; I didn't apply.&nbsp; Clueless, right?<br /><br /><strong>Uh, Blunder?</strong>&nbsp; Well, it is all in honor of causticTech (caution: <a href="http://caustictech.typepad.com/caustictech/2004/06/i_know_everythi.html">strong language ranting</a>), since I fit his <a href="http://caustictech.typepad.com/caustictech/2004/06/intro.html">profile of disdain</a> so closely:<blockquote><ul><li><strong>Enterprise this!</strong>&nbsp; Yup, I use "enterprise."  I use it as a noun.&nbsp; I don't verb it much ... well, I just did, didn't I?</li><li><strong>Architect</strong>.&nbsp; Yup, I say I am a system architect.&nbsp; I don't think it takes a great codesmith to be an architect.&nbsp; That might even be a hindrance.&nbsp; You'll see that von Clueless has no limitation on that score.</li><li><strong>SOA, Web Services, and Best Practices</strong>.&nbsp; Gee, seem perfectly good to me.&nbsp; And I do tend to favor "benchmark" and "best-of-breed" too.</li><li>Oh, and I love my <a href="http://caustictech.typepad.com/caustictech/2004/06/why_do_programm.html">kakhis</a>.</li></ul></blockquote>I notice that I am more sensitive about this than I thought.&nbsp; Hmm, a little clueless embarassment perhaps.&nbsp; The causticTech rants are very funny.<br /><br /><strong>OK, what goes here?</strong>&nbsp; The topic is all of the fumbling around that it takes to confirm and make repeatable anything to do with having a computer jump up and fetch the ball without running into a tree first.&nbsp; It is a live-action capture on some interesting experiences, such as "<a href="http://nfocentrale.net/orcmid/blog/2004/05/and-little-phish-have-bigger-phish-to.asp">and the little phish have bigger phish to bite them</a>," only more so.&nbsp; And I have to be prepared to look stupid, pursue bad ideas too far, and generally muck it up.<br /><br />First, I need to have this site made over.&nbsp; I'll have lab rat <a href="http://orcmid.com/BlunderDome/wingnut/">Spanner Wingnut</a> take a crack at that, since it is lined up with what <strong>that</strong> blog is for.<br /><br /><strong>Well, I wonder if we made it</strong>.&nbsp; HELLO?&nbsp; Hello?&nbsp; <small>Is this mike on?<br /><blockquote><dl><dt><em>Listening to:</em></dt><dd><strong>Tina Turner</strong>&nbsp; <em>One Last Time Live in Concert</em> DVD Video, Teamwork Productions (2000).</dd></dl></blockquote>[reposted 2004-06-18-14:38Z and the two flavors of heading show us that we are in the right place, along with updating the Atom feed.&nbsp; Sigh.]</small>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2004/06/all-right-now-what.asp">6/16/2004 05:01:23 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2004/06/all-right-now-what.asp">
        ...
        <a href="http://www.blogger.com/comment.g?blogID=7336679&postID=108743152423004140">Post a Comment</a>
		</div>
