...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /A2HostingWeb/orcmid/BlunderDome/clueless/2008_01_27_clu-chive.asp 1     08-10-07 14:29 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: 2008-01-27</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
    ...
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2008/02/cybersmith-10-golden-rules-for-mastery.asp">Cybersmith: 10 Golden Rules for Mastery</a><br />
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="2008-02-01" href="#2008-02-01">
          <font color="#660000">2008-02-01</font></a></h3>
   	

	<div class="posts">
	<a name="2516617949360523698"></a>
    ...
    <p>
	<div style="clear:both;"></div><p></p> <div class="wlWriterSmartContent" id="scid:0767317B-992E-4b12-91E0-4F059A8CECA8:565d9939-2d77-4ea9-9494-4caf516153d8" style="padding-right: 0px; display: inline; padding-left: 0px; padding-bottom: 0px; margin: 0px; padding-top: 0px">Technorati Tags: <a href="http://technorati.com/tags/computer%20science" rel="tag">computer science</a>, <a href="http://technorati.com/tags/Andrew%20Tanenbaum" rel="tag">Andrew Tanenbaum</a>, <a href="http://technorati.com/tags/cybersmith" rel="tag">cybersmith</a>, <a href="http://technorati.com/tags/VC++%20novice" rel="tag">VC++ novice</a>, <a href="http://technorati.com/tags/software%20engineering" rel="tag">software engineering</a>, <a href="http://technorati.com/tags/SE4E" rel="tag">SE4E</a></div> <p></p> <p><a href="http://blogs.msdn.com/alfredth/archive/2008/01/30/10-golden-rules-for-teaching-computer-science.aspx">10 Golden Rules for Teaching Computer Science</a>.&nbsp; Computer science teacher Alfred Thompson just posted a great article on <a href="http://www.cs.vu.nl/~ast/">Andrew Tanenbaum</a>'s 10 Golden Rules for Teaching Computer Science.&nbsp; These rules can be your guidance to learning and mastery of cybersmithing:</p> <ol> <ol> <li><a href="#1.0">Think long term</a>  <li><a href="#2.0">Emphasize principles, not facts</a>  <li><a href="#3.0">Expect paradigm shifts</a>  <li><a href="#4.0">Explain how things work inside</a>  <li><a href="#5.0">Show students how to master complexity</a>  <li><a href="#6.0">Computer Science is not science</a>  <li><a href="#7.0">Think in terms of systems</a>  <li><a href="#8.0">Keep theory under control</a>  <li><a href="#9.0">Ignore hype</a>  <li><a href="#10.0">Don't forget the past</a></li></ol></ol> <p>The examples and explanations in Tanenbaum's slide set are not to be missed [<a href="#1">1</a>].&nbsp; Here is a paraphrase emphasizing self-guided learning and personal practices:</p> <ol> <li><strong><a name="1.0">Think long term</a><br>&nbsp;&nbsp; </strong><br>The Y2K problem resulted from short-term thinking.&nbsp; Your software will be used longer than you think, and under more circumstances than you think.&nbsp; Your web site will be viewed with more browsers and from more devices by different people than you think you have to accommodate.&nbsp; There <em>will</em> be a need for maintenance of your code and you <em>will</em> need a way to troubleshoot incidents experienced by its users.&nbsp; There <em>will</em> be new releases of operating systems, code libraries, and developer tools.&nbsp; There <em>will</em> be changes in business systems and practices.&nbsp; There <em>will</em> be a need to replace or retire your software and the equipment it runs on.&nbsp; There <em>will</em> be outages, hardware failures, office fires, earthquakes, storms, and floods that make computer systems unusable or inaccessible.<br><br><em>Assignment:</em> Consider how the other rules relate to this principle.&nbsp; Look for ways that you fail(ed) to think long term and identify strategies that would preserve what you know and do over time (including changing what you choose to learn and what you do as a strategy for the long term).<br>&nbsp;&nbsp; <li><strong><a name="2.0">Seek out principles over facts</a><br>&nbsp;&nbsp; <br></strong>As a novice and budding cybersmith, you have had to absorb a mountain of facts in order to embrace a particular toolcraft.&nbsp;&nbsp; Many of those details and facts obscure important principles that will serve you beyond those particular facts and the special-case of the day.&nbsp; From principles, one can redevelop and confirm the details that matter.&nbsp; You cannot escape facts, but you can use principles to bring order to them.<br>&nbsp;&nbsp;&nbsp; <br><em>Assignments:</em> Identify principles that you have found that apply in the cybersmithing that you do.&nbsp; What level does the principle live at (coding, program design, development methodology, quality assurance, etc.)?&nbsp; Find one example of conditions where an exception to the principle applied.&nbsp; Identify principles by which you can operate without learning all of the relevant facts in advance.&nbsp; What's a common feature of exceptions to those principles?<br>&nbsp;&nbsp; <li><strong><a name="3.0">Expect paradigm shifts</a></strong>&nbsp;<br>&nbsp;&nbsp;&nbsp; <br>Do not think of every change of technology as a new paradigm.&nbsp; Some paradigms (ways of looking at and operating in the world) bring back older paradigms in new clothes (see rule 10).&nbsp; <br>&nbsp;&nbsp; <br><em>Assignment:</em> One automatic cost of operating within a particular paradigm is that it makes other paradigms invisible and inconceivable.&nbsp; Find an example of this.&nbsp; Consider how one might become alert to occurrence of different paradigms.<br>&nbsp;&nbsp; <li><strong><a name="4.0">Discover how things work inside</a></strong><br>&nbsp;&nbsp; <br>There are two problems that require some understanding of what is going on under the covers.&nbsp; First, having an incorrect conceptual model (whether mythical, folklore, what someone else said, or your own misguided speculation) will lead to misunderstanding of the connection over what you can control and what the outcome is.&nbsp; Secondly, when there are breakdowns, in very many cases it is necessary to understand how things work inside because the breakdown is exposed at (and exposes) the underlying workings.&nbsp; <br>&nbsp;&nbsp; <br>This applies to some degree in the use of computer-based systems, but it applies especially to those who are involved in the construction, support, and trouble-shooting of computer-based systems.&nbsp; Treating symptoms without understanding internal workings is not only wasteful and time-consuming, it can be dangerous.&nbsp; <br>&nbsp;&nbsp; <br><em>Assignments:</em>&nbsp; Consider the value to you of these levels of knowledge: Explaining the program build process and all that it depends on for any compiler system you use.&nbsp; Knowing how to find out what a compilation process is and how failures at different stages can be resolved.&nbsp; Knowing what it takes to deploy a computer program to a different computer than the one it is developed on.&nbsp; Knowing why these things are the way they are.&nbsp; When a program/script/web page of yours fails, knowing how to isolate the problem and also demonstrate it in a repeatable way.&nbsp; Now consider depths of knowledge that might be interesting but do not increase your mastery of cybersmithing at the level you practice it.&nbsp; Name at least two.<br>&nbsp;&nbsp; <li><a name="5.0">Study how masters deal with complexity</a>&nbsp;<br>&nbsp;&nbsp; <br>As suggested in Tanenbaum's slide set, there are two thrusts in the mastery of complexity: avoiding it altogether and confining unavoidable complexity. <br>&nbsp;&nbsp; <br><em>Assignment:</em> Find some masters to learn from.&nbsp; Their work may be available in books and even in computer code.&nbsp; Look for the principles embodied in their work.<br>&nbsp;&nbsp; <li><a name="6.0">Software development is engineering and construction, not science</a>&nbsp;<br>&nbsp;&nbsp; <br>There are scientific and mathematical principles that govern the operation of computing systems.&nbsp; But the construction of software (even programs that are produced as a science project) involves construction of real artifacts.&nbsp; The reliable, on-purpose construction of those artifacts to have important observable properties is accomplished with engineering practices.&nbsp; There is craft in the writing of individual elements of code, but the overall development and integration of a complete result takes engineering.<br>&nbsp;&nbsp; <br><em>Assignments:</em> Find a copy of Steve McConnell's <em>Code Complete</em> (either edition)[<a href="#2">2</a>].&nbsp; Notice what he identifies as craft of software construction and contrast that with the full-up move to professional development as an engineering activity[<a href="#3">3</a>].&nbsp; You won't find much emphasis on computer science here, although scientific study of software development and engineering does come up.&nbsp; Identify at least one subject of computer science that is usefully applied by the software developer.<br>&nbsp;&nbsp;&nbsp; <li><a name="7.0">Think in terms of systems</a><br>&nbsp;&nbsp;&nbsp; <br>As my friend Bill is always ready to remind me, it is very important to look at how software and computers are embedded systems.&nbsp; Software is used instrumentally on behalf of particular applications, whether by being applied by other software or exercised in the work practices of people.&nbsp; Those people and their activities are part of the system in which the programs and computers are instruments.&nbsp; The programs are not the "solutions" and they are not the applications.<br>&nbsp;&nbsp; <br><em>Assignment:</em> Look at who the people are who will be applying your software to some purpose that is important to them.&nbsp; Consider what that purpose is on behalf, and again, until you have found an entirely-human purpose that has nothing to do with technology.&nbsp; Now, how will what you are producing be as amenable to that purpose, with the least distraction of the human from achievement of their objectives.<br>&nbsp;&nbsp;&nbsp; <li><a name="8.0">Keep theory under control</a>&nbsp;<br>&nbsp;&nbsp;&nbsp; <br>Unless your development activity really is a science project, you do not want to be making theoretical explorations as part of a production software development activity.&nbsp; Tanenbaum suggests that the appropriate reliance on theory is the construction of a model that accurately describes the essentials of the system being developed.&nbsp; Don't forget rule 7 and ensure that the model embraces essential end-to-end functions.<br>&nbsp;&nbsp; <br><em>Assignment:</em> Consider whether you rely on theory and theory formulation at all.&nbsp; Do you have explainable conceptual models of how your software operates and fits into a system?&nbsp; Do you have concrete measures of when your software is complete and does the job it is required for?<br>&nbsp;&nbsp;&nbsp; <li><a name="9.0">Ignore hype</a>&nbsp;<br>&nbsp;&nbsp; <br>Develop your critical judgment and hype detector.&nbsp; Claims made with no context and with no demonstration of how they were developed and validated are immediately suspect.&nbsp; Claims about improvements without any account for the cost of movement to new products, tools, methodologies or whatever are also to be viewed with skepticism.&nbsp; <br>&nbsp;&nbsp; <br><em>Assignment:</em> Notice how easy it is to believe that something that does not exist will somehow lack all of the deficiencies of that which is known.&nbsp; Also notice where you automatically find changing more costly and disruptive than what you are doing now.&nbsp;&nbsp; What attitude can you adopt that avoids these untenable extremes?<br>&nbsp;&nbsp;&nbsp;&nbsp; <li><a name="10.0">Mine the past ... repeatedly</a><br>&nbsp;&nbsp; <br>Tanenbaum points out that there are developments from the past (virtual machines, interpreters, and time-sharing) that have been reinvented in the present.&nbsp; Old ideas are not necessarily obsolete ideas.&nbsp; I think there is more to it than that.&nbsp; One needs a relationship to the work of the past by which one can appreciate how it does and does not apply now, or apply in a new way.&nbsp; <br>&nbsp;&nbsp; <br><em>Assignment:</em> Take on the practice of finding past results and experiences that you can build upon in addressing a new concern.&nbsp; This may involve learning how to research past work and knowing where there are resources that may support you.&nbsp; You'll have to accept that earlier work may not be in a form that is directly usable, and overcoming that is also important.&nbsp; You don't have to research everything all of the time, just have means available and have experience using them.</li></ol> <p>I've turned a few of them around to address what it is you have control over in your own practice, rather than what you might be doing when coaching or mentoring someone else.</p> <p>For your first assignment in the application of rule 10, here are important resources.&nbsp; I could have chosen others, but these, especially the McConnell books, will provide avenues to a rich collection of resources that you can rely on:</p> <dl> <dt>[<a name="1">1</a>] Andrew Tanenbaum: Ten Golden Rules for Teaching Computer Science.  <dd>Presentation to the 28th SIGCSE Technical Symposium on Computer Science Education, San Jose, California, February 27 - March 1, 1997.&nbsp; The slide set is available as a 2.3 MB <a href="http://www.cs.vu.nl/~ast/talks/cse-97/cse-97.pdf">PDF file</a>.<br>&nbsp;&nbsp; <dt>[<a name="2">2</a>] Steve McConnell: <em>Code Complete</em>, second edition.  <dd>Microsoft Press (Redmond, WA: 2004).&nbsp; ISBN 0-7356-1967-0 pbk.&nbsp; There is a comprehensive bibliography and useful references to other resources.&nbsp; The book <a href="http://cc2e.com/">web site</a> provides enough materials to get a sense of what McConnell considers the craft of software construction.&nbsp; If you are a web site developer or are using some of the newer higher-level development systems, the examples here should be considered for the principles they reflect, illustrating them with details that arise in your own craft specialty. <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <dt>[<a name="3">3</a>] Steve McConnell: <em>Professional Software Development</em>.  <dd>Addison Wesley (Boston: 2004).&nbsp; ISBN 0-321-19367-9 pbk.&nbsp; This is toward professional level development and it features software engineering as a discipline.&nbsp; This is an overview book, not a how-to-be-an-engineer book.&nbsp; You can obtain a sense for the difference in perspective by exploring the <a href="http://www.stevemcconnell.com/psd.htm">book material</a> on McConnell's web site.</dd></dl>  <div style="clear:both; padding-bottom:0.25em"></div>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2008/02/cybersmith-10-golden-rules-for-mastery.asp">2/01/2008 02:54:00 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2008/02/cybersmith-10-golden-rules-for-mastery.asp">
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&postID=2516617949360523698">Post a Comment</a>
		</div>
