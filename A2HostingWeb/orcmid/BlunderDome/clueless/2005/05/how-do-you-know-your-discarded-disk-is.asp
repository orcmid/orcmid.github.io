...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2005/05/how-do-you-know-your-discarded-disk-is.asp 2     06-02-03 22:44 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: How Do You Know Your Discarded Disk Is Unreadable?</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
    ...
    <p>
	<p><a href="http://www.acm.org/technews/articles/2005-7/0502m.html#item12">ACM News Service: Skeletons on Your Hard Drive</a>.&nbsp; This blurb is a great reminder of how much we put faith in two things: What people tell us their service or disk wiper software provides, and what we believe because we don&rsquo;t know how to read the wiped data ourselves.&nbsp; We tend to forget that a culprit out for your information or&nbsp;simply opportunistically scanning for anyones goodies and private&nbsp;files&nbsp;is going to attempt things we aren&rsquo;t equipped to verify ourselves.</p><p><strong>This is distressing for me because I am a big advocate of arrangements that I&nbsp;term&nbsp;&ldquo;confirmable experience.&rdquo;</strong>&nbsp; Confirmable experiences,&nbsp;such as two end parties having the tools they need to figure out why an e-mail communication is failing, have a strong&nbsp;cooperative component&mdash;the willingness to arrange, use, and exchange confirmatory findings.&nbsp; You and I may successfully arrange to run the same tests at a distance, or tolerate failures&nbsp;in ways that the defect can be discovered.&nbsp; More than that, I am able to communicate what I am seeing to the other party so that the end-to-end picture can be pieced together.&nbsp; That&rsquo;s&nbsp;completely different&nbsp;than the situation where someone is willfully seeking an exploit and has no interest in my awareness of it, let alone confirming it with me.</p><p><strong>So here we are having to think about the unseen</strong> and putting faith that its invisibility to us means it is truly inaccessible.&nbsp; It&rsquo;s one of those moments that brings William Kingdon Clifford&rsquo;s challenging &ldquo;The Ethics of Belief&rdquo; sharply into recall.</p><p><strong>Matt Hines&rsquo; 2005-04-20 </strong><a href="http://news.com.com/Skeletons+on+your+hard+drive/2100-1029_3-5676995.html"><strong><em>CNet News.com</em> article</strong></a> provides more details and information about how to wipe disks properly if you&rsquo;re going to rely on such techniques.&nbsp; </p><p><strong>All of this is of little help for ordinary theft of a laptop.</strong>&nbsp; There you have a pristine hard drive with what the user wants to be there, in all its glory.&nbsp; Not only am I bothered by&nbsp;it apparently being quite easy for my laptop to be reset to an insecure default startup configuration, with physical access to the machine a thief can simply remove the hard drive and examine it at leisure using a different machine, so I have to protect the data on the drive&nbsp;in a direct way.&nbsp; Mostly, I don&rsquo;t want anyone else to be able to use the machine with my hard drive in it, and I&rsquo;d rather the thief be discouraged in trying to use&nbsp;anything that is on that&nbsp;drive, especially the operating system itself.&nbsp; A determined perpetrator won&rsquo;t&nbsp;be dissuaded, but I&rsquo;d like to cut down on the hazards of ordinary theft of a mobile device.&nbsp; </p><p><strong>If encryption is the answer, how do I rely on that, and whose product can I trust?</strong>&nbsp; How does it impact my day-to-day ability to operate?&nbsp; I have no idea.&nbsp; What I know is that I have little way of telling whether the safeguards are really working as claimed, just as I have to rely on my antivirus software being benign, on my software firewall really protecting my system, and my residential router actually being impenetrable from the net, especially with a DSL modem in front of it.&nbsp; I am left with Clifford&rsquo;s challenge: What right do I have to believe that I am protected by these measures?</p>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2005/05/how-do-you-know-your-discarded-disk-is.asp">5/3/2005 11:12:48 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2005/05/how-do-you-know-your-discarded-disk-is.asp">
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=111518716897202516">Post a Comment</a>
		</div>
