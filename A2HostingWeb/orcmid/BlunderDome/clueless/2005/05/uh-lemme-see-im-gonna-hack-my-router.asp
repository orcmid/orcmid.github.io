...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2005/05/uh-lemme-see-im-gonna-hack-my-router.asp 1     05-05-11 22:54 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: Uh, lemme see, I'm gonna hack my router and expose my residential LAN to the Internet ... Not.</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
    ...
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2005/04/flint-for-bug-free-secure-and-reliable.asp">FLINT for bug-free, secure, and reliable software.&nbsp; That should cover it!</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2005/04/trust-2-proliferation-of-cots-in.asp">TRUST 2: Proliferation of COTS in Critical Infrastructure</a><br />
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="Tuesday, May 03, 2005" href="#Tuesday, May 03, 2005">
          <font color="#660000">Tuesday, May 03, 2005</font></a></h3>
   	

	<div class="posts">
	<a name="111514075471441323"></a>
    ...
    <p>
	<p><a href="http://joi.ito.com/archives/2005/05/03/earthlink_rd_shows_that_ipv6_can_be_easy.html">Joi Ito's Web: Earthlink R&amp;D shows that IPv6 can be easy</a>.&nbsp; Joi Ito notices a great announcement on migration of some routers to IPv6 in a way that preserves IPv4 and NAT and allows you to have <a href="http://www.research.earthlink.net/ipv6/">serious IPv6 addressing of machines on your LAN</a>.&nbsp; Typically, you&rsquo;ll need a recent operating system release, such as Windows XP or OSX or Linux that tends to support a dual stack and/or tunneling of one through the other.</p><p>The nice thing is being able to have a block of permanent IP addresses.&nbsp; I am not sure I know how to get my ISP (I&rsquo;m on DSL) and border systems to route them to me,&nbsp;and I have a lot more questions before I&rsquo;m willing to try it.</p><p><strong>First, let me say this is great news</strong>.&nbsp; As recently as Spring 2004, while I was in an M.Sc in IT Computer Communications course, it looked like the disruption&nbsp;of our in-place systems and all of those small routers and nodes, just&nbsp;for an IPv6 migration ,was near-insurmountable.&nbsp; We have an interim scheme (IPv4 with NAT) that works so well there is not a strong business need to fix it in North America.&nbsp; It&rsquo;s not that broke that we need to fix it, and the migration has no benefit until it is done.&nbsp; That&rsquo;s like setting a time-bomb in Visual Basic 6.0.&nbsp; Nobody wants to <a href="http://www.joelonsoftware.com/items/2005/03/14.html">spend the money just to stand still</a>.</p><p><strong>What about transitional security?</strong>&nbsp; My concern is two-fold.&nbsp; I don&rsquo;t think I want to install any research-center&rsquo;s firmware upgrade on my Linksys residential router <strong>and firewall</strong> without giving it a good hard think.&nbsp; This is primary infrastructure stuff, and I am not sure I see all of the pieces in place to put my trust in (l) not knowing what&rsquo;s running in my first-line of network protection at the border to my SOHO LAN, and (2) exposing my systems to IP addresses that are addressable by anyone who sniffs for them.&nbsp; I&rsquo;m certain that I don&rsquo;t have appropriate safeguards for what happens when that avenue of attack succeeds against some system inside the residential firewall.</p><p><strong>How Is That Any Worse Than What We&rsquo;ve Got?</strong>&nbsp; My point.&nbsp; We&rsquo;ve been prepped to expect that IPv6 will solve our infrastructure (that is, basic Internet and IP) security problems as well as provide fixed addresses for every wandering mote on the planet.&nbsp; (I&rsquo;m assuming that not everyone gets a block of addressses as big as <a href="http://www.toyz.org/mrblog/archives/00000193.html">Mr. Blog reports</a>, or we&rsquo;ll run out of those faster than IPv4 addresses.)&nbsp; Now that it looks like we don&rsquo;t have to have a planetary Sunday in Sweden to switch over and some big&nbsp;bumps seem to have been smoothed out, let&rsquo;s get the security and safety part down pat while we have the opportunity.&nbsp; That will take more than the&nbsp;common assertion that IPsec is the answer.</p><p><strong>I really don&rsquo;t know what&rsquo;s running in my residential router now, do I?</strong>&nbsp; Do you (in mine or yours)?&nbsp; Perhaps it is time to raise the bar on how we establish trustworthiness for those fixtures we&rsquo;ve been accustomed to accepting without question.&nbsp; And then there&rsquo;s the trustworthiness of the way we integrate all of this beneath the useful applications that is what we&rsquo;re really interested in, and what that does to the vulnerability picture.</p><p><strong>I&rsquo;m going to take my time on this one before I go skipping naked through the jungle that the Internet has become</strong>.&nbsp; I think I&rsquo;ll keep those torches stacked near the cave mouth and be careful not to let the fire got out at night, thank you very much [;&lt;).</p><p><em></em></p>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2005/05/uh-lemme-see-im-gonna-hack-my-router.asp">5/3/2005 10:19:14 AM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2005/05/uh-lemme-see-im-gonna-hack-my-router.asp">
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=111514075471441323">Post a Comment</a>
		</div>
