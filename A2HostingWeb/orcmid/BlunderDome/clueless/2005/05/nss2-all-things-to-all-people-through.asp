...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2005/05/nss2-all-things-to-all-people-through.asp 2     06-02-03 22:44 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: NSS2: All Things to All People through Perfect Software</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
    ...
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2005/04/trust-points-and-trust-issues.asp">Trust Points and Trust Issues</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2005/04/how-do-we-safely-orient-for-aspects.asp">How Do We Safely Orient for Aspects?</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2005/04/conquering-business-application-life.asp">Conquering the Business-Application Life Cycle</a><br />
    </p>
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="Saturday, May 07, 2005" href="#Saturday, May 07, 2005">
          <font color="#660000">Saturday, May 07, 2005</font></a></h3>
   	

	<div class="posts">
	<a name="111552943204780616"></a>
    ...
    <p>
	<p><a href="http://www.acm.org/technews/articles/2005-7/0506f.html#item7">ACM News Service: Summit Calls for &lsquo;National Software Strategy&rsquo;.</a>&nbsp; The Second National Software Summit reported on the need for a national strategy that has something for everybody, so long as they&rsquo;re on-shore:</p><ul><li>Improved software trustworthiness</li><li>Empowered U.S. software workforce</li><li>Re-invigorated software R&amp;D</li><li>Encouraged software-industry innovation</li></ul><p>Naturally, we&rsquo;ll support the critical infrastructure, build software using known best practices, routinely develop trustworthy software products, establish a competitive U.S. software industry, and&nbsp;put a&nbsp;chicken in every pot.&nbsp; </p><p>To oversee this broad strategy (dare I say grand challenge),&nbsp;a similarly-representative group (of industry, government, and academic representatives, of course) is to be constituted as the National Software Strategy Steering&nbsp;Group and meet every three years.</p><p>But wait, save your matches,&nbsp;NSS2 sees&nbsp;light at the end of the tunnel.&nbsp; There&rsquo;s a vision:</p><ul><li>Stop accepting poor software quality as a fact of life.</li><li>We already know how to build better quality software (a real fact)</li><li>We need to&nbsp;invest in better software engineering for the future (another real fact)</li></ul><p>Oh, and a gap or two that need to be closed:</p><ul><li>lack of adequate tools and technology for building error-free software (uh oh, is this a real fact too?)</li><li>failure to apply best practices in software development</li><li>the significant threat to the software workforce from overseas competition</li></ul><p>It&rsquo;s wonderful to have so much scope and mission creep without leaving the starting gate, isn&rsquo;t it?&nbsp; </p><p>Which is to say, here we go, doing the same thing over and over again and expecting a different result.&nbsp; Except we now have to worry about the barbarian hoards doing it cheaper.</p><p>I don&rsquo;t know why I&rsquo;m so pissy about this except that it reads just like every high-minded-committee output that includes everyones agenda and everyones pet unsuccessful solution, with a&nbsp;road map that is no different than any road map we&rsquo;ve ever seen before and that is blindly trusted to get to the destination that we&rsquo;ve failed to reach time after time.</p><p>So, where did this&nbsp;inspiring account arise.&nbsp; Oh, from Reston Virginia, on the <a href="http://www.prnewswire.com/cgi-bin/stories.pl?ACCT=109&amp;STORY=/www/story/05-05-2005/0003544966">2005-05-05 PR Newswire</a>, under the title &laquo;&lsquo;Software 2015&rsquo; Program Addresses &lsquo;Unacceptable Risks and Consequences of Software Failure&rsquo;&raquo;.&nbsp; The PR that this news blurb is about heralds the new report, &ldquo;Software 2015: A National Software Strategy to Ensure U.S. Security and Competitiveness.&rdquo;</p><p>The original press release is a bit more coherent, though it is not clear that it is any more promising.&nbsp; The NSS2 meeting was apparently&nbsp;convened under the Center for National Software Studies (<a href="http://www.cnsoftware.org/">CNSS</a>), a not-for-profit <strong>with the <em>mission</em> of elevating software to the national agenda</strong>.&nbsp; I like it that their home-page logo and organization name has a noticeable blur to it.&nbsp; The <a href="http://www.cnsoftware.org/nss2report/">NSS2 Final report</a> is available there as a compilation of several PDFs.&nbsp; The list of issue presenters is impressive, too.&nbsp; There are smart people in this act.&nbsp; Could it be a matter of breathing the air too close to the belt-way?</p><p>I've taken a particular fancy to this bit from the press release:</p><blockquote>The Software 2015 Report makes a compelling case for the urgent need to<br />address critical software issues and problems that pose serious risks to the<br />nation's security and economic well-being and calls on the nation's leaders in<br />all sectors, government, industry and academia, to commit to working together<br />to achieve these common goals.</blockquote><p>I&rsquo;m beginning to understand what people mean when they speak of my breathless prose.&nbsp;&nbsp; </p><p>Look, I&rsquo;m a believer in software engineering practice, raising the level of trustworthiness in software, all of those things.&nbsp; I&rsquo;m willing to devote my life to that. But hawking this fluff&nbsp;the same way we&rsquo;ve been doing it for over 40 years, only louder (and more nonsensically) really frosts my cup cake, you hear?&nbsp;</p><p>I&rsquo;ve down-loaded all of the PDFs and trust my MSN Desktop&nbsp;Search to index them and let me know just what kind of goodies there are in the report.&nbsp; Some&nbsp;really bright and&nbsp;seasoned people may have added to this important conversation.&nbsp; I won&rsquo;t take a chance on having&nbsp;neglected&nbsp;finding some new insight in this work.&nbsp;&nbsp;&nbsp;</p><p>I can see it like it was happening today.&nbsp; Just over 30 years ago, Jack Laschenski turns to me, and says &ldquo;There is no software crisis.&nbsp; If there were, we&rsquo;d&nbsp;have to do&nbsp;something about it.&rdquo;&nbsp; We&rsquo;re still not doing much about it.&nbsp; Maybe it&rsquo;s not real?&nbsp; What would happen if we quit clamoring for more global, top-down intervention of national proportions and actually worked to deliver some trustworthy software.&nbsp; We&rsquo;d then have some handle on a measurable difference that could be made.&nbsp; I am a little afraid of what the lesson might be, but we&rsquo;ll never know until we do it, aye?</p>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2005/05/nss2-all-things-to-all-people-through.asp">5/7/2005 10:17:12 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2005/05/nss2-all-things-to-all-people-through.asp">
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=111552943204780616">Post a Comment</a>
		</div>
