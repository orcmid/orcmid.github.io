...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2005/05/flaws-in-genuine-software-still.asp 2     06-02-03 22:44 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: Flaws in Genuine Software Still Exploitable in Trusted Environment</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="Sunday, May 01, 2005" href="#Sunday, May 01, 2005">
          <font color="#660000">Sunday, May 01, 2005</font></a></h3>
   	

	<div class="posts">
	<a name="111493248512596618"></a>
    ...
    <p>
	<p><a href="http://www.acm.org/technews/articles/2005-7/0429f.html#item19">ACM News Service: Does Trusted Computing Remedy Computer Security Problems?</a>&nbsp; The use of trusted computer systems will make it likely that genuine software will be run under the protections of a trusted environment.&amp;nbsp; This blurb reports an analyis that asserts there will still be vulnerabilities in those programs, and a malicious intruder may be able to exploit them.</p><p>Although it would seem that computers will be more secure, there are a number of ways that trust can fail, and these will tend to be a result of defects in the trusted program that a malicious entity can still exploit.</p><p>The Rolf Oppliger and Ruedi Rytz <a href="http://www.computer.org/portal/site/security/menuitem.6f7b2414551cb84651286b108bcd45f3/index.jsp?&amp;pName=security_level1_article&amp;TheCat=1015&amp;path=security/freebies&amp;file=oppliger.xml&amp;">article</a> in the April 2005 <em>IEEE Security &amp; Privacy</em> issue provides a nice run-down on the trusted computing approach and its limitations.&nbsp; Basically, the trusted computing platform is unable to detect malicious acts that happen at a level where the exploited behavior is indistinguishable from correct behavior based on what the platform observes.&nbsp; Put simply, there can always be vulnerabilities at a higher-level that what the platform protects.&nbsp; The authors question whether this improvement, and it is one, will be acceptable based on the presumed loss of flexibility in being able to install and run software of the user&rsquo;s choosing.&nbsp; There is no generic answer to this question, it seems to me.&nbsp; Different circumstances will have different trade-off preferences, and we&rsquo;ll need to understand those better.</p><p>A side benefit for me is a definition of technical trustworthiness, based on the Glossary of Internet terms: </p><blockquote>&ldquo;trusted and trustworthy systems are not the same; according to <a href="http://www.ietf.org/rfc/rfc2828.txt">RFC 2828</a>&nbsp;[big file],<sup> </sup>a system is trusted if it &ldquo;operates as expected, according to design and policy. If the trust can also be guaranteed in some convincing way, such as through formal analysis and code review, the system is called trustworthy.&rdquo;</blockquote><p><em></em></p>Hmm, interesting, aye Wingnut?
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2005/05/flaws-in-genuine-software-still.asp">5/1/2005 12:28:05 AM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2005/05/flaws-in-genuine-software-still.asp">
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=111493248512596618">Post a Comment</a>
		</div>
