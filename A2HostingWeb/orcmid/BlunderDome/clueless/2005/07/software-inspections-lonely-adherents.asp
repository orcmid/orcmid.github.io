...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2005/07/software-inspections-lonely-adherents.asp 1     05-08-16 17:57 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: Software Inspection's Lonely Adherents</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
    ...
    <p>
	<div style="clear:both;"></div><p><a href="http://www.acm.org/technews/articles/2005-7/0715f.html#item17">ACM News Service: Software Under Scrutiny</a>.&nbsp; I was amazed to see a blurb that features software inspections as something that has not penetrated practice very much.&nbsp; </p><p>Sue Bushell&rsquo;s 2005-07-07 <a href="http://www.cio.com.au/index.php/id;1214283576;fp;16;fpid;0"><em>CIO Australia</em> article</a> confirms that to be the case, with great explanation for how inspections can be tied to demonstrable reduction of software-development costs.&nbsp; The article clarifies the resistance to inspections and also describes the importance of inspection, the common methodology in almost every software process improvement methodology.&nbsp; There are some useful principles as well as an assertion by Karl Wiegers that one of the greatest payoff is in inspection of requirements, about as up-front in the software-development stages as you can get.</p><p>An intriguing factor with regard to inspections is that the payoff approaches 1:1 (break-even) as the development processes become more successful at not having defects in the first place.&nbsp; This may lead management to want to abandon them.&nbsp; It becomes important to have&nbsp;clear understanding of&nbsp;what the phenomenon is.</p><p><em></em></p><div style="clear:both; padding-bottom: 0.25em;"></div>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2005/07/software-inspections-lonely-adherents.asp">7/16/2005 05:49:17 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2005/07/software-inspections-lonely-adherents.asp">
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=112156135753963187">Post a Comment</a>
		</div>
