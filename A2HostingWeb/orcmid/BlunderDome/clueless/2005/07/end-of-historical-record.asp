...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2005/07/end-of-historical-record.asp 1     05-08-16 17:57 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: The End of the Historical Record?</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="Saturday, July 16, 2005" href="#Saturday, July 16, 2005">
          <font color="#660000">Saturday, July 16, 2005</font></a></h3>
   	

	<div class="posts">
	<a name="112156207706211960"></a>
    ...
    <p>
	<div style="clear:both;"></div><p><a href="http://www.acm.org/technews/articles/2005-7/0715f.html#item19">ACM News Service: The Fading Memory of the State</a>.&nbsp; NARA, the National Archives and Records Administration has a painful job for preserving documents in the 16,000 software formats used by the federal government.&nbsp; This is aggrevated by the problem of &ldquo;bit rot&rdquo; which occurs much more rapidly with paper documents.&nbsp; NARA has contracted for a permanent Electronic Records Archive (ERA) that will handle present and future formats in an authentic, available and secure form.</p><p>It is not clear how close we are to accomplishing&nbsp;digital preservation so handily.&nbsp; Meanwhile there is mention of an open-source <a href="http://sourceforge.net/projects/xena">XENA</a> (XML Electronic Normalizing of Archives) being used in Australia.&nbsp; I want to know about that regardless of any reservations I have about the prospects for an ERA.</p><p>David Talbott&rsquo;s July 2005 <a href="http://www.technologyreview.com/articles/05/07/issue/feature_memory.1.asp"><em>Technology Review</em> article</a> is a great read, offering this daunting comparison: &ldquo;The most famous documents in NARA's possession&mdash;the Declaration of Independence, the Constitution, and the Bill of Rights&mdash;were written on durable calfskin parchment and can safely recline for decades behind glass in a bath of argon gas. It will take a technological miracle to make digital data last that long.&rdquo;&nbsp; </p><p><em></em></p><p>The challenge is simply illustrated by the 2000 census data: 40 terabytes of TIFF images.&nbsp; And NARA has a miniscule proportion of the digitally-born documents that it must preserve, and it has no way to take receipt of them.&nbsp; (The Library of Congress is not part of NARA and is making its own provisions for digital preservation and availability.)</p><p>The MIT <a href="http://www.dspace.org/">DSpace</a> project, another open-source effort, is an early example created to preserve scientific research data and papers.&nbsp; The ability to scale to the level of demand that NARA faces is completely untested, however.</p><div style="clear:both; padding-bottom: 0.25em;"></div>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2005/07/end-of-historical-record.asp">7/16/2005 06:01:17 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2005/07/end-of-historical-record.asp">
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=112156207706211960">Post a Comment</a>
		</div>
