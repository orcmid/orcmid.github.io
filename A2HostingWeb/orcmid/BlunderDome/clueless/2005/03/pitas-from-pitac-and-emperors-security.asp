...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2005/03/pitas-from-pitac-and-emperors-security.asp 1     05-04-18 16:32 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: The PITAS from PITAC And the Emperor's Security Cloak</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<div class="posts">
	<a name="111151076995626987"></a>
    
    <h2><font color="#000080"><!-- 2004-08-31 -->
    <a href="http://www.acm.org/technews/articles/2005-7/0321m.html#item1"
                    title="external link">
    ...
    <p>
	<a href="http://www.acm.org/technews/articles/2005-7/0321m.html#item1">ACM News Service: Study Criticizes Government on Cybersecurity Research</a>.&nbsp; A subcommittee of the President's Information Technology Advisory Committee (PITAC) has indicated that the research investment being made, especially in civilian (a.k.a. academic research) areas is inadequate for the Federal objectives being set for cybersecurity, infrastructure, and personnel.  "The report criticizes the commercial cybersecurity strategy of patching, and lists 10 cybersecurity research areas that should take precedence, including cyberforensics, authentication technologies, monitoring and detection tools, and secure protocols."<br /><br />The 2005-03-19 John Markoff <a href="http://www.nytimes.com/2005/03/19/technology/19computer.html"><em>New York Times</em> article</a> (registration and/or fee required) identifies the report, "Cybersecurity: A Crisis of Prioritization."&nbsp; The recommended priorities include "authentication technologies, secure protocols, improved engineering techniques, monitoring and detection tools and cyberforensics."<br /><br />I have a tangential interest with regard to trustworthiness in open-system integration, especially with software components.  This doesn't map directly onto the overall problems of Internet infrastructure protection, but there is enough harmony for me to be paying attention.
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2005/03/pitas-from-pitac-and-emperors-security.asp">3/22/2005 08:59:29 AM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2005/03/pitas-from-pitac-and-emperors-security.asp">
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=111151076995626987">Post a Comment</a>
		</div>
