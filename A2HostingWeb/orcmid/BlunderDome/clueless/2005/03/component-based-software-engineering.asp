...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2005/03/component-based-software-engineering.asp 2     06-02-03 22:44 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: Component-Based Software Engineering Projects</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<div class="posts">
	<a name="111057058217266794"></a>
    
    <h2><font color="#000080"><!-- 2004-08-31 -->
    <a href="http://www.acm.org/technews/articles/2005-7/0307m.html#item4"
                    title="external link">
    ...
    <p>
	<a href="http://www.acm.org/technews/articles/2005-7/0307m.html#item4">ACM News Service: Laying Foundations for Component-Based Software Markets</a>.&nbsp; A combination of EC initiatives support development of organizational and commercial arrangements for component-based software.&nbsp;  COMPONENT+  for built-in test capability is oriented to also confirming that an integration is coherent.&nbsp; This is tied to the European COTS User Working Group (ECUA), a growing organization now having annual workshops.<br /><br />A 2005-03-07 <a href="http://istresults.cordis.lu/index.cfm/section/news/tpl/article/BrowsingType/Features/ID/74638"><em>IST Results</em> release</a> has the details.<br /><br />The incorporation of <a href="http://www.component-plus.org/">built-in testing techniques</a> is valuable in TROSTing of components too, so I will take special interest.&nbsp; The University of Pau BIT/J library for incorporating built-in testing into Java components is interesting for the way that even their documentation process is accountable.&nbsp; The work is available on the equivalent of a Creative Commons attribution license.&nbsp; Simple.
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2005/03/component-based-software-engineering.asp">3/11/2005 11:20:00 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2005/03/component-based-software-engineering.asp">
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=111057058217266794">Post a Comment</a>
		</div>
