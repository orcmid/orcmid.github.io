...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2005/03/standards-as-arbitrary-solutions-to.asp 1     05-04-18 16:32 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: Standards as Arbitrary Solutions to Recurring Problems</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
    ...
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2005/03/pitas-from-pitac-and-emperors-security.asp">The PITAS from PITAC And the Emperor's Security Cloak</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2005/03/collaborative-development-spurs-open.asp">Collaborative Development Spurs Open-Source Arrangements</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2005/03/identifying-key-elements-of-safety.asp">Identifying Key Elements of Safety-Critical Software</a><br />
    </p>
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="Thursday, March 24, 2005" href="#Thursday, March 24, 2005">
          <font color="#660000">Thursday, March 24, 2005</font></a></h3>
   	

	<div class="posts">
	<a name="111168228373600187"></a>
    
    <h2><font color="#000080"><!-- 2004-08-31 -->
    <a href="http://www.acm.org/technews/articles/2005-7/0323w.html#item1"
                    title="external link">
    ...
    <p>
	<a href="http://www.acm.org/technews/articles/2005-7/0323w.html#item1">ACM News Service: Faster XML Ahead</a>.&nbsp; The drive to introduce an official W3C specification for an easier-to-handle XML encoding may lead to initiation of an XML supplement for use in performance- or space-critical applications.&nbsp; This raises the problem of introducing more standard in an area where there is one (XML 1.0) already well-established.&nbsp; One does not want to make a move that creates a problem where one does not exist, and fragmenting the choice of XML encodings is a concern.&nbsp; This is especially the case where the new specification addresses what might be better served by a niche agreement, and there does seem to be some need for that.&nbsp; And then the tension arises around needing to emit more than one form, being able to inter-convert, and being able to deal with legacy and repurposing situation.<br /><br />This blurb simply accounts for the current tension in the XML community, observing that  "another concern is that a binary XML standard would not be widely adopted; Rys notes that XML 1.1 has not met expectations and that Microsoft has not yet supported the specification because of backwards-compatibility fears."<br /><br />The 2005-03-23 Martin LaMonica <a href="http://news.com.com/Faster+XML+ahead/2100-1007_3-5630957.html">CNet News.Com article</a> provides comprehensive coverage of the concerns and the forces that are struggling for resolution.&nbsp; I see the usual tension between diving into the solution space and coughing up direct remedies (go binary, etc.) and taking a serious look at the XML specification life-cycle from a systems perspective.<br /><br />It seems to me that the demands of stability, consistency, and interoperability are quite high.&nbsp; The at-hand availability of XML as a format for everything is appealing, but edge-performance cases will always break down no matter what is done to the core specification.<br /><br />It seems to me that there are ways to assure interoperability by other mechanisms, although they could take more work and they can always be marginalized.  The different variant markups of Wikis and Weblog implementations are an example of niche specialization, new variants of which may be simple laziness and lack of homework.&nbsp; Either way, the existence of variant media and document formats are real and it might be more useful to look at ways to know what the format is and ensure they are well-defined and mappable rather than expect a single popular standard carry the weight of the world.
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2005/03/standards-as-arbitrary-solutions-to.asp">3/24/2005 08:38:03 AM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2005/03/standards-as-arbitrary-solutions-to.asp">
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=111168228373600187">Post a Comment</a>
		</div>
