...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2005/03/certification-of-network-attached.asp 1     05-04-18 16:32 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: Certification of Network-Attached Components?</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<div class="posts">
	<a name="111151387619683786"></a>
    
    <h2><font color="#000080"><!-- 2004-08-31 -->
    <a href="http://www.acm.org/technews/articles/2005-7/0321m.html#item8"
                    title="external link">
    ...
    <p>
	<a href="http://www.acm.org/technews/articles/2005-7/0321m.html#item8">ACM News Service: Protecting the Internet: Certified Attachments and Reverse Firewalls?</a>.&nbsp; In his 2005-03-16 <a href="http://www.circleid.com/article/975_0_1_0_C/">CircleID article</a>, Karl Auerbach suggests that the Internet be protected at the edges by requiring certification of edge-attached components.&nbsp; Karl adopts "the converse point of view that the net is being endangered by the masses of ill-protected machines operated by users."&nbsp; This would prevent many PCs from engaging in zombie activity through the simple device of having routers and broadband gateways filter outgoing as well as incoming traffic.&nbsp; <br /><br />What I find interesting is that there are easier ways than waiting for household firewall-router technology to be forced into certification and upgrading over time.&nbsp; The service provider could be doing the same thing at the other end of the broadband pipe and the true border onto the internet.&nbsp; Protecting the network from subverted edges can be done much more readily there, with detailing in the terms-of-service offered to end nodes.
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2005/03/certification-of-network-attached.asp">3/22/2005 09:51:16 AM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2005/03/certification-of-network-attached.asp">
 		...
 		<div class="blogComments">
			...
			<div class="blogComment">
				&nbsp;<br /><a name="111162005866575470"></a> 
				This fits well with David Eisenberg's ideas regarding the stupid network. Keep the intelligence, and presumably, the authentication, verification, etc., at the edges, where the people are.<BR/><BR/>Of course, we need a similar kind of authentication, and certification of TROST-worthiness, for the software itself, some of which resides in the interior. But this software also needs to get inside the system through the edges.<BR/><BR/>A interesting thread, indeed.<br />
				<div class="byline">
                  <a href="http://orcmid.com/BlunderDome/clueless/2005/03/certification-of-network-attached.asp#111162005866575470" 
                     title="permanent link">#</a>
                  posted by <a href="http://www.blogger.com/profile/3342052">Bill Anderson</a>: 
                  3:20 PM
                </div>
                <span class="item-control admin-1585504753 pid-1360140406"><a style="border:none;" href="http://www.blogger.com/delete-comment.g?blogID=7336679&amp;postID=111162005866575470" title="Delete Comment" ><span class="delete-comment-icon">&nbsp;</span></a></span>
			</div>
			
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=111151387619683786">Post a Comment</a>
		</div>
