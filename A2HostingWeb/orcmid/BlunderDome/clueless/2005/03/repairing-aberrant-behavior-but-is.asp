...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2005/03/repairing-aberrant-behavior-but-is.asp 1     05-04-18 16:32 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: Repairing Aberrant Behavior: But Is That the Threat?</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<div class="posts">
	<a name="111168330722144643"></a>
    
    <h2><font color="#000080"><!-- 2004-08-31 -->
    <a href="http://www.acm.org/technews/articles/2005-7/0323w.html#item2"
                    title="external link">
    ...
    <p>
	<a href="http://www.acm.org/technews/articles/2005-7/0323w.html#item2">ACM News Service: Supersmart Security</a>.&nbsp; I notice that there is a great deal of interest these days in systems that detect odd behavior of applications and find some way to fence it in or even re-establish a fresh copy.&nbsp; The motivation is finding an active approach to repairing a system that has been compromised.&nbsp; This is an interesting question, but I find myself puzzled about the problem being solved, especially when we talk about perturbing code so that exploits can't rely on a consistent pattern to apply their malevolent transformations against.&nbsp; I suspect that measure will only have temporary success, if the past is any guide here.<br /><br />A greater concern for me is whether this is the main or even most-serious threat?&nbsp; It is addressed to a symptom of compromise that might not deal with attacks that are really against higher levels in the application stack and intended to compromise data and users and the business system, not damage the computer.&nbsp; And it raises tremendous trust concerns for the security software itself.&nbsp; I already can't be sure my firewall is really working, and I am not sure a root kit, my main worry, is caught by this sort of thing (nor do I expect to see this sort of thing on consumer PCs anyhow).<br /><br />The Gary Anthes 2005-03-21 <a href="http://www.computerworld.com/securitytopics/security/story/0,10801,100475,00.html"><em>ComputerWorld</em> article</a> has more for digging deeper.&nbsp; I am simply not sure that system damage is the most prevalent threat or even the intention of most attackers, yet this seems to be the focus of this article, which links compromise and damage together: "For some time, we have been losing the battle against those who would damage our computer systems. That's because computers are increasingly interconnected and the software they run is more complex. Both factors increase vulnerability to infection and intrusion."<hr /><small>[updated 2005-03-24T18:00Z I've been bravely posting directly from my Blog This! bookmarklet, but it means less spell-checking.&nbsp; This one had a howler that I couldn't overlook.</small>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2005/03/repairing-aberrant-behavior-but-is.asp">3/24/2005 08:55:00 AM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2005/03/repairing-aberrant-behavior-but-is.asp">
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=111168330722144643">Post a Comment</a>
		</div>
