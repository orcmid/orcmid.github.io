...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2005/03/collaborative-systems-social-protocols.asp 2     06-02-03 22:44 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: Collaborative Systems: Social Protocols</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="Friday, March 11, 2005" href="#Friday, March 11, 2005">
          <font color="#660000">Friday, March 11, 2005</font></a></h3>
   	

	<div class="posts">
	<a name="111057239050224778"></a>
    
    <h2><font color="#000080"><!-- 2004-08-31 -->
    <a href="http://www.acm.org/technews/articles/2005-7/0309w.html#item12"
                    title="external link">
    ...
    <p>
	<a href="http://www.acm.org/technews/articles/2005-7/0309w.html#item12">ACM News Service: Will Social Databases Give Way to Social Protocols?</a>.&nbsp; This blurb refers to the blog of a ZDNet commentator.&nbsp; Does that make it journalism, when it is abstracted by a news service?<br /><br />David Berlind in a 2005-03-01 <a href="http://blogs.zdnet.com/Berlind/index.php?p=30"><em>ZDNet</em> posting</a> suggests that a protocol could alleviate the need for intermediated services and allow individuals to provide identity and affinity information on their own sites and pages using the XHTML Friends Network (XFN) microformat.&nbsp; The protocolaspect is the use of the <tt>rel</tt> attribute in links to suggest the relationship that is claimed as part of a link from one party's material to that of another.<br /><br />I am presently busy with <tt>rel="nofollow"</tt> additions to many links among my own pages that confuse linking-based search-relevance schemes.&nbsp; (It is cool that "orcmid" is at least as unique on the Internet as "Scoble."&nbsp;  It is less cool that most of the links that Google finds for my <em>nom di bit</em> are trivial -- dare I say banal -- references within my own material.)<br /><br />Meanwhile, I can see an adaptation of something like this as part of <a href="http://orcmid.com/BlunderDome/clueless/2005/03/trost-templates-for-raising-open.asp">TROSTing</a> authentication and establishment of authority via web-of-trust social-protocol assertions.&nbsp; Hmm.
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2005/03/collaborative-systems-social-protocols.asp">3/11/2005 11:33:00 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2005/03/collaborative-systems-social-protocols.asp">
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=111057239050224778">Post a Comment</a>
		</div>
