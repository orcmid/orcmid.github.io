...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /A2HostingWeb/orcmid/BlunderDome/clueless/2005/03/open-authentication-one-time-passwords.asp 2     08-10-07 12:42 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: Open Authentication: One-Time Passwords and Crypto-Hashing</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
    ...
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2005/03/repairing-aberrant-behavior-but-is.asp">Repairing Aberrant Behavior: But Is That the Threa...</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2005/03/standards-as-arbitrary-solutions-to.asp">Standards as Arbitrary Solutions to Recurring Prob...</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2005/03/easy-trouble-free-use-of-it-tops-list.asp">Easy trouble-free use of IT tops the list</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2005/03/maturing-uml-and-increasing.asp">Maturing UML and Increasing Expressiveness</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2005/03/more-open-than-open.asp">More Open Than Open</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2005/03/removing-complexity-makes-less-better.asp">Removing Complexity Makes Less Better</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2005/03/your-computer-is-insecure-bad-planning.asp">Your Computer Is Insecure. Bad planning, eh?</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2005/03/certification-of-network-attached.asp">Certification of Network-Attached Components?</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2005/03/reputation-and-community-trust-of.asp">Reputation and Community Trust of Download Files</a><br />
    </p>
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="Saturday, March 26, 2005" href="#Saturday, March 26, 2005">
          <font color="#660000">Saturday, March 26, 2005</font></a></h3>
   	

	<div class="posts">
	<a name="111186171930843823"></a>
    
    <h2><font color="#000080"><!-- 2004-08-31 -->
    <a href="http://www.acm.org/technews/articles/2005-7/0325f.html#item8"
                    title="external link">
    ...
    <p>
	<div style="clear:both;"></div><a href="http://www.acm.org/technews/articles/2005-7/0325f.html#item8">ACM News Service: SHA-1 Flaw Seen as No Risk to One-Time Password Proposal</a>.&nbsp; I've seen several links to Mark Willoughby's 2005-03-22 <a href="http://www.computerworld.com/softwaretopics/software/story/0,10801,100554,00.html"><em>Computerworld</em> article</a> and I passed over each one, thinking the title was self-explanatory and that I understood why SHA-1 is still usable based on Bruce Schneier's reporting on the topic.&nbsp; Fortunately, I did glance over this <em>TechNews</em> summary in my regular scanning of that source.
<br />
<br />Here's interesting material that you might have overlooked too, and that I want to examine as part of TROSTing development.  The <a href="http://www.openauthentication.org/">Initiative for Open Authentication</a> (Oath!) has the vision of developing strong universal authentication: among all users, all devices, and all networks.&nbsp; The consortium is out to produce a reference architecture based on existing "open standards."&nbsp; (The term "leveraging" is used, so your credibility may vary.)
<br />
<br />Vision is vision, and some of this may end up being a solution looking to reword the problem, but the effort is interesting to me, especially because the authentication part is based on Hashed Message Authentication Codes (HMACs) and what are called one-time passwords.&nbsp; The scheme is based on SHA-1.&nbsp; There is a very weird statement that this use is less vulnerable to connived collisions because only a small selection of the 60-bit hash are used, and that claim left my jaw hanging open.&nbsp; There is more to the protocol than that, unless information theory has failed.
<br />
<br />And I remain interested because I want to know how this might work with persistent entities (some of the everythings that the vision is intended to embrace).&nbsp; The one-time password scheme is being <a href="http://www.ietf.org/internet-drafts/draft-mraihi-oath-hmac-otp-02.txt">proposed to the IETF</a> and their is expected to be a standards-track adoption real-soon-now.
<br />
<br />The question will be, as always, how trust is established and recognized with all of these wondrous technical mechanisms in place, and how symmetrical can that trust arrangement be?  We seem to forget that one can also connive an unreliable application atop a reliable protocol, and this may matter more.<div style="clear:both; padding-bottom:0.25em"></div>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2005/03/open-authentication-one-time-passwords.asp">3/26/2005 10:28:00 AM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2005/03/open-authentication-one-time-passwords.asp">
        ...
        <a class="comment-link" href="http://www2.blogger.com/comment.g?blogID=7336679&postID=111186171930843823">Post a Comment</a>
		</div>
