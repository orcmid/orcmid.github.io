...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /A2HostingWeb/orcmid/BlunderDome/clueless/2005/03/trost-templates-for-raising-open.asp 3     10-04-30 23:09 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: TROST: Templates for Raising Open-System Trustworthiness</title>
...
<link rel="alternate" type="application/atom+xml" title="Professor von Clueless in the Blunder Dome - Atom" href="http://www.blogger.com/feeds/7336679/111060368778289975/comments/default" />
 <link rel="stylesheet" type="text/css" href="http://www.blogger.com/static/v1/v-css/50269083-blog_controls.css"/> <link rel="stylesheet" type="text/css" href="http://www.blogger.com/dyn-css/authorization.css?targetBlogID=7336679&zx=dec5c1b7-9230-4790-bb61-4cccc360e95a"/><script type="text/javascript" src="http://www.blogger.com/static/v1/v-js/1188848481-backlink.js"></script>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
    ...
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2005/02/blackbelted-that.asp">Blackbelted That!</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2005/02/blackbelt-this.asp">Blackbelt this!</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2005/02/little-things-mean-lot.asp">Little Things Mean a Lot</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2004/12/edos-integrates-open-source-software.asp">EDOS Integrates Open-Source Software</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2004/12/tech-challenges-i-want-to-see.asp">Tech Challenges I Want to See</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2004/12/eliminating-mutual-incomprehension-in.asp">Eliminating Mutual Incomprehension in Interoperabi...</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2004/12/dimensions-of-e-work.asp">The Dimensions of E-Work</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2004/12/legitimizing-p2p-maybe.asp">Legitimizing P2P, Maybe?</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2004/12/difference-open-source-makes.asp">The Difference an Open Source Makes</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2004/12/grounding-your-works-usability.asp">Grounding Your Work&#39;s Usability</a><br />
    </p>
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="2005-03-11" href="#2005-03-11">
          <font color="#660000">2005-03-11</font></a></h3>
   	

	<div class="posts">
	<a name="111060368778289975"></a>
    
    <h2><font color="#000080"><!-- 2004-08-31 -->
    <a href="http://orcmid.com/erudizione/MSC-DS/"
                    title="external link">
    ...
    <p>
	<div style="clear:both;"></div>On February 1, my proposal for an M.Sc in IT project dissertation was accepted by my Dissertation Advisor and approved by the Academic Coordinator of the program.&nbsp; I more or less went autistic and comatose at that point, although I had prepared a project plan and the clock began running in relentless one-day-per-day fashion.&nbsp; My deadline is July 28 and my plan envisions the dissertation being submitted on July 4 (and already slipping slightly in a replan I am conducting this weekend).&nbsp; There have been many little stumbles getting started, and that is something for <a href="http://www.43things.com/people/progress/orcmid/2356">43 Things</a> at another time.
...
<strong>Why TROST?</strong>&nbsp; Well, FROST was already taken and I was grasping at straws.&nbsp; Once I had an acronym that worked in a (puny?) punny way, I held onto it.&nbsp; I even adjusted the name of the project at one point.&nbsp; I was careful to preserve the acronym.

<strong>Templates?</strong>&nbsp; "Frameworks," "patterns," and "templates" all work.&nbsp; It is not about laws or theories although principles, practices, guidelines, and approaches figure in.  I can go either way with "model" but I think I'll save that one from further over-use just now.

<strong>Raising?</strong>&nbsp; Sure, as in improving, enhancing, enriching, increasing, expanding, and so on.&nbsp; I am looking at the achievement of trustworthiness as a process and a journey, not an absolute result.&nbsp; I do mean continuous improvement along with resilience in the face of setbacks.

<strong>Open-System?</strong>&nbsp; I had originally said Open-Source here.&nbsp; It didn't take long to realize that there is nothing in my vision for TROST that is peculiarly about open-source development (not to be confused with open-source licensing).&nbsp; I chose open-system trustworthiness in homage to OSI, the <a href="http://en.wikipedia.org/wiki/OSI_model">Open Systems Interconnection</a> effort that had much to teach us about interoperability and integration as well as network interconnection.&nbsp;  I mean open-system in this general way.&nbsp; My attention is on ways in which we can address the trustworthiness of components and their integrations in any open-systems setting.

<strong>Trustworthiness?</strong>&nbsp; Well, that should be easy.&nbsp; We all know trustworthiness when we see it, right?&nbsp; Maybe not.&nbsp; Starting out, I am looking at trustworthiness in terms of human arrangements for mitigation of the risks of everyday and not-so-everyday life.&nbsp; There is, most of all, the risk of dealing with each other, especially at a distance.&nbsp; I foresee a mapping into trustworthiness projected onto artifacts.&nbsp; I am not willing, at this point, to take my eye off of the <a href="http://orcmid.com/blog/2004/12/heart-of-trust.asp">ultimately human and social nature of trust and trustworthiness</a>.

<strong>Enough blather, where's the code?</strong>&nbsp; Uh, yes, this is an Information Technology project and that usually means that something will be built.&nbsp; So, along with some templates and a fair amount of metatemplating too, there is a feasibility demonstration involving honest-to-gosh delivered software.&nbsp;  The sofware will be produced using <a href="http://toolbar.search.msn.com/results.aspx?FORM=TOOLBR&q=%22open-box+software%22+Neumann">open-box development of an open-source component</a>.&nbsp; This component will integrate into open-system middleware, <a href="http://ODMA.info/">ODMA</a>, on the Microsoft Windows desktop.

Here's more based on the definition of TROST as a <a href="http://sourceforge.net/projects/trost/">SourceForge project</a>:<small><dl><dt><b><i>Project Aims:</i></b></dt><dd><ul><li>To deliver a framework for development and maintenance of software with demonstrable trustworthiness</li><li>To demonstrate feasibility of the framework by applying it to delivery of open-source software for integration on desktop PCs</li><li>To have procedures and practices that end-users, system administrators, and integrators can apply to confirm the level of trustworthiness asserted for a program</li></ul><br />&nbsp;&nbsp; </dd><dt><b><i>Project Sketch:</i></b></dt><dd>Computer end-users and IT organizations find they must trust in the software that they use, having few means to directly appraise the steps taken to assure the trustworthiness of software that is offered to them.&nbsp;  Although trust is a factor in the adoption of any software components for use, commercial adopters also express concern about the authenticity, legality, and quality of software obtained from open-source distributions.&nbsp; It is troubling when there is no distinct commercial organization that bears producer's risks and stands behind the software.<br />&nbsp;&nbsp; <br />TROST consists of a framework and procedures that are useful for incorporating trustworthiness assurance into the development and delivery of open-system software, demonstrating such assurance, and verifying the assurances.<br />&nbsp;&nbsp; <br />The goal is to enable adopters of a software product to confidently establish:<ul><li>Whether the software distribution is authentic, and what that means</li><li>Whether the software is certified to be derived from the "official" source code, and how that can be and has been independently verified</li><li>Whether there are assessments of the security, reliability, and integrity of individual source code constituents, how authoritative those assessments are, and the availability of details for independent review</li><li>Whether the covered subject-matter of the software license has been asserted to be free of conflicting intellectual-property restrictions by its producers/contributers</li><li>Whether a security threat model is defined for the software that addresses reconciliation to an overall threat model for the application in which the software is to be used</li><li>When modifications and even revocation of assessments come to light, and any remedies that are available for discovered deficiencies in the software</li></ul><br />I fancy having each installable component be linked with the latest certifications asserted for it, supporting trustworthiness as a dynamic.</dd></dl></small><strong>TROSTing, did you say TROSTing?</strong>&nbsp; More and more, I do say that.&nbsp; It all started because TROST was not availabe as a domain name.&nbsp; After looking for alternatives, I settled on <a href="http://TROSTing.org/">TROSTing</a> an an useful expression for the practice of raising the trustworthiness of open-system components.

I found another interesting domain name.&nbsp; It's for email:&nbsp; <b>trust@worthiness.org</b>&nbsp; Not an original device.&nbsp; I couldn't help myself.&nbsp; It's not working yet, so hold back on the spam for now, ok?

<b>On to Literature Search</b>.&nbsp; Now I get to suffer the fear and doubt of every postgraduate student.&nbsp; It's all been done already, it's been shown as not worth doing already; and so on.&nbsp; Yes, I am interested in leads to existing work, proposed work, past work, and the wisdom of the ages.&nbsp; I am.&nbsp; So lay it on me.<div style="clear:both; padding-bottom:0.25em"></div>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2005/03/trost-templates-for-raising-open.asp">3/11/2005 11:09:00 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2005/03/trost-templates-for-raising-open.asp">
        ...
        <a class="comment-link" href="https://www.blogger.com/comment.g?blogID=7336679&postID=111060368778289975">Post a Comment</a>
		</div>
