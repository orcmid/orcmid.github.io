...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2005/03/is-faith-in-innovation-wearing-thin.asp 1     05-04-18 16:32 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: Is Faith in Innovation Wearing Thin?</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
    ...
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2005/03/repairing-abharent-behavior-but-is.asp">Repairing Abharent Behavior: But Is That the Threat?</a><br />
	...
	<div class="posts">
	<a name="111168513389104804"></a>
    
    <h2><font color="#000080"><!-- 2004-08-31 -->
    <a href="http://www.acm.org/technews/articles/2005-7/0323w.html#item11"
                    title="external link">
    ...
    <p>
	<a href="http://www.acm.org/technews/articles/2005-7/0323w.html#item11">ACM News Service: Decrypting the Future of Security</a>.&nbsp; "customers are demanding better software licensing terms, as well as input into the code development lifecycle, greater transparency, and code escrowing in the event vendors are unavailable when customers need them."<br /><br />Mary Kirwan's 2005-03-18 <a href="http://www.theglobeandmail.com/servlet/story/RTGAM.20050311.gtkirwanmar11/BNStory/einsider/">article in the Canadian <em>Globe and Mail</em></a> is far more interesting and entertaining than the dry account in the news blurb.&nbsp; It is first rather startling to encounter so much sarcasm, but reading along it becomes clear how much the recent RSA Conference can be seen as a self-satirizing event among tech heavies, US-slanted economic and government mavens, and frightened enterprise IT personalities.&nbsp;  I'm particularly fond of this observation:<blockquote>"A veritable plague of locusts will descend on the planet and devour it inside out if software liability for vendors becomes a reality.&nbsp; Huge software vendors not usually unduly concerned about the trials and tribulations of the 'small software developer' are wracked with concern for their doomed brethren."</blockquote>For me the most-important take-away is the observation that the community that IT and computing serves is becoming seriously impatient:<blockquote>"Many attendees and speakers expressed the view that if legislation and a new required emphasis on software quality assurance and accountability for code development eradicated purveyors of vapourware, and separated the wheat from the chaff, they were all for it."</blockquote>So, are we having fun yet?
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2005/03/is-faith-in-innovation-wearing-thin.asp">3/24/2005 09:25:33 AM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2005/03/is-faith-in-innovation-wearing-thin.asp">
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=111168513389104804">Post a Comment</a>
		</div>
