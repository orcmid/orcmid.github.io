...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2005/06/mddi-integrated-tool-chains-for.asp 2     06-10-11 15:16 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: MDDi: Integrated Tool Chains for Software Development</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="Wednesday, June 22, 2005" href="#Wednesday, June 22, 2005">
          <font color="#660000">Wednesday, June 22, 2005</font></a></h3>
   	

	<div class="posts">
	<a name="111946994301366615"></a>
    ...
    <p>
	<div style="clear:both;"></div><p><a href="http://www.acm.org/technews/articles/2005-7/0617f.html#item8">ACM News Service: FP6 Project Aims to Increase EU Competitiveness in Software Systems Development.</a>&nbsp; Uh, &ldquo;programmers put on your chains and mechanize?&rdquo;&nbsp; Maybe not.&nbsp; The MDDi project is making the&nbsp;Eclipse Model Driven Development integration (you parse that, I gave up, but I think it&rsquo;s e[MDD]i sort-of&mdash;oh, it&rsquo;s <a href="http://www.eclipse.org/proposals/eclipse-mddi/index.html">Eclipse MDDi</a>).&nbsp; The expectation is that the open-source modeling tool will provide an integrated tool chain to help European system engineers make new software.</p><p>It bugs me that this is heralded as an economic maneuver to avoid falling behind those pesky Americans and Japanese and reduce the cost of software development.&nbsp; That&rsquo;s a peculiar motivation for wanting to improve the quality of software delivery.</p><p>The 2005-06-15 <a href="http://dbs.cordis.lu/fep-cgi/srchidadb?ACTION=D&amp;SESSION=112122005-6-22&amp;DOC=40&amp;TBL=EN_NEWS&amp;RCN=EN_RCN_ID:23981&amp;CALLER=EN_NEWS">CORDIS News article</a>&nbsp;starts out&nbsp;a little more affirmatively, based on conversation with Serge Salicki: &ldquo;Europe is faced with the double expectation from end-users of better, more complex and more reliable software systems, developed in an increasingly shorter time span at reduced costs.&rdquo;&nbsp;</p><p>The overall program is a European Sixth Framework Programme (FP6) project called MODELWARE.&nbsp; It is this effort that has the objectives of</p><ul><li>Reducing the cost of software systems while increasing the productivity [of development] by 25 per cent [the statement of work uses a lower number]</li><li>Lead to commercialization of the solution [uh, so where does open-source come in?]</li><li>Ensure industry adoption</li></ul><p><a href="http://www.modelware-ist.org/">MODELWARE</a> (MODELing solution for softWARE systems) seems to be a two-year project and [e]MDDi is emerging about half-way through.&nbsp; Hmm.&nbsp; And we have new nomenclature: modellisation for becoming model-centric, somehow in contrast to being code- and document-centric in our development methodologies.&nbsp; The pilot applications (air-traffic control, for example) seem rather ambitious, too.</p><p>I think my problem is with the blurb and the puffery, not the objectives of the effort.&nbsp; The idea is to produce open development platforms for software and services, and when we figure out what open means here, we can assess the value of the approach.&nbsp; One aspect of &ldquo;open&rdquo; is the choice of Eclipse as a development platform, although the <a href="http://www.eclipse.org/proposals/eclipse-mddi/index.html">participation of IBM </a>in the effort is understated in the materials at the project site.</p><p>I find fixing on a specific platform (in the sense Eclipse is used here) to be unsatisfying.&nbsp; I think it&rsquo;s more than Eclipse is not my platform of choice.&nbsp; I&rsquo;m wondering, rather, whether the methodology is abstracted enough that it can be rehosted and retargeted&nbsp;with the Model-Driven Development used to accomplish that.&nbsp; I&rsquo;m curious about that.</p><div style="clear:both; padding-bottom: 0.25em;"></div>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2005/06/mddi-integrated-tool-chains-for.asp">6/22/2005 12:52:23 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2005/06/mddi-integrated-tool-chains-for.asp">
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=111946994301366615">Post a Comment</a>
		</div>
