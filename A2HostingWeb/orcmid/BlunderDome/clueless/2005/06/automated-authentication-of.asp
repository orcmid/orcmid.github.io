...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2005/06/automated-authentication-of.asp 1     05-07-14 13:21 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: Automated Authentication of Programming Standards?</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="Wednesday, June 15, 2005" href="#Wednesday, June 15, 2005">
          <font color="#660000">Wednesday, June 15, 2005</font></a></h3>
   	

	<div class="posts">
	<a name="111885962655831879"></a>
    ...
    <p>
	<p><a href="http://www.acm.org/technews/articles/2005-7/0613m.html#item12">CM News Service: Automatic Source Code Review is Development Tools&rsquo; Next Frontier</a>.&nbsp; NIST is developing SAMATE (you think it&rsquo;s say-mate, or sam-awty, or same-awty or &hellip;), Software Assurance Metrics and Tool Evaluation.&nbsp; The idea is to introduce tools into the software development lifecycle for &ldquo;assessment, auditing, and acceptance.&rdquo;</p><p>This raises an interesting issue in the development of trustworthiness: do we accept the assessment of an automated tool as an attestation, or do we want the attestation of the software engineer that supervised and reviewed the results of using the tool?</p><p>Another factor is whether or not these tools will be found insanely&nbsp;pedanntic in their issuing of warnings and raising of alarms about deviations.&nbsp; It would seem that some sort of screening by a skilled developer, and a record of what the allowed deviations are, has to be part of the deal.&nbsp; I&rsquo;m sure there are those who see a bureaucratic nightmare in all of this.&nbsp; It will be interesting to see what the practical trade-offs become.</p><p>Peter Coffee&rsquo;s 2005 June 6 <a href="http://www.eweek.com/article2/0,1759,1821921,00.asp"><em>eWeek</em> article</a> leads out with the cautionary charge, &ldquo;Coding standards should leave room for innovation.&rdquo;&nbsp; Peter links to Paul Black&rsquo;s <a href="http://samate.nist.gov/">SAMATE</a> page, currently in a provisional state and already providing a nice compilation of tools and perspectives.&nbsp; As an examples of the kinds of coding standards, Coffee mentions the <a href="http://www.codingstandard.com/HICPPCM/">High Integrity C++ Coding Standards Manual</a>, a valuable find.</p><p>This column is apparently a companion to the same-day article I discussed as <a href="http://nfocentrale.net/orcmid/BlunderDome/clueless/2005/06/important-software-standards-quality.asp">The Important Software Standards: Quality, Performance, and Diligence</a>.&nbsp; Taking the two together provides more context on what standards mean&mdash;and how they are valuable&mdash;in this context.</p><p>I also think this all figures in how desirable it is to find a way to evolve trustworthiness as an ongoing approach to delivering and supporting software in a dependable way.</p><p><em></em></p>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2005/06/automated-authentication-of.asp">6/15/2005 11:20:26 AM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2005/06/automated-authentication-of.asp">
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=111885962655831879">Post a Comment</a>
		</div>
