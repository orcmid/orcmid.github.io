...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2005/06/rigorous-software-engineering-at.asp 3     06-10-11 15:16 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: Rigorous Software Engineering at the Application-Domain Integration Level</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="Monday, June 20, 2005" href="#Monday, June 20, 2005">
          <font color="#660000">Monday, June 20, 2005</font></a></h3>
   	

	<div class="posts">
	<a name="111925092116271466"></a>
    ...
    <p>
	<div style="clear:both;"></div><p><a href="http://www.acm.org/technews/articles/2005-7/0615w.html#item9">ACM News Service: Microsoft Research Aims to Ease Development</a>.&nbsp; Early in my experience with Grace Hopper, I recall a presentation on the introduction of programming languages into IT operations.&nbsp; She told of the following simple way that she found to overcome the &ldquo;real programmers don&rsquo;t Flowmatic&rdquo; (or Cobol) syndrome:</p><ul><li>Find some bright kid in computer operations that wants to get into development and turn them loose with the manual and the compiler.</li><li>As expected, the bright kid (the same ones we recruited whenever they showed up among the maintenance and operations folk) would quickly become quite productive, producing small useful programs that were seen to be needed.</li><li>The new performer was promoted into a programming position and continued to be rewarded for the high productivity.</li><li>Other programmers are forbidden to use&nbsp;the new tool.</li></ul><p>This came back to me when I noticed that the chosen venue for exploring and proving out the ideas for Rigorous Software Engineering is the new Microsoft Research India center in Bangalore.&nbsp; </p><p>John Ribeiro&rsquo;s 2005-06-13 <a href="http://www.itworld.com/AppDev/050613msresearch/"><em>ITworld.com</em> article</a> expands on a number of key ideas:</p><ul><li>There is little or no <a href="http://www.google.com/search?q=%22narrating+your+work%22">narration of the work</a>&nbsp;[courtesy of Jon <a href="http://weblog.infoworld.com/udell/2005/05/24.html#a1237">Udell</a>]&nbsp;that is done in software, and that creates difficulties for integrators (among others) who need to dig into the code to arrange for its integration into a larger system.</li><li>The institutional memory of software designs and architectural decisions need to be preserved some other way.</li><li>Rigorous Software Engineering is proposed for taking the level of abstraction of the programming closer to the application domain, so this becomes the level of modification and maintenance, using code-generation techniques to move from that level down to lower levels where the software is expressed to the computer.</li><li>I always wonder how this sort of thing is tested and debugged.&nbsp; The MSR-India researcher said they intend to create tools that &ldquo;provide visibility into the system and the way it is functioning at various levels of abstraction.&rdquo;&nbsp; That sounds like a valuable way to make sure the higher-level expression has been compiled in a way that preserves essential application behavior.</li></ul><p>This is not unlike the Model-Driven Architecture (MDA) view, at a high-altitude of comparison.&nbsp; I find this appealing, although I wonder whether the rigorous codification of design rules from near-application solution space to platform-specific solution space will be too demanding.&nbsp; I don&rsquo;t know. I am curious about that and about how performance factors enter into consideration.&nbsp; </p><p>I do look forward to schemes of this kind for what they show us is involved in near-application modeling as well as reconciliation of <a href="http://miser-theory.info/astraendo/pn/2004/06/what-is-model.asp">problem space and solution space</a>&nbsp;in ways where our clients may be able to check whether we&rsquo;re building and integrating what they expect.</p><p>&nbsp;</p><p><em></em></p><div style="clear:both; padding-bottom: 0.25em;"></div>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2005/06/rigorous-software-engineering-at.asp">6/20/2005 12:02:01 AM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2005/06/rigorous-software-engineering-at.asp">
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=111925092116271466">Post a Comment</a>
		</div>
