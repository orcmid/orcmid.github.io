...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2005/04/all-your-bios-are-still-mine.asp 2     06-02-03 22:44 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: All Your BIOS Are <i>Still</i> Mine</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
    ...
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2005/03/standards-as-arbitrary-solutions-to.asp">Standards as Arbitrary Solutions to Recurring Problems</a><br />
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="Thursday, April 07, 2005" href="#Thursday, April 07, 2005">
          <font color="#660000">Thursday, April 07, 2005</font></a></h3>
   	

	<div class="posts">
	<a name="111293785105558990"></a>
    
    <h2><font color="#000080"><!-- 2004-08-31 -->
    <a href="http://www.acm.org/technews/articles/2005-7/0406w.html#item1"
                    title="external link">
    All Your BIOS Are <i>Still</i> Mine
    </a>
    </font></h2>
    
    
    <p>
	<a href="http://www.acm.org/technews/articles/2005-7/0406w.html#item1">ACM News Service: Call of the Wild for BIOS</a>.&nbsp; I always relish an opportunity to be <a href="http://nfocentrale.net/orcmid/blog/2004/06/whose-computer-is-it-all-your-bios-are.asp">mildly prophetic</a>.&nbsp; The Free Software Foundation is calling for an open-source BIOS that cracks the thicket of proprietary, non-disclosed, and trade-secret agreements around the PC BIOS and the different components that can be configured to operate with it (and vice versa).<br /><br />John G. Spooner's 2005-04-05 CNet <a href="http://news.com.com/Call+of+the+wild+for+BIOS/2100-1016_3-5654272.html"><em>News.com</em> article</a> covers the points of the debate and the current tightly-held, secretive efforts to prevent reverse engineering and counter electronics piracy as well as unwanted competition.&nbsp; Although the secrecy-through-obscurity principle is also used as an argument that the current state protects users, that makes no sense.&nbsp; As far as I can tell, hackers are fully aware of BIOS vulnerabilities.<br /><br />Stay tuned.&nbsp; This arcane conflict is not likely to turn in open-source's favor.<hr /><small>I am presently in possession of a BIOS, in my Averatec C3500, of unknown lineage and scary behavior.&nbsp; Actually, this is also the first time I obtained Windows XP Pro as an OEM installation and I'm not thrilled about that either, especially since this OEM doesn't provide clean-install Windows disks and some of the defaults somebody chose for me are really scary.&nbsp; <br /><br />The scary part of this BIOS is that computer glitches will drive it back to the default setup, the most scarily-insecure frailty I've seen.&nbsp; It looks easy to induce too, though I don't go looking for trouble.&nbsp;  The reversion to default drops every safeguard I put in place: setup access password, boot password, boot from hard drive first, perform full POST, and drop the OEM wallpaper so I can see the progression of the startup sequence (and have the option to launch recovery console once I learn how to install it on XP SP2.&nbsp; To name a few precautions.&nbsp; Heh.<br /><br />I can't figure out how to kill the LAN card though, since it insists on enabling boot-on-LAN and staying active when I shut down the machine what I thought was completely.&nbsp; But no, the lights on my hub stay solid on for the that is connected to li'l Blocco.&nbsp;  So I make sure the powered-down machine has the lid closed and the LAN connector unplugged.&nbsp; But, you know, I just don't trust the machine to stay protected, and I haven't even listed my software safeguards.&nbsp; If the BIOS is vulnerable, practically all other bets are off and the obscurity of the BIOS implementation is not a source of reassurance [;<).</small>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2005/04/all-your-bios-are-still-mine.asp">4/7/2005 10:24:11 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2005/04/all-your-bios-are-still-mine.asp">
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=111293785105558990">Post a Comment</a>
		</div>
