...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2005/04/secure-rfid-identification-protocol.asp 2     06-02-03 22:44 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: A Secure RFID-Identification Protocol?</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="Thursday, April 28, 2005" href="#Thursday, April 28, 2005">
          <font color="#660000">Thursday, April 28, 2005</font></a></h3>
   	

	<div class="posts">
	<a name="111475627350896085"></a>
    ...
    <p>
	<p><a href="http://www.acm.org/technews/articles/2005-7/0427w.html#item3">ACM News Service: Feds Rethinking RFID Passport</a>.&nbsp; As <a href="http://www.schneier.com/blog/archives/2005/04/rfid_passport_s.html">noted by Bruce Schneier</a> as well, the <a href="http://www.icao.int/">International Civil Aviation Organization</a> has come up with a Basic Access Control protocol for security of RFID chips and their contents in passports.&nbsp; The US State Department is considering adoption of the approach in response to public comments and realization that RFIDs may be readable at greater distances than intended.&nbsp; This seems to&nbsp;involve a challenge response scheme&nbsp;using physical information on the passport folder as&nbsp;part of the conditioning&nbsp;scheme.&nbsp; The BAC seems to operate as follows:</p><ul><li>RFID scanner station A reads optical information from the physical passport folder, P(wallet).&nbsp; This establishes physical presence of the passport.&nbsp; This is also sufficient for initiation of an authentication exchange with the passports RFID, P(RFID).</li><li>RFID scanner A engages in a challenge-response exercise with the passport&rsquo;s RFID, P(RFID) in which P(RFID) demonstrates that it possesses two private keys (and A demonstrates that it has read the physically-imprinted information).&nbsp; A&nbsp;session key is created out of the process.&nbsp; The passport data is transmitted from p(RFID) to scanner A encrypted with the session key.</li><li>One concern in the Security Analysis that was carried out is that P(RFID) uses a UID during the challenge response and as a way to deal with collision detection.&nbsp; If this UID is fixed, it is enough to allow tracking of the passport bearer without knowing any of the encrypted information.</li><li>The decrypted message is presumably signed by a recognized authority. The signed material consists of biometric and other information about the authorized bearer.&nbsp; It ties to the physical P(wallet) information and provides biometric informaiton.&nbsp; This is mostly something the authentic bearer is, including a photographic image, a scanned signature, and other information.</li></ul><p>Kim Zetter&rsquo;s 2005-04-26 <a href="http://www.wired.com/news/privacy/0,1848,67333,00.html"><em>Wired News</em> article</a> has more information including links to a number of papers on the specifications, trials conducted with BAC-implementing devices, and an analysis that identifies some weaknesses.&nbsp; The article indicates that BAC has been tested and done well, other than for the slowness introducd in the use of cryptography.&nbsp; There are also some defects in the scheme, but these are not thought to be critical.&nbsp; It is the case that the RFID is presumed to be read-only, and PKI techniques are used.</p><p>The basic concern of the comments on Schneier&rsquo;s article seems to be that even transmitting an encrypted response reveals too much about the bearer.&nbsp; Simply obtaining&nbsp;the RFIDs pong may reveal all the information that a terrorist needs.&nbsp; And other out-of-band failures may occur, such as timing attacks and related ways of gaining enough information to carry off an exploit (including the ultimate denial of service, death of the bearer).&nbsp; Secondly, if there is no shared secret, the contents of the RFID message can be obtained by a replay attack.&nbsp; Based on my sketch, above, derived from a quick review of the available documents, this is not so likely if the recommendations made in the defect analysis are instituted, including having the RFID generate&nbsp;session UIDs via some random scheme.&nbsp; The recommended precautions&nbsp;in an undated analysis by Juels, Molnar, and Wagner seem reasonable to provide in the case of US passports and entry to the US, because the US scanners will have the prerequisite capabilities.</p><p>I have the sense that not all passports need provide the maximum set of security provisions, and not all readers need demand them.&nbsp; The minimal case is use of the physical passport and its markings and enclosures alone.&nbsp;&nbsp;One concern of the authors of the weakness analysis is not the limited application of the scheme for passports, where it seems to be reasonably well-suited.&nbsp; They express concern over function creep and application of the scheme in other settings where there can be unintended consequences of threats and interactions not foreseen for the ICAO use case.&nbsp; If P(RFID) can be altered&mdash;for visa information, say&mdash;there are new difficulties to consider.</p><p>&nbsp;</p><p>&nbsp;</p><p><em></em></p>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2005/04/secure-rfid-identification-protocol.asp">4/28/2005 11:31:13 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2005/04/secure-rfid-identification-protocol.asp">
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=111475627350896085">Post a Comment</a>
		</div>
