...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2005/04/trust-2-proliferation-of-cots-in.asp 1     05-04-18 16:33 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: TRUST 2: Proliferation of COTS in Critical Infrastructure</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
    ...
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2005/04/trust-team-for-research-in-ubiquitous.asp">TRUST: Team for Research in Ubiquitous Secure Technology</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2005/04/bring-us-your-metadata-your-tired-your.asp">Bring us Your Metadata, Your Tired, Your Poor, Your Abandoned Document Formats</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2005/04/building-blue-relationships-and.asp">Building Blue Relationships and Partnerships</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2005/04/secure-overlays-on-insecure-internets.asp">Secure Overlays on Insecure Internets: It Could Happen?</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2005/04/all-your-bios-are-still-mine.asp">All Your BIOS Are <i>Still</i> Mine</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2005/04/cylabs-angle-on-sustainable-computing.asp">CyLab's Angle on Sustainable Computing and Trustworthiness</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2005/04/c-moves-head-in-statistical-leapfrog.asp">C# Moves Head in Statistical Leapfrog</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2005/03/open-authentication-one-time-passwords.asp">Open Authentication: One-Time Passwords and Crypto-Hashing</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2005/03/is-faith-in-innovation-wearing-thin.asp">Is Faith in Innovation Wearing Thin?</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2005/03/repairing-aberrant-behavior-but-is.asp">Repairing Aberrant Behavior: But Is That the Threat?</a><br />
    </p>
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="Thursday, April 14, 2005" href="#Thursday, April 14, 2005">
          <font color="#660000">Thursday, April 14, 2005</font></a></h3>
   	

	<div class="posts">
	<a name="111350810488295571"></a>
    
    <h2><font color="#000080"><!-- 2004-08-31 -->
    <a href="http://www.acm.org/technews/articles/2005-7/0413w.html#item5"
                    title="external link">
    ...
    <p>
	<a href="http://www.acm.org/technews/articles/2005-7/0413w.html#item5">ACM News Service: Diffie - Infrastructure a Disaster in the Making</a>.&nbsp; This summary features Diffie's perspective on the current distractions from attention to the infrastructure, the rapid introduction of software that is not designed for such reliability, and the inevitability of PKI adoption, like-it-or-not.<br /><br />Bill Brenner's 2005-04-12 <a href="http://searchsecurity.techtarget.com/qna/0,289202,sid14_gci1077609,00.html">SearchSecurity.com article</a> is the second of two parts.&nbsp; This Diffie interview has some valuable context.&nbsp; For example, Diffie doesn't go for the monoculture theory, recognizing the practicalities that also figure into security approaches.&nbsp; Known for insightful gems, Diffie drops this keeper: "... Diversity isn't the most critical question.&nbsp; It's the proper attention to software coding that's critical.&nbsp; <em>Security differs from reliability because someone's looking for the part you didn't get right</em>." [dh: My emphasis]<br /><br />The article is too short.&nbsp; The sensibilities expressed here resonate for me and I want more!&nbsp; It's great to see Diffie anticipating direction and that suggests where I can concentrate on simplified use in my own cryptographic applications.&nbsp; And we get more Diffie humor:<blockquote><strong>How do you see the technology evolving over the next decade?</strong><br />Diffie: I expect it to develop an opposable thumb and settle into a level of standards.&nbsp; I think the most glaring example of success is the Advanced Encryption Standard (AES).&nbsp; We now have a high-grade crypto algorithm. Standards like AES, SHA-384 [and] ECC digital signatures… will drive out their competition ...</blockquote><br /><br />I find that encouraging.&nbsp; I will find it more encouraging if the shake-out doesn't leave us with protocols that require a business model that fore-closes cottage innovation.<br /><br />Martin Hellman's part of the interviews <a href="http://searchsecurity.techtarget.com/qna/0,289202,sid14_gci1077600,00.html">appeared on 2005-04-11</a>, and the Diffie-Hellman key exchange algorithm is presented in a <a href="http://searchsecurity.techtarget.com/tip/1,289483,sid14_gci876048,00.html">2003-01-23 article</a> by Mike Chapple.<br /><br />Brenner also has a 2004-07-01 article on <a href="http://searchsecurity.techtarget.com/originalContent/0,289142,sid14_gci991178,00.html">differing views of the monoculture threat</a>.&nbsp; That one demonstrates to me that the metaphor is too pat.&nbsp; Software platforms are clones, so it isn't even a monoculture in that regard.&nbsp; One disease kills all.&nbsp; But true diversity (in the Darwinian sense) is not possible for software, and it is also not useful.&nbsp;  Species survival doesn't matter if most of your copies die in the plague.&nbsp; Get it?&nbsp;  And contrived-diversity forms being proposed raise their own trustworthiness concerns.&nbsp; For one: How do you turn in a bug report against an operating system that has genetic variations in the copy you are running?&nbsp; The medical profession seems to handle that well enough, but how do you give your computer two aspirin?&nbsp; Digital failure of the software kind is not like having a few cells die while antibodies do their thing.&nbsp; The monoculture idea is catchy and only a metaphor with the destiny of all metaphors when over-applied.<br /><br />I am delighted to learn of.&nbsp; <a href="http://searchsecurity.techtarget.com/">SearchSecurity.com</a>.&nbsp; I am also amused by how strongly the site puts my software firewall through its paces, and how they track my every move as I navigate around.&nbsp;  I love all the little boxes with [ad] in them.&nbsp; Even more exciting are the rectangles on the page with browser warning pages scrunched into them, telling me that I am not authorized to browse a page and giving me a 403 response.&nbsp; I have finally figured out this is provoked by in-line MIME types.&nbsp; And of course my browser blocked the third-party cookie from bitpipe.com.<br /><br />I wonder how much more thrilling life will be if I register for the free membership?&nbsp; Not today, thank you very much.&nbsp; What's amusing about all of this is that this is <em>exactly</em> the way I find Microsoft to be at cross-purpose with itself.&nbsp; The market-facing side, illustrated by MSN, is busily expecting us to drop all of our safeguards to enjoy the experience they and their advertisers have in store for us, while the security-facing side is ragging us to practice the 3 whatnots, protect ourselves, update as often as we brush, etc., etc.&nbsp; The more I run into this, the dirtier I am beginning to feel.&nbsp; We are making ourselves crazy with this sick combination of security righteousness and base mercantilism.&nbsp; (Actually, I think I am giving mercantilism an undeserved bad name, but we are being taken a long way from dealing with the country storekeeper, and I don't have a better label.)
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2005/04/trust-2-proliferation-of-cots-in.asp">4/14/2005 12:48:24 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2005/04/trust-2-proliferation-of-cots-in.asp">
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=111350810488295571">Post a Comment</a>
		</div>
