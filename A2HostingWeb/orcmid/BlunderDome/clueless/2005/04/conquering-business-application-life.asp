...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2005/04/conquering-business-application-life.asp 2     06-02-03 22:44 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: Conquering the Business-Application Life Cycle</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="Saturday, April 23, 2005" href="#Saturday, April 23, 2005">
          <font color="#660000">Saturday, April 23, 2005</font></a></h3>
   	

	<div class="posts">
	<a name="111432131009037363"></a>
    
    <h2><font color="#000080"><!-- 2004-08-31 -->
    <a href="http://www.acm.org/technews/articles/2005-7/0422f.html#item18"
                    title="external link">
    ...
    <p>
	<a href="http://www.acm.org/technews/articles/2005-7/0422f.html#item18">ACM News Service: Together--At Last</a>.&nbsp; This blurb identifies the creation of systems for application-lifecycle management to combat the current wasteful, late, and failed corporate projects.&nbsp; The commoditization of application development tools is cited as the basis for failure in the process (?) and this appears to be the driver for moving away from the saturated low end to integrated platform approaches: IBM Rational's Unified Process (RUP), Borland's Software Delivery Optimization Strategy, and the rapidly approaching Visual Studio 2005 Team System platform.&nbsp; "ALM Platform" is the latest buzz.<br /><br />I think I need to understand better how these dots connect.  I wonder how one can avoid going through the equivalent of a SAP integration for Application Lifecycle Management.  That's way too high-end for my taste.<br /><br />Gavin Clarke's 2005-04 Computer Business Review article, "<a href="http://www.cbronline.com/content/comp/magazine/Articles/Features/TheDayoftheSuites.asp">The Day of the Suites</a>" provides deeper background.&nbsp; There is more effort to put modeling, such as MDA, into context, and also distinguish platforms for lifecycle management as opposed to the IDE focused on the programmng code-compile-test cycle.&nbsp; The writer's bottom line:<blockquote>We are moving into a world of fully integrated suites where the IDE, once a by-word of integration, looks increasingly anachronistic.&nbsp; Customers should be wary, however: this headlong rush to appear integrated is subject to some marketing hype, and integration is a subjective term that varies from vendor to vendor.</blockquote><br /><br />Clarke's 2005-03 "<a href="http://www.cbronline.com/content/COMP/magazine/Articles/Application_Development/Together-AtLast.asp">Together At Last</a>" article begins with a recounting of the US FBI's case-management system project failure where even the cost of exiting is estimated in the $100 millions.&nbsp; After building a case for the gap between development-methodology coverage and the pain centers of application development, the case for ALM is stimulated by three colliding factors.&nbsp; Commoditization at the programming level has forced development-system vendors to look upscale.  Recognition that the vendors must align their offerings with business needs leads to extension of platforms and tools to embrace the life-cycle.&nbsp; And new regulations on business operations are compelling even more attention to system lifecycle management and operating integrity in the business problem space, not just the IT solution-instrument space.<br /><br /><em>Computer Business Review</em> has more to offer on the <a href="http://www.cbronline.com/researchcenter.asp?id=1&z=rc_ApplicationDevelopment">application-development</a> scene.&nbsp; There is also more over-all perspective to be gained from their other coverage of <a href="http://www.cbronline.com/cbr/analysis.asp">business computing analysis topics</a>.<br /><br />My radar was triggered on this because I have my attention on life-cycle considerations in raising open-system trustworthiness.&nbsp; This is the squishy end of the trustworthiness problem and I despair over finding a clean, simple characterization that I can use as the context for framing the system deployment and software development levels.&nbsp; I believe the attention to lifecycle factors, will be critical, along with heightened attention to cradle-to-grave coordination of risk management.&nbsp; It is time to draw pictures and not trying so hardto find the perfect words.<br /><br />The only way I can see avoiding overwhelm and despair over the intricacy of system-lifecycle considerations is by taking on increased dependability and trustworthiness as a journey, not an end, with exploration, correction, and continuous improvement the name of the game.&nbsp; I'd like to see an easy on-ramp for building up trustworthy software-development practice.&nbsp; I want to hold onto the prospect of traveling light and improving the process while moving from one success to the next.&nbsp; I am a little wary of integrated platforms at the present (dare I say eroding) stage of application-development maturity,because of what strikes me as a high cost of engagement and no little desparation of the platform vendors to find a market.
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2005/04/conquering-business-application-life.asp">4/23/2005 10:41:50 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2005/04/conquering-business-application-life.asp">
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=111432131009037363">Post a Comment</a>
		</div>
