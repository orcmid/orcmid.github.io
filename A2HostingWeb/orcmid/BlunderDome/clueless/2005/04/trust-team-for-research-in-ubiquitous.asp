...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2005/04/trust-team-for-research-in-ubiquitous.asp 1     05-04-18 16:33 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: TRUST: Team for Research in Ubiquitous Secure Technology</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<div class="posts">
	<a name="111350265928603170"></a>
    
    <h2><font color="#000080"><!-- 2004-08-31 -->
    <a href="http://www.acm.org/technews/articles/2005-7/0413w.html#item1"
                    title="external link">
    ...
    <p>
	<a href="http://www.acm.org/technews/articles/2005-7/0413w.html#item1">ACM News Service: UC Berkeley to Lead $19 Million NSF Center on Cybersecurity Research</a>.&nbsp; This blurb features the announcement of a 5-10 year NSF grant to an 8-university "team" headed by UC Berkeley.<br /><br />Features of the arrangement seem to be concern for U.S. critical infrastructure, and a lack of alignment with human users and usability requirements.&nbsp; It looks like the eye is on development processes and the training of "trustworthy systems engineers" in the future.<br /><br />Although it looks like this is in danger of being too many things to too many people ("public policy, economics, social science, andhuman-computer interface technology" with the notable omission of software and system engineering), I most certainly want to pay attention to any initiative where "researchers will commit themselves to the development of novel technologies designed to make organizations more capable of designing, constructing, and operating trustworthy critical infrastructure information systems."<br /><br />Sarah Yang's 2005-04-11 <a href="http://www.berkeley.edu/news/media/releases/2005/04/11_trust.shtml">UC Berkeley press release</a> confirms that it's about critical infrastructure systems, and not Uncle Tully's PC.&nbsp; At the same time we know that commodity components are prevailing everywhere, and the TRUST folk may have to look harder at the reach of their grand acronym.&nbsp; I can see why usability is emphasized here, considering how operability of infrastructure systems under emergencies, and vulnerability to human error, is a big concern.&nbsp; At the same time, if the notion of cultivating disadvantaged groups as sources of future talent is more than motherhood, one would think that the training and outreach programs will also touch people who build, uh, future games, mobile arrangements and just maybe Uncle Tilly's media/household control center.<br /><br />The Berkeley CITRIS activity will be tied in, but the only link given was a cross-polliinator to <a href="http://www.nsf.gov/od/oia/programs/stc">NSF's Science and Technology Centers program</a>.&nbsp; It looks like I'll need to search more widely to find the concrete bits.
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2005/04/trust-team-for-research-in-ubiquitous.asp">4/14/2005 11:17:39 AM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2005/04/trust-team-for-research-in-ubiquitous.asp">
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=111350265928603170">Post a Comment</a>
		</div>
