...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2005/10/distraction-of-user-personas.asp 1     06-02-04 21:29 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: The Distraction of User Personas?</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
    ...
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2005/07/end-of-historical-record.asp">The End of the Historical Record?</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2005/07/software-inspections-lonely-adherents.asp">Software Inspection's Lonely Adherents</a><br />
    </p>
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="Tuesday, October 25, 2005" href="#Tuesday, October 25, 2005">
          <font color="#660000">Tuesday, October 25, 2005</font></a></h3>
   	

	<div class="posts">
	<a name="113029272972897146"></a>
    ...
    <p>
	<div style="clear:both;"></div><p><a href="http://orcmid.com/blog/2005/10/what-programmers-do.asp">Orcmid's Lair: What Programmers Do</a>.&nbsp; In the midst of struggling with some material on the gap between the world of computers and the situations in which they are employed, I played <a href="http://orcmid.com/blog/2005/10/what-programmers-do.asp">one of my cards</a> on the themes of &ldquo;What Computers Know&rdquo; and &ldquo;What Programmers Know.&rdquo;&nbsp; I was inspired by a <a href="http://blogs.msdn.com/ericgu/archive/2005/10/21/483571.aspx">simple exercise from Eric Gunnerson</a>.&nbsp; I overpowered that exercise, far beyond what the exercise situation called for, as a way to&nbsp;illustrate some of the concepts I&rsquo;ve been teasing out in my plodding investigations.</p><h3>The Risk of Too Much Information</h3><p>I also pointed out&nbsp;that there&rsquo;s too much information in a restatement&nbsp;I offered as an improvement:</p><blockquote dir="ltr" style="MARGIN-RIGHT: 0px"><p>&ldquo;Verify that a string is of format <em>ddd</em><tt>-</tt><em>dd</em><tt>-</tt><em>dddd</em><strong>, the format used for&nbsp;social-security numbers</strong>.&rdquo;</p></blockquote><p dir="ltr">The mention of social-security numbers can be distracting and may lead to misunderstanding&nbsp;of what the essential requirement is (having to do with verifying the format, not the presence of a genuine social-security number).</p><h3>How Much Persona is Too Much Persona?</h3><p dir="ltr">My buddy Bill Anderson&nbsp;<a href="http://orcmid.com/blog/2005/10/what-programmers-do.asp#113027135940333402">riffed</a> on the prospect of providing too much information.&nbsp; He&nbsp;ties it&nbsp;to the possibly-erroneous use of personas in software requirements:</p><blockquote dir="ltr" style="MARGIN-RIGHT: 0px"><p dir="ltr">&ldquo;Some of the current requirements specification methods that focus on user personas as proxies for actual users fall into this practice. Personas are constructed to represent a class of user, or even a work role, but then include data such as weight and hair color. These kinds of errors just compound the already difficult problem of articulating requirements for machines that can fit into the work and business lives of the users.&rdquo;</p></blockquote><p dir="ltr">I don&rsquo;t know what to make of this.&nbsp; I thought specifying personal traits gave&nbsp;developers&nbsp;a way to recognize and relate to the persona as an individual that the team creates a shared acquaintance of.&nbsp; I&rsquo;m&nbsp;unclear that&nbsp;this is an error that would mislead the developers into possibly misunderstanding a requirement.</p><p dir="ltr">Meanwhile, I&rsquo;ve been <a href="http://odma.info/faq/2005/10/q051001e.htm">creating a persona or two</a> as a way for me to focus on a project of mine.&nbsp; I&rsquo;ve already seen that being creative in&nbsp;persona invention&nbsp;can be a distraction, and I&rsquo;ve been stuck.&nbsp; I have assumed that was a consequence of my working alone, with no team to brainstorm with.</p><p dir="ltr">So how much should one personify the personas as a way of relating to them and creating a point-of-view that expresses their concerns,&nbsp;standing outside of the development process and looking inward?</p><h3>What About Developer Personas?</h3><p dir="ltr">I have another question too.&nbsp; Because of the nature of the project, I am wondering about having a persona for myself as well.&nbsp; It reflects my interest in understanding how the development lifecycle is a dance between both producers and adopters.&nbsp; Is it appropriate to represent the developer perspective with an identified persona?</p><p dir="ltr">&nbsp; <br /></p><div style="clear:both; padding-bottom: 0.25em;"></div>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2005/10/distraction-of-user-personas.asp">10/25/2005 07:12:09 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2005/10/distraction-of-user-personas.asp">
 		...
 		<div class="blogComments">
			...
			<div class="blogComment">
				&nbsp;<br /><a name="113034645176602796"></a> 
				Dennis, this is an important question. Regardless of what Alan Cooper writes, I think that what the developers need to understand are the work practices and the context of that work.<BR/><BR/>The very successful CLASS project (I need to put a link here) that we both worked on focused on the work, not on the individuals.  We established very good relations with the users as a result of choosing Participatory Design as our own work practice. The system was not designed for a specific person, but to support the development of a new library work practice of digital reformatting of brittle books.<BR/><BR/>So I think that the personas you've created for your ODMA work contain a good deal of information and detail that are irrelevant for software design purposes. The details may help with context, but even there, information about the family history of a user doesn't seem relevant.<br />
				<div class="byline">
                  <a href="http://orcmid.com/BlunderDome/clueless/2005/10/distraction-of-user-personas.asp#113034645176602796" 
                     title="permanent link">#</a>
                  posted by <a href="http://www.blogger.com/profile/3342052">Bill Anderson</a>: 
                  10/26/2005 10:07 AM
                </div>
                <span class="item-control admin-1585504753 pid-1360140406"><a style="border:none;" href="http://www.blogger.com/delete-comment.g?blogID=7336679&amp;postID=113034645176602796" title="Delete Comment" ><span class="delete-comment-icon">&nbsp;</span></a></span>
			</div>
			
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=113029272972897146">Post a Comment</a>
		</div>
