...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2005/02/blackbelted-that.asp 3     06-02-03 22:44 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: Blackbelted That!</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
    ...
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2004/12/eliminating-mutual-incomprehension-in.asp">Eliminating Mutual Incomprehension in Interoperability Arrangements</a><br />
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="Wednesday, February 09, 2005" href="#Wednesday, February 09, 2005">
          <font color="#660000">Wednesday, February 09, 2005</font></a></h3>
   	

	<div class="posts">
	<a name="110802087670647258"></a>
    
    <h2><font color="#000080"><!-- 2004-08-31 -->
    <a href="http://orcmid.com/BlunderDome/clueless/2005/02/blackbelt-this.asp"
                    title="external link">
    Blackbelted That!
    </a>
    </font></h2>
    ...
    <p>
	In <a href="http://orcmid.com/BlunderDome/clueless/2005/02/blackbelt-this.asp">Blackbelt This!</a> last Friday, I was being cranky about a Webcast audio problem and loss of notes from one webcast while moving to another that it overlapped.&nbsp; Joe Stagner commented with a reminder that these webcasts are archived and available for on-demand viewing at leisure.&nbsp; Other materials are also available for download.&nbsp; I have successfully viewed two more Live Meeting webcasts since my initial mishap and I've gone back and reviewed the first of the Digital Blackbelt presentations.&nbsp; OK, I'm happy now.&nbsp; Here's my peace offering:<br /><br /><b><a href="http://www.microsoft.com/mscorp/execmail/2005/02-03interoperability.asp">Bill Gates on Interoperability by Design.</a></b>&nbsp; This Bill Gates executive e-mail was the introduction of interoperability by design and the high-altitude view of the importance of interoperability as a theme for Microsoft.&nbsp; There are further resources in the sidebar.&nbsp; The Bill Gates webcast on the Connected Office is now featured as part of <a href="https://www.interopmonth.com/home/Default.aspx">interoperability month webcasts</a> and I recommend that you view it and take advantage of some of the others as well.&nbsp; There are prizes and premiums too.&nbsp; Finally, there's a follow-up on "<a href="http://blog.seattlepi.nwsource.com/microsoft/archives/004287.html?wbfrom=rss">Gates at the Office</a>" with links to other coverage and an <a href="http://www.microsoft.com/billgates/speeches/2005/02-04OfficeDevCon.asp">official text transcript</a>.&nbsp; I recommend the webcast over the transcript, because the liveliness and occassional awkwardness are valuable to observe.&nbsp; The great Q&A and the actual demonstrations are not included with the transcript.<br /><br /><a href="http://msevents.microsoft.com/CUI/WebCastEventDetails.aspx?EventID=1032267275&amp;EventCategory=5&amp;culture=en-US&amp;CountryCode=US">Joe Stagner's Digital Blackbelt Introduction</a> is now viewable as an on-demand presentation of the recorded webcast.&nbsp; It provides a full replay of the original webcast.&nbsp; All of the materials of the presentation are available at the <a href="http://www.DigitalBlackBelt.com">DigitalBlackBelt</a> site.&nbsp; I recommend replaying the webcast with its audio and verbal reactions during the Q&A.&nbsp; I'm looking forward to future episodes. 
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2005/02/blackbelted-that.asp">2/9/2005 11:30:36 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2005/02/blackbelted-that.asp">
        ...
        <a href="http://www.blogger.com/comment.g?blogID=7336679&postID=110802087670647258">Post a Comment</a>
		</div>
