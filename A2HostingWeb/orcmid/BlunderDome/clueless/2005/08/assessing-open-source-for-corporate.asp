...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2005/08/assessing-open-source-for-corporate.asp 1     05-08-16 17:59 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: Assessing Open Source for Corporate Usability</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="Tuesday, August 02, 2005" href="#Tuesday, August 02, 2005">
          <font color="#660000">Tuesday, August 02, 2005</font></a></h3>
   	

	<div class="posts">
	<a name="112301645661622937"></a>
    ...
    <p>
	<div style="clear:both;"></div><p><a href="http://radar.oreilly.com/archives/2005/08/open_source_bus.html">O'Reilly Radar &gt; Open Source Business Readiness Ratings</a>.&nbsp; Tim O&rsquo;Reilly&rsquo;s Radar has&nbsp;homed-in on <a href="http://www.openbrr.org/">Business Readiness Rating</a>, &ldquo;A proposed Open Standard to Facilitate Assessment and Adoption of Open Source Software.&rdquo;&nbsp; I want to pay attention to this, and indeed, <a href="http://trosting.org/">I have to</a>, because&nbsp;the sponsors are proposing to provide&nbsp;&ldquo;a <strong>trusted</strong>, unbiased source for determining whether the open source software they are considering is mature enough to adopt [my emphasis].&rdquo;&nbsp; There are white papers, some samples, and a way to get involved.</p><p>I am interested in assessments generally because they&nbsp;will touch on trustworthiness&nbsp;in products, especially&nbsp;in the&nbsp;overlap&nbsp;with usability, security,&nbsp;deployment and support/maintainability.&nbsp; There is something different than producer&rsquo;s risk required&nbsp;as part of open-source development and distribution models, and I am keen to see what can provide a&nbsp;comparable basis for the confidence in suppliers&nbsp;that commercial adopters require.&nbsp; Also, this&nbsp;approach would seem to provide developers a way to develop their trustworthiness and confidence in their products.&nbsp; </p><p>I am interested in this approach specifically for how the authority of assessments is developed and aggregated with regard to particular software products.&nbsp;&nbsp; I want to test this with regard to transparency, provenance of assessments, and verification / confirmation of assessments.&nbsp;&nbsp;Most of all, I&nbsp;want to understand the approach to aggregation.&nbsp; I don&rsquo;t have an answer to this: it is an area where I have questions, and I want to see what comes out of BRR.&nbsp; I also don&rsquo;t understand why we would deal any differently with closed-source offerings, and I will wonder about that as well.</p><p>I recommend downloading the white-paper (PDF file) and the sample form (Microsoft Excel file [;&lt;), registering with the site, and then joining the forum for discussion.&nbsp; (The forum membership rules are something.)&nbsp; I&rsquo;ll be there.</p><div style="clear:both; padding-bottom: 0.25em;"></div>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2005/08/assessing-open-source-for-corporate.asp">8/02/2005 02:00:56 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2005/08/assessing-open-source-for-corporate.asp">
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=112301645661622937">Post a Comment</a>
		</div>
