...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /A2HostingWeb/orcmid/BlunderDome/clueless/2007_11_04_clu-chive.asp 1     08-10-07 14:29 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: 2007-11-04</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
    ...
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2008/02/odf-ooxml-nfoworks-for-harmony.asp">ODF-OOXML: nfoWorks for Harmony?</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2008/02/dmware-office-system-developer.asp">DMware: Office System Developer Conference 2008</a><br />
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="2007-11-10" href="#2007-11-10">
          <font color="#660000">2007-11-10</font></a></h3>
   	

	<div class="posts">
	<a name="1135472849710125475"></a>
    ...
    <p>
	<div style="clear:both;"></div><p></p> <div class="wlWriterSmartContent" id="scid:0767317B-992E-4b12-91E0-4F059A8CECA8:20ec63d4-674d-46fc-8a78-9805f7c1f2d1" style="padding-right: 0px; display: inline; padding-left: 0px; float: none; padding-bottom: 0px; margin: 0px; padding-top: 0px">Technorati Tags: <a href="http://technorati.com/tags/orcmid" rel="tag">orcmid</a>, <a href="http://technorati.com/tags/ODMA" rel="tag">ODMA</a>, <a href="http://technorati.com/tags/ODMA64" rel="tag">ODMA64</a>, <a href="http://technorati.com/tags/x64" rel="tag">x64</a>, <a href="http://technorati.com/tags/64-bit%20applications" rel="tag">64-bit applications</a>, <a href="http://technorati.com/tags/64-bit%20desktop%20integration" rel="tag">64-bit desktop integration</a>, <a href="http://technorati.com/tags/AIIM%20Standards" rel="tag">AIIM Standards</a>, <a href="http://technorati.com/tags/AIIM%202008" rel="tag">AIIM 2008</a>, <a href="http://technorati.com/tags/DMware" rel="tag">DMware</a></div> <p></p> <p><strong>UPDATE:</strong> The timeline has been extended by 12 months and some additional migration considerations introduced.</p> <p>As we migrate over to 64-bit desktop PCs, I don't expect early demand for a 64-bit version of ODMA, the <a href="http://odma.info">Open Document Management API</a> and its supporting middleware.&nbsp; Still, it seems useful to envision what a practical migration to an ODMA64 could be.&nbsp; I'm thinking that 2008 can be spent stabilizing ODMA 2.0 fixtures, with ODMA 64 defined during 2009.&nbsp; Implementation and availability would be in 2010.&nbsp; That way, we won't be caught too short by whatever demand, if any, that does arise, as part of the movement of desktop clients to full 64-bit operation.</p> <h3>A Timeline</h3> <ul> <li><strong>November 2007:</strong> I've begun to capture <a href="http://odma.info/dev/devNotes/2007/10/d071002.htm">ideas for ODMA64</a> in <a href="http://odma.info/dev/">ODMdev</a> note pages.&nbsp; Those notes will be revised and expanded as I capture my own thoughts and those of stakeholders wanting to see and invest in an ODMA64.<br>&nbsp;&nbsp; <br><strong>UPDATE 2008-02-15:</strong> I have slipped the remaining time line by 12 months, adding in time for the stabilization of existing material and work toward an ODMA 2.5 supplement.<br>&nbsp;&nbsp;&nbsp; <li><strong>March 2008:</strong> The Open Source materials on ODMA will become available on the SourceForge <a href="http://sourceforge.net/projects/activeodma">ActiveODMA Project</a>.&nbsp; There will also be a CD-ROM of the official core materials, SDK, and specifications.&nbsp; This repository will be expanded with the ODMA 2.5 supplemental materials and fixtures over the next 12 months. <br>&nbsp;&nbsp; <li><strong>Spring 2009:</strong> I'm promoting an ODMA reunion/get-together in conjunction with AIIM 2009 in the Spring.&nbsp; What I want to appraise is  <ul> <li>Whether there is enough life and value in ODMA to migrate to 64-bit at all,  <li>Whether the idea of preserving but enriching the "sweet spot" ODMA functionality is agreeable  <li>Whether there is some superior avenue that should be encouraged instead of ODMA<br>&nbsp;&nbsp;&nbsp;&nbsp; </li></ul> <li><strong>Spring 2010:</strong> Assuming that there is headway toward ODMA64, use the occasion of the next AIIM Conference to get together and confirm any work that has been done and agree on how to distribute and integrate with ODMA64, conduct interoperability tests/demonstrations, and assure ODMA64 stability and dependability.</li></ul> <h3>Suggested Constraints</h3> <ol> <li><strong>No Second-System Syndrome.</strong>&nbsp; No major feature or function madness.&nbsp; Do enough to have it work great, but no more.<br>&nbsp;&nbsp; <strong></strong> <li><strong>Preserve the Sweet Spot.</strong>&nbsp;&nbsp; Continue to support the integration that has worked so well in the ODMA32 world, holding onto the feature set and use cases that matter for most applications that rely on ODMA integration.<br>&nbsp;&nbsp; <li><strong>Take Out What's Never Mattered</strong>.&nbsp; Simplify wherever possible to keep the functionality simple and conceptually coherent.&nbsp; Be a reliable connector and let the desktop software and the DMS integrations provide appropriate richness and feature competition.<br>&nbsp;&nbsp; <li><strong>Progressive Migration.</strong>&nbsp; Operate by incremental/iterative improvement of what there is to provide a stable ODMA32 framework for proof-of-concept and bridging to ODMA64.<br>&nbsp;&nbsp;&nbsp; <br> <ul> <li>Define the ODMA model that ODMA64 supports as ODMA 3.0.&nbsp; Make important core improvements along with <em>removal</em> of those features in ODMA 2.0 (such as code-page based 8-bit character strings) that have no survival value and that do not need to be a drag on new ODMA64 integrations.<br> <li>Introduce a hybrid layer, defined as ODMA 2.5, operating on Win32.&nbsp; ODMA 2.5 provides Win32 versions of the ODMA64 core improvements via supplemental wrappers above and below ODMA32 on Win32.&nbsp; Existing ODMA32 components would continue to operate properly.<br> <li>Develop the hybrid layer using bridges already envisioned for ODMA32 integration with <a href="http://odma.info/active/odmjni.htm">Java</a>, .NET, direct COM, and possibly ActiveX/IDispatch.<br>&nbsp;&nbsp;&nbsp; <li><strong>Added 2008-02-15:</strong> Explore means for implementation of managed-code DMS integrations (Java, Mono, or .NET) below the native ODMA32 (and ODMA64) Connection Manager implementations.<br>&nbsp;&nbsp; <li><strong>Added 2008-02-15:</strong> Explore means for discovering short-circuiting of the native-layer Connection Manager when a client-compatible managed DMS interface is available.&nbsp; Bypass native-platform interop and data-conversion layers whenever possible.</li></ul></li></ol> <h3>Core Improvements</h3> <p>The following improvements seen essential:</p> <ol> <li>Complete end-to-end Unicode UTF16 support<br>&nbsp;&nbsp; <li>Reliable and consistent integration of DMS modal dialogs with the desktop application program's GUI<br>&nbsp; <li>Thread safety and proper multi-threaded behavior<br>&nbsp;&nbsp; <li>Complete logging and operational confirmation/troubleshooting capability, with proper behavior when multiple ODMA applications are operated concurrently<br>&nbsp;&nbsp; <li>Easy power-user/administrator configuration control and inspection, with customization by user account, not just by machine</li></ol> <p>The ODMA64 Connection Manager and supporting utilities would be provided under the current modified-BSD template license.&nbsp; </p> <p>If this were to be done, my objective would be to ensure that the ODMA integration layer is the most dependable and stable portion of the desktop-program through ODMA to DMS-integration stack.</p> <hr> <small> <p>When I <a href="http://orcmid.com/blog/2005/12/odma-little-middleware-that-could.asp">celebrated</a> the 10th anniversary of ODMA in 2005, I was already bemused that I had somehow become its exclusive source of general support.&nbsp;&nbsp; Despite my own appraisals of ODMA as a niche with dwindling share of attention and interest, I am actively developing new fixtures for use in making ODMA-aware application software and DMS integrations.&nbsp; For now, I get a lot out of it, especially practice toward developing other software.&nbsp; Now we'll see whether there is sufficient community interest for development of ODMA64 to be worthwhile.&nbsp; I should probably update that <a href="http://nuovodoc.com/analysis/ODMA-Analysis.htm">analysis of where ODMA is going</a>.</p> <p>[<strong>update 2008-02-15:</strong> While adding 12 more months to the timeline for progressing toward ODMA64, I also added two additional challenges to be explored concerning interop with managed-code DMS integrations.<br>&nbsp;<strong>update 2007-11-11:</strong> While correcting a duplicate wording I added a few clarifying bits.&nbsp; Well, it clarifies for me what I wanted said, if it's not clear for you, ask.]</p></small>  <div style="clear:both; padding-bottom:0.25em"></div>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2007/11/dmware-how-about-that-odma64.asp">11/10/2007 10:46:00 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2007/11/dmware-how-about-that-odma64.asp">
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&postID=1135472849710125475">Post a Comment</a>
		</div>
