...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2005_08_28_clu-chive.asp 2     06-02-03 22:44 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: 2005-08-28</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
    ...
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2005/07/trustworthy-deployment-whats-that.asp">Trustworthy Deployment: What's That?</a><br />
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="Friday, September 02, 2005" href="#Friday, September 02, 2005">
          <font color="#660000">Friday, September 02, 2005</font></a></h3>
   	

	<div class="posts">
	<a name="112569493485555236"></a>
    ...
    <p>
	<div style="clear:both;"></div><div style="FLOAT: left"><a href="http://www.redcross.org/"><img height="125" alt="Donate to the Red Cross" src="http://www.sixapart.com/typepad/news/images/badge-rc-static-help-125x125.gif" width="125" /></a></div><p><strong><a href="http://trosting.org/info/2005/08/i050809b.htm">Yet Another Data Model</a></strong>.&nbsp; As I dug my way&nbsp;down to&nbsp;the bootstrap of TROST: <a href="http://trosting.org/">Templates for Open-System Trustworthiness</a>, it became increasingly clear that pattern languages are an important feature of the protocols by which evidence for trustworthiness is conveyed.&nbsp;&nbsp;TROST patterns are in the area of performance and processes in the cycle of learning and improvement that system producers and adopters are mutually engaged in.&nbsp; </p><p>Looking at system engagement/participation&nbsp;makes for a different kind of pattern than is employed for object-oriented design and programming.&nbsp; Patterns for processes and activities are more akin to the <a href="http://www.patternlanguage.com/leveltwo/ca.htm">Christopher Alexander</a> view of pattern languages as applied to activity around habitat and the structuring of spaces for performance and civil use.&nbsp; </p><p>Furthermore, the artifacts are different in the domain where TROST applies.&nbsp; I have in mind the documents, records, and software-deployment artifacts that have digital form, print form, and serve as&nbsp;instruments of communication and support among producers and adopters.</p><p>In building up <a href="http://trosting.org/">TROSTing.org</a>, I began to see numerous patterns in the way that I organized and coordinated web materials and also other forms such as documentation templates and packages of code and the procedures used to confirm the software.</p><p>How can one characterize and convey those artifactual patterns in a way that fits the pattern language spirit?&nbsp; </p><p>I automatically turned to a form of data-model diagramming that I have been using on-and-off since the mid 1970s as a way of abstracting what I was observing.&nbsp; At the time, I called these information-system models.&nbsp; Humbled somewhat by time and experience, I now refer to the approach as one of navigational data models.</p><p>Since there is&nbsp;near-unanimous agreement that the world doesn&rsquo;t need yet another data model, I have seriously considered why I keep returning&nbsp;to these rather than adopting ones that are already well-known.&nbsp; It is certainly a matter of familiarity and preference: &nbsp;I invariably use navigational data models as a way to explain other data models to myself.&nbsp; These are the models that come to mind naturally in my thinking.&nbsp; </p><p>That is probably not how they will strike others who&rsquo;ve internalized one of the well-known modeling approaches.&nbsp; Here, for example, is how I portray a classic example in data modeling: the organization of manufacturing product data about parts that may themselves be assemblies used as components&nbsp;of larger assemblies:</p><blockquote><p align="center"><a href="http://nfocentrale.net/TROST/info/2005/08/i050809c.htm#3.3.4"><img alt="Example of Navigational Model with Converse Relationships" src="http://nfocentrale.net/TROST/info/2005/08/i050809c6.png" border="0" /></a></p></blockquote><p>Although I&rsquo;ve given the biggest reason &mdash; personal preference &mdash; for pursuing this approach with TROST patterns, there are&nbsp;features of&nbsp;it that I am quite unwilling to give up:</p><ul><li>The diagrams are permitted to be incomplete and may be used for multiple patterns that, in practice, are manifest in a single, blended&nbsp;situation: pattern fusion.</li><li>It is valuable to recognize how keys &mdash; identifying data elements &mdash; for entry into navigational material may have <a href="http://nfocentrale.net/TROST/info/2005/08/i050809c.htm#2.5">local and subordinated scopes of visibility</a>.</li><li>The identification of relationships&nbsp;by naming&nbsp;the converse perspectives of the two <a href="http://nfocentrale.net/TROST/info/2005/08/i050809c.htm#3.3">associated data entities</a> is important (bonus: the associated data-entity types&nbsp;don&rsquo;t have to be connected by lines and arrows &ndash; the dashed connections in the figure are solely&nbsp;for convenience)</li></ul><p>The key test is&nbsp;whether it is easy to gain a sense&nbsp;of the import of one of these diagrams without first having to know how to create it.&nbsp; I don&rsquo;t think it takes much to to&nbsp;get the sense of&nbsp;these diagrams.&nbsp;&nbsp;Of course,&nbsp;I&rsquo;m not a fair test for achievement of that.&nbsp; I will have some illustrations in a variety of pattern that should test that hypothesis nicely.&nbsp; I&rsquo;ll announce a catalog of examples when there are more.&nbsp; Then we can see how readily-understandable the diagrams are in the descriptions of commonly-used patterns.&nbsp;</p><div style="clear:both; padding-bottom: 0.25em;"></div>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2005/09/navigating-data-models.asp">9/02/2005 02:02:14 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2005/09/navigating-data-models.asp">
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=112569493485555236">Post a Comment</a>
		</div>
