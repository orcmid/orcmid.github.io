...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2005_01_30_clu-chive.asp 4     06-04-23 15:46 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: 2005-01-30</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="Friday, February 04, 2005" href="#Friday, February 04, 2005">
          <font color="#660000">Friday, February 04, 2005</font></a></h3>
   	

	<div class="posts">
	<a name="110754846889893126"></a>
    ...
    <p>
	<div style="clear:both;"></div><i>You</i> can find out about the Digital Blackbelt webcast series and download the presentation materials for the first session at <a href="http://www.digitalblackbelt.com/forum/forum_posts.asp?TID=6">Joe Stagner's Digital Blackbelt forum site</a>.&nbsp; I would like to tell you whether I found it to be worthwhile, but I can't.<br /><br /><i>You</i> can watch a rerun of <a href="http://msevents.microsoft.com/CUI/WebCastEventDetails.aspx?EventID=1032268850&Culture=en-US">this morning's Bill Gates webcast</a> (one where all the demos worked just great, even Bill's code) once it is put up on the <a href="http://www.microsoft.com/seminar/events/webcasts/ondemand.mspx">recent-webcast list here</a>.&nbsp; I can tell you this one is worth watching, because there is a lot about connectivity and easy construction of connected applications for the enterprise as seen from a Microsoft-centric worldview.<br /><br />I will have to look at those myself, and I am very grumpy about that fact:&nbsp;  Two wasted hours grumpy.<br /><hr /><small><br />Bill Gates did a presentation and Q&A at the Windows Office Developers conference, scheduled from 10:00 am to 11:15 today.&nbsp; There was a live webcast of it.<br /><br />I was mildly irked that it overlapped with the first Digital Blackbelt webcast, running from 11:00 until noon today.&nbsp; I was already uncertain about attending a session that featured "Selling your Boss ..." in its title, but I figured I could suspend judgment for a bit.<br /><br />So I drop in on the "MSDN Webcast: Connected Systems and the Microsoft Office System (Level 300)" webcast and it all goes great.&nbsp;  I had pre-tested my system and downloaded all of the audio and video components that are apparently required.&nbsp;  It all works the first time.&nbsp; The demo displays of Visual Studio are pretty blurry in the webcast, and going to full screen is not that helpful.&nbsp; But I follow along well enough, busily typing my gleanings into an open Outlook Note.&nbsp;  The Q&A starts at 10:45 and is scheduled to go for 30 minutes.<br /><br />I tear myself away from the Q&A just past 11:00, preparing to open the Digital Blackboard webcast and maybe even keep the Connected System webcast around.&nbsp;  That didn't work, because my browser moved away when I started into the second conference.&nbsp;  OK, no problem.&nbsp;  But when the WebCast Console or whatever it is launches, my computer freezes.&nbsp;  The cursor is stuck, Ctrl-Alt-Del is ineffective, and I am hosed.&nbsp; So I lean on the power button until the laptop shuts down, then I power up again.<br /><br />Powering up into Windows XP after a crash takes longer (I figure NTFS has work to do), and starting up my account takes what seems like forever.&nbsp; Then Outlook takes even longer to start up after a crash too (but it has the note with the link to the webcast, perhaps).&nbsp;  I look in my Drafts folder to see if there is any surviving remnant of my hour's worth of notes from the first session.&nbsp;  Nothing, all gone.&nbsp; I know better, and every time I am lulled into complacency by an Internet-based application, I get slammed for it.&nbsp; Why do I insist on not learning that lesson?<br /><br />I head back into the Digital Blackbelt webcast and notice that I have to give lots of firewall permissions to have everything running.&nbsp;  This time I get into the middle of the webcast.<br /><br />Oh, we're sharing an application.&nbsp; I wonder what it is.&nbsp; I maximize my browser screen to see if I can get all of the application visible at once, No, I have to scroll around if I want to see more.  Beneath the application, there is this little text box where questions and answers are appearing.&nbsp; And to the left there is a big nearly-empty sidebar that prevents the application getting fully into my browser window.  <br /><br />There is no sound.&nbsp;  There's a "click here for audio" button in that nearly-empty sidebar, so I do.&nbsp;  The window says it is initializing or something and it takes freeking forever.&nbsp;  After a good 3 minutes, I close the silly thing.&nbsp; Still no sound and I have no idea what the application we're looking at is and why it is interesting.&nbsp;  Eventually, I give up and follow the link on how to test sound.&nbsp;  This gets me to a version of the soundcheck that says it succeeded in initializing.&nbsp;  I go back into the application and "click here for audio" again.&nbsp;  This time, I get a failure and the help page about what the cause should be is very geeky with lots of technical possibilities and no clues on how to tell which it might be.&nbsp; My guess is that some remnant application is hogging my sound interface and the webcast can't get to it.<br /><br />I do a restart, figuring there is something in my local audio that is messed up.&nbsp;  When I am logged-in again (it is now after 11:45), I do a quick check with MediaPlayer to see if my audio is working at all.&nbsp; I find a working Internet radio broadcast and then close MediaPlayer.&nbsp;  Then I go to the webcast site, tell my firewall that all of those scripts and ActiveX components are fine for one more time.&nbsp;  I get back to the webcast page at 11:55.&nbsp; The page I'm presented says the conference has ended.<br /><br />Bottom line: I was on-line for two hours.&nbsp; I lost my notes on the first hour when I attempted to get into the second hour.&nbsp;  I never got into the second hour successfully, and didn't even learn whether I would have heard audio if they were still there.<br /><br />So my one impression of the first digital blackbelt session is that there was some sort of dive down into nuts and bolts that I wouldn't want to show my boss even if I had one of those.&nbsp; I have no idea what kind of overview was provided to establish the context of it all.<br /><br />I had a lot more to take away from the Bill Gates presentation, the demos, and the Q&A.&nbsp;  Those notes are gone.&nbsp; And I won't be making any effort to reconstruct them.&nbsp;  Times up.<br /><br />Crap.</small><br /><br /> <br /><div style="clear:both; padding-bottom: 0.25em;"></div>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2005/02/blackbelt-this.asp">2/04/2005 01:00:51 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2005/02/blackbelt-this.asp">
 		...
 		<div class="blogComments">
			...
			<div class="blogComment">
				&nbsp;<br /><a name="110798314493645114"></a> 
				Sorry you had trouble with the Digital Black Belt Session via LiveMeeting. <br /><br />It's now available for on-demand viewing..... but If you would like, send me an email and I'll send it to you on CD. <br /><br />Joe Stagner<br />Digital Black Belt Webcasts<br />
				<div class="byline">
                  <a href="http://orcmid.com/BlunderDome/clueless/2005/02/blackbelt-this.asp#110798314493645114" 
                     title="permanent link">#</a>
                  posted by Anonymous: 
                  2/09/2005 1:05 PM
                </div>
                <span class="item-control admin-1585504753 pid-1385595275"><a style="border:none;" href="http://www.blogger.com/delete-comment.g?blogID=7336679&amp;postID=110798314493645114" title="Delete Comment" ><span class="delete-comment-icon">&nbsp;</span></a></span>
			</div>
			
			<div class="blogComment">
				&nbsp;<br /><a name="110802127995370195"></a> 
				Thanks Joe, I found the on-demand replay of the webcast and provided more connections in a <A HREF="http://www.blogger.com/r?http%3A%2F%2Fnfocentrale.net%2Forcmid%2FBlunderDome%2Fclueless%2F2005%2F02%2Fblackbelted-that.asp">follow-up post</A>.&nbsp; Your presentation was very nice and it make complete sense once I had the audio to go with the play-by-play on SQL injection.&nbsp; This is great because I can take advantage of the replay for session #2, happening while I am in transit to Vancouver, BC for an invent.<br />
				<div class="byline">
                  <a href="http://orcmid.com/BlunderDome/clueless/2005/02/blackbelt-this.asp#110802127995370195" 
                     title="permanent link">#</a>
                  posted by <a href="http://www.blogger.com/profile/963786" rel="nofollow">orcmid</a>: 
                  2/09/2005 11:41 PM
                </div>
                <span class="item-control admin-1585504753 pid-1762770988"><a style="border:none;" href="http://www.blogger.com/delete-comment.g?blogID=7336679&amp;postID=110802127995370195" title="Delete Comment" ><span class="delete-comment-icon">&nbsp;</span></a></span>
			</div>
			
			<div class="blogComment">
				&nbsp;<br /><a name="110802135149899727"></a> 
				Uh, an event, that is.&nbsp; I'll invent later.<br />
				<div class="byline">
                  <a href="http://orcmid.com/BlunderDome/clueless/2005/02/blackbelt-this.asp#110802135149899727" 
                     title="permanent link">#</a>
                  posted by <a href="http://www.blogger.com/profile/963786" rel="nofollow">orcmid</a>: 
                  2/09/2005 11:42 PM
                </div>
                <span class="item-control admin-1585504753 pid-1762770988"><a style="border:none;" href="http://www.blogger.com/delete-comment.g?blogID=7336679&amp;postID=110802135149899727" title="Delete Comment" ><span class="delete-comment-icon">&nbsp;</span></a></span>
			</div>
			
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=110754846889893126">Post a Comment</a>
		</div>
	
	</div>
    
	
      <h3><a name="Wednesday, February 02, 2005" href="#Wednesday, February 02, 2005">
          <font color="#660000">Wednesday, February 02, 2005</font></a></h3>
   	

	<div class="posts">
	<a name="110736821752716707"></a>
    
    <h2><font color="#000080"><!-- 2004-08-31 -->
    <a href="http://radio.weblogs.com/0001011/2005/02/02.html#a9310"
                    title="external link">
    ...
    <p>
	<div style="clear:both;"></div><a href="http://radio.weblogs.com/0001011/2005/02/02.html#a9310">Scobleizer: Microsoft Geek Blogger: Thinking Smaller Brings Lots of Interesting Ideas</a>.  [from 2005-02-02] Scoble was challenged about his notion of small ideas, and he responded to "will the little things make enough of a difference?" with a great list of example of small things that have done that.  The conversation moves on to the next small things (a nice shift).  Scoble primes the pump with a list of items that have crossed his radar, and his link blog carries more.<div style="clear:both; padding-bottom: 0.25em;"></div>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2005/02/little-things-mean-lot.asp">2/02/2005 10:16:00 AM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2005/02/little-things-mean-lot.asp">
       </script> data by <a href="http://www.newsgator.com">NewsGator 
                             Online</a><!-- 2004-10-28 --></span>
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=110736821752716707">Post a Comment</a>
		</div>
