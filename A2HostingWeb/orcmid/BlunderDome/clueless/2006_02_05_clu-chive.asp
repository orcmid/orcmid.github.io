...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2006_02_05_clu-chive.asp 1     06-04-23 15:55 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: 2006-02-05</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="Tuesday, February 07, 2006" href="#Tuesday, February 07, 2006">
          <font color="#660000">Tuesday, February 07, 2006</font></a></h3>
   	

	<div class="posts">
	<a name="113935240746641363"></a>
    ...
    <p>
	<div style="clear:both;"></div><h3>coComment Excitement</h3><p>As the result of recent excitement in <a href="http://scobleizer.wordpress.com/2006/02/04/track-your-comments-no-matter-where-you-make-them/">the Swiss Alps</a>, I applied for an invitation to <a href="http://www.cocomment.com/"><strong>coComments</strong></a> to see how well it works.&nbsp; </p><p>I love the idea of collecting the comments I leave on blogs in&nbsp;a place where I can find them again and also correlate with the comments of others.&nbsp; a</p><p>I&nbsp;developed serious&nbsp;<em><a href="http://www.fullcirc.com/weblog/2006/02/cocomment-tracking-your-comments.htm#113918834006046621">coComment Envy</a></em> when <a href="http://www.fullcirc.com/weblog/2006/02/cocomment-tracking-your-comments.htm">Nancy White</a> allowed as how she had used one of the invitations.&nbsp; For those who want to play with the comment coordination tool, you can leave your e-mail under the &ldquo;Get Notified&rdquo; dialog on the home page.&nbsp; So far, invitations have been returned within 24&ndash;48 hours.</p><p><strong>The site is in serious beta</strong> and you need to understand that the process won&rsquo;t work for comments on all blogs for a variety of reasons.&nbsp; There are useful forums operating on the site and you can check out what others are saying.&nbsp; It is also fun to watch <a href="http://scobleizer.wordpress.com/2006/02/04/track-your-comments-no-matter-where-you-make-them/">Scoble&rsquo;s</a>&nbsp;and <a href="http://www.fullcirc.com/weblog/2006/02/cocomment-tracking-your-comments.htm">Nancy&rsquo;s</a> posts where others are busily attempting to coComment them.</p><hr><h3>Studying the Confirmability of Browser-Hosted Web Service Hooks</h3><p>The reason for this post is that coComment is not working for me.&nbsp; There appear to be&nbsp;problems with&nbsp;my browser security and&nbsp;privacy settings.&nbsp;&nbsp; I think I know what to do now, and I am going to screen-capture the whole process and add it to this blog entry when I succeed (or give up).</p><p>This is an interesting challenge because I have noticed how difficult it is to harden a web-carried protocol when there is a tremendous variation of end-points.&nbsp; In this case, there are three parties: </p><ul><li>myself, with my browser</li><li>the blog I am visiting, with its comment arrangement</li><li>the coComment scripts and bookmarklet interacting<br />with the coComment server, my account, and my sign-on status there</li></ul><p>This is challenge reminds me of the kind of difficulty that can also arise in the <a href="http://lid.netmesh.org/wiki/Main_Page">LID approach</a> to single signon.&nbsp;&nbsp;It is representative of the&nbsp;problem of <a href="http://nfocentrale.net/orcmid/blog/2006/01/confirmable-experience-outstanding.asp">creating confirmable experience</a> over the internet when so much of what is happening is out of the sight of&nbsp;at least&nbsp;two end parties (in this case me, someone at coComment, and sometimes&nbsp;the&nbsp;owner of a blog I want to coComment).&nbsp; It is easier to find cases where, because of the opacity of one or more players, it is <a href="http://nfocentrale.net/orcmid/blog/2006/02/naked-monoculture-bites-msdn.asp">near-impossible</a> to&nbsp;perform end-user troubleshooting and even more difficult for end-point parties to figure out what is happening in the complex arrangement that is interposed between them.&nbsp; I have no idea how developers of these web systems are able to <a href="http://blogs.msdn.com/larryosterman/archive/2006/01/30/519675.aspx#519700">verify and troubleshoot them</a> in the face of &ldquo;it&rsquo;s not working&rdquo; reports.</p><hr><h3>Snooping Around</h3><p>So I have my screen capture utility at the ready and I am now going to see how to get from coComment-not-working to coComment-working in a way that may or may not be helpful to the coComment folk.</p><p>Aha, when I go to Scobleizer&rsquo;s page I get three blocked cookies that amazon.com wants me to have (related to the Naked Conversations image on the page).&nbsp;&nbsp; I am not going to change that.</p><p>When I have a comment ready, I click the coComment link in my browser.&nbsp; I get an invitation to log in.&nbsp; I am already.&nbsp; Ah, but wait, there are more blocked cookies now.&nbsp; Seven of them, all from <a href="http://www.cocomment.com/">www.cocomment.com</a>.&nbsp; I begin to see the problem.&nbsp; Oh look, when I logged on from here, I can see my coComment user ID and password, in plaintext, sent as parameters to a <a href="http://www.cocomment.com/LoginServlet">www.cocomment.com/LoginServlet</a> request.&nbsp; That&rsquo;s thrilling.</p><p>But I use the browser security pane to add cocomment.com to my approved sites for cookies.</p><p>And it all works.&nbsp; I will try one with Nancy White&rsquo;s site too just to make sure this is reproducible.&nbsp; Wow, I hadn&rsquo;t realized how many links on her page attempt to deliver cookies to my computer.&nbsp; That&rsquo;s awesome.&nbsp; I think I&rsquo;ll tell her about it.</p><p>So that&rsquo;s easier than I thought, once I realize I can use my browser&rsquo;s cookie detector to tell me what site to grant blanket permission to drop cookies on me.</p><h3>Excitement Excitement Excitement</h3><p>Now that this is working I can see how it can be mildly addictive.&nbsp; First, for anything I&rsquo;ve coCommented on, I can see all other coComments on the blog entry.&nbsp; This is an useful way to check on comment-chain conversations that I am part of.&nbsp; </p><p>Even sexier than that, I can subscribe to a feed that carries all of my coComments.&nbsp; And I can subscribe to the coComments feeds of others as well as look at the conversations they are part of.&nbsp; I need to check if I have to grant permission for that.</p><p>But meanwhile, here are&nbsp;Orcmid&rsquo;s <a href="http://www.cocomment.com/rss2/orcmid.rss">RSS 2.0</a> and <a href="http://www.cocomment.com/atom/orcmid.xml">Atom 0.3</a> coComment feeds.&nbsp; They appear to offer full content.&nbsp; I love to keep records and also be able to go back and see what others have said.&nbsp;</p><p>There is a lot to learn in working with coServices like coComment.&nbsp; It is starting to be fun.</p><p>Oh yes, for me the confirmable experience succeeded, and now I need to go tell them that.&nbsp; I wonder if I can coComment a forum submission on the coComment site &hellip;</p><div style="clear:both; padding-bottom: 0.25em;"></div>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2006/02/ultimate-confirmable-incoherence.asp">2/07/2006 02:46:47 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2006/02/ultimate-confirmable-incoherence.asp">
 		...
 		<div class="blogComments">
			...
			<div class="blogComment">
				&nbsp;<br /><a name="113935620727248692"></a> 
				Naturally, one of the things to do is coComment on my own site.  This one does that.  <BR/><BR/>It doesn't add much value here, for me, because I receive e-mails of all of the comments that are posted here. That's how I know there might be something to pay attention to, if only to remove a comment-spam item.<BR/><BR/>What it will do is at this to the index of my conversations on the coComment site, and it will put it in Orcmid's coComment conversation feed.  And it lets me play before I go out and mow the lawn on this nice Seattle afternoon.<br />
				<div class="byline">
                  <a href="http://orcmid.com/BlunderDome/clueless/2006/02/ultimate-confirmable-incoherence.asp#113935620727248692" 
                     title="permanent link">#</a>
                  posted by <a href="http://www.blogger.com/profile/963786" rel="nofollow">orcmid</a>: 
                  2/07/2006 3:50 PM
                </div>
                <span class="item-control admin-1585504753 pid-1762770988"><a style="border:none;" href="http://www.blogger.com/delete-comment.g?blogID=7336679&amp;postID=113935620727248692" title="Delete Comment" ><span class="delete-comment-icon">&nbsp;</span></a></span>
			</div>
			
			<div class="blogComment">
				&nbsp;<br /><a name="113942415576772508"></a> 
				At the <A HREF="http://www.cocomment.com/teamblog/?p=22" REL="nofollow">coComment TeamBlog</A> they've just announced their first speed bump.  Invitations are not being given out until some performance tuning and scaling gets dealt with.<br />
				<div class="byline">
                  <a href="http://orcmid.com/BlunderDome/clueless/2006/02/ultimate-confirmable-incoherence.asp#113942415576772508" 
                     title="permanent link">#</a>
                  posted by <a href="http://www.blogger.com/profile/963786" rel="nofollow">orcmid</a>: 
                  2/08/2006 10:42 AM
                </div>
                <span class="item-control admin-1585504753 pid-1762770988"><a style="border:none;" href="http://www.blogger.com/delete-comment.g?blogID=7336679&amp;postID=113942415576772508" title="Delete Comment" ><span class="delete-comment-icon">&nbsp;</span></a></span>
			</div>
			
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=113935240746641363">Post a Comment</a>
		</div>
