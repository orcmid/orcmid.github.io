...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2006/04/does-visual-studio-rot-mind.asp 2     06-07-25 8:20 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: Does Visual Studio Rot the Mind?</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="Saturday, April 01, 2006" href="#Saturday, April 01, 2006">
          <font color="#660000">Saturday, April 01, 2006</font></a></h3>
   	

	<div class="posts">
	<a name="114393991532775197"></a>
    ...
    <p>
	<div style="clear:both;"></div><p><cite cite="http://www.charlespetzold.com/etc/DoesVisualStudioRotTheMind.html"><a href="http://www.charlespetzold.com/etc/DoesVisualStudioRotTheMind.html">Does Visual Studio Rot the Mind?</a></cite>&nbsp; Thanks to <a href="http://chilco.textdrive.com/~dmahugh/2006/04/01/programming-in-structured-english/">Doug Mahugh having a dreary day indoors</a>,&nbsp;I&rsquo;ve found this&nbsp;<a href="http://www.charlespetzold.com/etc/DoesVisualStudioRotTheMind.html">October 2005 gem</a> from <a href="http://www.charlespetzold.com/blog/blog.xml">Charles Petzold</a>.&nbsp; Petzold&nbsp;gives voice to a number of problems that have been nagging at me and for which I haven&rsquo;t found a clear view.&nbsp; Petzold (who&rsquo;s April 1st 2006 <a href="http://www.charlespetzold.com/blog/2006/04/010000.html">parody on XAML</a> is also brilliant) sharpens the difference between programming fast, programming well, and programming clearly.&nbsp; Doug&rsquo;s grey-day post and Petzold&rsquo;s appraisal are instant candidates for&nbsp;<a href="http://www.joelonsoftware.com/items/2006/03/31.html">Best <em>Software Writing II</em></a> when Joel Spolsky gets around to it.</p><p align="center">{tags: <a href="http://technorati.com/tag/software+development" rel="tag">software development</a> <a href="http://technorati.com/tag/Visual+Studio" rel="tag">Visual Studio</a> <a href="http://technorati.com/tag/conceptual+integrity">conceptual integrity</a> <a href="http://technorati.com/tag/software+engineering" rel="tag">software engineering</a> <a href="http://technorati.com/tag/programming+practice" rel="tag">programming practice</a> <a href="http://technorati.com/tag/computer+science+education" rel="tag">computer science education</a><br /><a href="http://technorati.com/tag/Charles+Petzold" rel="tag">Charles Petzold</a> <a href="http://technorati.com/tag/Doug+Mahugh" rel="tag">Doug Mahugh</a>&nbsp;<a href="http://technorati.com/tag/Joel+Spolsky" rel="tag">Joel Spolsky</a>&nbsp;<a href="http://technorati.com/tag/orcmid" rel="tag">orcmid</a>}</p><p><small>[<strong>update:</strong> There were some nasty typos and mangled wordings.&nbsp; &ldquo;Does Visual Studio Rot the Mind?&rdquo; is already on Joel Spolsky&rsquo;s list, but I was&nbsp;happy to add my vote.]</small></p><p>I&nbsp;only recently learned that Petzold has a blog.&nbsp; The RSS feed&nbsp;quickly went into my WinDev category among others including <a href="http://blogs.msdn.com/larryosterman/default.aspx">Larry Osterman</a>, <a href="http://blogs.msdn.com/michkap/default.aspx">Michael Kaplan</a>, <a href="http://blogs.msdn.com/oldnewthing/default.aspx">Raymond Chen</a> and, of particular relevance here, the <a href="http://forums.microsoft.com/MSDN/ShowForum.aspx?ForumID=161&amp;SiteID=1">MSDN Forum for the Visual C++ 2005 Express Edition</a>.&nbsp; I learned of Doug&rsquo;s blog through his&nbsp;involvement on&nbsp;the <a href="http://openxmldeveloper.org/">new site</a> on Office Open XML formats and their use in document interchange.&nbsp; I notice that seeing each new offering from him has me smile.</p><p>First, I think that Doug&rsquo;s use of a kind of Structured English (what is also known as pseudo-code) for high-level characterization of a programming approach is classic.&nbsp; It&rsquo;s a recognized software-engineering methodology and is a recognized way to work on the conceptual organization and essentials of a procedure before dealing with the syntax and low-level details that can easily obscure the important overall organization.&nbsp; It&rsquo;s literally classic:&nbsp;it goes back to the very early days and Grace Hopper&rsquo;s efforts to make programming languages match that level of expression more closely.&nbsp; (I watched a dismal failure on that, ambitiously and prematurely advertised as &ldquo;English Spoken Here,&rdquo; but Cobol has to be counted as the eventual success.)</p><p>I can even recognize how that approach, which I have used and which I preserve in comments that introduce the detailed sections of code, fits into my breaking down of mainline procedures into use of components.&nbsp; There, I find that I am designing header files with descriptions of interface principles and stub procedures with pseudocode, all to be filled in progressively and confirmed with successive layers of tests&nbsp;as more function is available to exercise.</p><p>This works great for procedural logic and decomposition of the approach, something that remains a valuable practice.&nbsp; It also ties into how we can tell we&rsquo;re done and that we have produced what it is we started out to provide. It should also let someone else confirm <strike>that</strike> <u><a href="http://orcmid.com/blog/2006/02/what-computers-know.asp">what the program's for</a></u>, not just what it is doing with the bits. That way, others can perform maintenance and continuation work with&nbsp;easy recognition of the invariants that preserve the program&rsquo;s architecture and functionality.&nbsp; (Yes, it helps to&nbsp;<a href="http://headrush.typepad.com/creating_passionate_users/2006/03/code_like_a_gir.html">code like a girl</a>, or anyone else who cares about who will need to read and understand their programs.&nbsp; I code that way as a gift to my future forgetful self so I can recreate what exactly I was doing and why.&nbsp; I&rsquo;d like to think others may <a href="http://headrush.typepad.com/creating_passionate_users/2006/03/two_more_reason.html">find interest</a> in it.&nbsp; It&rsquo;s important to me for my own sense of competence and completed work.)</p><p>Where&nbsp;structured-anythi<u>n</u>g doesn&rsquo;t work very well without a lot of careful preparation and practice is when our code consists of&nbsp;fragments/components of something not in view (and that we may not understand how to debug).&nbsp; For example, our bits might form&nbsp;a cohesive interactive&nbsp;performance only when integrated with a not-so-well understood User Interface threaded-messaging process.&nbsp; We should be concerned about Petzold&rsquo;s observation&nbsp;that we are losing something with tools that hide this mystery and leave developers with an uneasy sense of incompetence.&nbsp; Old hands can adjust to it by bringing solid experience&nbsp;along with a willing&nbsp;beginner&rsquo;s mind.&nbsp; That&rsquo;s&nbsp;advantageous <u>to</u> finding out what is going on and <strike>how to establish</strike> <u>establishing</u> that our creations are reliable and, with luck, maintainable too.&nbsp; My concern is that beginners will not have that perspective and will suffer its absence down the road.</p><p>One of the great qualities I&nbsp;find in&nbsp;Petzold&rsquo;s work is his appreciation for the beginner.&nbsp; I value&nbsp;his care in making sure that his readers are advised about what they need <u>to already know</u>, while letting them operate with as little tool support and startup-cost as possible.&nbsp; You don&rsquo;t need Visual Studio for his classic <em>Programming Windows</em> (ending with the 1999 5th edition for Win32) and its sequel, <em>Programming Microsoft Windows with C#</em> (2002).&nbsp; You just need the compiler, understanding of command-line operation, and some standard developer utilities <u>plus the appropriate and freely-available SDK</u>.&nbsp; Another common feature of Petzold's work is progressive learning by doing and then doing more, backed up by worked examples that actually do something it is valuable to know about.</p><p>My interest in the <a href="http://msdn.microsoft.com/vstudio/express/default.aspx">Visual Studio Express Editions</a> is not just that they are currently available for free <strike>so far</strike> (and there are books now available that include copies of them on CD-ROM).&nbsp; It is that it the Integrated Development Environment is limited but sufficient, and the packages are intended for beginners, students, and hobbyists.&nbsp; I also get to see where some people are stumbling and reporting it on the forums.&nbsp; I don&rsquo;t know how representative that is, but it gives me a sense of where there are serious blanks to fill in.&nbsp; I notice this most with Visual C++ 2005 Express Edition, where there are the fewest beginner books and the power of the system is strewn with landmines for the unwary beginner.&nbsp; Now let&rsquo;s see if I can tap my beginner&rsquo;s mind well enough to fill in the blanks and ease the entry for others who want to program for Windows.&nbsp; Something that lets newbies come play with <u>the likes of</u> Doug and Charlie and see how satisfying that can be.</p><div style="clear:both; padding-bottom: 0.25em;"></div>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2006/04/does-visual-studio-rot-mind.asp">4/01/2006 05:05:15 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2006/04/does-visual-studio-rot-mind.asp">
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=114393991532775197">Post a Comment</a>
		</div>
