...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /A2HostingWeb/orcmid/BlunderDome/clueless/2006/12/amazoncom-your-order-has-shipped-joy.asp 1     07-02-18 18:04 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: Amazon.com: Your Order Has Shipped - Joy to Book Rats</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="Friday, December 15, 2006" href="#Friday, December 15, 2006">
          <font color="#660000">Friday, December 15, 2006</font></a></h3>
   	

	<div class="posts">
	<a name="116621479275277171"></a>
    ...
    <p>
	<div style="clear:both;"></div><p>I, <a href="http://gigaom.com/2006/12/13/bill-gates-on-the-future-of-web-apps/">like Bill Gates</a>, am hard to buy gifts for.&nbsp; Mostly because I just go ahead and order what I want for Christmas, not because I already have everything, although in my world I want for little.&nbsp; At the moment I am struggling with tech envy and saving up my American Express Reward points for a Nikon digital, or a digital video camera, or a pod-cast quality portable recorder, or a SanDisk MP3 player or &hellip; and fortunately &nbsp;I am hoarding my points and that is keeping me from foolish impulse purchases.&nbsp; Well, that Sansa e280 is giving me the eye and it takes courage to ignore it.&nbsp; I wonder if it qualifies as a thumb drive for <a href="http://blogs.msdn.com/tomarcher/archive/2006/06/02/615199.aspx">Vista ReadyBoost</a>? &hellip;</p><p>Then there are&nbsp;books.&nbsp; Books are my downfall.&nbsp;&nbsp; And certain software.&nbsp; Books and software.</p><p align="center">{tags: <a href="http://www.technorati.com/tag/orcmid" rel="tag">orcmid</a> <a href="http://www.technorati.com/tag/software+books" rel="tag">software books</a> <a href="http://www.technorati.com/tag/Charles+Petzold" rel="tag">Charles Petzold</a> <a href="http://www.technorati.com/tag/Jeffrey+Richter" rel="tag">Jeffrey Richter</a> <a href="http://www.technorati.com/tag/Kathy+Sierra" rel="tag">Kathy Sierra</a> <a href="http://www.technorati.com/tag/Bert+Bates" rel="tag">Bert Bates</a> <a href="http://www.technorati.com/tag/Raymond+Chen" rel="tag">Raymond Chen</a>}</p><p align="left">Two days ago&nbsp;I received one of those wonderful non-spam notices that a book order had shipped.&nbsp; I was particularly thrilled because I had it in my mind that Raymond Chen&rsquo;s <a href="http://blogs.msdn.com/oldnewthing/archive/2006/12/07/1233002.aspx">new book</a>, <em>The Old New Thing: Practical Development Throughout the Evolution of Windows</em> must have shipped early.&nbsp; Not so.&nbsp; But I forgot about the other books that I&nbsp;had gleefully ordered and&nbsp;that had been consolidated in one super-saver shipment.&nbsp;&nbsp;They arrived this morning via an early USPS delivery:</p><ul><li><div align="left">Charles Petzold, <em>Applications = Code + Markup: A Guide to the Microsoft Windows Presentation Foundation</em>.&nbsp; I&rsquo;m a big fan of Petzold&rsquo;s minimalist approach to mastery of foundation concepts and this is one of those &ldquo;kids, <a href="http://www.charlespetzold.com/blog/2006/12/050346.html">collect the whole set</a>&rdquo; exercises on my part.</div></li><li><div align="left">Jeffrey Richter, <em>CLR via C#,</em> ed.2.&nbsp; As much as I may understand the CLR intellectually, I need someone to hold my hand through the reality of coping with .NET development of deployable software, and this looks to be exactly what I need.&nbsp; I ordered the book entirely on speculation based on the <a href="http://www.charlespetzold.com/blog/2006/12/060421.html">glowing recommendation</a> of Charles Petzold.</div></li><li><div align="left"><a href="http://headrush.typepad.com/creating_passionate_users/2006/11/our_book_made_i.html">Kathy Sierra</a> and Bert Bates, <em>SCJP Sun Certified Programmer for Java 5 Study Guide</em> (exam 310&ndash;055).&nbsp; I have not managed to get my head around <em>Head First.</em>&nbsp; For me the Java documentation and tutorials are&nbsp;perfect.&nbsp;&nbsp;Exam study guides (when they are not terrible) are some of the best&nbsp;resources for technical mastery of a&nbsp;subject that I have found.&nbsp; Now that Java 6 is shipping, it is time for me to get on top of Java 5.&nbsp; I trust Kathy Sierra and the <a href="http://www.amazon.com/exec/obidos/tg/feature/-/1000024541/">amazon.com customers</a> on this one.</div></li></ul><p align="left">This may give you some sense for the variety of my interests, but probably not much insight into what I might <em>actually be working on</em> at the moment.&nbsp; And if my sponsor is reading this, be assured that I took time out to blog with one ear tuned&nbsp;to a webcast on 2007 Office System server-side capabilities.</p><p align="left">According&nbsp;to another friendly announcement in this morning&rsquo;s e-mail, I am about to receive delivery of <em><a href="http://www.microsoft.com/products/expression/en/expression-web/default.mspx">Microsoft Expression Web</a></em> (upgrade edition).&nbsp; This will be the test for whether Vicki and I can really abandon Microsoft FrontPage for our various web sites.&nbsp; They&rsquo;ve all been rehosted on Apache servers recently, so it&nbsp;will be interesting to see what works (although the development server is still IIS with FrontPage extensions and Visual SourceSafe).</p><p align="left">I will be excited to report on what I&rsquo;m busily at work on at another time.&nbsp; I needed mostly out-of-print books for the&nbsp;project&nbsp;(and <a href="http://blogs.msdn.com/oldnewthing/archive/2006/11/02/931674.aspx">Raymond&rsquo;s blog</a>, of course), and those I didn&rsquo;t have already were&nbsp;found through amazon.com referrals to sellers of remaindered and used books.</p><div style="clear:both; padding-bottom: 0.25em;"></div>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2006/12/amazoncom-your-order-has-shipped-joy.asp">12/15/2006 12:33:12 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2006/12/amazoncom-your-order-has-shipped-joy.asp">
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=116621479275277171">Post a Comment</a>
		</div>
