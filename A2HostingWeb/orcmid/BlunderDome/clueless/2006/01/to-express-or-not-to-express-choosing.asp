...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2006/01/to-express-or-not-to-express-choosing.asp 4     06-10-11 15:16 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: To Express or Not To Express: Choosing a C/C++ Compiler</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
    ...
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2005/12/lining-up-open-formats-for-office.asp">Lining Up Open Formats for Office Documents</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2005/11/open-standards-are-not-open-source.asp">Open Standards are not Open Source</a><br />
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="Thursday, January 12, 2006" href="#Thursday, January 12, 2006">
          <font color="#660000">Thursday, January 12, 2006</font></a></h3>
   	

	<div class="posts">
	<a name="113713035017449682"></a>
    ...
    <p>
	<div style="clear:both;"></div><p><strong>I have a small dilemma</strong>.&nbsp; I thought <a href="http://msdn.microsoft.com/visualc/vctoolkit2003/">Visual C++ Toolkit 2003</a> was a <a href="http://odma.info/faq/2005/09/q050901.htm">great choice</a> for a <a href="http://nuovodoc.com/products/">development effort</a> that I want to allow the greatest number of interested parties (whoever the four of them are) to partake of.</p><p>But time has passed and I am now torn between sticking with the Visual C++ Toolkit compiler that people can obtain for free and the <a href="http://msdn.microsoft.com/vstudio/express/visualC/default.aspx">Visual C++ 2005 Express Edition</a> that people can obtain for free at least until November 2006.&nbsp; I want to go to the Express Edition, but it requires more capacity and has more baggage, as useful as&nbsp;that might be for other projects, and I am concerned about that.</p><p>If you think I&rsquo;m making a mistake <strike>going to</strike> <u>avoiding</u> the heavier-weight but latest and more-functional Express Edition, let me know.&nbsp; <strike>Quickly.</strike>&nbsp; Comment here or drop a note on the <a href="mailto:ActiveODMA-discuss@lists.sourceforge.net">ActiveODMA-discuss list</a> <u>and I'll consider it in how I introduce VC++ Express Edition as an optional IDE and build environment</u>.</p><p align="center">{tags: <a href="http://technorati.com/tag/What+Programmers+Know" rel="tag">What Programmers Know</a> <a href="http://technorati.com/tag/programming+languages" rel="tag">programming languages</a>&nbsp;<a href="http://technorati.com/tag/computer+science+education" rel="tag">computer science education</a>&nbsp;<a href="http://technorati.com/tag/learning+programming" rel="tag">learning programming</a>&nbsp;<a href="http://technorati.com/tag/conceptual+models" rel="tag">conceptual models</a> <a href="http://technorati.com/tag/orcmid" rel="tag">orcmid</a>}</p><p><small>[<strong>update 2006-04&ndash;25T16:29Z:</strong> Now that the Visual Studio 2005 Express Editions are to be permanently available for free download, Microsoft is no longer offering downloads of the Visual C++ Toolkit 2003 edition.&nbsp; I now have no choice but to work with the Express Edition.&nbsp; That makes documentation and demonstrations easier, although there is a larger footprint and requirement for greater PC capability with the Express Editions.&nbsp; So be it.]</small></p><p><small>[<strong>update 2006-03-18T17:18Z:</strong> After hand-wringing way too long over this, I have taken the <a href="#4">side-by-side option</a>.&nbsp; I will be using Toolkit 2003 for all reproducible builds and the making of distributions for my <a href="http://nfoware.com/">educational </a>and other <a href="http://odma.info/dev/">simple projects</a>.&nbsp; I didn&rsquo;t receive any feedback on <a href="http://forums.microsoft.com/MSDN/ShowPost.aspx?PostID=202774&amp;SiteID=1">my quandary</a> and I am going for traveling light and simple.&nbsp; Also, my observations of the struggles people have with the Visual C++ 2005 Express Edition leads me to want simpler approaches that don&rsquo;t have so many pitfalls for beginners, as <a href="http://nfocentrale.net/orcmid/blog/2006/03/looking-for-ahah-when-did-you-get.asp">mentioned here</a>.&nbsp; I can&rsquo;t use C# for ActiveODMA (yet), but I do recommend it for beginners who want a gentle, well-paved introduction into development for Microsoft Windows.&nbsp; There will be more posts about this, but I wanted to place a marker on this one right away.]</small></p><p><small>[<strong>update 2006-01-13T18:45Z:</strong> Added e-mail link and mentioned the prospect of having Toolkit 2003 and 2005 Express Edition side-by-side under 4.4 below]</small></p><hr><h3>1. The Problem I wanted to Solve</h3><p><strong>1.1 Why is this a concern?&nbsp; </strong>I want to&nbsp;use a build process that anyone can duplicate at little or no cost apart from having a reasonable developer-grade computer.&nbsp; This means that (with a little help getting around a problem with time stamps) anyone could confirm that a built deliverable was indeed constructed from specific source code using the specific tools.</p><p><strong>1.2 You can choose your own tools.</strong>&nbsp; Where this confirmation exercise is not of concern, you could use any tools you prefer that are compatible with the level of C/C++ used in the project and able to create programs for the Microsoft Windows platform.&nbsp; You can use just the minimal set I am standardizing on, or use it just for build confirmations.&nbsp; In terms of distributed code, I will stick to a light-weight source code and build packaging that requires only freely-available tools.</p><p><strong>1.3 We&rsquo;re talking about relatively-small projects.</strong>&nbsp;&nbsp; Building the programs that are involved in my project won&rsquo;t require much sophistication, probably not even a make utility, for command-line compiling and testing.&nbsp; I will definitely not be distributing Visual Studio project files and related baggage.&nbsp; It will be easy enough to create your own if VS is your preferred development environment.</p><h3>2. About Visual C++ Toolkit 2003</h3><p><strong>2.1</strong> I downloaded and adopted the Toolkit compiler in March 2003. I find that it works just fine.&nbsp; I had to do <a href="http://odma.info/faq/2005/09/q050902b.htm">a little work</a> to operate under least-privilege with it, but that is now a repeatable install that I can make any time.</p><p><strong>2.2</strong>&nbsp;At the Standard C/C++ and simple Windows DLL construction&nbsp;level, the command-line Toolkit 2003 works just fine for what I'll be doing&nbsp;in the near future. </p><p><strong>2.3</strong> There's no IDE with Toolkit 2003, but that's not needed anyhow for simple command-line builds and recompiles. To work with source code, you'll want a good text editor, some sort of source-code control, and more utilities. There are free resources for that. There's no nmake and other well-known tools in the Toolkit 2003 package. It looks like there is enough more in the Platform SDK April 2005 edition.</p><p><strong>2.4</strong> In short, the Toolkit is close enough to lean and mean, but there&rsquo;s not much future in it beyond the simple projects I&rsquo;ll be doing for now.</p><h3>3. About Visual C++ 2005 Express Edition</h3><p><strong>3.1 Big Download.</strong> &nbsp;I downloaded the full CD-ROM image of the toolkit and made an install disk. Having done that, this is more work, but now I can always re-install it as needed (as with the Toolkit 2003 that I downloaded and backed-up to CD-ROM). This is a lot bigger package than with Toolkit 2003, even without installing SQL Server 2005 Express.</p><p><strong>3.2 Command-Line is Fine.</strong> The compiler can be used at the command line the same way as for the Toolkit 2003 compiler. However, there are more tools included in the package (nmake and lib come to mind) along with the ones that are part of the Platform SDK April 2005 edition.</p><p><strong>3.3 One-Stop Shopping for IDE.</strong>&nbsp; The Express Edition provides a reduced-capability Visual Studio IDE and an extensive MSDN Help for use and for reference. </p><p><strong>3.4 Overkill Only for Now.</strong>&nbsp; The Visual C++ 2005 Express Edition is a bit of overkill for what I think of as a minimalist approach, but it will probably be available longer.&nbsp; It provides a segue into .NET managed-application development, and has the full ECMA C++/CLI extensions for seamless working with .NET Framework 2.0 and managed code.&nbsp; That&rsquo;s a big deal for those who want to blend into the .NET world.</p><p><strong>3.5 Windows Apps Still Not That Easy.</strong>&nbsp; To develop non-.NET standard Windows Applications (rather than console applications and non-interactive DLLs) it takes a fair amount more work to install and use the Platform SDK with either compiler, though there is an edge for Express Edition once you get the hang of how to get Windows Application projects to compile.</p><p><strong>3.6 Oh, one other thing.</strong> The include files, even for command-line work, are <a href="http://orcmid.com/BlunderDome/clueless/2006/01/agile-builds-making-bad-idea-efficient.asp">more complicated and tricky</a> in the Express Edition than with Toolkit 2003.&nbsp; That&rsquo;s usually not a concern except I have a serious interest in reducing the dependency surface of software, and it will take more work to figure out what is going on as&nbsp;the big library&nbsp;ball-of-mud expands unchecked.&nbsp; Unfortunately, the later libraries are also&nbsp; more standards-compliant and&nbsp;have additional&nbsp;support for creating safer code (avoiding buffer over-run exposures and the like).</p><p><strong>3.7 More hard drive please.</strong>&nbsp; Finally, to use VC++ 2005 Express Edition you'll need lots of hard drive capacity and a fairly fast processor. There is also a lot of disk overhead in the VS Project structure and housekeeping files for what are pretty small projects.</p><h3><a name="4">4</a>. Now What?</h3><p><strong>4.1 I I want to choose VC++ 2005 Express Edition.</strong> My&nbsp;greatest concern is that it presents a substantial requirement for&nbsp;storage (700MB+) and speed to install and use it its IDE functionality. For just building the code, VC++ Toolkit 2003 (30MB+) is good enough, although the additional Platform SDK (300MB+) is required for either choice. </p><p><strong>4.2</strong> <strong>There seems to be a more lively development community</strong> and <a href="http://msdn.microsoft.com/vstudio/express/visualc/next/default.aspx">on-line resources</a> around the Express Edition, and I expect that will increase.&nbsp; That&rsquo;s a big factor in my thinking.</p><p><strong>4.3</strong> <strong>Unless I learn I&rsquo;m excluding any players</strong> from use of my source-code projects by using the heavier package from the get-go, I&rsquo;m going to adopt the Express Edition as the reference for reproducible construction of the software.</p><p><strong>4.4 The Best of Both?</strong>&nbsp; Another prospect is having Visual C++ Toolkit 2003 and Visual C++ 2005 Express Edition side-by-side.&nbsp; They install on the same computer without collision or conflict and&nbsp;a single Platform SDK installation can be used with development for both.&nbsp; There are also ways to use the Express Edition IDE as an editor for projects that use either compiler.&nbsp; This is a bit ball-of-muddish itself, except the experience of working it out is valuable for learning what other things that can be done using the Express Edition as a harness.&nbsp; The key, for me, is getting source-control integration.&nbsp; <strike>Meanwhile, the polls are&nbsp;still open.&nbsp; Should I simply dump the Toolkit 2003 or should I stick with it?&nbsp; <u>Well, I am going to stick with the Toolkit and delay introduction of VC++ editions until I can set a proper foundation.&nbsp; Comment are always welcome in helping me choose what urgency to give to that.</u></strike>&nbsp; <u>My side-by-side decision has been pre-empted by withdrawal of the Toolkit and continuing free availability of the Express Edition.&nbsp; I will now concentrate all of my efforts on VC++ 2005 Express Edition, this time getting it done well before there is yet-another Visual Studio Release</u>.</p></font>&nbsp;<div style="clear:both; padding-bottom: 0.25em;"></div>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2006/01/to-express-or-not-to-express-choosing.asp">1/12/2006 09:32:30 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2006/01/to-express-or-not-to-express-choosing.asp">
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=113713035017449682">Post a Comment</a>
		</div>
