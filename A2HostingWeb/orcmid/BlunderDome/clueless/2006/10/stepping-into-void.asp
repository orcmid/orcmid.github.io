...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /A2HostingWeb/orcmid/BlunderDome/clueless/2006/10/stepping-into-void.asp 1     07-02-18 18:02 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: Stepping Into the Void</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="Saturday, October 28, 2006" href="#Saturday, October 28, 2006">
          <font color="#660000">Saturday, October 28, 2006</font></a></h3>
   	

	<div class="posts">
	<a name="116206809941414561"></a>
    ...
    <p>
	<div style="clear:both;"></div><p>This is the final official post that will be made to <a href="http://nfocentrale.net/orcmid/BlunderDome/clueless">Professor von Clueless in the Blunder Dome</a> at the location <a href="http://nfocentrale.net/orcmid/BlunderDome/clueless">http://nfocentrale.net/orcmid/BlunderDome/clueless</a>.</p><p>The site feed will also be interrupted.</p><p>From now on, all posts will appear at the <a href="http://orcmid.com/BlunderDome/clueless">official Professor von Clueless</a> URL, at the location <a href="http://orcmid.com/BlunderDome/clueless">http://orcmid.com/BlunderDome/clueless</a>.&nbsp; The official site feed is also the one that is assured to always work from now on.</p><p>You will know that you are at the old blog location if you see no post more recent than this, neither on the web page nor in the site feed.</p><p><strong>PS:</strong> Sometime in the next few weeks, the old URLs will be moved atop the new, official ones and either set of URLs will work just fine.&nbsp; For a while.&nbsp; But the official ones will always work.&nbsp; You shouldn&rsquo;t be using the old ones.&nbsp; Really.</p><p>[<strong>update 2006-10-28-14:49</strong> This reposting of the post already seen on the old web page and site feed is being made to confirm that Blogger is now correctly posting to the official site and its site feed.&nbsp; There have also been some setting changes that will be developed more fully after the change-over is confirmed.]</p><div style="clear:both; padding-bottom: 0.25em;"></div>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2006/10/stepping-into-void.asp">10/28/2006 01:41:39 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2006/10/stepping-into-void.asp">
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=116206809941414561">Post a Comment</a>
		</div>
