...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2006/07/pimping-up-scampo-from-media-center-to_19.asp 1     06-07-25 8:50 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: Pimping up Scampo: From Media Center to Media Producer</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
    ...
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2006/03/modeling-office-open-xml-packaging.asp">Modeling the Office Open XML Packaging Conventions</a><br />
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="Wednesday, July 19, 2006" href="#Wednesday, July 19, 2006">
          <font color="#660000">Wednesday, July 19, 2006</font></a></h3>
   	

	<div class="posts">
	<a name="115334860875919198"></a>
    ...
    <p>
	<div style="clear:both;"></div><h3>Media Centers and the Slippery Slope Toward Media Producers: The Sneak Play</h3><p>I&rsquo;ve mentioned how I acquired <a href="http://orcmid.com/blog/2005/10/windows-media-centers-been-good-to-me.asp">Scampo, my Gateway 831GM Media Center PC</a>, as an emergency replacement for a cratered Tablet PC while in the midst of developing my (now-abandoned) M.Sc in IT dissertation project.</p><p>For my simple demands, this is a hot machine.&nbsp; But its on-board Intel Graphics Media Accelerator 900, doesn&rsquo;t help me see full rendering of Second Life (which is painfully sluggish even with my&nbsp;generous broadband access).</p><p>But I&nbsp;was pleased and quite content with the system.&nbsp; As a recovered on-line community addict (think CompuServe CB Simulator back when it was still called MicroNet), I am relatively immune to Second Life anyhow.&nbsp; I think.&nbsp; Maybe.&nbsp; Sure.</p><p align="center"><small><strong><font color="#800080">{tags: </font></strong><a href="http://technorati.com/tag/E-MU" rel="tag"><strong><font color="#800080">E-MU</font></strong></a><strong><font color="#800080"> </font></strong><a href="http://technorati.com/tag/digital+audio" rel="tag"><strong><font color="#800080">digital audio</font></strong></a><strong><font color="#800080"> </font></strong><a href="http://technorati.com/tag/Media+Center" rel="tag"><strong><font color="#800080">Media Center</font></strong></a><strong><font color="#800080"> </font></strong><a href="http://technorati.com/tag/Screencasting" rel="tag"><strong><font color="#800080">Screencasting</font></strong></a><strong><font color="#800080"> </font></strong><a href="http://technorati.com/tag/Vlogging" rel="tag"><strong><font color="#800080">Vlogging</font></strong></a><strong><font color="#800080"> </font></strong><a href="http://technorati.com/tag/orcmid" rel="tag"><strong><font color="#800080">orcmid</font></strong></a><strong><font color="#800080">}</font></strong></small></p><p>Then&nbsp;<a href="http://scobleizer.wordpress.com/">Robert Scoble</a> started <a href="http://scobleizer.wordpress.com/2006/06/25/production-values-debate-breaks-out-during-videologger-session/">looking ahead</a> in anticipation of his new career at PodTech.&nbsp; Robert&rsquo;s enthusiasm for the possibilities&nbsp;of &nbsp;enthusiast video and multimedia on the Internet is contagious.&nbsp; I have DVD recording capability on Scampo and on my Toshiba Satellite Tablet, so I figure I already have a decent foundation for becoming a multi-media producer too.</p><p>I also need&nbsp;new gear to off-load the audio-creation and MIDI support currently installed on a Windows 98 SE box that I want to recommission as a simple Windows XP peer server for my development web site.&nbsp; In conversation at the <em><a href="http://orcmid.com/blog/2006/01/launching-naked-conversations.asp">Naked Conversations launch</a></em>, I was marveling at how much the hot new Pentium machines have led to the prevalence of soft synthesizers and software audio solutions without use of co-processor boards.&nbsp; But <strike>new</strike> the latest audio software is CPU intensive and there&rsquo;s still a lot power more to be gained by offloading the main board and memory.&nbsp; The thirst for extreme graphics processing (especially for gamers) is an example of that continuing quest for power that the motherboard can&rsquo;t handle just yet.&nbsp; So, I don&rsquo;t think I&rsquo;ll give up on hardware-assisted audio after all.</p><p>Scampo is a low-end Media Center, though, and that has to figure into my considerations.&nbsp; The machine&nbsp;has only&nbsp;two PCI slots, one with an unused but important-to-keep modem (for the occasional fax transmission), and&nbsp;an additional&nbsp;odd-looking black slot with a locking tab on the end.&nbsp; On Centro, the faithful Windows 98 desktop, My Soundblaster Live! with daughter card is all old-style ISA bus with old audio technology too.</p><p>I&nbsp;love Robert&rsquo;s vision of&nbsp;how we can all become video producers and content creators.&nbsp; He also <a href="http://scobleizer.wordpress.com/2006/07/17/learn-how-to-use-your-treo/">keeps mentioning</a>&nbsp;an unmet&nbsp;need for hands-on, multi-media tutorials and demos around programming (and check out <a href="http://scobleizer.wordpress.com/2006/07/17/learn-how-to-use-your-treo/#comments">the comments</a> on that post too).&nbsp; That&rsquo;s something that inspires me too, and I have the urge to swim in those waters. I know there are ways to make videos from the Windows display, and this should work for a lot of programming work (no video camera required).&nbsp; I also want to make a web-/CD-based book on information technology and programming anyhow.&nbsp;&nbsp;I hadn&rsquo;t realized&nbsp;that I should be thinking DVD, not CD.</p><p>When&nbsp;Robert <a href="http://scobleizer.wordpress.com/2006/06/26/interesting-way-to-use-video/">pointed</a> to <a href="http://www.futureproducers.com/forums/showthread.php?t=149911">this demonstration</a>&nbsp;(scroll down and wait for it to load), I was hooked.&nbsp; The hard-to-watch demonstration of how to connect a MIDI controller to a PC and synthesizer lash-up reminded me that I don&rsquo;t have any keyboards and I want one.&nbsp; I buy an electronic&nbsp;keyboard instrument every 5 years or so and then give it away or sell it, under-used.&nbsp; This demo tipped me over into MIDI controller hunger.&nbsp; I wanted to be able to do what that guy and others can do.&nbsp; It was time for another run at it.&nbsp; Guitar Center having a July 4th sale, and a conversation with my musician son, Doug, had me wanting to see how cheaply I could get an E-MU MIDI/USB Controller.</p><p>Thanks to a link from <a href="http://blogs.msdn.com/saraford/archive/2006/06/28/650388.aspx">Sara Ford</a>, I wandered around the <a href="http://port25.technet.com/archive/2006/06/09/2595.aspx">improved Port 25</a> and&nbsp;realized that <a href="http://www.subservientprogrammer.com/">this technology</a> could also be used to put together how-to drill-downs from desktop videos.&nbsp; I wasn&rsquo;t ready to explore the full import of OneClick video-how-to downloading, but this possibility sticks in my mind.</p><h3><a href="http://www.netcrucible.com/blog/2006/06/27/pimping/">Pimping</a> Out the Rig</h3><p>&nbsp;So, where am I in all of this?</p><ol><li><strong>An E-MU XBoard 25 MIDI controller-keyboard is installed on my system.</strong>&nbsp; The lite-versions of software included with it are fine, and I realize that I have other material, including soft synthesizers and sound fonts, that I can bring over from Centro before I wipe it, upgrade its hard drive, and recommission it for other duty as a workhorse tender.&nbsp; This works great and now I need something for the output end of things.<br />&nbsp;&nbsp;&nbsp;&nbsp; </li><li><strong>An E-MU 1802M Digital Audio System is in its box waiting to be installed on Scampo.</strong>&nbsp; This will use up my remaining PCI slot and also the adjacent but slotless board-insert point (for a daughter card that connects only to the main 1802M circuit board).&nbsp; Beside providing awesome digital signal processing, I will get high-quality microphone/guitar/turntable pre-amps and inputs, two sets of MID in-out, and lots of audio outputs that will absorb all of my audio connections off of Centro.<br />&nbsp;&nbsp;&nbsp; </li><li><strong>A EVGA e-GeForce 7300 GS PCI-E graphics processor is waiting to be installed.</strong>&nbsp; Where did that come from, you say?&nbsp;&nbsp; Well, I decided that it would be useful for both DVD production and putting WinFX (.NET 3.0) features through their paces on Windows XP.&nbsp; I am not sure the nVIDIA GeForce 7300 GS graphics processor is enough to be Vista ready, but it is the hottest GPU I could get that can possibly run on the 300 watt power supply that is all Scampo can provide.&nbsp; The fact that the card doesn&rsquo;t require its own hi-amperage connector to the computer power supply is reassuring in this case.&nbsp; And SecondLife files for GPU detection suggest that I will get to see that application fully rendered (and this is merely a test of course).&nbsp; And hey, I have to open-up and make additions to the computer anyhow, so what the heck?&nbsp; This is the&nbsp;least-expensive addition of the three, so there&rsquo;s not much risk here.&nbsp; Oh, and I&nbsp;now know what the funny black&nbsp;connector is for.&nbsp; I had feared it was an AGP connector and I wouldn&rsquo;t be able to get close to HDTV-quality. But now &hellip;<br />&nbsp;&nbsp;&nbsp; </li><li><strong>I Upgraded to Sonar 5 Studio.</strong>&nbsp;&nbsp; This will give me full-up studio control&nbsp;over everything audio, with any luck.</li></ol><h3>Nail-Biting Time</h3><p>Now, the combination of (2) and (3) could well slag poor little Scampo and a power-supply upgrade may be called for.&nbsp; I am also uncertain that (3) is enough to&nbsp;have Windows Vista Aero working.&nbsp; I&rsquo;ll run the Vista Readiness program after I get the upgrades working.&nbsp; There may be many compatibility issues too.</p><p>I also don&rsquo;t know how much trouble I&rsquo;ll have with (3) and then (2) with regard to my Media Center settings, conflicts with existing DVD recording and player software, codecs, and whatnot.&nbsp; Then I have to get (4) on there without creating conflicts with all of the different LE versions of packages that will already be installed.&nbsp; I don&rsquo;t know how well my Pevey Studio Mix control surface will work with Sonar 5.</p><p>I&rsquo;ll do the installs with (1) connected because of a bizarre driver story that I will save for later, (3) done and verified first, then (2) followed by (4) at a later date when I am comfortable with everything else that is operating.</p><p>Thanks to <a href="http://weblog.infoworld.com/udell/2004/11/12.html#a1113">Jon Udell</a>, I also know where to download the video authoring and production software that I will need beside what comes with my Media Center PC.</p><p><em>Taking the BlunderDome to new heights of <strike>Dangerous</strike> Digital&nbsp;eXtremity, we are, we are</em>.</p><small><p align="center">[<strong>update 2006-07-16T03:40Z</strong>: adding in a link to Scoble&rsquo;s continuing hints about programming instruction.]</p></small><div style="clear:both; padding-bottom: 0.25em;"></div>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2006/07/pimping-up-scampo-from-media-center-to_19.asp">7/19/2006 03:36:48 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2006/07/pimping-up-scampo-from-media-center-to_19.asp">
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=115334860875919198">Post a Comment</a>
		</div>
