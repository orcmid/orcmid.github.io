...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2006/03/grady-booch-on-limits-of-software.asp 2     06-07-25 8:20 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: Grady Booch on the Limits of Software</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="Wednesday, March 29, 2006" href="#Wednesday, March 29, 2006">
          <font color="#660000">Wednesday, March 29, 2006</font></a></h3>
   	

	<div class="posts">
	<a name="114367051153005041"></a>
    ...
    <p>
	<div style="clear:both;"></div><p><cite cite="http://www.booch.com/architecture/blog.jsp"><a href="http://www.booch.com/architecture/blog.jsp">Blog (Handbook of Software Architecture)</a></cite>. Grady Booch makes a gracious observation about the furor concerning&nbsp;the&nbsp;announced delay for Windows Vista on his blog (no permalink: current article will scroll off).&nbsp; He looks at the angst posted by Microsoft developers and observes&nbsp;</p><blockquote cite="http://www.booch.com/architecture/blog.jsp"><p>comments suggest that the root problems are not technical, but rather orbit the region of design and organization in my characterization of the <a href="http://www.booch.com/architecture/architecture.jsp?part=Limits%20Forces">limits of software</a>&nbsp;[registration required &mdash; dh:].</p></blockquote><p align="center">{tags: <a href="http://technorati.com/tag/software+architecture" rel="tag">software architecture</a> <a href="http://technorati.com/tag/pattern+language" rel="tag">pattern language</a> <a href="http://technorati.com/tag/forces" rel="tag">forces</a> <a href="http://technorati.com/tag/system+constraints" rel="tag">system constraints</a> <a href="http://technorati.com/tag/system+requirements" rel="tag">system requirements</a> <a href="http://technorati.com/tag/Grady+Booch" rel="tag">Grady Booch</a> <a href="http://technorati.com/tag/orcmid" rel="tag">orcmid</a>}</p><p>Booch&rsquo;s&nbsp;depiction of the limits of software and the situational factors that&nbsp;originate many of&nbsp;those limits is a must-read.&nbsp; The registration process is painless.&nbsp; I heartily recommend the draft materials in the on-line <em>Handbook of Software Architecture</em> to anyone interested in architectural considerations&nbsp;that apply to&nbsp;software systems design and development.&nbsp; </p><p>One tangential value for me, on my third or fourth scan of the limits page, is that I finally have come to understand where &ldquo;Forces&rdquo; come from in templates for pattern languages.&nbsp; I&rsquo;m still uncomfortable with that metaphor for patterns of non-physical systems, and will stick to <a href="http://trosting.org/info/2005/08/i050803c.htm#Concerns">concerns</a>.&nbsp; I also notice that it is important to identify important constraints as well as requirements, especially non-functional ones and I haven&rsquo;t looked at that in the context of patterns for computer-based applications.&nbsp; (I also see that I have one more <a href="http://www.wisdom.weizmann.ac.il/~dharel/papers.html">David Harel</a> <a href="http://www.amazon.com/gp/product/0198505558/">book</a> to track down.)</p><div style="clear:both; padding-bottom: 0.25em;"></div>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2006/03/grady-booch-on-limits-of-software.asp">3/29/2006 02:15:11 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2006/03/grady-booch-on-limits-of-software.asp">
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=114367051153005041">Post a Comment</a>
		</div>
