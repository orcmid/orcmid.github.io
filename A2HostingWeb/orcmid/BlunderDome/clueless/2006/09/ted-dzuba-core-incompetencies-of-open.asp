...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2006/09/ted-dzuba-core-incompetencies-of-open.asp 1     06-10-11 16:05 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: Ted Dziuba: The Core Incompetencies of Open-Source Production</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="Sunday, September 03, 2006" href="#Sunday, September 03, 2006">
          <font color="#660000">Sunday, September 03, 2006</font></a></h3>
   	

	<div class="posts">
	<a name="115731183951491056"></a>
    ...
    <p>
	<div style="clear:both;"></div><blockquote dir="ltr" style="MARGIN-RIGHT: 0px"><p><small>[update 2006&ndash;09&ndash;04&ndash;11:34 It has taken me two updates to spell Dziuba correctly, this last time in the tags.&nbsp; For other amusement with regard to blog incoherence, this post figures in the account <a href="http://orcmid.com/blog/#2006-09-03">here</a>.]&nbsp;</small></p></blockquote><p><cite cite="http://epsilondelta.net/2006/08/27/mythtv-a-comedy-of-errors/"><a href="http://epsilondelta.net/2006/08/27/mythtv-a-comedy-of-errors/">Epsilon-Delta &raquo; MythTV: A Comedy of Errors</a></cite>.&nbsp;&nbsp;I&nbsp;favor&nbsp;open-source&nbsp;licensing for community-developed and community-shared software.&nbsp; I&nbsp;prefer&nbsp;open-source development for cultivation of novices and beginners, for sharpening the prowess of enthusiasts, and for long-tail undertakings that cannot survive business-plan scrutiny for return&nbsp;after the high costs of shrink-wrap industrial-grade software production.&nbsp;&nbsp;But&nbsp;the failure of the&nbsp;open-source community (and no small number of commercial-software aspirants) to attend to the customer delivery process (or even recognize that there are customers to attend to) has always bemused me.&nbsp; </p><p align="center"><small><font color="#800080">{tags: </font><a href="http://www.technorati.com/tag/Ted+Dziuba" rel="tag"><font color="#800080">Ted Dziuba</font></a><font color="#800080"> </font><a href="http://www.technorati.com/tag/orcmid" rel="tag"><font color="#800080">orcmid</font></a><font color="#800080"> </font><a href="http://www.technorati.com/tag/open-source+development" rel="tag"><font color="#800080">open-source development</font></a><font color="#800080">&nbsp;</font><a href="http://www.technorati.com/tag/software+engineering" rel="tag"><font color="#800080">software engineering</font></a><font color="#800080"> </font><a href="http://www.technorati.com/tag/software+lifecycle" rel="tag"><font color="#800080">software lifecycle</font></a><font color="#800080"> </font><a href="http://www.technorati.com/tag/core+incompetencies" rel="tag"><font color="#800080">core incompetencies</font></a><font color="#800080">}</font></small></p><p><a href="http://epsilondelta.net/who-am-i/">Ted Dziuba</a> had an <a href="http://epsilondelta.net/2006/08/27/mythtv-a-comedy-of-errors/">iconoclastic moment</a> that&nbsp;exposed ground truth&nbsp;underneath the&nbsp;accepted scripture&nbsp;that open-source is&nbsp;the natural&nbsp;law&nbsp;to goodness for personal computing and computer-based appliances:&nbsp;</p><blockquote><p>The last time I build a linux rig from scratch was 9 years ago. Things have certainly improved since then, but the core incompetencies of the open source movement still remain. Why doesn&rsquo;t stuff just work? Yes, I know what you&rsquo;re going to say: I should fix the problems, submit my patch, and make the world a better place. Well, I just wanted to build a personal video recording machine, not get deeply involved in a quagmire of open source projects, submitting patches to maintainers who turn them down because their egos take up half the space in the room. Plus, I don&rsquo;t have the time to dive into some pre-established project. I&rsquo;m building this machine explicitly to make my wasting of time more efficient and enjoyable.<br />In the end, I&rsquo;m going to use a serious solution: XP Media Center Edition. Sure, MythTV is cute, but it&rsquo;s not ready for prime time. I would also be willing to bet that had I gotten it installed and working, it wouldn&rsquo;t be &ldquo;wife friendly&rdquo;, but that&rsquo;s just idle speculation.</p><p>I guess for me it&rsquo;s worth the $100 to get a piece of software that I know will recognize with my $2,000 worth of machinery, will have updates that won&rsquo;t break the installation, and will actually do what I need it to do.</p></blockquote><p>Ted&rsquo;s&nbsp;commenters&nbsp;predictably turn to&nbsp;geek problem-solving, offering&nbsp;alternatives and speculating ways that might&nbsp;have worked better than Ted&rsquo;s excruciating experience.&nbsp; Sixth commenter &ldquo;oneofmany&rdquo; points to the key disparity and the simple reason that non-developers will&nbsp;prefer packaged commercial systems running Apple OS X or Microsoft Windows with this quotation: &ldquo; 'Don&rsquo;t buy a puzzle when it&rsquo;s just a picture that you want.' &rdquo;</p><p>One of the blind spots of developers is their failing to recognize and respect the world of the adopter.&nbsp; In particular, there is&nbsp;blindness to how&nbsp;commercial solutions can be&nbsp;economically-optimal choice and not&nbsp;against the best interests of the adopter at all.&nbsp; The adopter&rsquo;s value trade-off does not have to be the same as the open-source adherent&rsquo;s, and there&rsquo;s not a thing wrong with that.&nbsp;&nbsp;Our developer-centric,&nbsp;self-satisfying inpersonation of our customers&nbsp;as like ourselves, with our values,&nbsp;is an incompetent approach.</p><p>It is also a great lesson of my own experience, that&nbsp;(self-indulgent?) ignorance of adopter realities&nbsp;is a widespread failing of developers.&nbsp;&nbsp;Yet in open-source development and its support in academic circles,&nbsp;this&nbsp;vice is&nbsp;dressed-up as&nbsp;virtuous.&nbsp; That will be disheartening to those who actually want to see their work taken up and valued by users, users who don&rsquo;t have to have been able to write and trouble-shoot it themselves in order to enjoy its operation and utility.&nbsp; </p><p>Just yesterday I saw how&nbsp;the same problems can arise when professional developers (perhaps relatively junior ones) step out of the confines of their industrial-strength development-and-delivery&nbsp;enterprise and start lofting open-source contributions into the cyberverse.&nbsp; I take this anecdotal indicator as evidence that software quality, especially suitability for purpose, is an institutionally- (that is, socially-) maintained competency.&nbsp;&nbsp; </p><p>The&nbsp;achievement of dependable&nbsp;software quality is spotty everywhere,&nbsp;and it is clear that it invariably takes the restraints of institutionalized behavior to pull it off at any scale and level of consistency.&nbsp; </p><p>It comes down to this: the obsessive attention to detail, thoroughness, and honoring of the adopter&rsquo;s world is against&nbsp;our nature.&nbsp; We do not&nbsp;take this on&nbsp;naturally nor willingly.&nbsp;&nbsp; We are not automatically equipped for it and it doesn&rsquo;t scale (the same way warriors don&rsquo;t scale without a military)&nbsp;unless there&rsquo;s an&nbsp;institutional structure to keep restoring&nbsp;the commitment&nbsp;and having us succeed despite our contrary tendencies.</p><p>We also pursue tools, nostrums, and other magical elixirs to save us from the tedium and the frustrated demands of adopters.&nbsp;&nbsp;I&nbsp;accept that we do need the&nbsp;aid of all computational tools we can find for dealing with the parts of our work that are&nbsp;computational and formal in nature (and that fit into an institutionally-sustainable paradigm, not our self-absorbed predilections).&nbsp;&nbsp; </p><p>In the end, that won&rsquo;t be enough, because <a href="http://nfocentrale.net/orcmid/blog/2006/02/what-computers-know.asp">the world of the adopter is not what our computational formulations address</a>.&nbsp; How we&nbsp;bridge that gap and&nbsp;become responsible for our products as instruments (not ends) in the&nbsp;world of opportunity that adopters live in remains to be dealt with.&nbsp; I&nbsp;predict that it will demand teamwork and institutional structures of some form&nbsp;having&nbsp;a&nbsp;<a href="http://trosting.org/info/2005/06/i050601.htm">trustworthy relationship</a> with adopters at the heart of it.</p></small></small><div style="clear:both; padding-bottom: 0.25em;"></div>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2006/09/ted-dzuba-core-incompetencies-of-open.asp">9/03/2006 12:30:39 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2006/09/ted-dzuba-core-incompetencies-of-open.asp">
 		...
 		<div class="blogComments">
			...
			<div class="blogComment">
				&nbsp;<br /><a name="115800360482754593"></a> 
				Orcmid, very well said. And I will be using (and attributing to you) the following phrase (and its implications):<BR/><BR/>" ... recognize and respect the world of the adopter."<BR/><BR/>Very nicely put, and a very nice challenge you leave my software development and deployment efforts.<br />
				<div class="byline">
                  <a href="http://orcmid.com/BlunderDome/clueless/2006/09/ted-dzuba-core-incompetencies-of-open.asp#115800360482754593" 
                     title="permanent link">#</a>
                  posted by <a href="http://www.blogger.com/profile/3342052" rel="nofollow">Bill Anderson</a>: 
                  9/11/2006 12:40 PM
                </div>
                <span class="item-control admin-1585504753 pid-1360140406"><a style="border:none;" href="http://www.blogger.com/delete-comment.g?blogID=7336679&amp;postID=115800360482754593" title="Delete Comment" ><span class="delete-comment-icon">&nbsp;</span></a></span>
			</div>
			
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=115731183951491056">Post a Comment</a>
		</div>
