...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /A2HostingWeb/orcmid/BlunderDome/clueless/2006/11/tweaking-tweaking-tweaking-roll-on.asp 1     07-02-18 18:03 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: Tweaking, Tweaking, Tweaking, Roll-on ...</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="Thursday, November 30, 2006" href="#Thursday, November 30, 2006">
          <font color="#660000">Thursday, November 30, 2006</font></a></h3>
   	

	<div class="posts">
	<a name="116495232148704502"></a>
    ...
    <p>
	<div style="clear:both;"></div><p>This is a brief post to tweak my technorati blog claim.&nbsp; I made similar adjustments to the companion Orcmid&rsquo;s Lair and Numbering Peano sites.</p><p>The post is to cause the adjusted template to be used in updating of the main page and, from now on, individual-article and archive pages.</p><p>Because I don&rsquo;t republish previous pages except for comments and content updates, there are still many technorati tags that involve the now-unclaimed technorati locations.</p><p>It may be that technorati is smart enough to find the right places.&nbsp; On the other hand, this is an opportunity to do something that I always wanted to try: hook into the FrontPage extensions on my home-office development server and make content changes by search and replace in the blog-directory HTML files.&nbsp; I don&rsquo;t know when I will ever get around to that, so there may be considerable but less-than visible breakage around until I do undertake that. </p><p>Meanwhile, there is visible breakage on my sites as a result of moving from Windows-based servers to Apache and going from a case-insensitive web host to a case-sensitive one.&nbsp; I am slowly getting my head around that, and I have no automatic solution because I have many pages that are cross-linked using different capitalizations, and I will have to think much harder about</p><ul><li>not adding to the grief and cleaning up as I update pages in the normal course of events<br />&nbsp;&nbsp; </li><li>finding some scheme for a mass review and identification of pages and links to them that require some link straightening and orthodonture.&nbsp; Hmm, maybe I should look in <em>Dr. Dobbs</em>?</li></ul><div style="clear:both; padding-bottom: 0.25em;"></div>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2006/11/tweaking-tweaking-tweaking-roll-on.asp">11/30/2006 09:52:01 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2006/11/tweaking-tweaking-tweaking-roll-on.asp">
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=116495232148704502">Post a Comment</a>
		</div>
