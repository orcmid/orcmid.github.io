...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /A2HostingWeb/orcmid/BlunderDome/clueless/2007/03/recipe-for-nano-isv-success-j.asp 1     08-10-07 14:30 Orcmid $
  -->
...
I’ve become a regula...</a><br />
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="2007-03-11" href="#2007-03-11">
          <font color="#660000">2007-03-11</font></a></h3>
   	

	<div class="posts">
	<a name="4350601871656742609"></a>
    
    
    <p>
	<div style="clear:both;"></div><h2>Recipe for Nano-ISV Success?</h2>
<p>J. D. Meier <a href="http://blogs.msdn.com/jmeier/archive/2007/03/11/david-anderson-s-recipe-for-success.aspx">just posted</a> a précis of agile-manager David Anderson&rsquo;s <a href="http://www.agilemanagement.net/Articles/Weblog/RecipeForSuccess.html">recipe for success</a>:</p>
<ul>
<li>&ldquo;Focus on Quality 
<li>&ldquo;Reduce Work-in-progress 
<li>&ldquo;Balance capacity against demand 
<li>&ldquo;Prioritize&rdquo;</li></ul>
<p>It is Meier&rsquo;s description of these&nbsp;critical elements&nbsp;that caught my attention.&nbsp; I can see how, in my latest solo-developer, nano-ISV&nbsp;project, I have been providing precisely these elements and with more consistency than <a href="http://orcmid.com/blog/2007/01/awesome-breakthrough-lousy-estimates.asp">I first realized</a>.&nbsp; That&rsquo;s startling for me and I am going to want to come back and develop my report card more thoroughly as a record on which to base future work.</p>
<p>For one thing, I thought that these practices wouldn&rsquo;t scale down to sole-developer nano-projects, because of the problem of attention and focus in a human being (especially when that&rsquo;s myself).&nbsp; My experience says otherwise, and that is very exciting to see unfolding into full bloom.</p>
<p>It&rsquo;s great to be led back to Anderson&rsquo;s work via Meier&rsquo;s links in the article.&nbsp; I subscribe to the blog, but sometimes another perspective drives me back with new eyes for what&rsquo;s there.&nbsp; This time,&nbsp;I even resorted to Wikipedia so that I could figure out what a <a href="http://en.wikipedia.org/wiki/Kanban">kanban system</a> is.&nbsp; I also wonder why I resist applying that specific technique, now that I understand how it <a href="http://www.agilemanagement.net/Articles/Weblog/KanbaninAction.html">provides critical focus</a>.&nbsp; I do know that right now I am risking the &ldquo;overhead of running each iteration like a mini-project.&rdquo;</p>
<h3>Experiencing Focus on Quality</h3>
<p>One of the ways that &ldquo;Focus on Quality&rdquo; and pushing quality upstream showed up for me is in visualizing the end-point qualities from the beginning and coming up with an evolutionary development approach that&nbsp;I could envision constantly reinforcing quality in&nbsp;my particular project.&nbsp; This has given me surprising adaptability, and I now have a safety net that permits me some aberrations and adjustments that I could not have imagined at the start.&nbsp; </p>
<p>As I approach public beta and an opportunity to report more of the experiences when the open-source code comes out of embargo, I have found myself in an interesting situation.</p>
<h3>Inside a Relentless Process, You Can Permit Shortcuts</h3>
<p>There is a sponsoring customer that is putting my software to work inside of a specific product, on behalf of a specific customer of their own.&nbsp; As I approached the end of alpha-level deliverables and moved into&nbsp;private beta deliverables, I modified my approach to releases in ways I did not expect.&nbsp; </p>
<p>Having achieved the major design and implemented key functionality, <strong>I have now begun to short-circuit some of my testing and deployment investments in order to deliver the few&nbsp;remaining&nbsp;features that will provide the greatest first-customer utility.</strong>&nbsp; This isn&rsquo;t good enough for a public distribution of the software for reuse.&nbsp; It is more than good enough for a specific integration inside of a specific release of application software.&nbsp; So my attending to that at this time focuses on the least that could possibly work for the initial customer, accomplishing&nbsp;earlier availability and opportunity for further experience and correction.&nbsp; (It is also remarkable to me how much &ldquo;the least that could possibly work&rdquo; arises in the selection of iterations.)</p>
<p>The point I want to make is that I have designed and I am evolving toward a public product with all of the stability and conceptual coherence&nbsp;such an effort&nbsp;requires.&nbsp; However, for the first use, I can cover a point space that is good enough for the initial application and in which&nbsp;my later-hardened software can be slipped underneath without impact and with greater confidence in continuing stability in the face of changes in the application software.&nbsp; </p>
<p><strong>What&rsquo;s clear to me&nbsp;in this experience is&nbsp;the&nbsp;deficiency of code-and-fix&nbsp;point-solution development</strong>, the kind that often happens inside of an application-software development setting and for which testing and hardening is usually just enough to get things working in the context in which the software has been conceived.&nbsp; This variant of code-and-fix creates two well-known prospects for later failure: the cost of maintenance/re-engineering and the illusion of reusability (potentially for resale of what was originally an internal software development).&nbsp; The second effort often dies a grizzly death in consequence of the unaffordable maintenance and support costs.</p>
<h3>The Bet with Myself</h3>
<p>I claim that I have avoided that limitation because the points I fix are inside of a coherent design.&nbsp; That design dominates the development, as does the quality progression for which there is always a way to recover from (intentional) deviations and continue.</p>
<p>As I cross over to public beta, I know what cracks I must seal and I will do so.&nbsp; What struck me on reading Meier&rsquo;s post today was realizing that I have permitted myself some code-and-fix expedients simply to have my sponsor able to satisfy their immediate needs.&nbsp;&nbsp; So, for a short time, I am actually doing one-feature-fix-at-a-time, clean-up&nbsp;mini-drops (0.56, 0.57, &hellip;, 0.59) before catching my breath and declaring the 0.60 public beta.</p>
<p>With the logistics arrangements between my working in Seattle and the sponsor in Europe, I do have an incentive to package the deliverables in a way that has them be usable without my presence.&nbsp; This has been critically useful although I still probably over-do it.&nbsp; I am trusting that to&nbsp;pay off big&nbsp;in the home stretch, though.</p>
<p>So now, back to work.&nbsp; I have a roadmap to update and continue.</p><div class="bjtags">Tags:  <a rel="tag" href="http://technorati.com/tag/orcmid">orcmid</a>, <a rel="tag" href="http://technorati.com/tag/software+engineering">software+engineering</a>, <a rel="tag" href="http://technorati.com/tag/nano-ISV">nano-ISV</a>, <a rel="tag" href="http://technorati.com/tag/personal+software+productivity">personal+software+productivity</a>, <a rel="tag" href="http://technorati.com/tag/David+Anderson">David+Anderson</a>, <a rel="tag" href="http://technorati.com/tag/agile+development">agile+development</a></div><div style="clear:both; padding-bottom:0.25em"></div>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2007/03/recipe-for-nano-isv-success-j.asp">3/11/2007 03:00:00 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2007/03/recipe-for-nano-isv-success-j.asp">
        ...
        <a class="comment-link" href="http://www2.blogger.com/comment.g?blogID=7336679&postID=4350601871656742609">Post a Comment</a>
		</div>
