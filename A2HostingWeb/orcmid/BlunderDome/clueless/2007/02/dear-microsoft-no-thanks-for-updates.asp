...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /A2HostingWeb/orcmid/BlunderDome/clueless/2007/02/dear-microsoft-no-thanks-for-updates.asp 2     08-10-07 12:43 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: Dear Microsoft: No Thanks for the Updates</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="Saturday, February 10, 2007" href="#Saturday, February 10, 2007">
          <font color="#660000">Saturday, February 10, 2007</font></a></h3>
   	

	<div class="posts">
	<a name="117112884471312338"></a>
    ...
    <p>
	<div style="clear:both;"></div><p>This morning, I declined to accept the &ldquo;<a href="http://orcmid.com/blog/2007/02/dear-microsoft-what-trumps-security-as.asp">High Priority</a>&rdquo; update that Microsoft Update wanted to download and install for me: Visual Studio 2005 SP1.&nbsp; I already knew this update was available, and I have been waiting for the smoke to clear on how well it handles the Express Editions, especially the Visual C++ 2005 Express Edition.&nbsp; </p><p align="center">{tags: <a href="http://technorati.com/tag/orcmid" rel="tag">orcmid</a> <a href="http://technorati.com/tag/Microsoft+Update" rel="tag">Microsoft Update</a> <a href="http://technorati.com/tag/Visual+Studio" rel="tag">Visual Studio</a> <a href="http://technorati.com/tag/VC+2005+Express" rel="tag">VC++ 2005 Express</a> <a href="http://technorati.com/tag/software+engineering" rel="tag">software engineering</a>}</p><p>There are enough reports of instabilities and screw-ups around redistributables and other integration edge cases that I want to wait.&nbsp; In truth, I would wait in any case.&nbsp; I am in the middle of a project and&nbsp;all of my development tools are working just fine thank-you-very-much.&nbsp;&nbsp;I am not about to risk destabilization of <em>anything</em> until the project is at a point where I everything is delivered, buttoned down, and I have an easy fall-back mitigation in place.&nbsp; That means no installing hot graphics adapters, new sound fixtures, or upgrading to Vista on my main development machine.</p><p>What I will do is obtain the download/installable version, not the one that Microsoft Update installs automatically, and keep it around until I am ready to use it.&nbsp; Since it must be run once for each VS 2005 flavor that is installed, including each separate Express Edition on each machine, I want one I can keep, backup, move around, and re-rerun if I do any re-installs in the future.&nbsp; Hmm, it is interesting that the SP1 does not appear to be&nbsp;in my MSDN distribution for January 2007.&nbsp; I think I&rsquo;ll just wait&nbsp;for&nbsp;the little treasure&nbsp;to show up in my postal mailbox, no downloading required.</p><p>Some place around my project&rsquo;s 0.90 beta (I&rsquo;m building 0.60beta right now) and the hardening of my project and its regression tests, I will&nbsp;use variations of VC++ 2005, Platform SDKs, and Java SDKs so that I can verify that the&nbsp;source code, scripts,&nbsp;and builds all on the latest-available tool bases as well as the ones I started with.&nbsp; After that I can give myself leave to make other interesting upgrades to my systems.</p><p>Oh oh, I did download some non-priority upgrades,&nbsp;including .NET 3.0 and new root certificates.&nbsp;&nbsp;I will know shortly whether that was prudent or not.</p><p align="center"><small>[update 2007-02-10T20:37Z: added tags and a cross-reference on security.]</small></p><div style="clear:both; padding-bottom:0.25em"></div>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2007/02/dear-microsoft-no-thanks-for-updates.asp">2/10/2007 09:34:00 AM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2007/02/dear-microsoft-no-thanks-for-updates.asp">
        ...
        <a class="comment-link" href="http://www2.blogger.com/comment.g?blogID=7336679&postID=117112884471312338">Post a Comment</a>
		</div>
