...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /A2HostingWeb/orcmid/BlunderDome/clueless/2007/02/getting-to-unicode-least-that-could.asp 2     08-10-07 12:43 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: Getting to Unicode: The Least That Could Possibly Work</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="Monday, February 12, 2007" href="#Monday, February 12, 2007">
          <font color="#660000">Monday, February 12, 2007</font></a></h3>
   	

	<div class="posts">
	<a name="117130230676524214"></a>
    ...
    <p>
	<div style="clear:both;"></div><p>I&rsquo;m in the process of stabilizing the first beta release of a project.&nbsp; I&rsquo;m doing mini-drops of patches that move from 0.50beta (the first beta achieved) to 0.60beta.&nbsp; Getting from 0.52 to 0.54 involves adding code-page sensitivity to conversion from some native Windows interfaces that are hard-wired for single-byte codes.&nbsp; I must produce&nbsp;Unicode for use in Java and any other wrapper layers that must work&nbsp;in internationalized settings.</p><p align="center">{tags: <a href="http://technorati.com/tag/orcmid" rel="tag">orcmid</a> <a href="http://technorati.com/tag/software+engineering" rel="tag">software engineering</a> <a href="http://technorati.com/tag/software+testing" rel="tag">software testing</a> <a href="http://technorati.com/tag/evolutionary+development" rel="tag">evolutionary development</a>}</p><p>In considering this update, I looked at four solutions.&nbsp; The first solution leaves&nbsp;exposed the single-byte codes, delivered them into buffers of whatever wrapper surrounds my&nbsp;lowest-level native Windows layer.&nbsp;&nbsp;Solution #1&nbsp;basically punts the entire problem of correct conversion to all higher levels.&nbsp;&nbsp; I have a long list of reasons why that is unsavory and putting&nbsp;the job in the wrong place.&nbsp;&nbsp; Launching myself into architecture orbit, I considered three other solutions.&nbsp; The fourth completely encapsulates the conversion to Unicode at my deepest integration layer, making it a general solution for whatever kind of wrapper sits above me, whether to interface Java, plain C++, .NET, who knows.&nbsp; Naturally, I am in love with solution #4.</p><p>Last night, I went to sleep with the one last concern on my mind: all of the current unit and regression tests for the bottom layer&nbsp;will no longer work.&nbsp; They&nbsp;will have to be completely redone for Unicode:&nbsp;all of my tests, their displays and results, filenames, everything that is now&nbsp;conveyed in single-byte code.</p><p>This morning, I found the trump card.&nbsp; With solution #1, the conversion to Unicode with code-page sensitivity happens in exactly the place where I am converting to Unicode without code-page sensitivity.&nbsp; So no black-box tests have to change.&nbsp; They simply become regression tests and demonstrations that the single-byte codes outside of the basic ASCII set are coming through properly, something that really matters for the European&nbsp;ISV that is using the result of this work.</p><p>So, I am back to solution #1 and its winning qualities:&nbsp; It is the least change that can possibly work.&nbsp; It provides running code in the hands of an integrator as early as possible with the least possible destabilization.&nbsp; It requires additional testing to introduce interesting character codes into the test cases, but&nbsp;all regression-test code works without change.</p><p>I wasted a week figuring this out.&nbsp; I wonder if my hesitancy was because of some nagging sense that I was going down a dangerous path?</p><hr><p>I will, at a more convenient later time, be refactoring the lower and intermediate layers of my code as part of hardening and getting as much of the work as possible done at the native, high-performance layer.&nbsp; This will be at a point where my top-level component interfaces will be locked down and no refactoring will be visible to applications that use the components.&nbsp;&nbsp; It&rsquo;ll still be risky to make those changes, but I&rsquo;ll have painfully-solid regression tests by then.&nbsp; At that point, I&rsquo;ll look at approach #4 once again.&nbsp; I&rsquo;ll let you know what happens.</p><div style="clear:both; padding-bottom:0.25em"></div>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2007/02/getting-to-unicode-least-that-could.asp">2/12/2007 09:45:00 AM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2007/02/getting-to-unicode-least-that-could.asp">
        ...
        <a class="comment-link" href="http://www2.blogger.com/comment.g?blogID=7336679&postID=117130230676524214">Post a Comment</a>
		</div>
