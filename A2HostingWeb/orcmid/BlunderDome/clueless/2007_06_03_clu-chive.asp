...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /A2HostingWeb/orcmid/BlunderDome/clueless/2007_06_03_clu-chive.asp 1     08-10-07 14:29 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: 2007-06-03</title>
...
I’ve become a regula...</a><br />
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="2007-06-07" href="#2007-06-07">
          <font color="#660000">2007-06-07</font></a></h3>
   	

	<div class="posts">
	<a name="8039852429484264939"></a>
    
    <h2><font color="#000080"><!-- 2004-08-31 -->
    
    Code-Monkey Challenge: What is the PSDK Target-Platform Default?
    
    </font></h2>
    
    
    <p>
	<div style="clear:both;"></div><div class="wlWriterSmartContent" id="0767317B-992E-4b12-91E0-4F059A8CECA8:fd0ed614-22c2-45a9-be44-8bc9f8c851bf" contenteditable="false" style="padding-right: 0px; display: inline; padding-left: 0px; float: none; padding-bottom: 0px; margin: 0px; padding-top: 0px">Technorati Tags: <a href="http://technorati.com/tags/Windows%20LiveWriterndows%20PSDK" rel="tag">Windows LiveWriterndows PSDK</a>, <a href="http://technorati.com/tags/orcmid" rel="tag">orcmid</a>, <a href="http://technorati.com/tags/Raymond%20Chen" rel="tag">Raymond Chen</a>, <a href="http://technorati.com/tags/Visual%20C++%20Express" rel="tag">Visual C++ Express</a></div> <p>There are two features of the Windows Platform SDK that&nbsp;cast a spell of&nbsp;confusion&nbsp;on beginners: the name of the PSDK and how one chooses the versions of platform a program is targeted for.</p> <h3>What's in a Name?</h3> <p>Lately, the Platform SDKs --&nbsp;all of those header files, utilities, libraries, and documents that re freely available for use in developing applications for Windows -- have been given ridiculously-long names with lots of spaces in them.</p> <p>The last PSDK that I've installed, the one still recommended for users of the Visual C++ 2005 Express Edition, is named </p> <p align="center">"<a href="http://www.microsoft.com/downloads/details.aspx?FamilyId=E15438AC-60BE-41BD-AA14-7F1E0F19CA0D&amp;displaylang=en">Windows Platform SDK for Windows Server 2003 R2</a>"</p> <p align="left">And that's also the name of the folder it installed itself in on my computer.</p> <p align="left">A beginner who does not happen to have Windows Server 2003 and certainly is not thinking of making programs for Windows Server 2003 is given a certain basis for doubt when told this is the PSDK to download.</p> <p align="left">The most that can be done, for those who hesitate over this, is&nbsp;point out that (sometimes) the name of the PSDK indicates the latest version of the Windows Platform for which there is complete API support (roughly).&nbsp; The PSDK is still good for at least all versions of Windows that are still supported.</p> <p align="left">Even knowing this, I find <em>myself</em> reluctant to assume too much about the pre-eminence of two more-recent releases:</p> <p align="center">"<a href="http://www.microsoft.com/downloads/details.aspx?familyid=C2B1E300-F358-4523-B479-F53D234CDCCF&amp;displaylang=en">Microsoft® Windows® Software Development Kit for Windows Vista™ and .NET Framework 3.0 Runtime Components</a>"</p> <p align="left">and</p> <p align="center">"<a href="http://www.microsoft.com/downloads/details.aspx?familyid=ff6467e6-5bba-4bf5-b562-9199be864d29&amp;displaylang=en">Microsoft® Windows® Software Development Kit Update for Windows Vista™</a>"</p> <p align="left">where, although the second of these is a replacement for the first, there is no word about the PSDK for Windows Server 2003 R2 having become a legacy PSDK.&nbsp; Don't ask me what kind of directory name these beauties install themselves into.&nbsp; I'm afraid to find out.</p> <p align="left">For those who do not hesitate over any of this, I can only say, "Welcome to the code-monkey school of development, where you must just do what you are told and the reward of understanding is failure.&nbsp; You&nbsp;are now on level #2."&nbsp; Apparently the reward for code-monkey stardom is being allowed to name a future Platform SDK.</p> <h3>So What Am I Compiling For?</h3> <p align="left">Well yes, that could be an important existential topic.</p> <p align="left">But today I mean to say, if the Platform SDK that I have installed supports a range of Windows Platforms, how do I know which features are safe to use for those platforms I want my program to operate on?&nbsp; Or, let me put it another way: How do I make sure that I'm not using features that are unavailable on the platforms I want my application to run on?</p> <p align="left">Those are pretty good questions.&nbsp; Not particularly good for beginners though.&nbsp; One way is to find out all APIs that are being used and determine the platform versions those APIs (and the various options and parameters) were introduced on and supported since.&nbsp; The information is available but not even I am so obsessive as to figure it out for my API dependencies (although I have been so compulsive with Java, where it is easier and&nbsp;rather mechanical).</p> <p align="left">Actually, these are definitely not code-monkey questions.&nbsp; The early-stage code-monkey asks: "I am using feature <em>x</em> and when I compile my program I get message <em>y</em>" which is usually about something not being defined or not being locatable.&nbsp;&nbsp; The goal is to make the thing defined or locatable and have the message go away and have a program come out the delivery-end of the compiler.&nbsp; The fledgling code-monkey will do anything conceivable to achieve that end so long as it doesn't involve figuring out what is going on which is, as lesson #1 establishes, not rewarded and, as already confirmed&nbsp;in years of school-guppy training (and the no guppy left-behind program), won't be on the test.</p> <p align="left">Sometimes the program compiles and runs, but when copied onto another machine it then fails to execute, possibly accompanied by further mystery messages.&nbsp; It is at this point that the code monkey can achieve grasshopper status by realizing there may be different questions&nbsp;worth asking.&nbsp; These will not be answered by studying the much neglected built-in help or the online MSDN materials that one might think to seek.&nbsp; The source of difficulty and its resolution is nigh indescribable.</p> <p align="left">Well, then, one might suppose that without taking any particular action, a program will be compiled for (a) the&nbsp;oldest-platform supported by&nbsp;the PSDK, (b) the most-recent platform supported by the PSDK, (c) the platform you are running Visual C++ on, or (d) none of the above?&nbsp; The answer to this question is "yes."</p> <p align="left">Sometimes, features of the API are available only if you say you want them.&nbsp; Sometimes features of the API are unavailable only if you say you don't want them.&nbsp; Sometimes how you create your project may influence the gods in granting features to your program.&nbsp; There are certain selections by default.</p> <h3>How PSDK Header Files Honor Your Wishes</h3> <p align="left">Like any wily and tortured genie, the Platform SDK will grant you wishes.&nbsp; And, unless cornered, it will not willingly admit that there are wishes you may command.&nbsp; In particular, it will obey wishes you don't know you've made.</p> <p align="left">This mystery is buried behind the&nbsp;twin gates of <font face="Courier New">#include</font> and <font face="Courier New">#ifdef</font>, the recursive incantations of which are hidden behind the all-powerful injunction, "Just use <font face="Courier New">#include &lt;windows.h&gt;</font>."&nbsp; The C/C++ Language preprocessor is used to choose those API elements that&nbsp;your program can reference and&nbsp;those that it cannot (so easily).&nbsp;&nbsp; It accomplishes this by checking pre-processor variables, some that are set up by default and others that are not.&nbsp; Your influence on the matter is to over-ride the defaults and/or add&nbsp;definitions that were not provided by default.&nbsp; </p> <p align="left">There is a <a href="http://msdn2.microsoft.com/en-us/library/aa383745.aspx">sketchy explanation</a> of the top-level of control (failing to identify the versions of PSDK for which it applies, so a lot of beginners will be defining NTDDI_VERSION with no effect).&nbsp; Raymond Chen has provided a <a href="http://blogs.msdn.com/oldnewthing/archive/2007/04/11/2079137.aspx">handy narrative</a>, although the <a href="http://blogs.msdn.com/oldnewthing/archive/2007/04/10/2065725.aspx">general rule</a> about "default version" is apparently not so general as all that.</p> <p align="left">When I first began dealing with free versions of Visual C++, I created a little utility that would let me see what the values of various preprocessor variables happened to be in my programs, whether I had done anything to set them or not.&nbsp; This came to mind today when someone was baffled on the Microsoft Visual C++ Express Edition Forum.&nbsp; In this case,&nbsp;<a href="http://forums.microsoft.com/MSDN/ShowPost.aspx?PostID=1705776&amp;SiteID=1&amp;mode=1">a documented API flag was being reported as not defined</a>.&nbsp; The Forum newcomer had tracked down the PSDK header file&nbsp;having the definition, which was governed by this conditional code:</p> <blockquote> <p align="left"><font face="Courier New">#if (_WIN32_WINNT &gt;= 0x0500)</font></p></blockquote> <p align="left">Although it is a subtle clue, Visual C++ had greyed out the definition, indicating that it was being excluded (that is, the <strong><font face="Courier New">#if</font></strong> is not satisfied).</p> <p align="left">I&nbsp;compiled up a little version of my utility to see what the default situation is when using VC++ 2005 Express Edition and the Platform SDK on Windows XP SP2 (assuming that the platform I'm on might be a consideration).&nbsp; Here's what my little program&nbsp;reports&nbsp;concerning <font face="Courier New"><strong>#include &lt;windows.h&gt;</strong></font>&nbsp;without addition of&nbsp;any special definitions:</p> <blockquote><pre><p><font face="Courier New"><strong>CompiledFor&gt; Show Compile-Time Settings.</strong></font><p><strong></strong>
<p><font face="Courier New"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; __DATE__ is defined to "Jun&nbsp; 7 2007"<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;__TIME__ is defined to "13:34:08"</strong></font></p>
<p><font face="Courier New"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; WINVER is defined to 0x0501</strong></font><font face="Courier New"><strong><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;_WIN32_WINNT undefined<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;_WIN32_WINDOWS undefined<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NTDDI_VERSION undefined</strong></font></p></pre></blockquote>
<p><strong>Whatever "default" minimum target platform this relates to, it has no name.</strong>&nbsp; It is&nbsp;simply whatever <strong><font face="Courier New">windows.h</font></strong> comes up with given those&nbsp;and other initial conditions:</p>
<ul>
<li>There are features of the APIs introduced with&nbsp;Windows 2000 and Windows XP that cannot be referenced in this program.&nbsp; </li>
<li>There may be other features that can be.&nbsp;&nbsp; </li>
<li>It depends on whether the header-file definitions are guarded by WINVER, one of _WIN32_WINNT and _WIN32_WINDOWS, or are not guarded at all.&nbsp; </li></ul>
<p>On this machine, the PSDK has 1,577 include files in 15 folders, taking 62 MB.&nbsp; You tell me how it will all sort out.&nbsp; To be fair, there are only 1,278 in the top level, requiring a mere 57.8 MB.&nbsp;&nbsp;&nbsp;When only calling for&nbsp;<strong><font face="Courier New">windows.h</font></strong>, other&nbsp;include files are accessed only around&nbsp;100 times as part of that single <strong><font face="Courier New">#include</font></strong>.</p>
<h3>Flunking Code-Monkey School</h3>
<p>So what's a code monkey to do?&nbsp; Why, just let the default happen.&nbsp; All the examples and tutorials and most other programs do too.&nbsp; It must not be a problem.</p>
<p>I can't stand it.&nbsp; I want it to be definite and confirmable what the acceptable target platforms are without having to try them all.&nbsp; I'm flunking code-monkey school!</p><div style="clear:both; padding-bottom:0.25em"></div>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2007/06/code-monkey-challenge-what-is-psdk.asp">6/07/2007 07:16:00 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2007/06/code-monkey-challenge-what-is-psdk.asp">
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&postID=8039852429484264939">Post a Comment</a>
		</div>
