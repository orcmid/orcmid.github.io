...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2006_08_06_clu-chive.asp 1     06-10-11 15:59 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: 2006-08-06</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="Saturday, August 12, 2006" href="#Saturday, August 12, 2006">
          <font color="#660000">Saturday, August 12, 2006</font></a></h3>
   	

	<div class="posts">
	<a name="115541868554057391"></a>
    ...
    <p>
	<div style="clear:both;"></div><p>At the official kick-off&nbsp;of the <a href="http://www.easychair.org/FLoC-06/">2006 Federated Logic Conference</a> this morning, there were some interesting observations provided prior to the Plenary address by Carnegie Mellon&rsquo;s Randal Bryant.</p><small><p align="center"><strong><font color="#800080">{tags: </font><a href="http://www.technorati.com/tag/orcmid" rel="tag">orcmid</a><font color="#800080"> </font><a href="http://www.technorati.com/tag/FLoC2006" rel="tag">FLoC2006</a><font color="#800080"> </font><a href="http://www.technorati.com/tag/Logic+Conference" rel="tag"><font color="#800080">Logic Conference</font></a><font color="#800080"> </font><a href="http://www.technorati.com/Microsoft+Research" rel="tag"><font color="#800080">Microsoft Research</font></a><font color="#800080"> </font><a href="http://www.technorati.com/tag/Computational+Logic" rel="tag"><font color="#800080">Computational Logic</font></a><font color="#800080">}</font></strong></p></small><h3>The Computational Logic Community</h3><p>General Chair&nbsp;<a href="http://www.cs.rice.edu/~vardi/">Moshe Vardi</a> pointed out what a rich and deep field computational logic has become.&nbsp; There is a mailing list of over&nbsp;10,000 names across the participating organizations.&nbsp; The typical individual conferences attract around 200 people and are highly-specialized.</p><p>The occasional&nbsp;Federated Logic Conference (FLoC),&nbsp;brings together these&nbsp;focused communities in three rings&nbsp;under one big tent (in the case of 2006).&nbsp; This is an amazing opportunity for the different communities, researchers, and students to partake of all of them.&nbsp; Although someone can&nbsp;simply stay in the sessions registered for, it is permissible to take advantage of any event happening in the parallel conferences.&nbsp; We also share the same hotel ballroom area, break area, and schedules, so that it is easy to move between tracks and to mingle with&nbsp;the broad&nbsp;community.</p><p>Conference Co-Chair <a href="http://research.microsoft.com/~tball/">Thomas Ball</a>&nbsp;provided further details about this jamboree of six conferences and 41 workshops:</p><ul><li>803 on-line registrations</li><li>375 from North America</li><li>375 from Europe</li><li>30 from Asia</li><li>17 from the Middle East</li><li>6 others</li></ul><p>There were 1200 paper submissions.</p><p>This is an explosive expansion of an arcane field.&nbsp; One feature, that I discovered as I visited the different sessions, is that the field is producing remarkable successes that have extremely-valuable applications.</p><h3>The Presence of Microsoft Research</h3><p>I moved from Seattle to the Northeastern United States in 1961, and did not return until I left Silicon Valley in 1999.&nbsp; In the time since, I have enjoyed living in the gravity well of Redmond.&nbsp; There are many benefits to software developers and computer scientists simply from being in the neighbouring community and able to participate in Microsoft-sponsored activities.&nbsp; So I understand the benefit and enjoyment of such a strong software development and computer science community.&nbsp; Most recently, participation in <a href="http://langnetsymposium.com/">lang.NET 2006</a> was a direct benefit.</p><p>What was startling for me at FLoC was the depth of gratitude to Microsoft Research for the generous sponsorship and participation in FLoC 2006.&nbsp; It is becoming clear that not only is Microsoft generous in its support for serious computer-science research in many forms, but it provides one of the most open and visible industrial research organizations on the planet.&nbsp; Whatever happens with intellectual-property transfer into products, I sense a great community commitment by Microsoft researchers and support of that level of visibility and contribution by the corporation.&nbsp; This strikes me as a clear demonstration of enlightened self-interest at work, including Microsoft&rsquo;s strenuous effort in cultivating the attraction of students to computation-oriented careers and computer science.&nbsp; </p><p>I don&rsquo;t know how well-recognized this might be in academic circles.&nbsp; It is quite startling to open my eyes to how much there is this support separated from the Microsoft product-centric promotional and educational activities.&nbsp; That&rsquo;s great too, but to see the devotion to applied and theoretical research is exciting.</p><div style="clear:both; padding-bottom: 0.25em;"></div>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2006/08/federated-logic-floc-community.asp">8/12/2006 02:38:05 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2006/08/federated-logic-floc-community.asp">
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=115541868554057391">Post a Comment</a>
		</div>
