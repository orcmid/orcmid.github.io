...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2005_11_13_clu-chive.asp 1     06-02-04 21:27 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: 2005-11-13</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="Wednesday, November 16, 2005" href="#Wednesday, November 16, 2005">
          <font color="#660000">Wednesday, November 16, 2005</font></a></h3>
   	

	<div class="posts">
	<a name="113220649739033003"></a>
    ...
    <p>
	<div style="clear:both;"></div><p><a href="http://www.uwb.edu/CSS/about/speakerseries.html/">Ten Myths of Rapid Development</a>.&nbsp; This was my second opportunity to hear <a href="http://www.stevemcconnell.com/">Steve McConnell</a> speak in the six years I&rsquo;ve been living in the Seattle area.&nbsp; I enjoy listening to his presentation and the delivery.&nbsp; I recorded the ten myths in my notes in this fashion:</p><ol><li>Rapid Development is New</li><li>Productivity Is About the Same at Every Company [reminding me of Stan Erdreich&rsquo;s brown-grass theory of life, in which grass is brown all over and ours is no browner than anyone else's]</li><li>Working Hard Promotes Rapid Development</li><li>Short Estimates Produce Short Projects</li><li>Productivity Can be Improved Tactically, on a Project-by-Project Basis</li><li>You Can Trade Off Quality for Cost and Schedule</li><li>Customers and Managers Want Short Schedules</li><li>Smart Developers Have the Most Impact on Productivity</li><li>Software Processes Apply Only to Large, Old-Fashioned, Bureaucratic Projects</li><li>Systematic Development Approaches Hurt Morale</li></ol><p>It&rsquo;s necessary&nbsp;to go to one of these presentations to see how these&nbsp;topics are&nbsp;woven together as each myth is dismissed.&nbsp; McConnell&rsquo;s perspective is grounded and practical.&nbsp; I have done little justice to the presentation by listing the headings, but it would serve even less to attempt to fill in the blanks.</p><p>Instead, I want to share some of the impressive ways that Steve promotes professional approaches and attitudes and how that came up in the course of questions and discussion.</p><p>First, around the <strong>cost of defects</strong>, this observation passed on by Steve deserves to be carved on the walls of buildings and the sides of mountains as a reminder of the cost of quick-and-dirty: &ldquo;dirty remains long after quick is forgotten.&rdquo;&nbsp; </p><p>In response to a question about teams feeling they must <strong>low-ball estimates</strong> (for <em>internal</em> IT projects) in order to gain approval, Steve&nbsp;politely and&nbsp;graciously point out&nbsp;that intentionally low-bidding a project completely undermines management&rsquo;s effort to reconcile costs and priorities and find the best allocation to fit overall business needs.&nbsp; He quietly hinted&nbsp;at the damaging repercussions as the true cost of the project become apparent and the organization suffers the opportunity cost of&nbsp;having missed what might have been&nbsp;more-valuable projects.&nbsp; It is refreshing to see emphasis on the technical staff taking responsibility for empowering management rather than second-guessing and undermining executive decision processes.</p><p>With regard to <strong>advocacy of change of methodologies and processes</strong>, Steve also counselled that there are a large number of factors that impact the pace of change in an organization, as well as organizations simply having their own styles.&nbsp; If one does not find satisfaction in working for organizational improvement from within, it would be valuable to find an organization whose practices already fit with a developer&rsquo;s own preferences and sources of satisfaction in the work.</p><p>I thought it was also useful&nbsp;to&nbsp;to hear Steve&rsquo;s cautioning about&nbsp;<strong>methodological features</strong> that&nbsp;may be&nbsp;seized upon for&nbsp;self-serving purposes and actually misapplied.&nbsp; Sometimes, it occurs to me, adherents of extreme and agile programming methodologies focus on convenience for developers that may not lead to successful results for the clients and users.&nbsp; For example, there was brief discussion about over-generalizing the&nbsp;impossibility of clear-enough requirements&nbsp;in justifying&nbsp;trial-and-error (but &ldquo;agile&rdquo;) processes.&nbsp;&nbsp; This&nbsp;concern for working through requirements agreement struck me as a corollary of&nbsp;the&nbsp;importance of&nbsp;removing defects as early as possible:&nbsp;defects in requirements are certainly the most&nbsp;costly to carry through into implementation.&nbsp;&nbsp;The absence of sufficiently-solid requirements is also&nbsp;something that disciplined risk management could spotlight, although this didn&rsquo;t come up&nbsp;in the talk.</p><p>Concerning <strong>predictability</strong>, there were three repeated observations that I&nbsp;want to&nbsp;emphasize together:</p><ul><li>As organizations move through levels of process maturity, the ability to achieve stable, predictable project schedules is notable.</li><li>There is consistent evidence that managers want predictability and reliability at meeting commitments and are reluctant to trade it for anything else.</li><li>The high level of satisfaction among developers in high-maturity organizations is noteworthy and consistently observed.</li></ul><p>Over the course of the talk, Steve reminded us that many of the ideas and approaches were proved out 15-30 years ago.&nbsp; They need to be promoted still because they are available and not being adopted.&nbsp; I take that to mean that the tools are available, it is incorporation in practice that continues to be the challenge.</p><p>With regard to Steve&rsquo;s favored methodologies, he suggested (subtlely) that prototypes that <em>have</em> to be thrown-away are a great approach for eliciting requirements, and that iterative methodologies are certainly valuable, with many levels and phases where iteration can be beneficial.</p><p>Finally, Steve reported that he has returned to work on his book&nbsp;on estimation.&nbsp; We can expect it in the Spring of 2006.</p><p align="center"><small><font color="#aa00aa">{tags: <a href="http://technorati.com/tag/McConnell" rel="tag">McConnell</a> <a href="http://technorati.com/tag/Rapid_Development" rel="tag">Rapid Development</a> <a href="http://technorati.com/tag/Software_Engineering" rel="tag">Software Engineering</a>}</font></small></p><small><p><strong>Further Observations and Reflections</strong></p><p>Early this year, I used <a href="http://www.construx.com/resources/estimate/">Construx Estimate</a> while&nbsp;taking a Project Management Course and I&nbsp;find the support for&nbsp;cones of uncertainty&nbsp;much more understandable than relying on the free CoCoMo tools.&nbsp; I would love to see what Steve&rsquo;s book can provide in my weakest area of project management and project planning.</p><p>This meeting was my geek respite from 1-1/2 days at a conference of ethnographers, <a href="http://www.epic2005.com/program.html">EPIC 2005</a>, where I was definitely a fish out of water.&nbsp; It was also comforting to be reminded how practised presenters are able to bring ideas to the public without the academic weirdness of reading papers aloud that are written in a form only to be read carefully and privately.</p><p>Standing outside the entrance to the lecture hall, I was facing Steve and wondering whether it was really him &mdash; he is younger looking and fitter than I remember him from one of the Seattle University Project Night events when he spoke.&nbsp; Before I got up the nerve to ask if he was himself and introduce myself again, the <a href="http://faculty.uwb.edu/aberger/">faculty host</a> walked up and greeted him.&nbsp; I&rsquo;m sure&nbsp;Steve doesn&rsquo;t remember me and I&rsquo;ll have to reconnect by e-mail again.</p><p>The <a href="http://www.ieee-seattle.org/computersociety/">Seattle Section</a> of the IEEE Computer Society <a href="http://www.ieee-seattle.org/computersociety/15Nov2005.shtml">announced this event</a> some time ago.&nbsp;&nbsp; The event was at the joint campus of Cascadia Community College and the University of Washington Bothell <a href="http://www.uwb.edu/admin/services/transportation/map.xhtml">location</a>.&nbsp; This gave me an opportunity to wander the shared branch of the <a href="http://www.bookstore.washington.edu/">University Bookstore</a> (typical for a small campus and not approaching the famous richness of&nbsp;the store serving the main campus), check out the CIS textbooks (geepers, way too pricey: buy them used on amazon.com), and visit the library&nbsp;(nice, but friends of the library at $100 to have borrowing privileges is a bit steep, especially in contrast to something like the ACM and IEEE Computer Society digital libraries).&nbsp; The lecture hall tables that we&nbsp;sat at&nbsp;had power outlets and RJ45 sockets between each pair of positions.</p><p>It is interesting that a student IEEE groups also supported the <a href="http://nfocentrale.net/orcmid/BlunderDome/clueless/2005/10/sending-orcmid-to-code-camp.asp">Seattle Code Camp</a> last month, hosted at the Devry University Federal Way Campus.&nbsp; One notable difference between the two event locations, along with the smaller size of the <a href="http://www.devry.edu/locations/campuses/loc_federalwaycampus_map.jsp">Devry location</a>, was the disparity in available public transportation.&nbsp; Devry was served by one bus route with intermittent weekend service and you can&rsquo;t find out even that much from the web site.&nbsp; The Bothell campus&nbsp;is a very different experience, and provided me an easy and enjoyable public transportation experience, travelling from Microsoft to the Southeast of Bothell and returning through downtown Seattle and home.&nbsp; </p><p>The <a href="http://www.computer.org/">IEEE</a>&nbsp;affiliation of student activities here reminds me that there is&nbsp;marginal presence&nbsp;of the <a href="http://www.acm.org/">Association for Computing Machinery</a> in Seattle (although a couple of SIGs have chapters and there are some student chapters with out-of-date web sites).&nbsp; This has a long history from when, in my student-programmer days, there was an independent Pacific Northwest computing association.&nbsp; It was at one of those conferences, in 1959, that I saw Grace Hopper speak.&nbsp; I also remember chatting with Edmund C. Berkeley, Fred Gruenberger, and Stan Poley&nbsp;at events in Seattle.&nbsp; I&rsquo;ll save the Grace Hopper stories for another account, but the impression she made was a definite factor in my going to work for Remington Rand Univac in Seattle and then moving on to (newly-named) Sperry Univac in New York City and Blue Bell, Pennsylvania.</p></small><div style="clear:both; padding-bottom: 0.25em;"></div>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2005/11/steve-mcconnell-beyond-myths-of-rapid.asp">11/16/2005 09:48:17 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2005/11/steve-mcconnell-beyond-myths-of-rapid.asp">
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=113220649739033003">Post a Comment</a>
		</div>
