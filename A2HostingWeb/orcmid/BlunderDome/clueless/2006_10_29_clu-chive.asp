...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /A2HostingWeb/orcmid/BlunderDome/clueless/2006_10_29_clu-chive.asp 1     07-02-18 18:01 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: 2006-10-29</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="Sunday, October 29, 2006" href="#Sunday, October 29, 2006">
          <font color="#660000">Sunday, October 29, 2006</font></a></h3>
   	

	<div class="posts">
	<a name="116214508581600455"></a>
    ...
    <p>
	<div style="clear:both;"></div><p>It&rsquo;s dark here <a href="http://orcmid.com/BlunderDome/clueless/2006/10/stepping-into-void.asp">in the void</a>, that&rsquo;s for sure. It&rsquo;s even a struggle to make out the indicators in my suit&rsquo;s heads-up display. </p><p>I&rsquo;m pretty sure I&rsquo;m at the new site but there&rsquo;s a visibility problem and I haven&rsquo;t found the surface yet.</p><p>It would be pretty funny if this mission were snuffed out because of a little thing like the difference between case-sensitivity and case-insensitivity in different parts of the habitat environmental systems. &hellip;</p><hr><p>This is the second confirmation post on the migration of Blogger to using the new <a href="http://orcmid.com/BlunderDome/clueless/">official location</a> for this blog. </p><p>What I am noticing is how unsuspecting I was about Apache being case sensitive and all of my site-development tools (IIS, FrontPage, and VSS) being case-insensitive in a weirdly case-honoring way. </p><p>I have images and pages whose URLs have capital letters in them, and some that are all lower-case. I have links to images and pages, some of which match the spelling of the target and some of which do not. So some are broken, some aren&rsquo;t. In the case where all links are broken the same way, there are remedies. For the others, it is a nightmare.</p><p>This morning, I&rsquo;m giving my tale of woe to Vicki, who is showering while I&rsquo;m shaving. She wonders if there was any warning about this. I don&rsquo;t think so. I missed it if there was. I also figured that migration would be a snap because I have full backups of the previous (case-insensitive) site content and it is easy for me to migrate onto a new server via FTP. And it was. </p><p>It took me a while to figure out what the breakage was all about, and I thought it would be easy to fix. Then I started nosing around and realizing that it is very difficult to get my case-insensitive tools to force the same spelling of page locations everywhere. </p><p>So Vicki asks if maybe there is some setting that can control this. It is time to find out. I&rsquo;m on a shared host, so it will have to work with the Apache .htaccess file. That is about all I can control. What a great question. Wish me luck in finding a favorable answer.</p><p>I really don&rsquo;t want to go back to an IIS-hosted web site. I have waited for years to be able to do add-on domains (not knowing that&rsquo;s what they would be called), and I don&rsquo;t want to give that up. The economy and capacity of the new site is also wonderful. Now it is just a little problem about getting all of the case-differing links and targets repaired somehow.</p><p>[<strong>update 2006-10-29-18:09Z:</strong> Well, it looks like the life-support system is failing. I was able to post to the new location via Blogger last night, but not this morning (in gmt-0800). Let's see if it is an easy fix.</p><p>No, if I use Blogger to repost the message, rather than&nbsp;BlogJet (which doesn&rsquo;t learn of Blogger errors), I get this handy report:</p><blockquote dir="ltr" style="MARGIN-RIGHT: 0px"><p>001 java.net.UnknownHostException: ftp<!-- no URL please -->.nfocentrale<!-- no URL please -->.com </p></blockquote><p dir="ltr" style="MARGIN-RIGHT: 0px">but I can get get to that site with no problem using WS_FTP, that domain name, and the account name and password that I set up specifically for Blogger FTP of my blog pages to the site of my choice.&nbsp; In a word, WTF?]</p><p dir="ltr" style="MARGIN-RIGHT: 0px">[<strong>update 2006&ndash;10&ndash;30&ndash;01:12Z:</strong> I used a <a href="http://orcmid.com/BlunderDome/wingnut/2006/10/little-reality-check.asp">page on Spanner Wingnut</a>&nbsp;to retry posting from time to time, and&nbsp;posts from Blogger seem to be working now.&nbsp; Here goes for this site and blog.]&nbsp;</p><div style="clear:both; padding-bottom: 0.25em;"></div>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2006/10/switching-oxygen-supplies.asp">10/29/2006 10:04:00 AM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2006/10/switching-oxygen-supplies.asp">
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=116214508581600455">Post a Comment</a>
		</div>
