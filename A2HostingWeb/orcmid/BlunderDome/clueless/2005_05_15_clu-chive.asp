...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2005_05_15_clu-chive.asp 2     06-02-03 22:43 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: 2005-05-15</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
    ...
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2005/05/3i-individualized-interactive.asp">3I: Individualized Interactive Instruction</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/BlunderDome/clueless/2005/05/three-defects-we-can-do-without-memory.asp">Three Defects We Can Do Without: Memory Leaks, Buffer Overflows, and Unclosed Files</a><br />
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="Thursday, May 19, 2005" href="#Thursday, May 19, 2005">
          <font color="#660000">Thursday, May 19, 2005</font></a></h3>
   	

	<div class="posts">
	<a name="111656320804861788"></a>
    ...
    <p>
	<p><a href="http://www.acm.org/technews/articles/2005-7/0518w.html#item1">ACM News Service: Quick Picks.</a>&nbsp; I don&rsquo;t have time to dig into these deeper, but I don&rsquo;t want to lose them, either:</p><ul><li>&ldquo;<a href="http://www.acm.org/technews/articles/2005-7/0518w.html#item17">Join the Evolution</a>&rdquo; &mdash; Scott Ambler&rsquo;s invitation to &ldquo;Agile Database Techniques.&rdquo; I&rsquo;m interested in the modeling, refactoring, and coupling issues.&nbsp; I&rsquo;m also curious how much business entities are able to adhere to the problem space rather than be solution-space artifacts.</li><li>&ldquo;<a href="http://www.acm.org/technews/articles/2005-7/0518w.html#item15">Developers&rsquo; Growing Challenge</a>&rdquo; &mdash; Peter Coffee&rsquo;s eWeek article on the problems of vulnerabilities in line-of-business applications and how developers are ill-equipped to deal with it and soon tools will make it harder.&nbsp; Now there&rsquo;s a challenge for simplifying rather than covering over fragile complexity.</li><li>&ldquo;<a href="http://www.acm.org/technews/articles/2005-7/0518w.html#item5">Researchers Speed, Optimize Code With New Open Source Tools</a>&rdquo; &mdash; This is about optimization of computer codes for certain large-scale computations.&nbsp; It would be interesting to see how generic this is and what its domain of application could turn out to be.&nbsp; (This goes deep in my files, but filed it is.)</li></ul><p><em></em></p>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2005/05/sorting-mail-agile-databases.asp">5/19/2005 09:26:48 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2005/05/sorting-mail-agile-databases.asp">
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=111656320804861788">Post a Comment</a>
		</div>
	
	</div>
    
	
      <h3><a name="Tuesday, May 17, 2005" href="#Tuesday, May 17, 2005">
          <font color="#660000">Tuesday, May 17, 2005</font></a></h3>
   	

	<div class="posts">
	<a name="111636953306641086"></a>
    ...
    <p>
	<p><a href="http://www.acm.org/technews/articles/2005-7/0516m.html#item1">ACM News Service: Researchers Reveal Holes in Grid</a>.&nbsp; SSH is not new technology, and apparently that is no assurance of&nbsp;confirmed security.&nbsp; MIT CSAIL researcher Will Stockwell refers to a critical and widespread SSH flaw along with visibility of known_hosts files (demonstrated by probing 92 systems to obtain 8,000 unique addresses) that is enough to&nbsp;permit attack by a simple worm&nbsp;that disrupts a grid or supercomputer system.&nbsp; Compromised versions of SSH have already been exploited in attacking TeraGrid and National Supercomputing Center machines.</p><p>Well, it just keeps getting better, doesn&rsquo;t it.&nbsp; This blurb had me looking around for a handy Bruce Schneier quote in my blog clippings, but I didn&rsquo;t have to go that far.</p><p>The Paul Roberts 2005-05-13 <a href="http://www.eweek.com/article2/0,1759,1815795,00.asp"><em>eWeek</em> article</a> has this great quote from Schneier on the holes in SSH and the prospects for a cascade attack:</p><blockquote><p>&ldquo;Nobody realized they were there. Security involves someone saying, 'You can do this,'&rdquo; said Bruce Schneier, chief technology officer of Counterpane Internet Security Inc., of Cupertino, Calif., and a widely respected cryptographer. </p></blockquote><p>This strikes me as an ugly consequence of Dijstra&rsquo;s assurance that it is only possible to demonstrate flaws, not the absence of flaws [my paraphrasing].&nbsp; Although&nbsp;Dijkstra had great hopes for provably-correct programs, we know that the gap between theory and practice is immense in this case. It takes a different kind of mind to seek weaknesses rather than completed work, and how do we keep that sort of skill from wandering over to the dark side where the juice seems to be?</p><p>This and other discussions were held at the International Workshop on Cluster Security held as part of <a href="http://www.ccgrid.org/">IEEE CCGrid</a> in Cardiff, Wales, earlier in May.</p>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2005/05/ssh-and-knownhosts-vulnerabilities.asp">5/17/2005 03:38:53 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2005/05/ssh-and-knownhosts-vulnerabilities.asp">
       </script> data by <a href="http://www.newsgator.com">NewsGator 
                             Online</a><!-- 2004-10-28 --></span>
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&amp;postID=111636953306641086">Post a Comment</a>
		</div>
