...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /A2HostingWeb/orcmid/BlunderDome/clueless/2007_09_30_clu-chive.asp 1     08-10-07 14:29 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: 2007-09-30</title>
...
I have noticed tha...</a><br />
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="2007-10-06" href="#2007-10-06">
          <font color="#660000">2007-10-06</font></a></h3>
   	

	<div class="posts">
	<a name="1294289605183555836"></a>
    ...
    <p>
	<div style="clear:both;"></div><p></p> <div class="wlWriterSmartContent" id="scid:0767317B-992E-4b12-91E0-4F059A8CECA8:80ea3e06-5308-4dc5-88a0-d915bf1ea4e7" style="padding-right: 0px; display: inline; padding-left: 0px; padding-bottom: 0px; margin: 0px; padding-top: 0px">Technorati Tags: <a href="http://technorati.com/tags/NWCPP" rel="tag">NWCPP</a>, <a href="http://technorati.com/tags/Herb%20Sutter" rel="tag">Herb Sutter</a>, <a href="http://technorati.com/tags/latency" rel="tag">latency</a>, <a href="http://technorati.com/tags/complexity" rel="tag">complexity</a></div> <p></p> <p>Living a short commute from Redmond, Washington, I was able to attend the <a href="http://www.nwcpp.org/index.html">Northwest C++</a> group's meeting with <a href="http://herbsutter.spaces.live.com/Blog/cns!2D4327CC297151BB!261.entry">Herb Sutter on September 19</a>.&nbsp;&nbsp; I was delighted to have my Herb Sutter books autographed.&nbsp; I follow Sutter's blog, so his name has high recognition for me, more than for his being Chair of the ISO committee on C++.&nbsp;&nbsp; <a href="http://erdani.org/">Andrei Alexandrescu</a>, co-author of <em>C++ Coding Standards: 101 Rules, Guidelines, and Best Practices</em> was also at the standing-room-only presentation.&nbsp; He signed my book as well.&nbsp; Not being a <em>Dr. Dobb's</em> regular, I didn't know much about Alexandrescu and I hope we'll see more of him as he completes his graduate studies.</p> <p>The talk centered on machine architectures and how that impacts the optimization of programs (by compilers) and the performance of the code that we write, performance that we may have little sense for.&nbsp; Sutter has announced the video and slide set for your viewing.&nbsp; This will completely shatter many ideas about how to write "optimum" programs and whether one should even try (although reducing algorithmic complexity (and decision cost) is almost always a good idea, as reinforced near the end of the talk:</p> <blockquote> <p>Herb Sutter: <a href="http://herbsutter.spaces.live.com/Blog/cns!2D4327CC297151BB!304.entry">Suggestions for "Required Viewing": Machine Architecture Talk Online</a>.&nbsp; <em>Sutter's Mill</em> (web log), 2007-09-24.&nbsp; The video is a little low-resolution, but having the discussion and verbal presentation is invaluable.&nbsp; I recommend having the slides open so that you can follow along with the talk in the video.</p></blockquote> <p>Here's my skimpy collection of bullet points, but a review of the slides and an index to the now-available video would be superior:</p> <ul> <li>Latency is the root of all complexity <a title="Herb Sutter (right) does stand-up question with Timothy Know" href="http://www.flickr.com/photos/orcmid/1502722860/"><img style="margin: 0px 0px 5px 10px" height="173" alt="2007-09-19 NWCPP: Timothy Knox and Herb Sutter Stand-Up" src="http://farm3.static.flickr.com/2291/1502722860_24b5d9aacc_m.jpg" width="240" align="right"></a>  <li>Assembler: you know what the line of code does, you know how long it takes.  <li>Does it affect my code's performance?  <li>Bandwidth vs. Latency  <li>You can always solve a bandwidth problem with money.  <li>Don't count on buying your way out of a latency problem.  <li>Everything about the complexity of hardware performance improvement has been true for past 40 years.  <li>Actual Memory Hierarchy reviewed (simplified)  <li>DRAM latency is ~200 clocks.&nbsp; ("DRAM bad!")  <li>Little's Law: Bandwidth X Latency = Concurrency  <li>data caching &amp; store caching can effect your code.(concurrency)  <li>pipeline execution impacts code  <li>Modern CPU chip: 85% cache, 99% to move/store data [and we once thought 15% operating-system overhead was a bad deal]  <li>The memory hierarchy is just going to get deeper. <a title="We took a lengthy pledge at the end, and it was pretty funny, but so long I can't tell you what it was." href="http://www.flickr.com/photos/orcmid/1501865963/"><img style="margin: 0px 0px 5px 10px" height="147" alt="2007-09-19 NWCPP: Taking the Sutter Pledge" src="http://farm3.static.flickr.com/2324/1501865963_b986f3de71_m.jpg" width="240" align="right"></a>  <li>l979 Lamport - Sequential consistency.  <li>All the things that can perturb the actual execution.&nbsp; Rearrangements are OK if you can never tell the difference (apart from performance improvement).  <li>Must not have "gray bits" that are controlled on a different critical section [related to problem of leaks that breach invariants for safe concurrency, but I forget the illustration now].  <li>Interesting question about a suspect sequence of operations that appears to be safe and isn't.  <li>Performance: Is it faster to sum an array of ints, a list of ints, or a tree of some sort?  <li>Intel Rightmark [?] Analyzer providing interesting results</li></ul> <p>Fortunately, <a href="http://www.nwcpp.org/Meetings/2007/09.html">the slides of the presentation</a> have been made available and you can figure it out from there.</p> <p><small>[<strong>update 2007-10-08:</strong> Added the link to the video of Sutter's presentation and his recommendation about this particular topic.&nbsp; I also remember talking to someone near the door afterward and remarking that computer processors are like software now, not because of micro-programming but because of the scheduling and heuristics for pipelining and maintaining consistency.&nbsp; Now the compiler doesn't reorder your code (though it can help the processor that way), the processor reorders and interleaves your code to hide latency in concurrency.&nbsp; There was a recent blog post that reminded me of that.&nbsp; I'll find it again eventually.]</small></p> <div style="clear:both; padding-bottom:0.25em"></div>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2007/10/nwcpp-herb-sutter-things-your.asp">10/06/2007 10:12:00 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2007/10/nwcpp-herb-sutter-things-your.asp">
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&postID=1294289605183555836">Post a Comment</a>
		</div>
