...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /A2HostingWeb/orcmid/BlunderDome/clueless/2007_11_18_clu-chive.asp 1     08-10-07 14:29 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: 2007-11-18</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<span class="byline">posted by orcmid
      ...
      <h3><a name="2007-11-19" href="#2007-11-19">
          <font color="#660000">2007-11-19</font></a></h3>
   	

	<div class="posts">
	<a name="2018139386896906933"></a>
    ...
    <p>
	<div style="clear:both;"></div><p></p> <div class="wlWriterSmartContent" id="scid:0767317B-992E-4b12-91E0-4F059A8CECA8:2a2a1568-7b9e-4483-8e8e-a181de64ab9c" style="padding-right: 0px; display: inline; padding-left: 0px; padding-bottom: 0px; margin: 0px; padding-top: 0px">Technorati Tags: <a href="http://technorati.com/tags/VC++%20Novice" rel="tag">VC++ Novice</a>, <a href="http://technorati.com/tags/Visual%20Studio%202008%20Express%20Edition" rel="tag">Visual Studio 2008 Express Edition</a>, <a href="http://technorati.com/tags/downloads" rel="tag">downloads</a>, <a href="http://technorati.com/tags/VC++%202008%20Express%20Edition" rel="tag">VC++ 2008 Express Edition</a>, <a href="http://technorati.com/tags/programming" rel="tag">programming</a>, <a href="http://technorati.com/tags/software%20development" rel="tag">software development</a>, <a href="http://technorati.com/tags/CP4E" rel="tag">CP4E</a>, <a href="http://technorati.com/tags/SE4E" rel="tag">SE4E</a>, <a href="http://technorati.com/tags/toolcraft" rel="tag">toolcraft</a></div> <blockquote> <p align="left"><strong><em>see also:<br></em></strong>&nbsp;&nbsp;&nbsp;&nbsp; 2007-11-26 Toolcraft: <a href="http://orcmid.com/BlunderDome/clueless/2007/11/toolcraft-making-discs-from-cddvd-image.asp">Making Discs from CD/DVD Image Downloads</a><br>&nbsp;&nbsp;&nbsp;&nbsp; 2007-08-24 VC++ Novice: <a href="http://orcmid.com/BlunderDome/clueless/2007/08/vc-novice-what-about-vc-2008-orcas.asp" target="_blank">What About VC++ 2008 (Orcas) Express Editions?</a><br>&nbsp;&nbsp;&nbsp;&nbsp; 2007-06-10 VC++ Novice: <a href="http://orcmid.com/BlunderDome/clueless/2007/06/vc-novices-what-visual-express-edition.asp" target="_blank">What's the Visual C++ Express Edition?</a></p></blockquote> <p align="center"><a title="New Visual Studio Express Page" href="http://www.microsoft.com/express"><img src="http://mpauia.bay.livefilestore.com/y1pSnwPiUtxyHcvKj1AjGKDTLI7i02TYRgDT3t2Z6wC2_5tzbtxmYieRuvLZxwZumW--CchJD4WmeSR42rWmCiHNA"></a></p></img> <p>It's <a title="Visual Studio 2008 Express Developer Center" href="http://www.microsoft.com/express" target="_blank">here</a>!</p> <p>The Visual Studio 2008 Express Edition release is now available for download.&nbsp;&nbsp; The developer center for Express Editions has been revamped with fancy visuals and re-organized access to materials.</p> <p>For users of Visual C++ 2005 Express Edition, the key first features are that</p> <ul> <li>Your Visual Studio 2008 Express Editions can be installed alongside Visual C++ 2005 Express Edition (and other Visual Studio 2005 Express packages) without interference with each other.&nbsp; (There may be some changes with regard to which IDE opens when you double-click a program file or a solution.&nbsp; And VS 2008 will upgrade 2005 projects.&nbsp; We'll explore how to control all that later.)<br>&nbsp;&nbsp; <li>The complete set of VS 2008 Express Edition packages is available as a single DVD-image download.&nbsp; It takes a DVD because it is slightly more than what fits on a single CD-ROM.&nbsp; The disk image is 894MB.<br>&nbsp;&nbsp; <li>There are differences in packaging and supplemental materials between VC++ 2005 Express and VC++ 2008 Express.&nbsp; There are also differences with regard to .NET dependencies and the .NET libraries that you can take advantage of (if using the C++/CLI dialect in a project).</li></ul> <h3>First Things First</h3> <p>I <strong>strongly</strong> recommend that you download the DVD image and arrange to record it for preservation purposes.&nbsp; This provides a medium from which you can reinstall the package as often as you want.&nbsp; It is an important backup if for any reason that you need to revert back to this software at some future time, if you need to install on a new computer, and so on.</p> <p>Step #1: Go to the fancy new <a href="http://www.microsoft.com/express/download/" target="_blank">Download Page</a>, using the menu bar at the top of the development-center page (above):</p> <p align="center"><a title="Download Page for VS 2008 Express Editions" href="http://www.microsoft.com/express/download" target="_blank"><img src="http://mpauia.bay.livefilestore.com/y1pSnwPiUtxyHcoENQeyx1wc8XQgC8wbWJMAF7EpIK2ktbJhB8xQFfMqG1dL-siOODpBsY1pRW3N6R-zsuKe7F_jA"></img></a></p> <p>While you are here, notice that</p> <ul> <li>The top of the page offers web installs of the individual VS 2008 Express Edition components.&nbsp; I do not recommend this approach.&nbsp; It's here as a convenience.&nbsp; I prefer having recorded media that I can use whether or not I have a connection, whether or not the download is still available.<br>&nbsp;&nbsp; <li>Notice that there is an MSDN Express edition that is now downloadable separately.&nbsp; This is part of the packaging differences.&nbsp; Remember that you saw that here.<br>&nbsp;&nbsp;&nbsp; <li>There is a menu item for <a title="Offline Install provides the DVD image to download" href="http://www.microsoft.com/express/download/offline.aspx" target="_blank">Offline Install</a>.&nbsp; I want you to want that.</li></ul> <h3>The DVD Image Download</h3> <p>If you scroll down the main download page (above), you'll see that there is a DVD download option below the different web install invitations:</p> <p align="center"><img src="http://mpauia.bay.livefilestore.com/y1pSnwPiUtxyHesV_0uclkDPANjj0f1VabHHsvC7bcz7E3QaqUhdtySo5ejfbcrto9yxx-n4swP8bdS3OSJAYM18g"></p></img> <p>This is how I selected my DVD download.&nbsp;&nbsp; If you click the Offline Install link at the top of the download page, there is a more-detailed page with more information about burning DVDs and other options:</p> <p align="center"><a title="Instructions on the VS 2008 Express Edition Offline-Install Downloads page" href="http://www.microsoft.com/express/download/offline.aspx" target="_blank"><img src="http://mpauia.bay.livefilestore.com/y1pSnwPiUtxyHcPNv0J6ZGdu-r6DSAbnxdMfbOePoPpTcFi2hllvqciuhoDP8mWYpvsedhecNlBGdKPwAUXx-hARQ"></a></p></img> <p>Either way, the first step is to perform the download.&nbsp; You should perform a standard download to a handy place on your PC:</p> <p><img style="margin: 0px 10px 5px 0px" src="http://mpauia.bay.livefilestore.com/y1pSnwPiUtxyHfScpQ_l2mQi_NtNiwaNR8OcRaXON8Wj3U4SfO-SBmH86pEpgoNGaVtg0JUWtSKctwovPW3wCoyRw"></img><img style="margin: 0px 0px 5px 10px" src="http://mpauia.bay.livefilestore.com/y1pSnwPiUtxyHdysfKJtkP40YZxPr2xjbPpbHCh6w5xAafvJBmLxvz4y0Bn1eVenkwJKP5DFMKeavHS2rgCxZjoIg"></p> <p><img style="margin: 0px 0px 5px 10px" src="http://mpauia.bay.livefilestore.com/y1pSnwPiUtxyHdf7Si0Mv7pIQqWiq3gVHH7x_WGnhXfFFyahcBJ_4Dtqj1MCpWOSRuHffCtMJdxKN8O8c1blapT4Q" align="right"></img>My first download stalled at 33% and would go no farther.&nbsp; I cancelled that download and started another.&nbsp; That time, the full 894MB landed safely on my computer.&nbsp; </p> <p>The next action is making a DVD from the image file.&nbsp; I won't attempt anything else until I have the DVD and can explore it as part of choosing how I want to do the installation, and on what machine.</p> <p>Meanwhile, if you have been using Visual C++ 2005 Express Edition, or because you simply want to have it, now is a good time to download its Offline Install CD-ROM image.&nbsp; At some point, the VS 2005 Express Edition material may become more difficult to locate.&nbsp; Obtain the CD-ROM and use it to back yourself up.</p> <h3>Additional Information</h3> <ul> <li>There is a <a href="http://www.microsoft.com/express/support/faq/" target="_blank">FAQ page</a> for the VS 2008 Express Editions.&nbsp; Please note the intended audience and the limitations of the Express Editions in contrast with the commercial VS 2008 Standard Edition and higher offerings.<br>&nbsp;&nbsp; <li><strong>Good News:</strong> The PSDK is no longer a separate install.&nbsp; There is an integrated version of the Platform SDK as part of the Visual C++ 2008 Express Edition.&nbsp; More details as further exploration is conducted.<br>&nbsp;&nbsp; <li>The <a href="http://forums.microsoft.com/MSDN/default.aspx?ForumGroupID=35&amp;SiteID=1" target="_blank">Forums for the Express Editions</a> have been consolidated for support of VS 2005 and VS 2008 Express Editions release versions.&nbsp; When asking questions on the VC++ Express Edition forum, please be careful to specify whether it applies to the VC++ 2005 or VC++ 2008 Express Edition.</li></ul> <hr> <small> <p>[<strong>update 2005-11-26</strong>: I added a link to a tutorial on making CD/DVD discs from the downloaded <font face="monospace"><strong>.iso</strong></font> image files.<br>&nbsp;<strong>update 2007-11-20T06:51Z: </strong>I corrected a wording and added more about 2008 upgrading 2005 projects and needing to learn how to prevent that.&nbsp; There are some image links that were to the wrong pages, too.]</p></small>  <div style="clear:both; padding-bottom:0.25em"></div>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2007/11/vc-novice-visual-studio-2008-express.asp">11/19/2007 02:34:00 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2007/11/vc-novice-visual-studio-2008-express.asp">
       </script> data by <a href="http://www.newsgator.com">NewsGator 
                             Online</a><!-- 2004-10-28 --></span>
        ...
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7336679&postID=2018139386896906933">Post a Comment</a>
		</div>
