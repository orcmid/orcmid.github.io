...
<!-- PROFESSOR VON CLUELESS BLOGGER.COM TEMPLATE
  ...
  $$Header: /nfoCentraleMSbCentralWeb/orcmid/BlunderDome/clueless/2004_10_24_clu-chive.asp 2     05-01-22 13:40 Orcmid $
  -->

<head>
<title>Professor von Clueless in the Blunder Dome: 2004-10-24</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<td bgcolor="white" colspan="2" valign="top" align="left">
      ...
      <h3><a name="Thursday, October 28, 2004" href="#Thursday, October 28, 2004">
          <font color="#660000">Thursday, October 28, 2004</font></a></h3>
   	

	<div class="posts">
	<a name="109579627115423296"></a>
    
    <h2><font color="#000080"><!-- 2004-08-31 -->
    <a href="http://www.f-secure.com/weblog/#00000298"
                    title="external link">
    ...
    <p>
	<a href="http://www.f-secure.com/weblog/#00000298">F-Secure : New Java Applet Trojan</a>.&nbsp; 2004-09-21: I've been slugging away building a Java development setup for the great <em>Numbering Peano</em> escapade.&nbsp; One part of demonstrating the grounding of code includes providing an account of the tools I used and the version of Java (J2SE 1.4.1 SDK 1.4.1_02) that you can confirm my tests with.&nbsp; I already knew that this build isn't supported any longer, and I was going to refresh anyhow as part of my XPSP2 upgrade, but now I've got a new problem:&nbsp; Security exploit against the Sun Java Runtime.&nbsp; Yippy Skippy.&nbsp; OK, <em>after</em> I send in my proposal to commence my M.Sc in IT Dissertation Project, I will do a refresh to the nearest higher-numbered release that doesn't have this flaw and reconfirm the little bit of code that I am using so far.<br /><br />The <a href="http://sunsolve.sun.com/search/document.do?assetkey=1-26-57221-1&searchclause=57221">Sun Alert Notification</a> is <em>one year old</em>, and the apparent reason that F-Secure mentions it now is because there is an exploit in the wild.&nbsp; Dangnabit.<br /><br />Then I need to check other Java Security Bulletins to see what else there is to upgrade beyond.&nbsp; Ah hah.&nbsp; Okey dokey.<h3>It looks like I need to be at 1.4.2_05 at least</h3><a href="http://sunsolve.sun.com/search/document.do?assetkey=1-26-57613-1&amp;searchclause=Java">Java Runtime Environment May Allow Untrusted Applets to Escalate Privileges</a>.&nbsp; 2004-09-21: Well, here's another vulnerability, in J2SE 1.4.2_04 and earlier (and some 1.4.1 and 1.4.0 builds too), so I might as well move higher.&nbsp; According to the 2004-08-02 bulletin, the safe move is upgraded t0 1.4.2_05.&nbsp; We'll just have to see about that.&nbsp; And now that I have delayed putting these clippings in my face where it will do some good, I must remember to get the latest information, again before I download updates.&nbsp; Oh, woe is me ...
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://orcmid.com/BlunderDome/clueless/2004/10/uh-oh-time-to-refresh-java.asp">10/28/2004 11:43:49 PM</a>,
       rating 
       <script src="http://www.newsgator.com/ngs/ratings.aspx?rurl=http://orcmid.com/BlunderDome/clueless/2004/10/uh-oh-time-to-refresh-java.asp">
 		...
 		<div class="blogComments">
			...
			<div class="blogComment">
				&nbsp;<br /><a name="109906852246458099"></a> 
				Yes, I do have a backlog of draft postings!&#160; This old one is here because it looked like the simplest thing I could do to force refresh with a new template that removes an annoyance (for me) and also tries out the rating system that NewsGator Online has introduced.<br />
				<div class="byline">
                  <a href="http://orcmid.com/BlunderDome/clueless/2004/10/uh-oh-time-to-refresh-java.asp#109906852246458099" 
                     title="permanent link">#</a>
                  posted by <a href="http://www.blogger.com/profile/963786">orcmid</a>: 
                  10/29/2004 09:48:42 AM
                </div>
                <span class="item-control admin-1585504753 pid-1762770988"><a style="border:none;" href="http://www.blogger.com/delete-comment.do?blogID=7336679&postID=109906852246458099" title="Delete Comment" ><span class="delete-comment-icon">&nbsp;</span></a></span>
			</div>
			
			<div class="blogComment">
				&nbsp;<br /><a name="110151224075670001"></a> 
				Well, no, 1.4.2_05 isn't safe either.  It is necessary to move up to 1.4.2_06 according to http://jouko.iki.fi/adv/javaplugin.html which reports a vulnerability discovered before April 29 and now repaired.<br />
				<div class="byline">
                  <a href="http://orcmid.com/BlunderDome/clueless/2004/10/uh-oh-time-to-refresh-java.asp#110151224075670001" 
                     title="permanent link">#</a>
                  posted by <a href="http://www.blogger.com/profile/963786">orcmid</a>: 
                  11/26/2004 03:37:20 PM
                </div>
                <span class="item-control admin-1585504753 pid-1762770988"><a style="border:none;" href="http://www.blogger.com/delete-comment.do?blogID=7336679&postID=110151224075670001" title="Delete Comment" ><span class="delete-comment-icon">&nbsp;</span></a></span>
			</div>
			
        <a href="http://www.blogger.com/comment.g?blogID=7336679&postID=109579627115423296">Post a Comment</a>
		</div>
