...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/08/all-clear-1.asp 5     26-03-22 14:10 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="109379650599614748">&nbsp;</a><br>
	<blockquote><br /><p style="BORDER-RIGHT: #ccccff 6px double; PADDING-RIGHT: 5px; BORDER-TOP: #ccccff 6px double; PADDING-LEFT: 5px; PADDING-BOTTOM: 5px; BORDER-LEFT: #ccccff 6px double; PADDING-TOP: 5px; BORDER-BOTTOM: #ccccff 6px double; BACKGROUND-COLOR: #99ff99" align="center"><br /><span style="color:#000080;"><b><big><br /><br /><i><big><big><big>All Clear: End of Test</big></big></big></i><br /><br /><br /><br />Any entries since the last<br /><br /></big></b></span><span style="color:#000080;"><b><big>"<i><a href="http://orcmid.com/construction/C000011B.htm" target="_top">Caution: Feed Testing</a></i>"<br /><br />announcement were part of the test activities.<br /><br /><br /><br />Consult the <a href="http://orcmid.com/status.htm">Site Status</a><br />page for further information.<br /><br /> </big><br /></p></b></span></blockquote><br />&#160;<br /><p>This confirms that the testing of incident-response preparations for the Orcmid's Lair blog are completed and the blog is no longer locked down.  Although similar notices were placed in the site feed during testing, those manually-injected announcements are obliterated when the automated feed produced by Blogger.com is reinstituted.&#160;  This message marks closure of testing and other preparations in the "permanent" feed.</p><p>As part of the institution of consistent incident-response procedures for Orcmid's Lair and related blogs, the URL for the Orcmid's Lair blog has been simplified to &lt;<a href="http://orcmid.com/blog/"><strong>http://orcmid.com/blog/</strong></a>&gt;.&#160;  That's all you need.&#160;  It will be faster to use this than be redirected from the previous URL, so please update any shortcuts you have to this blog.<br /><br /></p><br>
	<span class="byline">posted by orcmid at <a href="http://orcmid.com/blog/2004/08/all-clear-1.asp">8/29/2004 09:20:45 AM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=109379650599614748">Post a Comment</a>
		</div>
