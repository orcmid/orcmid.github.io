...
<!-- 2004-06-27-17:40 -0700 Add Castle Clueless to the list of associated blogs -->
<!-- 2004-06-27-17:48 -0700 Fix the path to the "Atom Feed" button to work absolutely -->
<html>
<head>
...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/08/pent-up-blogophilia.asp 5     26-03-22 14:10 Orcmid $-->
        <base target="_top">
<style>
...
<div class="links">
	...
	<br>
        <a href="http://orcmid.com/blog/lair-atom.xml" target="_top"><img border="0" src="http://orcmid.com/blog/atom-feed.bmp" alt="Click for Atom feed"></a>
        ...
        <a href="http://orcmid.com/BlunderDome/clueless/">Prof. von Clueless in the Blunder Dome</a></p>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
    	...
    	<h2><a name="2004-08-29" href="#2004-08-29"><font color="#660000">2004-08-29</font></a></h2>
   	

	<div class="posts">
	<a name="109380186156270621">&nbsp;</a><br>
	It has been difficult to withhold myself from blogging while I do some important scaffolding around being able to recover from a variety of misadventures here.  It helped that I was in an 8-week on-line course that also demanded my attention.  But that was then, and now I don't have to get a typing fix by spewing comments onto <a href="http://radio.weblogs.com/0001011/">Scobleizer</a> so much.<br /><br />I did allow myself to accumulate drafts on Blogger.com, and now I have to see what I have. In addition to that material, I already thought of several new postings that I will be building somewhere around here: <blockquote><ul><li><strong>A way of Living:</strong>  Joi Ito and Tim Bray in common</li><li><strong>What's Your Scoble Number?</strong>  Something that the blogosphere has altered forever</li><li><strong>Throw 'Em a Phish:</strong> I managed to decode a couple of phishes and they are indeed wonders to behold.</li><li><strong>Personal Refactoring:</strong>  How Do I Unravel this Knot?</li><li><strong>ODMA Is Ten This Year:</strong>  The little middleware bridge that could forges ahead.</li><li><strong>Blogger:</strong>  Here's a Good Thing. While I'm sulking over Blogger, they begin to fill in the blanks for people who want to do more and understand more, with a great update to their user Help and Support Status.  There's just that little thing about privacy that nags me now.</li><li><strong>Meme Mimicry</strong>.  So, is it thought control or the hundredth monkey?</li></ul></blockquote><p>I will stop now before I overwhelm myself.  These will show up here or over in Professor von Clueless's place.  Oh, yeah.  I need to get that blog up and operating before I get too carried away.</p><p>Later.  Heh.</p><br /><br>
	<span class="byline">posted by orcmid at <a href="http://orcmid.com/blog/2004/08/pent-up-blogophilia.asp">8/29/2004 10:50:01 AM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=109380186156270621">Post a Comment</a>
		</div>
