...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/06/accountability-and-transparency-for.asp 5     26-03-22 14:10 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
    	...
    	<h2><a name="2004-06-14" href="#2004-06-14"><font color="#660000">2004-06-14</font></a></h2>
   	

	<div class="posts">
	<a name="108722380336812021">&nbsp;</a><br>
	<h3>Accountability and Transparency for Credibility</h3><a href="http://www.masternewmedia.org/news/2004/06/13/critical_factors_in_gaining_online.htm">RG News: Critical Factors In Gaining Online Credibility</a>.&nbsp; Here's a great checklist and some links on the conditions that have a web site be considered credible and trustworthy, at least as a provisional judgment by visitors.&nbsp; I am fascinated by how many of the items involve establishing some personal level of visibility along with accountability for the site itself and what is offered.  The general thrust is toward transparency as a means to building a trust relationship.<br /><br />A key aspect is establishing a track-record of dependability.&nbsp; I would add that the greatest test is how breakdowns are handled.&nbsp; What do you do when there's a mess, and what does that show you can be counted on.<br /><br />I suppose that reputation building is a factor as well.  <br /><br />I'm redesigning my <a href="http://NuovoDoc.com/">consulting-practice and ISV site</a>, and these are matters I intend to address, especially as I shift my focus to more-personalized areas of computing.<br>
	<span class="byline">posted by orcmid at <a href="http://orcmid.com/blog/2004/06/accountability-and-transparency-for.asp">6/14/2004 03:27:23 PM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108722380336812021">Post a Comment</a>
		</div>
