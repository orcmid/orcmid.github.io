...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/06/opened-academic-middleware-shifts.asp 5     26-03-22 14:10 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
    	...
    	<h2><a name="2004-06-05" href="#2004-06-05"><font color="#660000">2004-06-05</font></a></h2>
   	

	<div class="posts">
	<a name="108629162703785810">&nbsp;</a><br>
	<h3>Opened Academic Middleware Shifts Culture</h3><a href="http://www.acm.org/technews/articles/2004-6/0602w.html#item4">ACM News Service: Science Middleware Initiative Goes Open-Source</a>.&nbsp; There is expansion of the NSF Middleware Initiative (NMI) to include other open-source contributions from academic researchers.&nbsp; It is particularly interesting that unusual distributed collaborations are arising among institutions to handle common middleware requirements.  "Collaboration is ongoing between university middleware and grid programs and corporate-world counterparts, such as the Liberty Alliance and WS-Security, says Internet2 middleware and security director Ken Klingenstein."<br /><br /><a href="http://www.linuxworld.com.au/index.php/id;1260723106;fp;16;fpid;0">Nancy Weil's 2004-05-31 LinuxWorld article</a> provides more detail and potential links.&nbsp; The fascinating aspect for me is that this is fostering new cooperation models in academic research communities that don't seem so bound to grantsmanship and perishable publishing.<br>
	<span class="byline">posted by orcmid at <a href="http://orcmid.com/blog/2004/06/opened-academic-middleware-shifts.asp">6/5/2004 10:32:58 AM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108629162703785810">Post a Comment</a>
		</div>
