...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/06/cattle-driving-future.asp 5     26-03-22 14:10 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
    	...
    	<h2><a name="2004-06-19" href="#2004-06-19"><font color="#660000">2004-06-19</font></a></h2>
   	

	<div class="posts">
	<a name="108768020578069317">&nbsp;</a><br>
	<h3>Cattle-Driving the Future</h3><a href="http://www.looselycoupled.com/blog/lc00aa00040.html">Phil Wainewright: Avalon - Microsoft's Microchannel</a>, in his followup on Joel Spolsky's <a href="http://www.joelonsoftware.com/articles/APIWar.html">API Wars</a> article, Phil compares Microsoft's Avalon efforts to IBM's PS/2 and Microchannel misfire.&nbsp; I suppose that makes Microsoft's Bob interface the mate to PC Jr.<br /><br />Phil bases his speculation on Avalon GUI technology being delivered exclusively with Longhorn.&nbsp; Unless we are to believe that our existing applications won't run on Longhorn unless we convert to Avalon somehow, I don't see the danger.<br /><br />I have no idea whether the sharp minds at Microsoft want to confine Avalon to Longhorn as an attractor.&nbsp; It's not that I'd be surprised that Microsoft is positioning to serve more than one agenda by developing a very high-performance graphical capability.&nbsp; I just can't see that as an area of concern for me.&nbsp; I think I'm going to pay more attention to integrative technology (.NET and Web Services) that is already available.<br /><br />But I am left to muse about unspoken agendas and the Microsoft-IBM history.<br /><hr />Sometimes, unspoken agendas have us be wary.&nbsp; It's as if what isn't being said is shouted very loud on the human backchannel.&nbsp; I think it is natural to feel wary at those times.  <br /><br />Here, context is everything.&nbsp;  When Heathkit advertised "We won't let you fail," it was heard quite differently than IBM's expression of that.&nbsp; IBM is known historically for aggressive maintenance of "account control," and the PS/2 might well have been seen as a way of re-establishing a "franchise." <br /><br />I see in this a different insight than Phil's into the OS/2 fiasco.&nbsp; The breakup of Microsoft and IBM over OS/2 seems like a complements clash of the kind that Joel Spolsky has noticed: "<a href="http://www.looselycoupled.com/blog/lc00aa00040.html">smart companies try to commoditize their product's complements</a>."&nbsp;  From that perspective, we should not be surprised about the antagonistic breakups of partnerships where one company wants software to be nearly free and the other wants hardware to be nearly free.&nbsp;  That the guy with the franchise on the operating system owns the toll-booth for that particular racetrack is also not surprising, nor is the effort of hardware floggers to break away from that rat-race for their own mercantile purposes.<br /><br />In the game of "who do you trust" that customers are left to figure out, I think we should just notice where they put their money and where do they aggressively seek substitutes, realistically or not.&nbsp; I bet Avalon is not part of that equation.<br>
	<span class="byline">posted by orcmid at <a href="http://orcmid.com/blog/2004/06/cattle-driving-future.asp">6/19/2004 04:33:17 PM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108768020578069317">Post a Comment</a>
		</div>
