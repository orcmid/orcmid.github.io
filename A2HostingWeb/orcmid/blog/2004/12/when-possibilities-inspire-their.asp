...
<!-- ORCMID'S LAIR BLOGGER.COM TEMPLATE
     ...
     2002-10-31 Template modification adventures.  Add a configuration-
        ...
        title into a link
   $$Header: /nfoCentraleMSbCentralWeb/orcmid/blog/2004/12/when-possibilities-inspire-their.asp 1     05-01-21 21:40 Orcmid $
   -->
<head>
<title>Orcmid's Lair: When Possibilities Inspire Their Sources</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<div class="posts">
    <a name="110217765200071184"></a>
    
     <h2><font color="#000080"><!-- 2004-09-02 -->
	 <a href="http://radio.weblogs.com/0001011/2004/12/04.html#a8798" 
                     title="external link">
	 When Possibilities Inspire Their Sources
	 </a></font>
     </h2>
    

	<p>
    <a href="http://radio.weblogs.com/0001011/2004/12/04.html#a8798">Scobleizer: Microsoft Geek Blogger - New Book Born -- The Red Couch</a>.&nbsp; OK, Scoble was so energized by the interaction he had with one of his readers that he himself caught fire.&nbsp; I can be a little arch about this and say, "Scoble, see who you are for the world, it is now giving possibility back to you with interest?"<br /><br />Scoble is inspired to go completely off the charts with a proposal for a virtual collaboration leading to a book.&nbsp; He's declaring that the entire book will be developed by blogging, and then sold to a publisher on eBay.&nbsp; His initial brainstorming/FAQ makes me salivate and want to do something similar.&nbsp; I bet that the title sticks, too.<br /><br />Here's a completely transparent approach to collaborative work that is also its own dog food.&nbsp; You have to love that.&nbsp; I also love all the ways this is going to put kinks in our ordinarily proprietary, stingy way of hiding our work until it is done.&nbsp; Especially something that we fear has competitors in the timid mercantile, zero-sum view of the world that is aroused so easily.<br /><br />Last night I was looking at checklists on <a href="http://www.gantthead.com">Gantthead</a> (registration required, yadda yadda) and an entry about virtual projects caught my eye.&nbsp; It has to do with remote/distributed stakeholders and distributed developers too.&nbsp; I am going to look more closely because I want to see what is adaptable to conduct of an open-source effort that has strong community-contribution qualities.&nbsp; It is a specialized-niche community, but that makes for a nice small laboratory for perfecting an approach that may also work for greater undertakings.<br /><br />In the spirit of Scoble's work at public collaborative authoring, I think there is room for a little wikification here. In a sense, blogging with good and automatic tracking-back arrangements would provide a sort of distributed wiki of the kind I have in mind.&nbsp; But that's not what my project is about, and I am not going to derail myself from that commitment to address this.&nbsp; Hmm, it would be weird if MSN Spaces were the right kind of tool for this.&nbsp; I've been thinking of it as a toy, but it might be just the right toy.&nbsp; Heh. 
    </p>
	<span class="byline">posted by orcmid 
       at <a href="http://nfocentrale.net/orcmid/blog/2004/12/when-possibilities-inspire-their.asp">12/4/2004 10:48:13 AM</a></span>
	  
         <!-- 2004-05-10 -->
		<div class="blogComments">
			&nbsp;<br /><b><i>Comments:</i></b><!-- 2004-10-04 -->  
			
	    <a href="http://www.blogger.com/comment.g?blogID=3896669&postID=110217765200071184">Post a Comment</a>
		</div>
