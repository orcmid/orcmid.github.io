...
<!-- ORCMID'S LAIR BLOGGER.COM TEMPLATE
     ...
     2002-10-31 Template modification adventures.  Add a configuration-
        ...
        title into a link
   $$Header: /nfoCentraleMSbCentralWeb/orcmid/blog/2004/12/test.asp 1     05-01-21 21:40 Orcmid $
   -->
<head>
<title>Orcmid's Lair: TEST</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<div class="posts">
    <a name="110221207828330573"></a>
    
     <h2><font color="#000080"><!-- 2004-09-02 -->
	 <a href="http://www.becker-posner-blog.com/archives/2004/12/test.html" 
                     title="external link">
	 TEST
	 </a></font>
     </h2>
	...
	<p>
    <a href="http://www.becker-posner-blog.com/archives/2004/12/test.html">The Becker-Posner Blog: TEST</a>.&nbsp; I've never quite figured out what it means to spew a TEST message onto the ether.&nbsp; Does anyone want to know that it has been seen?&nbsp; If nobody responds, does a tree fall in the woods?&nbsp; I ponder weighty questions like that.<br /><br />While we all wait breathlessly for the Becker-Posner blog to get going, I figured I could do a trakback ping to this test posting that made it into the Becker-Posner RSS feed.&nbsp; The archive page seems to have comments and most everything else disabled.&nbsp; The test message is archived but is not shown on the default page.&nbsp; But the test reached me, so I want to speak up.&nbsp; I can use SimpleTracks and ping the trackback URL, even without an article back on my blog (tit-for-tat, that).<br /><br />My cleverness was for nought.&nbsp;  The SimpleTracks manual trackbacker reports that "An error occured. The TrackBack server said: Invalid TrackBack ID '567'".&nbsp; That's like getting to the bottom of the Cracker Jacks only to find no prize.&nbsp; A new emotion for this blogging life: dejection.<br /><br />
    </p>
	<span class="byline">posted by orcmid 
       at <a href="http://nfocentrale.net/orcmid/blog/2004/12/test.asp">12/4/2004 06:18:57 PM</a></span>
	  
         <!-- 2004-05-10 -->
		<div class="blogComments">
			&nbsp;<br /><b><i>Comments:</i></b><!-- 2004-10-04 -->  
			
	    <a href="http://www.blogger.com/comment.g?blogID=3896669&postID=110221207828330573">Post a Comment</a>
		</div>
