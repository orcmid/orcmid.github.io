...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/where-do-integration-agreements-live.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
    	...
    	<h2><a name="2004-05-26" href="#2004-05-26"><font color="#660000">2004-05-26</font></a></h2>
   	

	<div class="posts">
	<a name="108560752265250385">&nbsp;</a><br>
	<h3>Where Do Integration Agreements Live?</h3><a href="http://praxis101.com/blog/archives/000011.html">PRAXIS101: Interfaces, systems, engineering, and API's</a>.&nbsp; Anderbill and I have been pondering <a href="http://nfocentrale.net/orcmid/blog/2004/05/tss-article-mda-nice-idea-shame-about.asp">where meaning arises for interfaces</a>.&nbsp; He has found a relevant systems engineering account in terms of the building failure at Charles deGaulle airport.  Keep in mind that this speculation precedes the thorough analysis that will be undertaken to reach a conclusive understanding of the failure and its root causes.<br /><br />Just the same, the discussion of the airport failure is a great reminder that integration points introduce opportunities for misunderstanding.  This inspired anderbill to recall an example of two teams understanding the use of a TIFF image-property code differently, leading to an incoherent result between image-capture software and image-presentation software.&nbsp; This fits with many discussions of metadata coding and also of the general viability of the Semantic Web.<br /><br />Meanwhile, anderbill and I have taken our exploration of the syntax, semantics, and "what is coded where" out of sight until we have the crude initial exploration out of the way.&nbsp; We are already having fun discovering our misunderstanding of each other with regard to the chosen example and a <a href="http://nfocentrale.net/orcmid/blog/2004/05/tss-article-mda-nice-idea-shame-about.asp#108519274068979517">provocative comment</a> from anderbill.<br>
	<span class="byline">posted by orcmid at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/where-do-integration-agreements-live.asp">5/26/2004 02:38:34 PM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108560752265250385">Post a Comment</a>
		</div>
