...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/versioning-is-hard.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
    	...
    	<h2><a name="2004-05-27" href="#2004-05-27"><font color="#660000">2004-05-27</font></a></h2>
   	

	<div class="posts">
	<a name="108569136216872809">&nbsp;</a><br>
	<h3>Versioning Is Hard</h3><a href="http://www.25hoursaday.com/weblog/PermaLink.aspx?guid=9be4939b-737f-47cc-8672-8f08abd01a7b">Dare Obasanjo aka Carnage4Life - Versioning is Hard</a>.&nbsp; "One of the hardest problems in software development is how to version software and data formats. One of the biggest problems for Windows for years has been DLL Hell which is a versioning problem. One of the big issues I have to deal with at work is how to deal with versioning issues when adding or removing functionality from classes."<br /><br />Amen.&nbsp; Versioning is very nasty, and Dare proposes to provide a paper on the topic.&nbsp; Meanwhile, as part of <a href="http://nfocentrale.net/orcmid/blog/2004/05/where-do-integration-agreements-live.asp">an exercise</a> that I am doing with anderbill, the problem of versioning Java classes and interfaces just reared its ugly head.&nbsp; This is something I wanted to demonstrate before, and now I must do at least enough to have a running development of versions of a (single) abstraction work properly.<br>
	<span class="byline">posted by orcmid at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/versioning-is-hard.asp">5/27/2004 01:56:30 PM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108569136216872809">Post a Comment</a>
		</div>
