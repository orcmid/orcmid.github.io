...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/understanding-without-proof.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108352185838646663">&nbsp;</a><br>
	<a href="http://www.rattlesnake.com/notions/math-metaphor.html">Understanding Without Proof</a>.&nbsp; Posted by rattlesnake, this article looks at the George Lakoff and Rafael E. Núñez book, <em>Where Mathematics Comes From</em>.&nbsp; It also plays on Proof Without Understanding and uses a lengthy example inspired by a quotation from Benjamin Pierce.&nbsp; So there is something about chasing threads and noticing harmonies in all this too.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/understanding-without-proof.asp">5/2/2004 11:17:25 AM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108352185838646663">Post a Comment</a>
		</div>
