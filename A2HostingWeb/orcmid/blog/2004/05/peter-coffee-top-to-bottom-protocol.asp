...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/peter-coffee-top-to-bottom-protocol.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108440823733303908">&nbsp;</a><br>
	<h3>Top-to-Bottom Protocol May Pave Way to Security, How?</h3><a href="http://www.eweek.com/article2/0,1759,1591312,00.asp?kc=EWRSS03129TX1K0000612">Top-to-Bottom Protocol May Pave Way to Security</a>.&nbsp; Well, here's something that I also find intriguing, the lead statement that "Web services at every level could shorten lists of analogous problems requiring separate solutions."<br /><br />I can buy that.&nbsp; I am not so sure that security is the outcome, but this would seem to be why SOA and component-oriented integration is thought to be so promising.<br /><br />And Coffee stresses something else:  transparency and disclosure of what systems "do and how they do it, and the means by which I can tell them not to do those things that I don't like."  Peter favors the Web Services model, around interface contracts if you like, as a common language for coordinated operation and some consistent visibility that might afford uniform configuration and control.&nbsp; That's my impression, and I can see how it responds to one of my favorite questions: "Who's computer is it?"<br /><br />I don't think that employing this sort of framework and plumbing guarantees the result that Peter envisions, but it certainly could sort out as people narrow in on component-approaches that serve his concerns for transparency and sovereignty.<br /><br />The article is also inspired by John Shewchuk's <a href="http://msdn.microsoft.com/theshow/episode040/default.asp">view of communications infrastructure</a>, and that is worth exploring deeper.&nbsp; This answers the security tie-in: Shewchuk discusses the Indigo technologies for secure, reliable, transacted messaging ("based on" the Web services architecture).&nbsp; That's the security that is the focus here.&nbsp; We need to drag in Michael Howard's new pet question: "Against What Threats?"<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/peter-coffee-top-to-bottom-protocol.asp">5/12/2004 05:30:24 PM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108440823733303908">Post a Comment</a>
		</div>
