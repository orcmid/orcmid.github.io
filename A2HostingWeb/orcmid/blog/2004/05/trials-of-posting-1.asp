...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/trials-of-posting-1.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
    	...
    	<h2><a name="2004-05-15" href="#2004-05-15"><font color="#660000">2004-05-15</font></a></h2>
   	

	<div class="posts">
	<a name="108467430991788972">&nbsp;</a><br>
	<h3>The Trials of Posting #1</h3>I am very accustomed to posting using Blog It! (where I always post drafts) and using the Blogger Edit page where I promote drafts to published and sometimes make new creations.<br /><br />This moment, I am using a Blogger posting plug-in in NewsGator.&nbsp; I'm evaluating the prospects for this kind of posting.&nbsp; It seems too much like sending myself an e-mail.&nbsp; I don't have the context and sense of authoring that I have in other cases.&nbsp; With Blog It! (the Java scriplet that fits into a My Links URL) I have the page that I am "clipping" and filing in my blog.&nbsp; With the editor, I have the body of material I am working on, I have its preview, and I have the context of my existing current posts as well as any pages that I refer to while composing.<br /><br />Here, I'm simply in Outlook and, as I said, I feel like I'm writing e-mail to myself.<br /><br />It's time to see what this looks like and whether the operability of the plug-in has survived the great Blogger Reloaded upgrade.<br /><hr /><br />Well, that was interesting.&nbsp;  From now on I will ask to post drafts and see if that avoids sending crude draft out on my feed.&nbsp; There are also some style matters to deal with, and formatting to anticipate.&nbsp; This was a successful experiment, but it is a risk-ladden arrangement.  Next!  Confirming that I can e-mail to my Blogger blog.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/trials-of-posting-1.asp">5/15/2004 07:25:20 PM</a></span>
