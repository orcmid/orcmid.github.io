...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/bill-de-hra-rdf-meet-smartfrog.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108352095598826068">&nbsp;</a><br>
	<a href="http://www.dehora.net/journal/2004/05/rdf_meet_smartfrog.html">Bill de hÓra: RDF, meet SmartFrog</a>.&nbsp; This article spots some Hewlett Packard initiatives related to activating and managing distributed objects.&nbsp; Some of them are open-sourced (and in Java).&nbsp; One of the HP teams has support for the latest RDF and Owl specifications.&nbsp; Hmm ...<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/bill-de-hra-rdf-meet-smartfrog.asp">5/2/2004 11:02:14 AM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108352095598826068">Post a Comment</a>
		</div>
