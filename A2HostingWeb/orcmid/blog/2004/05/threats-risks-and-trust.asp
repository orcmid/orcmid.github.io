...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/threats-risks-and-trust.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
    	...
    	<h2><a name="2004-05-25" href="#2004-05-25"><font color="#660000">2004-05-25</font></a></h2>
   	

	<div class="posts">
	<a name="108551740975383441">&nbsp;</a><br>
	<h3>Threat, Risks, and Trust</h3><a href="http://weblog.infoworld.com/udell/2004/05/25.html#a1008">Jon's Radio: Threat Modeling</a>.&nbsp; Jon Udell has a nice sampling of the ideas of threat modeling and the new possibilities of computer-assisted support for creating, populating, and <em>maintaining</em> threat analyses using such models.<br /><br /><a href="http://blogs.msdn.com/michael_howard/archive/2004/05/24/140932.aspx">Michael Howard: Threat Modeling tool now available</a>.&nbsp; This is the lead that Jon Udell followed.&nbsp; Michael Howard shows where to download the tool and Udell illustrates its application.<br /><br />I notice that threat modeling is not independent of risk management, and has some of the same imperatives with regard to maintenance of a current analysis and risk identification.&nbsp; When  something changes, it is very important to rebuild the assessment and also update the model.<br /><br />Anderbill and I toy with the notion of "trust points."  This is about seeing all the places in a system where there is an occasion of trust.&nbsp; This work on threat modeling has me wonder what the relationship to trust modeling might be, though I can also see trust models as being at a different level.&nbsp; My own exercises, mostly in thought problems, have trust points be at very deep points in terms of detail.<br /><br />I don't have a clear picture of the relationship, if any, between trust and threat vulnerability.&nbsp; I am missing something.&nbsp; This may be a place to dig deeper (and also in the <a href="http://www.microsoft.com/downloads/details.aspx?familyid=60eadcd5-a00f-4f22-be40-30d0fda6b0ef&amp;displaylang=en">existing terminology</a> addressed to such matters).<br /><br /><br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/threats-risks-and-trust.asp">5/25/2004 01:36:25 PM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108551740975383441">Post a Comment</a>
		</div>
