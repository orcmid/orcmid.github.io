...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/following-conversation-turn-based-vs.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108465740075206703">&nbsp;</a><br>
	<h3>Following a Conversation: Turn-Based vs. Interrupted Threads</h3><br /><a href="http://www.emacswiki.org/cgi-bin/community?action=browse;id=TurnBasedVsInterruptedThreadMode">CommunityWiki: TurnBasedVsInterruptedThreadMode</a>.&nbsp; Here is a great discussion on how turn-taking or other threading of discussion takes place using Wiki pages.&nbsp; I am very interested about this, for myself, because I want to look at the <a href="http://nfocentrale.net/orcmid/blog/2004/05/federating-wikis-and-overlays.asp">Wiki-Blog-whatnot convergence</a> through common small things, and also see the different ways I can operate nfoWiki as a form of creation of a reference work.&nbsp; The wikipedia experience figures in here, for me.&nbsp; Great material and also some great links.&nbsp; (How one groks the connectivity structure -- site map -- of a wiki is another matter, and also how one might regulate the graph ... hmmm.)<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/following-conversation-turn-based-vs.asp">5/15/2004 02:43:04 PM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108465740075206703">Post a Comment</a>
		</div>
