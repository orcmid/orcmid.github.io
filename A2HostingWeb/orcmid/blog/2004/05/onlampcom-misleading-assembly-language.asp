...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/onlampcom-misleading-assembly-language.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
    	...
    	<h2><a name="2004-05-10" href="#2004-05-10"><font color="#660000">2004-05-10</font></a></h2>
   	

	<div class="posts">
	<a name="108421732410340238">&nbsp;</a><br>
	<a href="http://www.onlamp.com/pub/a/onlamp/2004/05/06/writegreatcode.html">ONLamp.com: Why Learning Assembly Language is Still a Good Idea [May. 06, 2004]</a>.&nbsp; Scrolling through this article, I also want to take exception to some simplistic claims.&nbsp; The sticking point for me is the unsupported claim, "Clearly, professional software engineers should strive to achieve this level of greatness is all their code. But the real question is, 'What makes code great?'"&nbsp; <br /><br />This gets into the business of exceeding expectations and also focusing on efficiency of execution without consideration of context and priorities.&nbsp; This might be what programmers think Software Engineers should strive for, but I want to suggest that the focus of Software Engineering is far broader and always suited to the context.&nbsp; The perspective here is oversimplified and decontextualized.&nbsp; That is a mistake.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/onlampcom-misleading-assembly-language.asp">5/10/2004 12:28:43 PM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108421732410340238">Post a Comment</a>
		</div>
