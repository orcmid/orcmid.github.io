...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/mamamusings-teaching-new-technologies.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108362618837533034">&nbsp;</a><br>
	<a href="http://mamamusings.net/archives/2004/05/03/teaching_new_technologies.php">mamamusings: teaching new technologies</a>.&nbsp; This is an interesting article about what it is like to be a teacher for a technological subject for which the content (and the precursor classes) advance rapidly.  At the same time, Liz also says something that gives me a lot to think about.  At first blush, I like the idea a lot:<br /><br />"The future, I think, is to let go of the traditional approach of teaching how to do things in a specific language, and instead offer a more studio-like environment in which students are given access to resources and tools, and then work on developing a project. (We teach most of our classes in 'studio mode,' but in most cases they’re far from real studio approaches—they’re lectures with occasional hands-on exercises.) Surprisingly, it’s the students who are often most resistant to this mode of teaching—we’ve successfully conditioned them to see school as a series of core dumps, and switching gears into a more user-directed model often generates resentment and confusion rather than enthusiasm and creativity."<br /><br />I think this ties to how we learn by exploring and doing and failing and figuring it out as we go, not in advance.&nbsp; I also think we learn when the learners generate the learning.&nbsp; I think the teacher should sit outside the circle, not in the middle.&nbsp; How do we do that?&nbsp; How do we make it satisfying for teachers to have empowered students?<br /><br /><br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/mamamusings-teaching-new-technologies.asp">5/3/2004 04:16:38 PM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108362618837533034">Post a Comment</a>
		</div>
