...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/orcmid-standing-in-users-world-and-not.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108433761645191123">&nbsp;</a><br>
	<h3>Reprise: Standing in the Users World ... And Not</h3><a href="http://nfocentrale.net/orcmid/blog/2004/05/stopdesign-new-blogger.asp">Orcmid: Standing in the User's World ... And Not</a>.&nbsp; Rather than feeding out updates of the same May 10 lament, I will bracket that monolog with this close-out entry.<br /><br />So, Blogger Reloaded is challenging, especially with the sudden change in document-organization model, and I have managed to wrestle it into submission.&nbsp; The posts prior to 2004-05-02 are the same they always were and I am not going to touch them with Blogger any more.&nbsp; Ever.&nbsp; Starting with May 2, the posts are following the new organization.<br /><br />I am still learning how to organize entries so that they and their comments fit together into some sort of cohesive body of material.&nbsp; The chasm from 3-by-5 card blogclippings to organized writing and presentation has not been crossed; now there's room to experiment and see how to add more sanity.<br /><br />I organized my normalization of the Blog on the web site rather than in the blog.  That worked better than to use the blog as a place to think things through, and I will continue to use that approach.&nbsp; For starters, I used a <a href="http://nfocentrale.net/orcmid/blog/C000000.htm">simple job jar</a> and diary technique that I have come to love.&nbsp; And I have enough <a href="http://nfocentrale.net/orcmid/blog/2004/05/">scaffolding</a> to keep this material surrounded.&nbsp; I'm even maintaining my <a href="http://nfocentrale.net/orcmid/blog/lair.template.asp">template</a> <a href="http://nfocentrale.net/orcmid/blog/lair-chive.template.asp">files</a> in FrontPage and, as for all of my web site material, I'm using VSS integration with IIS and FrontPage extensions for configuration management.&nbsp; That's not always evident because the files posted from Blogger don't show their checked-in identity, although they are all checked-in on a regular basis.<br /><br />I'm satisfied for now.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/orcmid-standing-in-users-world-and-not.asp">5/11/2004 09:53:49 PM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108433761645191123">Post a Comment</a>
		</div>
