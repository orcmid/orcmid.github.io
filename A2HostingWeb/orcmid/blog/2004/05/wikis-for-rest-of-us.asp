...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/wikis-for-rest-of-us.asp 4     26-03-22 14:10 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108575040721892851">&nbsp;</a><br>
	<h3>Wikis for the Rest of Us?</h3><a href="http://www.socialtext.com/weblog/040528bizwkwiki.html">Socialtext: Something Wiki This Way Comes</a>.&nbsp; This is a great high-level view of the introduction of wikis that riffs off of a BusinessWeek feature.<br /><br />There are suggestions about easy ways to begin using wikis via hosting services created for that purpose.  Although my goal in life is to bring all of that onto my own systems and reduce the use of intermediaries, taking the geek prerequisite out of the care and feeding of a wiki is a challenge.<br /><br />This assertion for Socialtext applies to social software generally, especially wikis and blog-wiki integrations: "Socialtext changes the way people work beyond making group communications more productive and effective. But beyond productivity, it changes the way people work by letting them adapt to a changing environment while developing a group memory."<br /><br />Which leaves me with a great theme to explore: Wiki -- Whose Memory Is It?<br>
	<span class="byline">posted by orcmid at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/wikis-for-rest-of-us.asp">5/28/2004 06:20:51 AM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108575040721892851">Post a Comment</a>
		</div>
