...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/css-zen-garden-beauty-in-css-design.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108368660822185021">&nbsp;</a><br>
	<a href="http://www.csszengarden.com/">css Zen Garden: The Beauty in CSS Design</a>.&nbsp; I was <a href="http://nfocentrale.net/orcmid/blog/2004_05_02_lair-chive.asp#108361370542996357">telling myself</a> that it is time to look into CSS and XHTML.&nbsp; This site suggests some amazing possibilities of that approach.&nbsp; I particularly like the home page and <a href="http://www.csszengarden.com/?cssfile=/099/099.css&page=0">Wiggles the Wonderworm</a>.<br /><br />[later: It strikes me that this example of brilliant software has much to offer in looking for the mathematical rigor in programming.&nbsp; How is it to be found here?&nbsp; What theory accounts for these results and ones not created yet?]<br /><br />[later: 2004-05-10] I am also thinking that this is a demonstration of how much of what we experience in software is emergent in situated usage and is not apparent in the design of the software, and certainly not in the implementation.&nbsp; It is valuable to notice that formal understanding is at a reductionary level neare the implementation and the emergent behavior arrives through empirical trial-and-error and heuristic adjustment that is not evident as such in the formalization.&nbsp; This is an important feature of engineered artifacts and it is not clear to me how this is accounted for in any rigorous way in treatment of the relationship among logic, language, computation, and mathematics.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/css-zen-garden-beauty-in-css-design.asp">5/4/2004 09:03:16 AM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108368660822185021">Post a Comment</a>
		</div>
