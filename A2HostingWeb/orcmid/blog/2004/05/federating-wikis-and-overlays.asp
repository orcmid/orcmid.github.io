...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/federating-wikis-and-overlays.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
    	...
    	<h2><a name="2004-05-14" href="#2004-05-14"><font color="#660000">2004-05-14</font></a></h2>
   	

	<div class="posts">
	<a name="108458783291777686">&nbsp;</a><br>
	<h3>Federating Wikis and Overlays</h3><a href="http://www.emacswiki.org/cgi-bin/community?action=browse;id=SubsetWiki">CommunityWiki: SubsetWiki</a>.&nbsp; This is an interesting discussion about federation of wikis and how that works when there are different authentications, authorizations, and whatnot of various communities that have different uses for particular layers/overlays/subsets.&nbsp; I think it gets weirder because the subsets are graphs, and the same node (or different flavors of the same node) might appear in multiple graphs.&nbsp; So, if the nodes have the same wikiLabels, and different visible content, it gets very tricky.&nbsp; I am not at all sure of the conceptual model that will work for people.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/federating-wikis-and-overlays.asp">5/14/2004 07:23:51 PM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108458783291777686">Post a Comment</a>
		</div>
