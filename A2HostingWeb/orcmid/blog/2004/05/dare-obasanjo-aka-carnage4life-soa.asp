...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/dare-obasanjo-aka-carnage4life-soa.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108362800928389984">&nbsp;</a><br>
	<h3>Small Things Loosely Connected</h3>I am stealing David Weinberger's meme because I am tired of writing headings and I want to somehow link up all of the material I have pointed at below.&nbsp; SOA is about architecture, but it is also about components, and it is here because this is when I noticed it.<br /><br /><a href="http://www.25hoursaday.com/weblog/PermaLink.aspx?guid=88d79765-0ba6-42eb-a84f-dd2c67de7f8a">Dare Obasanjo aka Carnage4Life - The SOA Hype Keeps Chugging Along</a>.&nbsp; Dare provides some examples of the extremes of SOA hype, and also provides some nice insider chat on who he listens to and where he sees useful content on SOA.&nbsp; I didn't even know that MSDN had an Architecture Journal, and I have picked up a couple of other blogs from this.&nbsp; I will ignore that I don't live that far from Redmond and MS is hiring.&nbsp; There is something important in all of these particular gleanings about RSS Bandit and having feeds work properly, but I haven't figured it out yet.&nbsp; What I do notice is that some blog pages require me to drop my mobile-code defenses to read them.  While this one is worth it, and so are the MSDN pages, I don't like having to do that.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/dare-obasanjo-aka-carnage4life-soa.asp">5/3/2004 04:46:06 PM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108362800928389984">Post a Comment</a>
		</div>
