...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/ideas-asylum-push-pull-click-click.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108351982233971110">&nbsp;</a><br>
	<a href="http://ideasasylum.com/weblog/2004_04_01_archive.php#108333605525022879">ideas asylum - Push, Pull, Click, Click</a>.&nbsp; That was actually a comment (attributed to David Ferguson) in the meta-assembler developed for the Univac III around 1963&nbsp; It goes back to a commercial that few will remember.&nbsp; It has been a nostalgic morning ...<br /><br />This article, spotted by Bill dehÓra, looks at the current RSS syndication model and considers whether a P2P model for aggregation and feeds would work better.&nbsp; This leads to a critical look at whatever the interaction model is to be, and Bill adds that maybe we should look at interactions even more broadly.&nbsp; I concur.&nbsp; There are some interesting links here.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/ideas-asylum-push-pull-click-click.asp">5/2/2004 10:43:10 AM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108351982233971110">Post a Comment</a>
		</div>
