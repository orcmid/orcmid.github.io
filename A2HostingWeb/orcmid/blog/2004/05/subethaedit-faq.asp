...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/subethaedit-faq.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108352547101355735">&nbsp;</a><br>
	<a href="http://www.codingmonkeys.de/subethaedit/faq.html">SubEthaEdit FAQ</a>.&nbsp; Well, um, no, there is not any cross-platform interoperability and apparently the design is trapped in the code or in Cocoa and elsewhere.&nbsp; It looks, from here, that this could really use Zeroconf a little better.&nbsp; On the other hand, the protocol used for concurrent editing without locking has been published and maybe that is what we need to get above this nice but narrowly-focused implementation (this solves a problem when getting concurrent edits to wikis and comments on blogs, too).<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/subethaedit-faq.asp">5/2/2004 12:17:01 PM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108352547101355735">Post a Comment</a>
		</div>
