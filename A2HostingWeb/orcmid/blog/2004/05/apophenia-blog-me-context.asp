...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/apophenia-blog-me-context.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108386976129152911">&nbsp;</a><br>
	<a href="http://www.zephoria.org/thoughts/archives/2004/05/06/blogging_out_of_context.html">apophenia: Blog Me Context</a>.&nbsp; <a href="http://www.zephoria.org/thoughts/"><strong>danah</strong></a> expands on something that has been nagging at me.&nbsp; My blogs are wildly out of context and I do want to organize and consolidate many of the ill-woven threads that I have accumulated.&nbsp; I am frustrated about that, as my reliance on throwbacks and blowbacks (and flashbacks) should demonstrate.&nbsp; I need threadbacks and laybacks and waybacks and some way to pull together, dismember, organize, and republish without making myself nuts.&nbsp; (A search engine over my archive would help, too.)&nbsp; And I don't want to damage the blog as it is (throwbacking being too icky already).<br /><br />My idea is to back out and look at the expectations that are being frustrated, arrive at some sensible requirements, define constraints on what technology must afford, and take another run at it.&nbsp; All without stumbling into the world-hunger solution, mind you.&nbsp; Ouch.<br /><br />Or, put simply, how do I get from blog as privately-contexted sticky notes to writings and the level of conversation that involves organized thought?&nbsp; Can I keep the blog around and lead from it to the refined materials?&nbsp; I have questions.<br /><br />[later 2004-05-10-22:33 -0700] The revamping of Blogger, as much as it irritates me (I am busy having to refresh about 100 posts to deal with the new posting model breaking my archives and my feeds), promises to provide better support for repurposing and the 3-by-5-card model of blog entries by having each post to a separate file, along with any comments on that entry.&nbsp; This approach has more promise for scaling, although the idea of having all these little files around gave me the shudders at first.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/apophenia-blog-me-context.asp">5/6/2004 11:56:20 AM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108386976129152911">Post a Comment</a>
		</div>
