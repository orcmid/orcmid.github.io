...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/who-killed-programming.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108492332705516130">&nbsp;</a><br>
	<h3>Who Killed Programming?</h3><a href="http://www.acm.org/technews/articles/2004-6/0428w.html#item5">ACM News Service: Is Programming Dead?</a>.&nbsp; In the blurb, Model-Driven Architecture (MDA) is identifed as the next big evolutionary step, still in programming.&nbsp; The enabling standards are considered to be the Unified Modeling Language (UML) and application architectures such as .Net and J2EE.&nbsp; The promise is for genuinely high-level application specification tools, supported by code-generation techniques from platform independent specifications.&nbsp; There is interesting mention of the automatic incorporation of operations that support autonomic computing.<br /><br /><a href="http://management.silicon.com/itpro/print.htm?TYPE=story&AT=39120223-39024675t-40000032c">The silicon.com Jon Collins 2004-04-23 article</a> lead is "MDA takes craft to new highs."&nbsp; There are no links, but interesting reader comments have accumulated.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/who-killed-programming.asp">5/18/2004 04:35:46 PM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108492332705516130">Post a Comment</a>
		</div>
