...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/communitywiki-intermap.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108351418664134095">&nbsp;</a><br>
	<a href="http://www.emacswiki.org/cgi-bin/community/InterMap">CommunityWiki: InterMap</a>.&nbsp; I use InterWiki mapping so rarely that I keep forgetting where to find the map and what it looks like.&nbsp; Here is an archetypical occurence.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/communitywiki-intermap.asp">5/2/2004 09:09:26 AM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108351418664134095">Post a Comment</a>
		</div>
