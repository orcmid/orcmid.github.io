...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/subethaedit.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108352497749387157">&nbsp;</a><br>
	<a href="http://www.codingmonkeys.de/subethaedit/">SubEthaEdit</a>.&nbsp; I missed the original <a href="http://www.corante.com/many/archives/2003/04/28/hydra_social_editing_at_etech.php">Shirky</a> spotting about this, and the discussion of CuWiN and Zeroconf led me back to it.&nbsp; I have a slight interest in editors, especially for friendly ones that can be configured or used or incorporated in Wikis and Blogs.&nbsp; The editor formerly known as Hydra is for MacOS X 10.2.8 or beyond, but since it runs over Apple Rendezvous, it should be portable enough for running on Zeroconf and some alternative like .NET or Java or something or all of the above.<br /><br />There is a comparison with version control systems that intrigues me, because one still wants that in collaborative editing too.&nbsp; I want to figure out how/whether that works, and what the integration is.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/subethaedit.asp">5/2/2004 12:09:19 PM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108352497749387157">Post a Comment</a>
		</div>
