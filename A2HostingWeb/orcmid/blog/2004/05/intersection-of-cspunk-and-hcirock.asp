...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/intersection-of-cspunk-and-hcirock.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108483748605966383">&nbsp;</a><br>
	<h3>The Intersection of CS.Punk and HCI.Rock?</h3><a href="http://trevor.typepad.com/blog/2004/05/browser_bowels.html">Trevor F. Smith: Exterior: Browser bowels</a>.&nbsp; Trevor observes that browsers live at an interesting intersection of the OS Highway.&nbsp; I am beginning to think of interactive information systems that way too.&nbsp; Trevor recommends a Dave Hyatt note on the heuristics of browser page loading/display/measurement for a taste of the magical roadway.<br /><br />I must save all of this for discussion with fellow math-droids who think that <a href="http://nfocentrale.net/orcmid/blog/2004/05/when-is-programming-mathematics-and.asp">programming is mathematics</a>.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/intersection-of-cspunk-and-hcirock.asp">5/17/2004 04:44:47 PM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108483748605966383">Post a Comment</a>
		</div>
