...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/inside-out-security.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108492214183566628">&nbsp;</a><br>
	<h3>Inside-Out Security</h3><a href="http://www.acm.org/technews/articles/2004-6/0428w.html#item13">ACM News Service: Security From the Inside Out</a>.&nbsp; The news blurb emphasizes that multilayered approaches are being employed to protect enterprise systems, although attack against applications is considered a specific area of weakness aggrevated by the lack of security focus during application development.<br /><br /><a href="http://techupdate.zdnet.com/techupdate/stories/main/Security_from_the_inside_out.html">The 2004-04-21 Dan Farber ZDNet article</a> provides more meat.&nbsp; It is not clear to me that the simulated-attack approach to application vulnerability detection is enough.&nbsp; I have been waiting to discover how attack detection system will help in repair/correction.  I suppose this is related to the still-mysterious autonomic repair promise.&nbsp; Oh, I can envision denial-of-service attacks that work by attacking the detection and fail-over provisions of a system.&nbsp; Tricky, tricky.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/inside-out-security.asp">5/18/2004 04:15:01 PM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108492214183566628">Post a Comment</a>
		</div>
