...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/praxis101wiki.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108422400927206525">&nbsp;</a><br>
	<a href="http://praxis101.com/">Praxis101Wiki</a>.&nbsp; Wowza, anderbill has a wiki up and running (and I have suppressed the link, because it is a private deal).&nbsp; It is an UseMod Wiki, for now, serving as a laboratory for anderbill and orcmid co-authoring on topics that are dear to our hearts.<br /><br />I am starting out by making myself an user and then learning how to use the editor password.&nbsp; I make several attempts at avoiding CamelCase and then gave up, using OrcmidArrives as my first-created page.&nbsp; This is getting exciting.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/praxis101wiki.asp">5/10/2004 02:20:03 PM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108422400927206525">Post a Comment</a>
		</div>
