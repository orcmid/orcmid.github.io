...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/many-to-many-matt-webb-and-practical.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108386637939370802">&nbsp;</a><br>
	<a href="http://www.corante.com/many/archives/2004/05/06/matt_webb_and_a_practical_guide_to_social_software.php">Many-to-Many: Matt Webb and a practical guide to social software</a>.&nbsp; This page links to some useful resources (that I will throwback), and I already resonate with the quotation on identity that Clay Shirky provides here.&nbsp; It turns out that "orcmid" has proven to be a far-more durable identity for me in cyberspace than my own name.&nbsp; There are many Dennis Hamiltons, but pretty much only one orcmid.&nbsp; I would definitely not want to mess that up.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/many-to-many-matt-webb-and-practical.asp">5/6/2004 10:59:00 AM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108386637939370802">Post a Comment</a>
		</div>
