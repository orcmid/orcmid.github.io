...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/bbc-news-technology-little-less.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108361060434650482">&nbsp;</a><br>
	<a href="http://news.bbc.co.uk/1/hi/technology/2949588.stm">BBC NEWS | Technology | A little less conversation</a>: "Fire, agriculture and the wheel are probably the only three transforming technologies that have been around long enough to have observable consequences for basic human physiology and psychology, so we should not expect too much from social software in the next 18 months."<br /><br />This is the article spotted by <a href="http://tresolini.org/andrew/words/archive/000007.html">andrew</a>.&nbsp; It is a lot of fun, as you might tell from the quotation.&nbsp; There is more on <a href="http://nfocentrale.net/orcmid/blog/2004/05/words-social-software-hype-alert.asp">how much is shallow</a> and fails to rely on serious work that has already been done and that could inform the social-software enterprise.&nbsp; This is one of those articles that one can use to stop and think.&nbsp; I suspect more of Bill's Blog will be like that too, and I am going to hook up to it.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/bbc-news-technology-little-less.asp">5/3/2004 11:56:30 AM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108361060434650482">Post a Comment</a>
		</div>
