...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/many-to-many-social-hardware-champaign.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108352259547680701">&nbsp;</a><br>
	<a href="http://www.corante.com/many/archives/2004/04/29/social_hardware_champaignurbana_mesh_project.php">Many-to-Many: Social hardware: Champaign-Urbana mesh project</a>.&nbsp; This is the Clay Shirky posting that has me think that P2P bootstrapping may have just gotten easier, especially for modest, self-selecting group overlays (whatever I mean by that).&nbsp; I need to now dig into the referenced articles, so I will do that now.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/many-to-many-social-hardware-champaign.asp">5/2/2004 11:29:36 AM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108352259547680701">Post a Comment</a>
		</div>
