...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/grand-old-rag.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
    	...
    	<h2><a name="2004-05-05" href="#2004-05-05"><font color="#660000">2004-05-05</font></a></h2>
   	

	<div class="posts">
	<a name="108379622394309731">&nbsp;</a><br>
	<h3>The grand old rag</h3><br /><br /><strong>Yankee Doodle Dandy</strong>.&nbsp; [added 2004-05-06-14:38]&nbsp; Last night, I saw a performance of "Yankee Doodle Dandy," the musical.&nbsp; It was difficult to be with the literal flag waving that occured on the stage.&nbsp; In the build-up to the flagstraveganza at the end of Act One, I though I heard the actor speak of "the grand old rag" that had flown at the battle of Gettysburg.&nbsp; We lofted from there into "You're a Grand Old Flag," and I suppose its true.  <br /><br />More difficult was the Act Two opener, "Over There."&nbsp;  What a contrast between the optimism of yesteryear and the reality of today.&nbsp; Now, how proudly does it wave?&nbsp; I feel ashamed.<br /><br /><a href="http://web.amnesty.org/library/eng-usa/index">Amnesty International - Library - Usa</a>.&nbsp; There is a "No Torture" icon that David Weinberger posted and that links to Amnesty International.&nbsp; I want a more specific statement for myself, and the red-white-and-blue to go with it.&nbsp; This is something I captured while looking for a way to express that.&nbsp; The point for me is that the Rule of Law should prevail above all else where the Star Spangled Banner stands.&nbsp; We have nothing as a democracy if we don't have trusting each other to govern ourselves and to abide by the rule of law, freely accepted.&nbsp; That we think there is any place off the battlefield where that does not hold strikes me as ethically unsupportable and morally repugnant.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/grand-old-rag.asp">5/5/2004 03:30:15 PM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108379622394309731">Post a Comment</a>
		</div>
