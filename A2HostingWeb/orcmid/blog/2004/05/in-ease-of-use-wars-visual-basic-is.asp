...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/in-ease-of-use-wars-visual-basic-is.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108440699110185659">&nbsp;</a><br>
	<h3>In the Ease of Use Wars, Visual Basic is the Benchmark</h3><a href="http://www.eweek.com/article2/0,1759,1586352,00.asp?kc=EWRSS03129TX1K0000612">Rational Extends WebSphere Tool Lines</a>.&nbsp; Well, I am looking through a number of articles that talk about how enterprise development is being made simpler, and that Java-focused application development tools are being extended for ease-of-use.&nbsp; Ahem, and the benchmark is (tearing open the envelope): Microsoft Visual Studio and Visual Basic.<br /><br />OK, so now there's a calibration on what may be meant by keeping things simple.&nbsp; I need to think about this.&nbsp; Maybe tomorrow.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/in-ease-of-use-wars-visual-basic-is.asp">5/12/2004 05:09:45 PM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108440699110185659">Post a Comment</a>
		</div>
