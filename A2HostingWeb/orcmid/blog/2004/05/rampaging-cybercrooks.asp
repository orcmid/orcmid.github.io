...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/rampaging-cybercrooks.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
    	...
    	<h2><a name="2004-05-19" href="#2004-05-19"><font color="#660000">2004-05-19</font></a></h2>
   	

	<div class="posts">
	<a name="108498206289192456">&nbsp;</a><br>
	<h3>Rampaging Cybercrooks</h3><a href="http://blog.ziffdavis.com/coursey/archive/2004/05/18/1042.aspx">Frightening Security</a>.&nbsp; Recently, I was enthralled by an account of how difficult it is to detect and remove zombieware from our machines.&nbsp; Next, I ran into a klez.h deposited deep in the bowels of an administrative MSN directory on my machine.&nbsp; I can recall when my system was vulnerable (I had to do a registry recovery), and it still bothers me that the penetration must have occured through other than e-mail.&nbsp; I have not done the forensics to be satisfied that my system is clean and that I understand the infection vector.<br /><br />Today, David Coursey mentions a discussion where it landed "how really frightening this whole security thing has become.&nbsp; Professional cybercriminals, working on a global basis, are a serious threat and not enough is being done.&nbsp; There is a danger that the value the average consumer places on the Internet could soon be overwhelmed by the threat of what might happen if they do use it.&nbsp; Goodbye Internet?"<br /><br />I use Zone Alarm Pro on my laptop, and I like it a lot except for a certain level of inscrutibility that comes with it being easy to use.&nbsp; (Is that necessary?&nbsp; I wonder.)&nbsp; I will look at the link to <a href="http://www.guidancesoftware.com/">Guidance Software</a> too.&nbsp; I confess that I have a concern that, whatever the intentions, cyber-protection organizations depend on the existence of cyber-criminality for their daily bread.&nbsp; How does one secure a safe neighborhood in an inherently unsafe (?) world?<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/rampaging-cybercrooks.asp">5/19/2004 08:54:41 AM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108498206289192456">Post a Comment</a>
		</div>
