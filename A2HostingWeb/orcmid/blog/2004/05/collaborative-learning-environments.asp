...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/collaborative-learning-environments.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108422051382116111">&nbsp;</a><br>
	<a href="http://www.criticalmethods.org/collab/2004/5/news.htm#1084180534290">Collaborative Learning Environments</a>.&nbsp; This is interesting on two counts.&nbsp; SCORM (described in the article) is a way to preserve content across eLearning systems.&nbsp; There is now an interest in making it more collaborative by providing for learner annotations and interactions.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/collaborative-learning-environments.asp">5/10/2004 01:21:31 PM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108422051382116111">Post a Comment</a>
		</div>
