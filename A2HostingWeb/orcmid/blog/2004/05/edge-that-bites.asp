...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/edge-that-bites.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108579030405131539">&nbsp;</a><br>
	<h3>The Edge That Bites</h3><a href="http://www.intertwingly.net/blog/2004/05/28/detente">Sam Ruby: Détente</a>.&nbsp; <a href="http://diveintomark.org/archives/blinks/2004/05/#b20040528175510">Spotted</a> by Mark Pilgrim, and noted on Sam's Feed earlier, this entry carries an amazing amount of information about edge cases.&nbsp; (I have one right here - my Blog This! tool doesn't capture the &lt;title> use of "é" in détente, so I have to paste it in from the little character-map tool.)&nbsp; This is a wonderful compilation of interoperability and coherence glitches.<br>
	<span class="byline">posted by orcmid at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/edge-that-bites.asp">5/28/2004 05:25:12 PM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108579030405131539">Post a Comment</a>
		</div>
