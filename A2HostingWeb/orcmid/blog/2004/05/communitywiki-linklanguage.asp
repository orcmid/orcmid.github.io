...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/communitywiki-linklanguage.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108380239576066169">&nbsp;</a><br>
	<a href="http://www.emacswiki.org/cgi-bin/community?action=browse;id=LinkLanguage;revision=23">CommunityWiki: LinkLanguage</a>.&nbsp; Another interesting page, about the value of WikiWords as links so that you get to have a HyperText way of digging out context, nuance, and so on.&nbsp; Murray Altheim adds zest to the soup by pointing out that conceptual integrity is not so easy and that the ontology forced by one target per WikiLink has its own problems.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/communitywiki-linklanguage.asp">5/5/2004 05:13:14 PM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108380239576066169">Post a Comment</a>
		</div>
