...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/thoms-blog-bill-thompsons-commentary.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108361159655289279">&nbsp;</a><br>
	<h1>Computing Milieux</h1><h2>Cooperative and Coordinated Computing</h2><h3>Mining the Blogosphere</h3><a href="http://bill.verity-networks.com/palimpsest/blogs/thom.php">thom's blog</a>.&nbsp; This is Bill Thompson's commentary, and it is as lively as I expected from the spotting that I traced.&nbsp; This guy is as weirdly organized as I am.&nbsp; This blog has a feed (well, three feeds and you choose your poison).&nbsp; And it is not the only blog for Bill Thompson.&nbsp;  There is the <a href="http://bill.verity-networks.com/billslog/">billblog</a>, which is not syndicated -- I think -- and which is referred to from thom's blog, so that kind of works.&nbsp; Then there is what the BBC on-line pages refer to as Bill's Blog, and these seem to be the collection of Friday articles, somehow related to billblog, but presented another way and published as articles, such as <a href="http://news.bbc.co.uk/1/hi/technology/3629599.stm">this one</a>.&nbsp; I am not sure how it all fits together, and I am sure that I haven't broken the code.&nbsp; I'll keep watching.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/thoms-blog-bill-thompsons-commentary.asp">5/3/2004 12:13:58 PM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108361159655289279">Post a Comment</a>
		</div>
