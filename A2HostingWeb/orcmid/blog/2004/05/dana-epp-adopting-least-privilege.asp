...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/dana-epp-adopting-least-privilege.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
    	...
    	<h2><a name="2004-05-28" href="#2004-05-28"><font color="#660000">2004-05-28</font></a></h2>
   	

	<div class="posts">
	<a name="108578451064097838">&nbsp;</a><br>
	<h3>Dana Epp: Adopting a Least Privilege Stance</h3><a href="http://silverstr.ufies.org/blog/archives/000612.html">Dana Epp's ramblings at the Sanctuary : Longhorn: Adopting a least privilege stance for users</a>.&nbsp; Encouraged and <a href="http://radio.weblogs.com/0001011/2004/05/28.html#a7613">spotted</a> by Scoble, this article provides some interesting links and a discussion of the stance one takes to foster secure installation of operating-system distributions.<br /><br />I like the idea of running with least privilege, and I went from Windows 98 to Windows XP Pro to be able to enjoy that kind of safe operation.&nbsp; If I could only make it work simply.<br /><br />Although Dana is talking about technical approaches, I think his comments and the Channel 9 commentary on running/installing as administrator point to something deeper.  I want to emphasize the notion of a "stance" and what it takes to institutionalize vigilant, pro-active attention to safety and security.  We have a long way to go.  I notice for myself that I want the benefits and I don't want to do the work.  Based on the alibis I read, I'm not alone in that.  A pervasive alteration of development culture and attitudes is required, and backsliding will always be the path of least resistance.<br>
	<span class="byline">posted by orcmid at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/dana-epp-adopting-least-privilege.asp">5/28/2004 03:48:40 PM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108578451064097838">Post a Comment</a>
		</div>
