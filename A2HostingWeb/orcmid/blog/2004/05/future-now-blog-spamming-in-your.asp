...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/future-now-blog-spamming-in-your.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108362673814046080">&nbsp;</a><br>
	<a href="http://blogger.iftf.org/Future/000411.html">Future Now: New comment spam attack</a>.&nbsp; Spammers are figuring out how to act badly on blog comment lists.&nbsp; <a href="http://www.iftf.org/people/apang.html">A.S.K.Pang</a> wonders if he should turn off comments altogether.&nbsp; I think this is one of the things that registration is good for.&nbsp; I know there is a reluctance for some people to register and there is also a desire for anonymity.&nbsp; Unfortunately, anonymity is the haven of the bad actors too.&nbsp; I guess I am going to be simplistic about this: You want to talk to me, you have to be williing to stand up and speak for yourself as yourself.&nbsp; Of course, I don't mind pseudonyms (so orcmid speaketh), but something that involves creating an useful association and that can't be conveniently mechanized to suit the spam business model.<br /><br />[later 2004-05-10: Well, comments have been enabled on the new version of Blogger, and they are working on this site.&nbsp; I allow commenting by anyone, but the process of gettting to a comment-creation window is a big clumsy.&nbsp; People may have more trouble with it than spammers, and that is a concern for me.&nbsp; For all of the human factors and UI redesign that was presumed to be invested, I don't understand the basis for some decisions that were made around usability.]<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/future-now-blog-spamming-in-your.asp">5/3/2004 04:25:41 PM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108362673814046080">Post a Comment</a>
		</div>
