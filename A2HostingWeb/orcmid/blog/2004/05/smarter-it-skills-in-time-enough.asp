...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/smarter-it-skills-in-time-enough.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
    	...
    	<h2><a name="2004-05-29" href="#2004-05-29"><font color="#660000">2004-05-29</font></a></h2>
   	

	<div class="posts">
	<a name="108584962033774207">&nbsp;</a><br>
	<h3>Smarter IT Skills in Time Enough</h3><a href="http://www.acm.org/technews/articles/2004-6/0528f.html#item12">ACM News Service - The Increasing Importance of Process Skills</a>.&nbsp; This blurb is a little scary, to the extent that it points to a dangerous dumbing-down of IT experience: "New technicians today may have the requisite knowledge of technology, but may lack an understanding of how their work affects business operations; they might, for example, patch a critical system during the middle of the business day without realizing the implications of that system crashing."&nbsp; I find that unreal, mostly because I don't see where operations management would allow that -- unless that is part of the inexperience equation.  There's a fetching analogy, that "putting such inexperienced and harried workers behind critical systems is like putting someone who has no driving experience or knowledge of driving laws behind the wheel of a Ferrari."<br /><br /><a href="http://itmanagement.earthweb.com/career/article.php/3359521">George Spafford's 2004-05-26 Datamation article</a> offers more perspective, especially on the need for maturing experience and how we may have outrun our ability to achieve that (along with our divided attention problems).&nbsp; Spafford does list a 5-point approach to moving forward:<ul><li>Formal IT Governance</li><li>Risk Management of Rapid, Destabilizing Technology Adoptions</li><li>Hiring for Process Maturity Skills</li><li>Establish Well-Accepted Professional Accreditation (as opposed to vendor-driven)</li><li>Fundamental Process Disciplines in Academic Curricula</li></ul>The <a href="http://www.itpi.org/home/default.php">IT Process Institute</a> is featured as a resource for further guidance.<br /><br />In short, "IT tools will come and go, but the processes learned along the way provide the real value."&nbsp; There must be room for "along the way" learning.&nbsp; I think this goes hat-in-hand with a bigger issue: institutional learning takes time and considerable experience over time, by individuals, teams, and the organizations in which they partake.<br>
	<span class="byline">posted by orcmid at <a href="http://orcmid.com/blog/2004/05/smarter-it-skills-in-time-enough.asp">5/29/2004 09:53:25 AM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108584962033774207">Post a Comment</a>
		</div>
