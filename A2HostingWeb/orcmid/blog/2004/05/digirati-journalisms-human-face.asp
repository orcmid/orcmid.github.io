...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/digirati-journalisms-human-face.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108585753701389416">&nbsp;</a><br>
	<h3>Digirati Journalism's Human Face</h3><a href="http://www.acm.org/technews/articles/2004-6/0528f.html#item15">ACM News Service: Publishing by Design - Time to Make Human Factors a Concern</a>.&nbsp; This blurb invites consideration that "insights into human-computer interaction (HCI) and design can solve many problems that currently limit the usability and appeal of digital mass communication, which is currently influenced by several false assumptions about convergence and traditional media."  In particular, there are different interface challenges that come with different (mass) communication platforms, and Human-Computer Interaction (HCI) principles suggest that there's "need for interaction design that satisfies individual users."&nbsp; The idea of context-applicable technologies is suggested as a way of dealing with situation as well as differing access-point constraints on presentation and interaction.<br /><br /><a href="http://ojr.org/ojr/workplace/1085015758.php">Nico Macdonald's 2004-05-20 article</a> in the Online Journalism Review goes more deeply into strongly-held poor assumptions and provides an useful appraisal of the ease-of-use conundrum.&nbsp; The article is the first in a series on HCI and design issues related to online journalism.<blockquote><dl><dt><em>See also:</em></dt><dd></dd><a href="http://nfocentrale.net/orcmid/blog/2004/05/semantic-web-needle-or-haystack.asp">Semantic Web: The Needle or the Haystack?</a> for tie-in to social software and integration<br /><a href="http://nfocentrale.net/orcmid/blog/2004/05/whats-it-all-about-objects-languages.asp">What's It All About? Objects, Languages, and Meaning</a> for attention to abstraction and metaphor<br /><a href="http://orcmid.com/blog/2004_04_04_lair-chive.asp#108145770883266251">Changing Lives Through Technology</a></dl></blockquote><br>
	<span class="byline">posted by orcmid at <a href="http://orcmid.com/blog/2004/05/digirati-journalisms-human-face.asp">5/29/2004 12:05:31 PM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108585753701389416">Post a Comment</a>
		</div>
