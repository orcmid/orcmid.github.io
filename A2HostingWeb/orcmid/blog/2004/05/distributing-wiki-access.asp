...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/distributing-wiki-access.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108499978156115815">&nbsp;</a><br>
	<h3>Distributing Wiki Access</h3><a href="http://www.emacswiki.org/cgi-bin/community?action=browse;id=DistributingWiki">CommunityWiki: DistributingWiki</a>.&nbsp; This discussion is related to distributed editing as well as cached transclusion.&nbsp; I find this to be intriguing.&nbsp; The complication of distributed editing is also taken into account.<br /><br />I want to handle the federated user case in something like this pattern, so that registered users of wikis don't have to introduce themselves newly in each wiki they register on.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/distributing-wiki-access.asp">5/19/2004 01:49:05 PM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108499978156115815">Post a Comment</a>
		</div>
