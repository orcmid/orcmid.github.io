...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/caveat-lector-valid-right.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108351543590323736">&nbsp;</a><br>
	<a href="http://www.yarinareth.net/caveatlector/archive/week_2004_05_02.html#e002949">Caveat Lector: Valid != Right</a>.&nbsp; I think Dorothea may be feeling better.&nbsp; Here's a lovely rant on the difference between having a valid XML and having the document be "right."&nbsp; A number of useful distinctions are introduced (and some examples of non-useful practices).<br /><br />There is a discussion of EAD but the link doesn't work at the moment.&nbsp; This reports on an unsuccessful effort to use a common process across some heterogeneous implementations of the same DTD.&nbsp; I suspect that Dorothea's suspicions are correct since, as far as I can tell, if you simply used Dublin Core attributes, the assurance of interoperability is only slightly better than the existence of the proverbial snowball.<br /><br /><br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/caveat-lector-valid-right.asp">5/2/2004 09:30:07 AM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108351543590323736">Post a Comment</a>
		</div>
