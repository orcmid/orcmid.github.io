...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/mauro-di-nasso-home-page.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108361652656239405">&nbsp;</a><br>
	<a href="http://www.dm.unipi.it/~dinasso/">Mauro Di Nasso Home Page</a>.&nbsp; Cool, the title of the home page is in English, and the page is in Italian.&nbsp; There is the occasional English phrase, and that is interesting too.&nbsp; There is material here that makes it worth practicing my clumsy lingua italiana.<br /><br />Remind me to tell you some day about when I was moved to learn Italian long before meeting Vicki and later learning that it was her life's dream to be in Italy (which is when I finally took concerted action to learn Italian).<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/mauro-di-nasso-home-page.asp">5/3/2004 01:35:33 PM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108361652656239405">Post a Comment</a>
		</div>
