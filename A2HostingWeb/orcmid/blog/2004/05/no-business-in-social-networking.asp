...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/no-business-in-social-networking.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108380056734499134">&nbsp;</a><br>
	<a href="http://www.eweek.com/article2/0,1759,1584928,00.asp">No Business in Social Networking</a>.&nbsp; Here's more on the good, bad, and ugly of Artificial Social Networks (ASNs).<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/no-business-in-social-networking.asp">5/5/2004 04:42:10 PM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108380056734499134">Post a Comment</a>
		</div>
