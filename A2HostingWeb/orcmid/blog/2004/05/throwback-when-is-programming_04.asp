...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/throwback-when-is-programming_04.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108382639925937893">&nbsp;</a><br>
	<strong>Throwback: When Is Programming Mathematics, and Vice Versa?</strong>  [posted 2004-05-05-23:49 -0700] I am making a space her for more elaboration on the topic introduced by the <a href="http://nfocentrale.net/orcmid/blog/2004_05_02_lair-chive.asp#108370243385113129">preceding note</a> and continuing to the <a href="http://nfocentrale.net/orcmid/blog/2004_05_02_lair-chive.asp#108380482788990412">end of these additions</a>.  It is an experiment involving making inserts between existing blog entries by interpolating between the time time stamps.  (Blogger lets me fudge the time on an entry.)<br /><br />[later: 2004-05-10-22:07] I now have a means to accept comments on these blog entries, so <strong>comments are now welcome</strong>.&nbsp; I have set my blog to invite registration, and I prefer that visitors do so although anonymous comments are also allowed.&nbsp; I reserve the right to delete any comment that offends my sense of civility.&nbsp; In such cases, I am willing to post links to material that I don't find appropriate for inclusion here, with appropriate disclaimers about linked content not being the responsibility of the present management.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/throwback-when-is-programming_04.asp">5/4/2004 01:25:03 PM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108382639925937893">Post a Comment</a>
		</div>
