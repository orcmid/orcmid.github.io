...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/blog-wiki-notes-text-discuss.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108507625710564555">&nbsp;</a><br>
	<h3>Blog-Wiki-Notes-Text-Discuss</h3><a href="http://scottwater.com/blog/archive/2004/05/20/MyLinksPage.aspx">My Links Page</a>.&nbsp; Scott Watermasysk builds .Text and invents other interesting goodies.&nbsp; Here, Scott asks about something he has tried out and receives some very constructive follow-ups.&nbsp; I like the organized links, and also the idea of some marginal links on some or all pages.&nbsp; The bigger deal is having control over all of that, and see if it can be moved up from the developer/programmer level.&nbsp; I haven't looked at the .Text model, and this is my reminder to do that.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/blog-wiki-notes-text-discuss.asp">5/20/2004 11:04:52 AM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108507625710564555">Post a Comment</a>
		</div>
