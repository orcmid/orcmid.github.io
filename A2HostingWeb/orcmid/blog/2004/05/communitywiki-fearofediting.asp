...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/communitywiki-fearofediting.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108378671523989783">&nbsp;</a><br>
	<a href="http://www.emacswiki.org/cgi-bin/community?action=browse;id=FearOfEditing;revision=3">CommunityWiki: FearOfEditing</a>.&nbsp; Here's an interesting Wiki page about the inhibitions people have about editing.&nbsp; This is not unrelated to other situations where people don't speak up, and there may be much to learn here.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/communitywiki-fearofediting.asp">5/5/2004 12:51:08 PM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108378671523989783">Post a Comment</a>
		</div>
