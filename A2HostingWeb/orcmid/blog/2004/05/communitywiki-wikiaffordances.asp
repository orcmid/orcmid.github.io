...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/communitywiki-wikiaffordances.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108458814935183988">&nbsp;</a><br>
	<h3>Wiki Affordances</h3><br /><a href="http://www.emacswiki.org/cgi-bin/community?action=browse;id=WikiAffordances">CommunityWiki: WikiAffordances</a>.&nbsp; Here's interesting reference to work by Gibson and also Don Norman on affordances of objects/artifacts.&nbsp; Some subtle affordances of this particular wiki, and some comparative discussions add to the discussion, which is just getting started.<br /><br />For me, this marker holds the questions: what are the affordances I have in mind for nfoWiki? and what is a way to specify them as -ility requirements?<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/communitywiki-wikiaffordances.asp">5/14/2004 07:29:28 PM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108458814935183988">Post a Comment</a>
		</div>
