...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/programma-lmm.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108361708262361277">&nbsp;</a><br>
	<a href="http://www.dm.unipi.it/%7Edinasso/lmm/programma.htm">Programma LMM (in Italian)</a>.&nbsp; Wow, how did I miss this guy.&nbsp; I downloaded some papers (I think) on infinity, on axiomatic methods from Euclid to Gödel, and so on.&nbsp; Here is a syllabus for a course of study on Language and Method of Mathematics.&nbsp; For me, this is hot stuff.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/programma-lmm.asp">5/3/2004 01:44:51 PM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108361708262361277">Post a Comment</a>
		</div>
