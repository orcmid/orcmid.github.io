...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/wi-fi-jamming-mischief.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
    	...
    	<h2><a name="2004-05-24" href="#2004-05-24"><font color="#660000">2004-05-24</font></a></h2>
   	

	<div class="posts">
	<a name="108544469324499290">&nbsp;</a><br>
	<h3>Wi-Fi Jamming Mischief</h3><a href="http://www.computerworld.com/securitytopics/security/story/0,10801,93221,00.html?nas=WK-93221">'Indefensible' Wi-Fi flaw discovered in 802.11b network protocol - Computerworld</a>.&nbsp; This Bob Brewin 2004-05-17 ComputerWorld article reports on the Denial of Service jamming attack that 802.11b is vulnerable to.&nbsp; This vulnerability is accomplished at the medium (the modulation scheme of 802.11b) and cannot be mitigated with current hardware.  (802.11a and uses of 802.11g in non-802.11b mode are apparently free of the defect.)<br /><br /><a href="http://www.kb.cert.org/vuls/id/106678">US-CERT Vulnerability Note VU #106678</a>  provides specific details and contrasts this vulnerability with other known vulnerabilities for IEEE 802.11.<br /><br />I am warming up for a security engineering course next month.&nbsp; This information reveals how there are multiple levels of vulnerability and trust points in network protocols.&nbsp; It is useful to wonder what form of risk management would lead to confinement and mitigation of these eventualities.&nbsp; It is also useful to recognize that our development of technology is error-prone from a safety and security perspective, and appreciate what it takes to create dependable results in the face of that.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/wi-fi-jamming-mischief.asp">5/24/2004 05:24:20 PM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108544469324499290">Post a Comment</a>
		</div>
