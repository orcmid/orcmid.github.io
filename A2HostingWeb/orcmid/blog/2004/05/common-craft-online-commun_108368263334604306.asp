...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/common-craft-online-commun_108368263334604306.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108368263334604306">&nbsp;</a><br>
	<a href="http://www.commoncraft.com/">Common Craft - Online Community Strategies</a>.&nbsp; Being really curious now, I go to the commoncraft (not CommonCraft nor Common Craft, though they are not sure about the second form, which is used most places other than the logo).<br /><br />It appeals to me that the site is done in a friendly and chatty voice, and that it is (oh, there's one) about CommonCraft, which is a very nice advance over ToolCraft (which tends to be separative and not common).&nbsp; I also learn from this site that there is a Social Software Alliance.<br /><br />The most-important part may be the the little blurb about a conversation with Ward Cunningham that gets into the fragility and the remarkable survival of civilizations, a metaphor for how wikis thrive through civility despite the hostile and anti-social elements afforded by the Internet.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/common-craft-online-commun_108368263334604306.asp">5/4/2004 07:57:22 AM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108368263334604306">Post a Comment</a>
		</div>
