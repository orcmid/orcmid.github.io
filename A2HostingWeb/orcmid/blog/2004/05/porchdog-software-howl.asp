...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/porchdog-software-howl.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
    	...
    	<h2><a name="2004-05-02" href="#2004-05-02"><font color="#660000">2004-05-02</font></a></h2>
   	

	<div class="posts">
	<a name="108352406228632862">&nbsp;</a><br>
	<a href="http://www.porchdogsoft.com/products/howl/">Porchdog Software: Howl</a>.&nbsp; This is the open-source implementation of Zeroconf that <a href="http://www.corante.com/many/archives/2004/04/30/spike_and_howl_less_is_more_and_zeroconf_is_a_lot_more.php">Shirky</a> spotted.&nbsp; It would be very interesting to see if this protocol is expressed in such a way that it can be a WAN overlay across NATs as well as working with direct wireless, IR, and port/modem connections among machines.&nbsp; (I keep forgetting that my Nokia 9000's have IR connectors and run as modems, though it saved my butt in an Atlanta hotel whose phone system had gone out.)<br /><br />I'm overloaded by the possibilities here, and I don't know that it means the Zeroconf protocol holds up.&nbsp; I really want a trivial P2P bootstrap, and this looks like it may be the avenue.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/porchdog-software-howl.asp">5/2/2004 11:54:15 AM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108352406228632862">Post a Comment</a>
		</div>
