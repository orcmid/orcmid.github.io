...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/i-want-mono-for-kissing.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108440650317572760">&nbsp;</a><br>
	<h3>I want Mono for KISSing</h3>Heh, heh, try that on your precise, unambiguous Semantic Web, pard<br /><br /><a href="http://www.eweek.com/article2/0,1759,1586734,00.asp?kc=EWRSS03129TX1K0000612">Mono Development Platform Moves into Beta</a>.&nbsp; Picking up on an older item as I add a news feed to my subscriptions, I am reminded that I am fascinated about Mono.&nbsp; I don't have any sensibility about Novell now supporting the effort as part of its Ximian acquisition, but I can see that there is serious momentum.&nbsp; I don't even have too much concern about C# 2.0 being developed at Microsoft while Mono is targeted against the current ECMA Specifications for the CLR and C# and other standards-based goodies.<br /><br />What is it that intrigues me?&nbsp; I think it is the ability to travel, and travel light.&nbsp; While Visual Studio, Eclipse, Sun One, and other GUI-based, graphically-oriented development platforms are climbing into the bloatsphere, there is a chance to maintain some simplicity without having to buy into someone else's idea of hiding complexity.&nbsp; I think it is something Peter Coffee is saying about developer discipline.&nbsp; Not only must developers strive to keep things simple in providing a computing experience, the developer's platform or framework should reflect the same perspective.<br /><br />I still don't know that I've captured my visceral affinity for Mono.&nbsp; I may also find that it is misplaced.&nbsp; This may be the real concern: I think the way we build up components in current Object-Oriented Technologies (C++, Java, C#, etc.) is too messy.&nbsp; I think that the intensification of design- and coding-time layering to somehow hiding the mess is a heavyweight solution that leaves way too much swept under the rug.&nbsp; I am not certain this trip is necessary.&nbsp; Granted that this has to do with <em>my</em> comfort level around managing (that is, isolating and limiting) complexity, I want to get to a lightweight place where I can see how the framework works and also see how to master the overall delivery process without overlays that obscure the integrity of the delivery of a confirmed configurable element (e.g., an installable program or a reusable component).<br /><br />I get to work this out in the coming months with some toolcraft projects I have in mind.&nbsp; Meanwhile, you can calibrate my perspective by my telling you that when I finally dug into Java this time last year, I used just the J2SE SDK, with 4NT and jEdit as my "development platform."  And I am still puzzling out how to work the package metaphor from initial experimental trials all the way to delivered code with JavaDocs.&nbsp; I will happily work through the same with Mono. <br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/i-want-mono-for-kissing.asp">5/12/2004 05:01:43 PM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108440650317572760">Post a Comment</a>
		</div>
