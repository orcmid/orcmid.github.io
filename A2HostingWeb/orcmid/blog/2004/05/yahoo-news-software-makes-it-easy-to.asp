...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/yahoo-news-software-makes-it-easy-to.asp 5     26-03-22 14:10 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108440234633372074">&nbsp;</a><br>
	<h3>Blogger Makes It Easier to Begin, Then ... ?</h3><a href="http://story.news.yahoo.com/news?tmpl=story&amp;u=/ap/20040512/ap_on_hi_te/tech_test_blogging&amp;e=1">Yahoo! News - Software Makes It Easy to Begin Blogging</a>.&nbsp; This is an interesting appraisal of Blogger and TypePad.&nbsp; I have to say that its appraisal of Blogger is close to my own, especially with the geekiness of HTML and related techie mysteries that have to be mastered, such as dealing with the markup that is inserted into edit windows for what are ordinarily WYSIWYG functions.&nbsp; I don't mind that, but I think it will be daunting to the new clientele that Blogger is entreating to cross its redesigned sign-up facade.&nbsp; This fits the writer's observation that Blogger is a nice way to get started, although it doesn't satisfy the hunger for more.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/yahoo-news-software-makes-it-easy-to.asp">5/12/2004 03:52:32 PM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108440234633372074">Post a Comment</a>
		</div>
