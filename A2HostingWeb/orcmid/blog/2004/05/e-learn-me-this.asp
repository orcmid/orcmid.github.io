...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/e-learn-me-this.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108584720477996716">&nbsp;</a><br>
	<h3>E-Learn Me This</h3><br /><a href="http://www.acm.org/technews/articles/2004-6/0528f.html#item10">ACM News Service: New E-Learning Tools</a>.&nbsp; I'm half-way through an <a href="http://orcmid.com/erudizione/M.ScIT/">M.Sc in IT program</a> that is delivered by distance learning.&nbsp; Everything is done on-line via computer-mediated communication (CMC).&nbsp; And I find it very difficult to relate this blurb to anything I recognize as E-Learning.&nbsp; It seems to be about applying learning algorithms to Interactive Tutoring Systems (ITS), and the learning algorithms are about machine learning.&nbsp; I can't tell whether the machine is learning, or the machine is supporting a human learning something, or if these are thought to be the same thing.<br /><br /><a href="http://www.emedia.com.my/TECH/BizComp/NewsAnalysis/20040527131206/wartrevamp">Chandra Devi's NSTRP e-media report</a> has more words, but my parser hasn't learned to gain more from it than in the original blurb, but for the final statement: "Overall, the [Canadian research Learning Objects Repositories Network (Lornet)] mandate is to make progress on the fundamental research required to support distance education."<br /><br />I might be happier if I understood what the linkage between "machine learning" and "distance education" is meant to be.&nbsp; On the other hand, maybe not.<br>
	<span class="byline">posted by orcmid at <a href="http://orcmid.com/blog/2004/05/e-learn-me-this.asp">5/29/2004 09:13:38 AM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108584720477996716">Post a Comment</a>
		</div>
