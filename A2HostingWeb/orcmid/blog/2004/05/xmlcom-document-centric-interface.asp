...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/xmlcom-document-centric-interface.asp 6     26-03-22 14:10 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
    	...
    	<h2><a name="2004-05-12" href="#2004-05-12"><font color="#660000">2004-05-12</font></a></h2>
   	

	<div class="posts">
	<a name="108441094536937079">&nbsp;</a><br>
	<h3>Document-Centric Interface Contracts?&nbsp; What??</h3><a href="http://www.xml.com/pub/a/2004/05/12/dotnet.html">XML.com: Document-Centric .NET [May. 12, 2004]</a>&nbsp; I wanted to pass over this feed topic, but "document-centric" caught me.&nbsp; Taking a look, I was caught by Eric Gropp's opening comment:<blockquote>The principle "program to an interface, not an implementation" helps control the complexity and enhance the flexibility of systems. XML interfaces are a natural extension of this principle that bring a number of new benefits in terms of flexibility, reusability, simplified code, and readiness for enterprise environments.</blockquote>The first lesson for me is that I must review my own breathless prose for meaningless sweeping claims.<br /><br />Here the puzzle for me is how XML interfaces <em>extend</em> that principle, especially considering the nuts-and-bolts level that we immediately dive into.&nbsp; OK, I do that too.&nbsp; Still, I think there are too many things jumbled in here, and there is lots of implementation of something-or-other.<br /><br />So, have we traded getting lost in one set of bits and inessentials (implementations) for the same trap in new cloths?&nbsp; Why is it that this simple example doesn't come across as simply-understandable as a demonstration of the power of interface agreements?&nbsp; It may be a tacit-knowledge trap where I lack the tacit knowledge of the intended audience.  If so, that needs to be understood better, at least.&nbsp; To be filed in my mysteries-of-toolcraft folder.<br /><br>
	<span class="byline">posted by orcmid at <a href="http://orcmid.com/blog/2004/05/xmlcom-document-centric-interface.asp">5/12/2004 06:15:59 PM</a></span>
		...
		<div class="blogComments">
			...
			<div class="blogComment">
				<a name="108464632762809651"></a> 
				Yeah, the intro was pretty heady.  I submitted a more practical version, but it didn't make it into the final cut.<br /><br />There is a lot of stuff piled into the article.  My intent was to show .Net developers a number of ways that they could produce and consume XML documents within their applications, without having to fiddle with low-level XML APIs.<br /><br />Your tacit-knowledge trap comment probably correct, and I am still looking for that single all-persuasive paragraph about interface contracts.<br /><br />Thanks for checking the article out.  -Eric G.  Portland, OR<br />
				<div class="byline"><a href="http://orcmid.com/blog/2004/05/xmlcom-document-centric-interface.asp#108464632762809651" title="permanent link">#</a> posted by Anonymous : 5/15/2004 11:38:47 AM</div>
				<a style="border:none;" href="http://www.blogger.com/delete-comment.do?blogID=3896669&postID=108464632762809651" ><img border="0" src="http://www.blogger.com/comments/delete/0/3896669" /></a>
			</div>
			
			<div class="blogComment">
				<a name="108656612195462891"></a> 
				Eric, I wanted to follow up with you about "looking for that single all-persuasive paragraph about interface contracts."&nbsp; I don't have the answer, but there is an experiment over on Numbering Peano (http://miser-theory.info/astraendo/pn/) that discusses interface contracts and is building toward demonstrating what is accomplished using a simple interface/API declaration.<br /><br />The xml.org site seems to be confused about automatic log-ins (and maybe cookies), so I put it into a URL loop when I go to comment on your article!<br />
				<div class="byline"><a href="http://orcmid.com/blog/2004/05/xmlcom-document-centric-interface.asp#108656612195462891" title="permanent link">#</a> posted by <a href="http://www.blogger.com/profile/963786">orcmid</a> : 6/6/2004 04:55:21 PM</div>
				<a style="border:none;" href="http://www.blogger.com/delete-comment.do?blogID=3896669&postID=108656612195462891" ><img border="0" src="http://www.blogger.com/comments/delete/963786/3896669" /></a>
			</div>
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108441094536937079">Post a Comment</a>
		</div>
