...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/meshing-net.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108492501348795627">&nbsp;</a><br>
	<h3>Meshing the Net</h3><a href="http://www.acm.org/technews/articles/2004-6/0505w.html#item17">ACM News Service: Mesh Networks Winning Converts</a>.&nbsp; Additional material on the appeal of wireless mesh networks points out that the mesh promises automated discovery, routing, and rapid handoffs, without single-points of failure.&nbsp; For those reasons, the ideas also matter to me with regard to self-forming peer-overlay structures for custom purposes.<br /><br /><a href="http://www.nwfusion.com/news/2004/0503mesh.html">The 2004-05-03 NetworkWorldFusion article</a> provides useful links as well as a list of resources.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/meshing-net.asp">5/18/2004 05:03:45 PM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108492501348795627">Post a Comment</a>
		</div>
