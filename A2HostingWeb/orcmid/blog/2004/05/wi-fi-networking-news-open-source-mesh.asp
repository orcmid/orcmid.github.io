...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/wi-fi-networking-news-open-source-mesh.asp 4     26-03-22 14:10 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108352283424057486">&nbsp;</a><br>
	<a href="http://wifinetnews.com/archives/003279.html">Wi-Fi Networking News: Open-Source Mesh Group Releases Software, Discusses Social Goals</a>.&nbsp; This is the article by Glenn Fleishman that Clay Shirky spotted.&nbsp; It is going to depend a little on how CUWiN actually bootstraps, and I can't tell from here.&nbsp; Also, this is another group that distributes open-source software by posting ISO CD-ROM images (urk) without source code.&nbsp; [Off topic: If the BSD license doesn't require you to say where to find the source, how did it qualify as an OSI-conforming license?  Or did I miss a stitch in the OSI requirements.]<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/wi-fi-networking-news-open-source-mesh.asp">5/2/2004 11:33:08 AM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108352283424057486">Post a Comment</a>
		</div>
