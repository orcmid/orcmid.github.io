...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/12-laws-of-customer-loyalty.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108430322862818862">&nbsp;</a><br>
	<h3>12 Laws of Customer Loyalty</h3><a href="http://marketingprofs.com/4/griffin1.asp">12 Laws of Customer Loyalty</a>.&nbsp; This Jill Griffin article was spotted by <a href="http://blog.fastcompany.com/archives/2004/05/11/loyalty_for_two.html">Fast Company</a>, with some additional commentary of interest.&nbsp; These laws are pretty straightforward, even though I have a slight ick response to "customer loyalty."&nbsp; But I don't see anything here that I couldn't restate without the ick to satisfy my own preference for being loyal to ones customers.&nbsp; The laws would not change so much, but the stand for the customer is more clear.&nbsp; Then customer loyalty (I want a better expression) would become a measure of how well one is serving the customer.<br /><br />I think I should look up loyalty in the dictionary, too.&nbsp; Maybe what I want to see is Relationship Excellence or something.&nbsp; No, I'm reaching.&nbsp; But I really like the ick test and the way the ick factor conversation gives us permission to directly declare where something lands off-kilter with us.&nbsp; More research, later.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/12-laws-of-customer-loyalty.asp">5/11/2004 12:20:55 PM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108430322862818862">Post a Comment</a>
		</div>
