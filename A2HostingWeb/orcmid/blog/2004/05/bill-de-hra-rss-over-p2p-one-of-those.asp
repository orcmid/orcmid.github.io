...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/bill-de-hra-rss-over-p2p-one-of-those.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108351914586538321">&nbsp;</a><br>
	<a href="http://www.dehora.net/journal/2004/05/rss_over_p2p_one_of_those_aha_moments.html">Bill de hÓra: RSS over P2P: one of those aha moments</a>.&nbsp; I am not taken with the pushing-tin theory and other observations here.&nbsp; I do think that the need to look at the interaction model of feeds.&nbsp; There is a recent observation about P2P bootstrapping that is done completely without reliance on a central service, and that strikes me as important for P2P, social software, and also coordination among blogs, wikis, and even service-oriented-architecture components.&nbsp; Let's go looking for more. <br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/bill-de-hra-rss-over-p2p-one-of-those.asp">5/2/2004 10:32:04 AM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108351914586538321">Post a Comment</a>
		</div>
