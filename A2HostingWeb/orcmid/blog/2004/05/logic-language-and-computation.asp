...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/logic-language-and-computation.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108362046624229485">&nbsp;</a><br>
	<h1>Logic, Language, and Computation</h1>I notice that, now that my Atom feed includes full articles, the formatting comes through in the feed because it isn't mangled by passing through a summarizer.&nbsp; Good move, Orc.&nbsp; So, I will put in headings and separators and not worry about them making trash in the feed.&nbsp; Mathematics, Logic, and Computation are a fascination of mine.&nbsp; It is also a passion of mine, though not at the rarefied level that serious theoreticians seem to deal with it.&nbsp; So it is easy for me to feel out of place and incompetent.&nbsp; That my fascination has me straddle two worlds that speak two different languages using the same words is something that I stumble on regularly.&nbsp; Meanwhile, here are some of my gleanings in this area.<h2>Studying Mathematics and Logic</h2>I just ran into a little goldmine of material in Italian because I was curious about a conference that I was sure I wasn't interested in.<h3>Language and Method of Mathematics at Pisa</h3><br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/logic-language-and-computation.asp">5/3/2004 02:41:43 PM</a></span>
