...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/bill-de-hra-steve-vinoski-on-ws-inside.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108352059930765367">&nbsp;</a><br>
	<a href="http://www.dehora.net/journal/2004/05/steve_vinoski_on_ws_inside_the_enterprise.html">Bill de hÓra: Steve Vinoski on WS inside the enterprise</a>.&nbsp; Well, well.&nbsp; This is a nice statement about use of Web Services to do some repurposing of legacy systems without every committing to creating "real" Web Services.&nbsp; This is eminently sensible and some further practical observations are provided here.&nbsp; This is a little far from the P2P "taking back the net" discussion.&nbsp; Or is it?<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/bill-de-hra-steve-vinoski-on-ws-inside.asp">5/2/2004 10:56:34 AM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108352059930765367">Post a Comment</a>
		</div>
