...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/operational-transformation-in-real.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108352564433633642">&nbsp;</a><br>
	<a href="http://citeseer.ist.psu.edu/sun98operational.html">Operational Transformation in Real-Time Group Editors: Issues, Algorithms, and Achievements - Sun, Ellis (ResearchIndex)</a>.&nbsp; Here's how Hydra (I can't remember the new name at all) handles concurrent editing over Rendezvous.&nbsp; Beside the many forms the paper is cached in, there are goodies in the papers that cite this one.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/operational-transformation-in-real.asp">5/2/2004 12:20:11 PM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108352564433633642">Post a Comment</a>
		</div>
