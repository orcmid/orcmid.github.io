...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/accessible-wiki.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108491106448249954">&nbsp;</a><br>
	<h3>Accessible Wiki</h3><a href="http://nfocentrale.net/orcmid/viaggio/V040505.htm"><img border="0" src="http://nfocentrale.net/orcmid/viaggio/0694350-R1-016-6A-clip.jpg" alt="Accessible Wiki" width="298" height="45"></a><br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/accessible-wiki.asp">5/18/2004 01:06:51 PM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108491106448249954">Post a Comment</a>
		</div>
