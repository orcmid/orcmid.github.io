...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/too-many-fake-friends.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108378740292404311">&nbsp;</a><br>
	<a href="http://www.pcmag.com/article2/0,1759,1584079,00.asp">Too Many Fake Friends</a>.&nbsp; This Jim Louderback article for PCMag gives a careful look to social-network schemes like Orkut and where it starts to get icky.&nbsp; It is interesting how we get that icky feeling when up against an undisclosed agenda that just doesn't have an arrangement feel clean.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/too-many-fake-friends.asp">5/5/2004 01:03:48 PM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108378740292404311">Post a Comment</a>
		</div>
