...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/i-want-my-security.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108492151857523739">&nbsp;</a><br>
	<h3>I Want My Security</h3><a href="http://www.acm.org/technews/articles/2004-6/0428w.html#item19">ACM News Service: Dire Straits</a>.&nbsp; This blurb suggests that 7 major trends are not going to simplify security concerns:<blockquote>elimination of bloated operating systems<br />development of components and objects<br />advent of mobile code<br />normalization of distributed computation<br />shift in payment models<br />spread of embedded systems<br />widespread adoption of wireless networks</blockquote>Increased security issues are expected to accompany introduction of distributed systems that rely on the network for communications between components (e.g., Web Services).<br /><br /><a href="http://infosecuritymag.techtarget.com/ss/0,295796,sid6_iss366_art684,00.html">The April 2004 Information Security article</a> emphasizes that perimeter defenses will be more difficult and also suggests that the heart of the problem is bad software, with no way to account for that in network defense systems.&nbsp; There's also concession that much is being done to reduce the attack surface of software systems.&nbsp; Sounds a little muddled, doesn't it?&nbsp; The point-by-point analysis of trends is worth keeping around for reference.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/i-want-my-security.asp">5/18/2004 04:05:22 PM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108492151857523739">Post a Comment</a>
		</div>
