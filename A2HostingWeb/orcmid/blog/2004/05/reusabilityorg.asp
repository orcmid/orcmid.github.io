...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/reusabilityorg.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108422124399665225">&nbsp;</a><br>
	<a href="http://www.reusability.org/">reusability.org</a>.&nbsp; Ah, here is a very interesting if a mildly icky site on aspects of the teacher bandwidth (ick) problem.&nbsp; A redeeming virtue is that resort to non-teacher-centric approaches is considered.&nbsp; There is more here for exploration and discussion.&nbsp; After a little work I find that this site is created by David Wiley (and that took something!).&nbsp; There's other tacit knowledge assumed in the site content too, and it stands out because it is not my tacit knowledge from the world of computer geekdom.&nbsp; This is educator geek-speak.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/reusabilityorg.asp">5/10/2004 01:34:37 PM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108422124399665225">Post a Comment</a>
		</div>
