...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/mindjack-linked-out-blogging-equality.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108362992889180516">&nbsp;</a><br>
	<a href="http://www.mindjack.com/feature/linkedout.html">Mindjack - Linked Out: Blogging, Equality, and the Future</a>.&nbsp; <a href="http://www.zephoria.org/thoughts/archives/2004/04/20/linked_out_blogging_equality_and_the_future.html">danah boyd</a> pointed to this (with discomfort about A-list status), and I have learned in the echo here that there is something important to consider around perceived power relationships and people giving themselves the authority to speak.&nbsp; And beyond that, finding ones authentic voice.&nbsp; This is relevant to on-line education and discussion settings.&nbsp; I shall pay attention.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/mindjack-linked-out-blogging-equality.asp">5/3/2004 05:18:55 PM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108362992889180516">Post a Comment</a>
		</div>
