...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/snapping-spring.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
    	...
    	<h2><a name="2004-05-17" href="#2004-05-17"><font color="#660000">2004-05-17</font></a></h2>
   	

	<div class="posts">
	<a name="108481983281041172">&nbsp;</a><br>
	<h3>Snapping Spring</h3><img border="0" src="http://nfocentrale.net/orcmid/viaggio/0694350-R1-020-8A.jpg" width="376" height="509" align="left">This entry is an excuse to experiment with images in the blog (and whatever happens in the site feed).<br /><br />It is <a href="http://nfocentrale.net/orcmid/viaggio/V040504.htm">Spring in the neighborhood</a> and I was motivated to take a camera walk.&nbsp;  I am also making a half-way change to digital photography. &nbsp; (If this were a music CD, the code would be AAD.)&nbsp;  I continue to use film and the N8008s that I upgraded to in 1992.&nbsp; My last roll was processed and delivered on CD-ROM, with the only prints being the little index print that provides thumbnails of each frame.<br /><br />Bringing home the CD-ROM has a number of advantages over the double-print order I normally turn in:&nbsp;  First, it is less expensive.&nbsp; Secondly, I have digital images already, and I suspect the large ones (JPEGs of around 1.5MB each) are better quality than I can obtain using my desktop scanner with film adapter.  Third, I still have the color negatives if I do need to do that.&nbsp; Fourth, I have eliminated the normal preparation barrier before I have something I am willing to put on the web or make prints from.<br /><br />The one disadvantage that I see is that I don't have prints for filing and for mailing -- now that is the barrier.&nbsp; I can make prints, though I am not sure that will be less expensive, in terms of materials and especially effort.&nbsp; I'll see.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/snapping-spring.asp">5/17/2004 11:34:18 AM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108481983281041172">Post a Comment</a>
		</div>
