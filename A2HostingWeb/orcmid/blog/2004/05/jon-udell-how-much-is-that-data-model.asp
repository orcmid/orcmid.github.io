...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/jon-udell-how-much-is-that-data-model.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108421572772458555">&nbsp;</a><br>
	<a href="http://weblog.infoworld.com/udell/2004/05/10.html#a993">Jon Udell: How Much Is That Data Model in the Window?</a>.&nbsp; This is a nice addition to the discussion of XML providing a data model or not.&nbsp; The audio interview with John Shewchuk is interesting, as is Jon's wresting with the assertion that there isn't any primary data model.&nbsp; I would add that this isn't just because we haven't found it yet.&nbsp; There is not likely to be anything that we would call a primary data model.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/jon-udell-how-much-is-that-data-model.asp">5/10/2004 12:02:05 PM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108421572772458555">Post a Comment</a>
		</div>
