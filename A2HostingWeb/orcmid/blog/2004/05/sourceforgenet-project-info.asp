...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/sourceforgenet-project-info.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108386738416899825">&nbsp;</a><br>
	<a href="http://sourceforge.net/projects/kanren/">SourceForge.net: Project Info - kanren: A declarative logic programming system</a>.&nbsp; This is a project spotted at Lambda the Ultimate.&nbsp; My curiosity is not only because of the participants on the project but also the prospect of having a sound computational logic and declarative system that runs on tiny processors.&nbsp; Because it speaks of purely-functional subsets of scheme, it would be interesting to see what has to be defined in oMiser as primitive (if anything) to have the model work there too.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/sourceforgenet-project-info.asp">5/6/2004 11:16:24 AM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108386738416899825">Post a Comment</a>
		</div>
