...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/bill-de-hra-is-that-envelope-i-see.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
    	...
    	<h2><a name="2004-05-07" href="#2004-05-07"><font color="#660000">2004-05-07</font></a></h2>
   	

	<div class="posts">
	<a name="108394917750605059">&nbsp;</a><br>
	<a href="http://www.dehora.net/journal/2004/05/whats_in_an_envelope.html">Bill de hÓra: Is that an envelope I see before me?</a>.&nbsp; There is coming to be some discomfort around the use of XML this week, and here's part of the discussion where XML is considered to be the elephant in the middle of the room.&nbsp; I think there are misunderstandings at a couple of levels.&nbsp; It may be that misunderstandings already around (in?) RDF/XML may be lifting into Atom.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/bill-de-hra-is-that-envelope-i-see.asp">5/7/2004 09:59:51 AM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108394917750605059">Post a Comment</a>
		</div>
