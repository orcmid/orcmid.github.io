...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/autounfocus-imsssp-comes-so-close.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108422073667570356">&nbsp;</a><br>
	<a href="http://www.reusability.org/blogs/david/archives/000538.html">autounfocus: IMS/SSP Comes So Close...</a>.&nbsp; Here's discussion of how SCORM does not provide a back door for introduction of annotation, commentary, and other interactions from, between and among learners and delivery agents.&nbsp; There is more to find out about this.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/autounfocus-imsssp-comes-so-close.asp">5/10/2004 01:25:02 PM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108422073667570356">Post a Comment</a>
		</div>
