...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/sean-mcgrath-more-relax-ng.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108352022493391780">&nbsp;</a><br>
	<a href="http://seanmcgrath.blogspot.com/2004_04_18_seanmcgrath_archive.html#108280344151929939">Sean McGrath: More Relax NG</a>.&nbsp; You are trapped in a maze of twisty little threads all the same ...<br /><br />Well, there are some interesting convergences this morning.&nbsp; I am just weeding through the web with my little newspaper clipping clipper (called Blog This! in this incarnation), so I will point out for now that there is a lot of interesting material here on schemas and also on distillation/translation and caching schemes.&nbsp; This is something that I have in mind, sort of, for nfoWiki retention of already distilled web pages, inspired by a different markup system that does something similar.<br /><br />Other than that, I am not sure how this connects things up for me.&nbsp; I am inspired to dig deeper and find out.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/sean-mcgrath-more-relax-ng.asp">5/2/2004 10:50:08 AM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108352022493391780">Post a Comment</a>
		</div>
