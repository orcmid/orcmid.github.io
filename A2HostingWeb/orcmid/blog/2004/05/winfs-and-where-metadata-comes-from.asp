...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/winfs-and-where-metadata-comes-from.asp 5     26-03-22 14:10 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108440471431739823">&nbsp;</a><br>
	<h3>WinFS and Where the Metadata Comes From</h3><a href="http://channel9.msdn.com/ShowPost.aspx?PostID=7102#7102">Channel9: Sam Druker on WinFS and MetaData Sources</a>.&nbsp; If we go to attributed file systems in a big way, bluring the distinction between store and database, where will the metadata elements come from?&nbsp; This video interview provides some useful practical observation about that in terms of the WinFS effort at Microsoft.&nbsp; The capturing of contextual information and already-available metadata is key.&nbsp; There is also some early discussion of how one might want to locate and situate items based on important views.&nbsp; I also found the discussion of transfer formats for moving an item from one WinFS instance to another rather interesting, and a number of questions come easily to mind on that score, with "Namespace?" high up on that list.<br /><br /><strong>Geek Tip of the Day</strong>: These videos are designed for embedded-in-the-page viewing using Microsoft Media Player.&nbsp;  For those who can't or don't want to do that, but can handle the file streams, subscribe to or open the RSS feed from the page, and pick the URL out of the feed.&nbsp; Of course, if you're a geek, you already knew that, dintcha?<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/winfs-and-where-metadata-comes-from.asp">5/12/2004 04:31:18 PM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108440471431739823">Post a Comment</a>
		</div>
