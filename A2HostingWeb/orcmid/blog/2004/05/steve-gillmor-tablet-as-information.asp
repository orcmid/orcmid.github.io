...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/steve-gillmor-tablet-as-information.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108578594445715022">&nbsp;</a><br>
	<h3>Steve Gillmor: Tablet as Information Appliance</h3><a href="http://www.eweek.com/article2/0,1759,1599458,00.asp">Gates Paying Attention to RSS</a>.&nbsp; Another Scoble <a href="http://radio.weblogs.com/0001011/2004/05/28.html#a7620">spotting</a>, this 2004-05-25 eWeek article by Steve Gillmor has far more to offer than the usual "what took Bill so long?" and "watch out, here come the Borg!" analyses.&nbsp; Gillmor talks about what it is that Gates gets and expresses from his position as visionary, and how the theme is unerring.<br /><br />I am fascinated by the Tablet PC, and I won't have one until a year from now, securing my longstanding record as a late adopter (I still have two Windows 98 machines in the SOHO operation here, and my Windows XP Pro laptop was built in 1998).&nbsp; And Steve Gillmor confirms my anticipation by pointing out that he won't give up his HP tablet, even though he still uses his Mac PowerBook, but more like a home-base system, in my view.<br /><br />It is interesting how OneNote, full multi-media capture/manipulation/transformation/presentation (including ink), and simplified authoring, collaboration, and syndication figure into the evolving information-appliance nature of tablet configurations.&nbsp; Yummy.<br>
	<span class="byline">posted by orcmid at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/steve-gillmor-tablet-as-information.asp">5/28/2004 04:12:09 PM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108578594445715022">Post a Comment</a>
		</div>
