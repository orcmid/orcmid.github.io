...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/words-social-software-hype-alert.asp 5     26-03-22 14:10 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108361022136061484">&nbsp;</a><br>
	<a href="http://tresolini.org/andrew/words/archive/000007.html">words: Social software: hype alert?</a>.&nbsp; There is a recuring complaint about how geek culture ends up corrupting and misapplying work that has been developed over substantial time by serious practitioners in other, subject-oriented domains.&nbsp; I think the contribution of what was called library science, and is now called information science is one example that gets misunderstood by geek science.&nbsp; In this posting, we are reminded that something similar happens around human interactions, human-computer interactions, and the awful design of so-called social software.&nbsp; I am going to look further.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/words-social-software-hype-alert.asp">5/3/2004 11:50:11 AM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108361022136061484">Post a Comment</a>
		</div>
