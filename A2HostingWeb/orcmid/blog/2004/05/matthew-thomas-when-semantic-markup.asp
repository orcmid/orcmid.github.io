...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/matthew-thomas-when-semantic-markup.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108378599309103533">&nbsp;</a><br>
	<a href="http://mpt.net.nz/archive/2004/05/02/b-and-i">Matthew Thomas » When semantic markup goes bad</a>.&nbsp; The first sentence of this useful entry is "In HTML, there are semantic elements and presentational elements. Semantic elements (like a href, cite, code, em, p, samp, and strong) have specific meanings. Presentational elements (like br, font, tt, b, and i) do not – they only alter visual presentation."&nbsp; Although I think there is an unfortunate confusion in the use of "semantics," it is interesting that one can tag this way, and have a better chance, with some agreement, of customizing presentation in an appropriate way.&nbsp; Go here for tips on that and not to worry about my objection to "semantic."<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/matthew-thomas-when-semantic-markup.asp">5/5/2004 12:39:53 PM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108378599309103533">Post a Comment</a>
		</div>
