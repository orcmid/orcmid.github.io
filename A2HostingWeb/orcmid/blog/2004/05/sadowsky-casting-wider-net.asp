...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/sadowsky-casting-wider-net.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
    	...
    	<h2><a name="2004-05-18" href="#2004-05-18"><font color="#660000">2004-05-18</font></a></h2>
   	

	<div class="posts">
	<a name="108490574907032772">&nbsp;</a><br>
	<h3>Sadowsky - Casting a Wider Net</h3><a href="http://www.acm.org/ubiquity/interviews/v5i12_sadowsky.html">ACM: Ubiquity - Casting a Wider Net</a>.&nbsp; This interview with <a href="http://pws.prserv.net/sadowsky/">George Sadowsky</a> looks at major threads in his career, including work to encourage economic development around the world.  One interesting tid-bit applies to urban Wireless in the US:<blockquote>"In India, for example, Michael Best and the MIT labs are experimenting with an inexpensive network that doesn't use any existing standard but instead essentially uses a mesh of computers and antennae to transmit messages on a store-and-forward basis until they get to where they're going. That's a nice model for many areas in rural India because those parts of rural India don't look rural compared to, say, North Dakota, or anyplace that we would consider really rural in the US."</blockquote>There's quite a bit more.  Because he joined the Association for Computing Machinery the same time I did (and I was at that conference, too), I'll end with George's observation about that:<blockquote>"I joined ACM in 1961 when I attended the ACM annual conference in Los Angeles, and I've been a member ever since. It was there that I first realized that I would have a long-term association with this profession and that I had better make sure that I keep up with the field as best I could. That has paid off in some spectacular ways, both in terms of reading articles that changed the way I understood certain fields, and in terms of meeting people who were helpful, some of whom are good colleagues to this day. In 1968 a group of us started SICCOC, a Special Interest Committee for the Social Sciences, which became a SIG, but then due to lack of binding with the relevant academic disciplines, transmuted itself in the early 1980s into SIGCHI."</blockquote><br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/sadowsky-casting-wider-net.asp">5/18/2004 11:42:30 AM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108490574907032772">Post a Comment</a>
		</div>
