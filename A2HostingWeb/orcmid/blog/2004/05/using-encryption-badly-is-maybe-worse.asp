...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/using-encryption-badly-is-maybe-worse.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
    	...
    	<h2><a name="2004-05-16" href="#2004-05-16"><font color="#660000">2004-05-16</font></a></h2>
   	

	<div class="posts">
	<a name="108475908948512370">&nbsp;</a><br>
	<h3>Using encryption badly is maybe worse than no encryption at all?</h3><a href="http://slashdot.org/article.pl?sid=04/05/16/1515216">Slashdot | Attacking WinZip AES Encryption</a>.&nbsp; Although there are some impressive cryptographic techniques available for general use, there is many a slip twixt cup and lip.&nbsp; Here's a cautionary case illustrated by analysis of a well-known software product.&nbsp; This is also a great indirect hint for subscribing to Bruce Schneier's <a href="http://www.schneier.com/crypto-gram-0405.html">Crypto-Gram</a> too.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/using-encryption-badly-is-maybe-worse.asp">5/16/2004 06:58:32 PM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108475908948512370">Post a Comment</a>
		</div>
