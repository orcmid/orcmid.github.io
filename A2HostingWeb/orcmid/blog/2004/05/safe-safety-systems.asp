...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/safe-safety-systems.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108585831056606221">&nbsp;</a><br>
	<h3>Safe Safety Systems</h3><a href="http://www.acm.org/technews/articles/2004-6/0528f.html#item19">ACM News Service: Software Safety by the Numbers</a>.&nbsp; IEC Standard 61508 describes how one establishes the safety and security of programmable electronics and the requirements on the development process for "traceability, criticality inspection, and validation."  Safety integrity is also considered, including "failsafes to ensure the detection of failures and the system's switchover to a safe state should it be unable to carry out a safety function."<br /><br />While this is directed toward embedded systems of a particular kind, it would seem that there is much lore here that translates into considerations for the vetting of autonomic systems for dependable computing.<br /><br /><a href="http://www.embedded.com/showArticle.jhtml?articleID=19201765">Jeff Payne's 2004-04-26 Embedded.com article</a> has the intriguing lead, "When it comes to safety, it's not what you do, but how you do it."  The well-illustrated article begins with a great anecdotal example and then expands into the risk management procedures and development-process models appropriate for different levels of safety criticality.&nbsp; These seem highly adaptable to an initiative for trustworthy software as well.<br>
	<span class="byline">posted by orcmid at <a href="http://orcmid.com/blog/2004/05/safe-safety-systems.asp">5/29/2004 12:18:07 PM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108585831056606221">Post a Comment</a>
		</div>
