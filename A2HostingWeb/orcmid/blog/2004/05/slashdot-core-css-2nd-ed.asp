...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/slashdot-core-css-2nd-ed.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108361370542996357">&nbsp;</a><br>
	<h1>Personal Computing</h1><h2>Cooperative and Collaborative Computing</h2><h3>The promise of light-weight components and tools</h3>I have the sense that we are on the verge of a major simplification in the personal computing space, especially around communication, coordination, and lots of small things loosely coupled.&nbsp; It may not be soup yet, but I can smell something simmering.<br /><br /><a href="http://books.slashdot.org/article.pl?sid=04/04/27/1517248&mode=thread&tid=126&tid=156&tid=185&tid=95">Slashdot | Core CSS (2nd ed.)</a>.&nbsp; I haven't gone for CSS, the use of Cascading Style Sheets in web pages.&nbsp; I have been working on content-first and widely-usable HTML pages, though I don't know how well I am doing.&nbsp; I think I must go for CSS though.&nbsp; I also think it will assist more in accessibility and I want to make sure I deal with that.&nbsp; I can also see CSS plus XHTML being the desired avenue for generated pages from Wikis, from bloggers, and so on.&nbsp; So, it is time.&nbsp; This book review suggests an useful starting point.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/slashdot-core-css-2nd-ed.asp">5/3/2004 12:48:18 PM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108361370542996357">Post a Comment</a>
		</div>
