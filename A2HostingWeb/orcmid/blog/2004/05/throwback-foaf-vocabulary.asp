...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/throwback-foaf-vocabulary.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108386572586239341">&nbsp;</a><br>
	<h3>Throwback: FOAF Vocabulary Specification</h3><a href="http://xmlns.com/foaf/0.1/">FOAF Vocabulary Specification</a>.&nbsp; [originally posted 2004-05-06-1042 -0700] This is apparently the specification for Friend-Of-A-Friend (FOAF).&nbsp; I found the Foaf-a-matic and created a little FOAF file for myself.&nbsp; I'm not sure what that proves.&nbsp; I edited it a little bit but it doesn't give me much to go by.&nbsp; This specification is immersed in RDF and OWL and Semantic Web technology, and all I want to know is just what is this.&nbsp; I also have trouble decoding the copyright claim.&nbsp; I think I will steer clear until I'm satisfied there's no volcano in all the magma.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/throwback-foaf-vocabulary.asp">5/6/2004 10:48:22 AM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108386572586239341">Post a Comment</a>
		</div>
