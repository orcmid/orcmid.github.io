...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/foaf-what-open-standards.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
    	...
    	<h2><a name="2004-05-06" href="#2004-05-06"><font color="#660000">2004-05-06</font></a></h2>
   	

	<div class="posts">
	<a name="108386398095832150">&nbsp;</a><br>
	<h3>FOAF: What Open Standards?</h3><a href="http://www.ariadne.ac.uk/issue39/web-focus/">Get Tooled Up:'FOAF : Using open standards to support community building', Ariadne Issue 39</a>/&nbsp; Spotted by <a href="http://dannyayers.com/archives/002576.html">danny</a>, this article wanders through a screen-shot-oriented overview of what one might do with a FOAF.&nbsp; I can't tell exactly what open standards are being refered to.&nbsp; (There are links and I will follow some.)&nbsp; Mostly I have this "ick" reaction to the screen shots and maybe even the idea.&nbsp; There is also a too-common "gee, look at these cool tools" along with "and it is extensible so it doesn't have to do everything (right)" sense I am getting from this.<br /><br />I need to stand back farther and see ways of looking at community, and then what use one makes of a plumbing tool to maintain a particular communities existence for itself.&nbsp; My first thought is that a community ought to grab a namespace and qualify the bejeezus out of familiar words, like "friend" or "associate."&nbsp; <br /><br />Then I would look at the idea that individuals assert their communities or their place in communities (with FOAF-like entries on their web sites) and see if that is a good way to do the job.&nbsp; It is about as nicely decentralized as you can get, I'll grant that.<br /><br />Finally, there are the dynamics of the game, including trolling around and reconciling the asserted community participation by analysis of these web-situated certificates attributable to the various actors.<br /><br />Sounds like a half-dozen or so thesis projects, some of which are doubtless being breathlessly developed as we speak.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/foaf-what-open-standards.asp">5/6/2004 10:50:56 AM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108386398095832150">Post a Comment</a>
		</div>
