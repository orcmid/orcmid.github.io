...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/many-to-many-insistent-messiness-of.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108368366617664913">&nbsp;</a><br>
	<a href="http://www.corante.com/many/archives/2004/05/04/the_insistent_messiness_of_humans.php">Many-to-Many: The insistent messiness of humans</a>.&nbsp; Ah, yes.&nbsp; Yes indeed.&nbsp; Nods knowingly.&nbsp; Uh hum.&nbsp; k00l!<br /><br />[later: 2004-05-10-21:46] All right, I am serious about this.&nbsp; The important thing is, to borrow a phrase from Wheelright, "artifacts have contexts; people have perspectives."&nbsp;  That we can apply multiple perspectives to the same material is of keen important when we talk about notions of unambiguous, well-defined meanings of data, as is said in the context of the Semantic Web.&nbsp; This <em>must</em> be snake oil or, at best, unwarranted hype.&nbsp; And clinging to that silver bullet will distract us from accepting and then working with the way people are with language and how there is absolutely nothing wrong with that.&nbsp; Then maybe we can be direct about where there are prospects for precision and rigor and the difficulty of preserving fidelity to that, once achieved.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/many-to-many-insistent-messiness-of.asp">5/4/2004 08:14:16 AM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108368366617664913">Post a Comment</a>
		</div>
