...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/autonomy-and-service-oriented.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108559583336717550">&nbsp;</a><br>
	<h3>Autonomy and Service-Oriented Architecture</h3><a href="http://www.looselycoupled.com/stories/2004/policy-infr0526.html">Adding policy to integration</a>.&nbsp; Phil Wainewright's 2004-05-26 <em>Loosely Coupled</em> blog comments on SOA management software as a means to deal with exceptions and also enforcement of business policies.&nbsp; The article does not address autonomic behavior directly; it promotes discussion of how deviations can be treated from a system-management cockpit.&nbsp;  The lead is compelling: "SOA management software can put your business operations on cruise control, but don't fall asleep at the wheel."<br /><br />The key section with relevance to management of autonomic operation is at the end, on Unexpected Errors.&nbsp; The preceding section there, on concerns about breaching of layers of abstraction is also relevant.&nbsp; The key overlapping concern is expressed this way, at the end of the article: "When [enterprises] automate process integration, it removes manual steps where people would previously have been on hand to spot policy breaches.&nbsp; So unless policy enforcement is automated at the same time as the process itself, much of the benefit of automating the integration is lost.&nbsp; Effective policy enforcement is essential to productive services integration, and customers are going to expect SOA management vendors to fulfil that need."<br /><br />I don't know if SOA management will do the job, but it would seem that SOA and component models may be a good place to come to grips with failure modes and policy breaches.&nbsp; I also remain concerned about interoperability and integration in the enterprise.<blockquote><dl><dt><i>See also:</i></dt><dd>&nbsp;<a href="http://nfocentrale.net/orcmid/blog/2004/05/autonomy-where-art-thou.asp">Autonomy, Where Art Thou?</a><br />&nbsp;<a href="http://nfocentrale.net/orcmid/blog/2004/05/mda-lock-in.asp">MDA Lock-In?</a><br />&nbsp;<a href="http://nfocentrale.net/orcmid/blog/2004/05/tss-article-mda-nice-idea-shame-about.asp">MDA Article: Couple of Misunderstandings</a></dd></dl></blockquote><br>
	<span class="byline">posted by orcmid at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/autonomy-and-service-oriented.asp">5/26/2004 11:23:48 AM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108559583336717550">Post a Comment</a>
		</div>
