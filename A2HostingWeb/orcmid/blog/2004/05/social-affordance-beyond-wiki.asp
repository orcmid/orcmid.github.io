...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/social-affordance-beyond-wiki.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108473128108396890">&nbsp;</a><br>
	<h3>Social Affordance beyond Wiki Affordance</h3><a href="http://www.emacswiki.org/cgi-bin/community?action=browse;id=SocialAffordance">CommunityWiki: SocialAffordance</a>&nbsp; Here is more work on refining the notion of Affordance in the context of wiki.<br /><br />[note to self: Self, remember that a wiki page should tell you what version it is, and one might want to permalink a particular version or the resource that is the always-latest version.&nbsp; This is one way that a wiki is different than a web log, unless blog pages are versioned too, perhaps?]<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/social-affordance-beyond-wiki.asp">5/16/2004 11:14:13 AM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108473128108396890">Post a Comment</a>
		</div>
