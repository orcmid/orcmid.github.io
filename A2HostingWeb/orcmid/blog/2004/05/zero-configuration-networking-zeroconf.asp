...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/zero-configuration-networking-zeroconf.asp 4     26-03-22 14:10 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108352359355816395">&nbsp;</a><br>
	<a href="http://www.zeroconf.org/">Zero Configuration Networking (Zeroconf)</a>.&nbsp; OK, well I may have been confusing Zero Configuration Networking and what I thought was happening with CuWiN and the Champagne-Urbana Mesh project.&nbsp; And maybe not.&nbsp; They could go together.<br /><br />Zeroconf is about simple peer-to-peer discovery using IP as the only common protocol different platforms are likely to have.&nbsp; It is designed to work even when carried out on links that are part of a larger, more-managed (-configured) network.&nbsp; I think (just think) that this might work really well across NAT too, and that would be marvelous.&nbsp; I haven't done the detail work, but the basic charter and scope of the Zeroconf work is appealing.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/zero-configuration-networking-zeroconf.asp">5/2/2004 11:46:01 AM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108352359355816395">Post a Comment</a>
		</div>
