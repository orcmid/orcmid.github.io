...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/channel9-transparency-one-post-at-time.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
    	...
    	<h2><a name="2004-05-11" href="#2004-05-11"><font color="#660000">2004-05-11</font></a></h2>
   	

	<div class="posts">
	<a name="108429860571949778">&nbsp;</a><br>
	<a href="http://channel9.msdn.com/ShowPost.aspx?PostID=603">Yup ... we gots bugs ... we gots things to do better</a>. [updated 2004-05-11-18:38]&nbsp; <strong>Channel 9</strong> is an interesting and sometimes overwhelming experiment.&nbsp; And I would say it is working.&nbsp; When I saw this original post, I asked <a href="http://channel9.msdn.com/ShowPost.aspx?PostID=1581#1581">how to turn in bug reports</a> (not seeing that a deep message provided the answer already).&nbsp; I recorded some initial findings about my experience as part of my question, and then I used the designated place for further feedback.&nbsp; That was a month ago, and I had since gone on to other things.&nbsp; I wasn't expecting a response, I just wanted to toss some concerns into the Microsoft MSDN Channel 9 space.<br /><br />Thanks to the wonders of site feeds, I learned that there was a <a href="http://channel9.msdn.com/ShowPost.aspx?PostID=6830#6830">response to one of my kvetchings</a> over on Channel 9.&nbsp; I thought that they were telling me what already didn't work, but I tried again and Charlie's advice was bang on.&nbsp; What a relief.<br /><br />There is this semi-permeable membrane now available, and osmosis is happening.&nbsp; It is a grand experiment, and it provides different levels of contact and attention at a minion-to-minion level.<br /><br />It is also good that many of the folks here <em>are</em> experienced evangelists, because people spit on them.&nbsp; And it doesn't seem to deter their commitment to keeping the kimono open and to continue establishing bridges to developer and user communities by remaining level-headed and focused on what they see as important.&nbsp; Whether or not the products are for you, and whether or not you are uncomfortable (or outright hostile) over Microsoft business models and practices, it is nice to see people who are committed to producing great software and who demonstrate great respect for the work that is done in the industry at large.&nbsp; I had been concerned for some time that the fortress mentality that Microsoft seemed driven to would have them be increasingly isolated, hardened and defensive. I see that the willingness of 'softies to stand up in public has not been diminished.<br /><br />With my struggles over Blogger since yesterday, and my efforts in the past to let Blogger know they had an authentication bug and security breach, there is an amazing contrast against the move toward transparency that Channel9 represents.&nbsp; (And I still don't like the butterscotch scheme and some of the incoherence of Channel9, but I don't have to like it.)<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/channel9-transparency-one-post-at-time.asp">5/11/2004 11:03:33 AM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108429860571949778">Post a Comment</a>
		</div>
