...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/bbc-news-technology-question-of-trust.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108361297966461109">&nbsp;</a><br>
	<h1>Trust and Trustworthy Computing</h1><h2>Situations of Trust</h2><h3>Overcoming the distrust of trusting</h3><a href="http://news.bbc.co.uk/1/hi/technology/3653425.stm">BBC NEWS | Technology | A question of trust online</a>.&nbsp; This article is <a href="http://bill.verity-networks.com/palimpsest/blogs/thom.php?p=46&more=1&c=1&tb=1&pb=1">self-spotted</a> by Bill Thompson, and I want to use it in a discussion about transparency and open operation in an on-line university setting.&nbsp; Issues of distrust come up, usually raised by students about the speculative behavior of other students if, for example, study materials are made more widely available earlier.&nbsp; Here I favor the reminder that there are demonstrable trustworthy situations in what would be predicted to be anarchies on the Internet, and there is something to learn there about our automatic, prejudged distrust of trusting.  As Bill says, "When I am overwhelmed with despair by the spammers and the scammers, [communal activities such as Wikis] give me hope."<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/bbc-news-technology-question-of-trust.asp">5/3/2004 12:36:21 PM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108361297966461109">Post a Comment</a>
		</div>
