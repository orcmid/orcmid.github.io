...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/fom-object-oriented-formal.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108388414887478823">&nbsp;</a><br>
	<a href="http://www.cs.nyu.edu/pipermail/fom/2004-May/008157.html">[FOM] Object-Oriented Formal Mathematical Languages</a>.&nbsp; [thrownback from 2004-05-06-16:00 -0700] After I collected myself a bit and took the coaching of the moderator, I posted a brief version of my "<a href="http://nfocentrale.net/orcmid/blog/2004_05_02_lair-chive.asp#108370243385113129">When Is Programming Mathematics, and Vice Versa</a>" concerns to the Foundations of Mathematics Discussion List.&nbsp;My note is restrained and fairly self-contained, the essential point being that<blockquote>I see enormous quantities of successful practice that show little evidence of what I would call mathematical activity.&nbsp;  And I do not doubt the value of a mathematical perspective in creation of software.</blockquote><blockquote>I am keenly interested in the connection between software and mathematics (and logic and language).&nbsp; I accept that it is off-purpose for FOM and welcome off-list suggestions of more-appropriate forums/communities where the connections might be explored.</blockquote>I make that an open invitation.&nbsp; I have received some comments, and I suspect this might grow best in a social network, even if carried out in public.&nbsp; I do not have in mind the creation of yet-another discussion list.<br /><br /><br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/fom-object-oriented-formal.asp">5/4/2004 01:20:05 PM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108388414887478823">Post a Comment</a>
		</div>
