...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/stinking-silver-badges.asp 4     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
	...
	<div class="posts">
	<a name="108492454144596002">&nbsp;</a><br>
	<h3>Stinking Silver Badges</h3><a href="http://www.acm.org/technews/articles/2004-6/0503m.html#item10">ACM News Service: Why Certifying IT Workers Won't Help</a>.&nbsp; It is difficult to determine what non-anecdotal value arises in this blurb's suggestion that failures can happen anyhow.&nbsp; I suppose it is like rejecting fire insurance because there are still fires.&nbsp; Of course, we don't know of the failures that were avoided through disciplined software engineering.<br /><br /><a href="http://zdnet.com.com/2100-1107-5200686.html">Martin Brampton's 2004-04-27 ZDNet commentary</a> earned some interesting comments, but the article doesn't go very deep.&nbsp; It is a little mind-wrenching to see how <em>Dijkstra's Go To Considered Harmful</em> supports a crucial argument about the irrelevance of certification.&nbsp; While there are appropriate concerns about the reliability of examinations as demonstrations of engineering competence, Brampton proposes no measurable alternative.&nbsp; Indeed, it doesn't look like Brampton proposes to measure anything.&nbsp; Good, we will keep it all in the domain of opinion, the approach that has taken us this far.&nbsp; Bully. <br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/stinking-silver-badges.asp">5/18/2004 04:55:46 PM</a></span>
	  
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->  
		<div class="blogComments">
			Comments:  
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108492454144596002">Post a Comment</a>
		</div>
