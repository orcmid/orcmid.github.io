...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/fom-tony-hoare-and-software.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
    	...
    	<h2><a name="2004-05-04" href="#2004-05-04"><font color="#660000">2004-05-04</font></a></h2>
   	

	<div class="posts">
	<a name="108388853149273402">&nbsp;</a><br>
	<a href="http://www.cs.nyu.edu/pipermail/fom/2004-May/008161.html">[FOM] Reply on Tony Hoare and Software Mathematics Economics</a>.&nbsp; [thrownback from 2004-05-06-0851 -0700] After my little note, <a href="http://www.semeiosis.com/">Steven</a> posted a response in support of the work of Tony Hoare.&nbsp; Let me be clear:&nbsp; I have nothing but admiration for Hoare's work, the formalization of Concurrent Sequential Processes, and all of the work that flows therefrom, including Z. <br /><br />I reiterate that this is valuable work, it is not the same as saying successful software development requires it (as a generality), and it will not always be applicable (i.e., in confirming non-formalized qualities and the validity of formalized ones).&nbsp; I don't expect to find a silver bullet.&nbsp; And the work should be continued, so that its standing as an useful bullet can be understood and delimited.&nbsp; In practice, computer science is an empirical science, I say, and we definitely do need to understand that better and also comprehend where solid theories apply.<br /><br />Steven also asserts that "it is only a matter of economics that lets software companies get away with the liberal informality of modern programming languages."  He speaks of bugs as an externality the cost of which is passed on to customers, concluding that "computer programmers are not mathematicians is matter only of economic tolerance and engineering pragmatics."  I do not know how to eliminate engineering pragmatics and (mere?) economic considerations.  I have nothing to contribute along those axes.<br /><br />I do cling to a middle-ground view that is perhaps allied with the "middle road" perspective of <a href="http://www.cas.mcmaster.ca/sqrl/parnas.homepg.html">David Parnas</a>.  I think verification tools are important, I don't think they can ever be all of it, and there is far more to software engineering than verification to specifications, however and to whatever degree it is carried out.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/fom-tony-hoare-and-software.asp">5/4/2004 01:15:48 PM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108388853149273402">Post a Comment</a>
		</div>
