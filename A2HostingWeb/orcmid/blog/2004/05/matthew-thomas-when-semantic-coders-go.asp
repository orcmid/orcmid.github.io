...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/matthew-thomas-when-semantic-coders-go.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
    	...
    	<h2><a name="2004-05-09" href="#2004-05-09"><font color="#660000">2004-05-09</font></a></h2>
   	

	<div class="posts">
	<a name="108416369187861819">&nbsp;</a><br>
	<a href="http://mpt.net.nz/archive/2004/05/09/semantic">Matthew Thomas » When semantic coders go bad</a>. [2004-05-11-14:02 -0700 cleanup]&nbsp; This follow-on about markup and presentation versus semantics consists of a solid demonstration about presentation, the intention for a presentation choice, and how semantics may have nothing to do with the preceding.&nbsp; Two important catches here: (1) what the actual practices are, and the browser behaviors are, by which people gain the presentations they intend; (2) the silliness of assuming that there is a way to prevent people from carrying any semantics they like in whatever presentation and quasi-semantic markup they contrive to accomplish their purpose.&nbsp; In other words, there is no way to <em>mechanically enforce</em> precise, unambiguous semantics in a markup practice.<br /><br />[added 2004-05-11-14:11 -0700] I think there is some sort of information systems law that must apply here.&nbsp; Try these: There is no way to limit the evocation of higher-level abstractions and interpretations in the use of lower-level formal coding schemes.&nbsp;  <strong>The text is material to the message.&nbsp; The text is not the message. There is no "the message" there.&nbsp; Syntax has no power over semantics</strong>.&nbsp; There.<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/matthew-thomas-when-semantic-coders-go.asp">5/9/2004 09:34:04 PM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108416369187861819">Post a Comment</a>
		</div>
