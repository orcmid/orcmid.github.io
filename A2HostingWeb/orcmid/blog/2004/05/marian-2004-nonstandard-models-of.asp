...
<!-- 2004-02-04-17:22 Add content-type and content-language information to see what that improves -->
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/2004/05/marian-2004-nonstandard-models-of.asp 5     26-03-22 14:09 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
    	...
    	<h2><a name="2004-05-03" href="#2004-05-03"><font color="#660000">2004-05-03</font></a></h2>
   	

	<div class="posts">
	<a name="108361617877861242">&nbsp;</a><br>
	<h3>Computational Arithmetic versus Encounters of the Standard Kind</h3><a href="http://www.dm.unipi.it/~dinasso/marian2004/">MARIAN 2004 - Nonstandard Models of Arithmetic and Analysis</a>.&nbsp; OK, a stranger than usual clipping, but I have automatic radar that notices things about Universities in Italy and particularly Pisa and the nearby CNR organization.&nbsp; I have this dream of having an institutional affiliation like that so that we could live part-year in Italy and Vicki could realize her lifelong dream of being in Italy.<br /><br />I immediately ruled-out this congress because I have a class at the time and the subject is way afield of my limited and clumsy expertise at connection of mathematics, logic, language, and computation anyhow.<br /><br />But it does say arithmetic, and almost all of the arithmetics used by computers are decidedly non-standard in ever way imaginable, so there is probably a topic here, whether or not even remotely close to what these folks talk about as non-standard.&nbsp;  And models, the wonders of models.&nbsp; So this reminder is for me to at least notate something (not here).<br /><br />Odd, I notice that conference announcements often inspire something that I make a technical note about, even though it might not be what the conference is actually devoted to.&nbsp;  It's like opening a newspaper and reading someone else's horoscope, then being inspired by what that brings up!<br>
	<span class="byline">posted by Dennis at <a href="http://nfoCentrale.net/orcmid/blog/2004/05/marian-2004-nonstandard-models-of.asp">5/3/2004 01:29:32 PM</a></span>
	
                  <!-- 2004-05-10-14:47 -0700 Include comments within my template and see if I can get it working properly -->
		<div class="blogComments">
			Comments:
			
			<a href="http://www.blogger.com/comment.g?blogID=3896669&postID=108361617877861242">Post a Comment</a>
		</div>
