...
<!-- ORCMID'S LAIR BLOGGER.COM TEMPLATE
     ...
     2002-10-31 Template modification adventures.  Add a configuration-
        ...
        title into a link
   $$Header: /nfoCentraleMSbCentralWeb/orcmid/blog/2006/02/stupid-is-as-stupid-does-me-and.asp 1     06-04-23 14:35 Orcmid $
   -->
<head>
<title>Orcmid's Lair: Stupid Is as Stupid Does: Me and NewsGator</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<td bgcolor="white" colspan="2"><!-- 2004-10-02 -->
      ...
      <h3><a name="2006-02-15" href="#2006-02-15">
          <font color="#660000">2006-02-15</font></a></h3>
   	

	<div class="posts">
    <a name="114003582111823239"></a>
	...
	<p>
    <div style="clear:both;"></div><p><small>I updated NewsGator to overcome a problem I had with a site that silently and&nbsp;unilaterally upgraded&nbsp;all of its&nbsp;Atom feeds to Atom 1.0.&nbsp; This cured one problem only to saddle me with another, as described in the <a href="http://nfocentrale.net/orcmid/blog/2006/02/naked-monoculture-bites-msdn.asp">final update to that saga</a>.&nbsp;&nbsp; A <a href="http://orcmid.com/blog/2006/02/naked-monoculture-bites-msdn.asp#113995031712520312">comment</a> on that article provided a link to a NewsGator knowledge-base article and patch that is purported to remedy the new problem.</small></p><p align="center"><small>{tags: <a href="http://technorati.com/tag/TROSTing" rel="tag">TROSTing</a> <a href="http://technorati.com/tag/NewsGator" rel="tag">NewsGator</a> <a href="http://technorati.com/tag/confirmable+experience" rel="tag">confirmable experience</a> <a href="http://technorati.com/tag/system+coherence" rel="tag">system coherence</a> <a href="http://technorati.com/tag/least+privilege" rel="tag">least privilege</a> <a href="http://technorati.com/tag/UAC" rel="tag">UAC</a> <a href="http://technorati.com/tag/SUA" rel="tag">SUA</a> <a href="http://technorati.com/tag/orcmid" rel="tag">orcmid</a>}</small></p><p><strong>2006-02-14-08:58 I thought I&rsquo;d fixed it.</strong>&nbsp; When I noticed that my NewsGator Outlook folders were being trashed, I manually went into my subscriptions and either deleted a subscription or changed it to be stored into a specific Outlook folder of my choosing.&nbsp; I did that for all 190 feeds.&nbsp; When I was done, I had 100 subscriptions left.&nbsp;&nbsp; I figured I had resolved the problem, after 90 minutes of painful editing.&nbsp; I was still grumpy, but I figured I had some respite while I figured out a better way to do this.&nbsp; I can also resubscribe to the deleted feeds on an opportunistic basis when I want to be caught up on one of them.&nbsp; Meanwhile, all of my existing feed &ldquo;clippings&rdquo; are still sitting in my Outlook folders and kept searchable by Windows Desktop Search.&nbsp; I can get back to work.</p><p><strong>2006-02-14-14:30 Not So Fast, Sparky.</strong>&nbsp; When I&nbsp;saw the&nbsp;comment, I took a look at the <a href="http://newsgator.mykbpro.com/Article_F844F.aspx">NewsGator Knowledge Base item</a>.&nbsp; It&rsquo;s a little daunting that it is not at a NewsGator domain, but the download is from a NewsGator URL.&nbsp; Since I had already gone through and corrected everything, I was hoping that my problem was resolved and I could proceed without applying a patch.</p><p><strong>Haven&rsquo;t We Met Somewhere Before?</strong>&nbsp; The odd thing about the patch is that is offered for some other problems.&nbsp; When I was researching the status of NewsGator Outlook 2.5 before updating to 2.5.12.495, I saw a patch file of the same name being offered for another class of problem(s). That other problem&nbsp;involves some weird confluence of interactions&nbsp;depending on&nbsp;installation of Visual Studio 2005 (which I don&rsquo;t have on this machine) and a variety of plug-ins that might be installed in Outlook (none of which I have) and that conspired to prevent NewsGator from running.&nbsp; The peculiarity of these interactions and the &ldquo;try this, maybe it will help&rdquo; approach is not something that I find confidence-inspiring and I figured I would not be&nbsp;using any&nbsp;patch unless I absolutely had to (and was still using NewsGator).</p><p><strong>I&rsquo;m Still Screwed, Time to Patch.</strong>&nbsp; A&nbsp;while later, I manually&nbsp;start a NewGator &ldquo;Get News&rdquo; and son-of-a-gun, there are renamed folders again.&nbsp; I look in the NewsGator | Subscriptions &hellip;&nbsp;list and I see that all of my subscriptions have been either marked as destined for &lt;base&gt; or for folders having the same name as the feed.&nbsp;&nbsp; All of those carefully-entered manual corrections have been trashed.</p><p><strong>2006-02-14-18:36 Patching Is Such Sweet Sorrow.</strong>&nbsp; I downloaded the patch (it is gigantic, larger than the production release).&nbsp; I upgrade&nbsp;what I call my&nbsp;<strong>least-privilege Safe User Account</strong> (SUA, just to add to the confusion around LUA and <a href="http://blogs.msdn.com/uac/default.aspx">UAC</a>) to Administrator so I can do an install that has NewsGator operating only under the one SUA account.&nbsp; I launch the patch program and it completes successfully, completing much more quickly than I was expecting based on the size of the download.</p><p><strong>NewsGator, Where Are You?</strong>&nbsp; I restore my account to non-administrator SUA (limited access, in Windows XP parlance), restart my computer, and then bring up Outlook.&nbsp; <strong>NewsGator isn&rsquo;t there at all.</strong>&nbsp; The updated to 2.5.12.495 didn&rsquo;t have this problem.&nbsp; I wonder what&rsquo;s different.&nbsp;&nbsp; This is starting to become my worst nightmare.</p><p><strong>NewsGator Diagnostics Tell All.</strong>&nbsp;&nbsp; There&rsquo;s a program called NewsGator Diagnostics on the Start | All Programs | NewsGator menu.&nbsp; I run it.&nbsp; Oh, I see, the patched NewsGator needs to modify something in Outlook and my SUA account doesn&rsquo;t write privileges to do that.&nbsp; I&rsquo;ve been here before.&nbsp; There are essentially first-time startup operations of the NewsGator Outlook plug-in that require unusual privileges.&nbsp; I change the account type back to Administrator.&nbsp; I run NewsGator Diagnostics again and it seems to succeed.&nbsp; I go back to least privilege, start up Outlook, and NewsGator is there and running.</p><p><strong>2006-02-14-20:30 Endless Optimism.</strong>&nbsp; I had the vague hope that somehow my fixed-up subscriptions would be restored, but that isn&rsquo;t to be.&nbsp; So I spend an hour after dinner fixing them all up once again.&nbsp; Meanwhile, to get through this without messing up I delete 40 more subscriptions, ending up with 60&nbsp;of the 190 I started with&nbsp;in the&nbsp;morning.&nbsp; Some of these I know I&rsquo;ll want back, and I&rsquo;ll resubscribe to those later.</p><p><strong>2006-02-14-22:00 Unlimited Pessimism.</strong>&nbsp; I have to tell you that I was fully expecting the patch not to work.&nbsp; And the only way to know is to have done all of the cleanups and then downloaded any updates to the 60 subscribed feeds remaining in my list.&nbsp; I click to &ldquo;Get News&rdquo; and NewsGator works through the downloads.&nbsp; There isn&rsquo;t much new, but it all goes to the right places.&nbsp; My subscription entries seem&nbsp;to be unchanged.&nbsp; I&rsquo;ve exhausted myself fretting with this stuff and I shut down to see what the new day will bring.</p><p><strong>2006-02-15-12:16 Reflections: What a Difference a Day Makes.</strong>&nbsp; I have downloaded feeds again and there is no further disruption.&nbsp; The patch brings me to version 2.5.12.537 of NewsGator and apart from installation hiccups I&rsquo;ve seen before (requiring unusual privileges to complete setup during the first-use of the application), I seem to be back in business.&nbsp; I have even subscribed to two feeds as a result of some morning e-mail alerts that I receive.</p><p>I&rsquo;m relieved that I still have my system and all of my feed clippings intact.&nbsp; I&rsquo;m mildly dismayed at the difficulty that I went through and that there are data-corruption cases and plug-in interference conditions to be found in a feed reader.&nbsp; The fact that NewsGator is a .NET application is also revealing in ways that I don&rsquo;t even want to think about.</p><p>I think there are lessons here concerning the difficulty of having predictable, coherent behavior of software.&nbsp; I also think that there is something to be seen about how one confirms operation, confirms difficulties, and is able to provide positive support responses.&nbsp; I also notice that going to NewsGator to see if there were already-known problems about corruption of subscriptions was not part of my approach to finding a solution.&nbsp; I figured it was a failure of the update process and not a chronic condition of the new version.&nbsp; I went directly to working around the damage.&nbsp; I didn&rsquo;t&nbsp;realize I was making a bet, but I lost it anyhow.</p><div style="clear:both; padding-bottom: 0.25em;"></div>
    </p>
	<span class="byline">posted by orcmid 
       at <a href="http://orcmid.com/blog/2006/02/stupid-is-as-stupid-does-me-and.asp">2/15/2006 12:37:01 PM</a></span>
	  
         <!-- 2004-05-10 -->
		<div class="blogComments">
			&nbsp;<br /><b><i>Comments:</i></b><!-- 2004-10-04 -->  
			
	    <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=3896669&amp;postID=114003582111823239">Post a Comment</a>
		</div>
