...
<!-- ORCMID'S LAIR BLOGGER.COM TEMPLATE
     ...
     2002-10-31 Template modification adventures.  Add a configuration-
        ...
        title into a link
   $$Header: /nfoCentraleMSbCentralWeb/orcmid/blog/2006/10/orcmids-lair-disruption.asp 1     06-10-11 15:42 Orcmid $
   -->
<head>
<title>Orcmid's Lair: Orcmid's Lair Disruption</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
    ...
    <p align="right"><a href="http://clustrmaps.com/counter/maps.php?url=http://nfocentrale.net/orcmid/" id="clustrMapsLink"><img src="http://clustrmaps.com/counter/index2.php?url=http://nfocent