...
<!-- ORCMID'S LAIR BLOGGER.COM TEMPLATE
     ...
     2002-10-31 Template modification adventures.  Add a configuration-
        ...
        title into a link
   $$Header: /A2HostingWeb/orcmid/blog/2007/01/raymond-chen-celebrating-old-in-new.asp 1     07-02-15 8:51 Orcmid $
   -->
<head>
<title>Orcmid's Lair: Raymond Chen: Celebrating the Old in the New</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
    ...
    &#160;<br />
    <a href="http://orcmid.com/blog/2007/01/geek-dinner-with-jon-udell-thursday.asp">Geek Dinner with Jon Udell: Thursday, January 18, 7pm, Bellevue Crossroads Mall</a><br />
	...
	<td bgcolor="white" colspan="2"><!-- 2004-10-02 -->
      ...
      <h3><a name="2007-01-23" href="#2007-01-23">
          <font color="#660000">2007-01-23</font></a></h3>
   	

	<div class="posts">
    <a name="116958887128850440"></a>
	...
	<p>
    <div style="clear:both;"></div><p>Raymond Chen&rsquo;s <em><a href="http://www.amazon.com/Old-New-Thing-Development-Throughout/dp/0321440307/">The Old New Thing</a></em> arrived within the original delivery promise, even though amazon.com had beseeched me to approve a delay.&nbsp; </p><p align="center">{tags: <a href="http://www.technorati.com/tag/orcmid" rel="tag">orcmid</a> <a href="http://www.technorati.com/tag/Raymond+Chen" rel="tag">Raymond Chen</a> <a href="http://www.technorati.com/tag/Windows" rel="tag">Windows</a> <a href="http://www.technorati.com/tag/software+development" rel="tag">software development</a>}</p><p>The problem with the book&rsquo;s timely arrival&nbsp;is I&rsquo;m&nbsp;in the middle of a crunch and I don&rsquo;t dare let myself get lost in 21 chapters of amazing material, some I know I&rsquo;ll be using real soon now.</p><p>OK, I peeked at the table of contents, read the preface, and scanned the first couple of articles.&nbsp; To protect myself, I decided that my wife, Vicki, would enjoy some of the <a href="http://www.theserverside.net/tt/articles/showarticle.tss?id=OldNewThing">first articles on user-interface design</a>, and I handed it off to her.</p><p>Enjoy?&nbsp; She hooted, howled, stamped her feet,&nbsp;and had tears in her eyes.&nbsp; She did that all the way to around page 29 where the technical aspects left her behind.</p><p>This is probably the most fun I have seen Vicki have over geek pleasures.&nbsp; She&rsquo;s a potter.&nbsp; Computer techie conversations leave her shut out and cranky.&nbsp; But Raymond has the knack of seeing things from more than one point of view and explaining it at the level where it works best.</p><p>You might not&nbsp;display <em>The Old New Thing</em> on your coffee table (but then you might).&nbsp; Yet there&rsquo;s&nbsp;more than one reason to possess the book (and the downloads that are also available): A megadose of Raymond Chen might help you learn to look at your software involvement in ways that recognize the ridiculous and honor the tried-and-true.&nbsp; And have a lot of fun doing it.</p><p>I can&rsquo;t wait to start listening to <a href="http://blogs.msdn.com/oldnewthing/archive/2007/01/23/1514672.aspx">the interviews</a> he&rsquo;s giving as part of his duty to promote the book.&nbsp; Hmm, how about a bookstore event within Raymond&rsquo;s bicycling range?&nbsp; If I bring Vicki I wonder if she's let it count as a date night out?&nbsp; Well, best not suggest it, geek codger.</p><div style="clear:both; padding-bottom: 0.25em;"></div>
    </p>
	<span class="byline">posted by orcmid 
       at <a href="http://orcmid.com/blog/2007/01/raymond-chen-celebrating-old-in-new.asp">1/23/2007 01:47:51 PM</a></span>
	  
         <!-- 2004-05-10 -->
		<div class="blogComments">
			&nbsp;<br /><b><i>Comments:</i></b><!-- 2004-10-04 -->  
			
	    <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=3896669&amp;postID=116958887128850440">Post a Comment</a>
		</div>
