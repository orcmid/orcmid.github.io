...
<!-- ORCMID'S LAIR BLOGGER.COM TEMPLATE
     ...
     2002-10-31 Template modification adventures.  Add a configuration-
        ...
        title into a link
   $$Header: /A2HostingWeb/orcmid/blog/2007/01/don-ferguson-near-death-experience.asp 1     07-02-15 8:51 Orcmid $
   -->
<head>
<title>Orcmid's Lair: Don Ferguson: Near Death Experience</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<td bgcolor="white" colspan="2"><!-- 2004-10-02 -->
      ...
      <h3><a name="2007-01-21" href="#2007-01-21">
          <font color="#660000">2007-01-21</font></a></h3>
   	

	<div class="posts">
    <a name="116942947429848550"></a>
	...
	<p>
    <div style="clear:both;"></div><p>I&rsquo;m putting the <a href="http://www.25hoursaday.com/weblog/PermaLink.aspx?guid=6d73ab52-6745-4e98-ab0c-b8ff44e048f1">Release Candidate of RssBandit 1.5</a> through its paces and my &ldquo;Update All Feeds&rdquo;&nbsp;brings me&nbsp;<a href="http://www-03.ibm.com/developerworks/blogs/page/donferguson?entry=near_death_experience">Near Death Experience</a> from September 2005.&nbsp; I am not sure why this particular blog article was refetched by RssBandit.&nbsp; It might be part of&nbsp;the random time-machine feature of the aggregator or the web site.</p><p align="center">{tags: <a href="http://www.technorati.com/tag/orcmid" rel="tag">orcmid</a> <a href="http://www.technorati.com/tag/Don+Ferguson" rel="tag">Don Ferguson</a> <a href="http://www.technorati.com/tag/IBM" rel="tag">IBM</a> <a href="http://www.technorati.com/tag/Microsoft" rel="tag">Microsoft</a>}</p><p>This was long before the January 2007 news that <a href="http://www.redmonk.com/jgovernor/2007/01/16/don-ferguson-joins-microsoft-5-things-you-didnt-know/">Don Ferguson has moved to Microsoft</a>.&nbsp; Shortly after that became public, there was some <a href="http://scobleizer.com/2007/01/17/ibm-shows-why-employees-shouldnt-blog-on-corporate-sites/">blogosphere griping</a> about how IBM-site blogs of alums tend to be removed.</p><p>The masthead over the September 2005&nbsp;article does point out that &ldquo;Dr. Ferguson is no longer an employee of IBM,&rdquo; as does the <a href="http://www-03.ibm.com/developerworks/blogs/page/donferguson">front page of that blog</a>, with its last entry dated September 22, 2006 (one year later, which I didn&rsquo;t cotton to on first look).&nbsp; So far, Don&rsquo;s blog is still proudly hosted at IBM developerWorks, although he is not listed in the directory of IBM bloggers.&nbsp; Fair enough.</p><p>I subscribed to Don Ferguson&rsquo;s blog because of his architectural perspective, and I look forward to reading any blog he takes up elsewhere now that IBM developerWorks is no longer a haven for his postings.&nbsp; His past postings are also a treasure and it honors IBM and Don&rsquo;s contribution there to have&nbsp;preserved them.</p><p>Ferguson&nbsp;was also an ecumenical participant in the Web Services work jointly sponsored by IBM and Microsoft.&nbsp; It&rsquo;s not unnatural to see him want to deepen that contribution in some way where he finds Microsoft a suitable home.&nbsp; </p><p>I wonder.&nbsp;&nbsp;Did he think he needed that&nbsp;Black Belt before signing on at Redmond or to&nbsp;remain on at IBM?</p><div style="clear:both; padding-bottom: 0.25em;"></div>
    </p>
	<span class="byline">posted by orcmid 
       at <a href="http://orcmid.com/blog/2007/01/don-ferguson-near-death-experience.asp">1/21/2007 05:31:14 PM</a></span>
	  
         <!-- 2004-05-10 -->
		<div class="blogComments">
			&nbsp;<br /><b><i>Comments:</i></b><!-- 2004-10-04 -->  
			
	    <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=3896669&amp;postID=116942947429848550">Post a Comment</a>
		</div>
