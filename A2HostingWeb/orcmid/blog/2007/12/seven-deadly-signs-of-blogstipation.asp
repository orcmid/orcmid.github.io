...
<!-- ORCMID'S LAIR BLOGGER.COM TEMPLATE
     ...
     2002-10-31 Template modification adventures.  Add a configuration-
        ...
        title into a link
   $$Header: /A2HostingWeb/orcmid/blog/2007/12/seven-deadly-signs-of-blogstipation.asp 1     08-10-07 13:17 Orcmid $
   -->
<head>
<title>Orcmid's Lair: The Seven Deadly Signs of Blogstipation</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<td bgcolor="white" colspan="2"><!-- 2004-10-02 -->
      ...
      <h3><a name="2007-12-20" href="#2007-12-20">
          <font color="#660000">2007-12-20</font></a></h3>
   	

	<div class="posts">
    <a name="7637783115363512592"></a>
    
     <h2><font color="#000080"><!-- 2004-09-02 -->
	 
	 The Seven Deadly Signs of Blogstipation
	 </font>
     </h2>
    

	<p>
    <div style="clear:both;"></div><div class="wlWriterSmartContent" id="scid:0767317B-992E-4b12-91E0-4F059A8CECA8:0e1ee357-1672-4cd1-afde-b69bc57304bd" style="padding-right: 0px; display: inline; padding-left: 0px; padding-bottom: 0px; margin: 0px; padding-top: 0px">Technorati Tags: <a href="http://technorati.com/tags/orcmid" rel="tag">orcmid</a>, <a href="http://technorati.com/tags/blogging" rel="tag">blogging</a>, <a href="http://technorati.com/tags/blogstipation" rel="tag">blogstipation</a>, <a href="http://technorati.com/tags/RSS%20congestion" rel="tag">RSS congestion</a>, <a href="http://technorati.com/tags/procrastination" rel="tag">procrastination</a></div> <p>I just noticed that my Windows Live Writer (WLW) drafts folder has 188 items in it, not counting this one.&nbsp; Part of the problem is that WLW lets me accumulate drafts so easily.&nbsp; It is very easy to use WLW blog drafts for note-taking.&nbsp; There is this small difficulty that, um, the idea about blog drafts is that, er, they should turn into posts with some regularity?&nbsp; </p> <p>So, deadly signs.&nbsp; These come to mind ...</p> <ol> <li>I have more blog drafts (188) than the posts made so far this year (124):</li> <ul> <li>25 at <a href="http://orcmid.spaces.live.com/" target="_blank">Orcmid's Live Hangout</a> (where it is painfully easy to post images and screen shots)</li> <li>63 at <a href="http://orcmid.com/blog" target="_blank">Orcmid's Lair</a> (not counting this one or any that follow it)</li> <li>27 at <a href="http://orcmid.com/BlunderDome/clueless/" target="_blank">Professor von Clueless in the Blunder Dome</a> (with most drafts being destined for here)</li> <li>&nbsp; 9 at <a href="http://miser-theory.info/astraendo/pn/" target="_blank">Numbering Peano</a> with much more called for here<br>&nbsp;&nbsp; </li></ul> <li>I will soon have more marked-for-follow-up-in-a-blog feed reader items (2456) than all of the posts I have made (3289) since my first post on <a href="http://orcmid.com/blog/2002_10_27_lair-chive.asp#83664807" target="_blank">October 28, 2002</a>.&nbsp; It was about blogging, of course.&nbsp;&nbsp; The backlog increases about 35 items every day.<br>&nbsp;&nbsp;&nbsp; </li> <li>Every time I open a draft to work on it, I find that there is always more to research and link to before I can finish it.&nbsp; And, shudder, many drafts need to be broken up into multiple posts ... some day.<br>&nbsp;&nbsp; </li> <li>When I see something relevant to an existing draft, I cannot find what I've already written and obsess until I do.<br>&nbsp;&nbsp; </li> <li>There are so many drafts that it is unpleasant to use the Open Drafts menu in Windows Live Writer.&nbsp; I have a shortcut to the drafts folder and I use Windows Explorer to scroll through the titles in detail view, double-clicking to open the winner in WLW.<br>&nbsp;&nbsp;&nbsp; </li> <li>I keep thinking that my problems would be cured if I started some new topic-focused blogs, or maybe a wiki or two.&nbsp; How about some podcasting, videos and screen-casting.&nbsp; Yes, that's the ticket.<br>&nbsp;&nbsp;&nbsp; </li> <li>It takes me 2-3 hours every day to scan through the morning's unread blog items in my 257 feeds.&nbsp; The feed reader is getting pokey and tends to crash.&nbsp; I am afraid to switch to folders other than the giant marked-for-follow-up list because it hemorrhages when I switch back.&nbsp; So I can't easily find posts filed under particular categories that I want to review in completing any of my drafts.</li></ol> <p>Well, that is not very well thought out.&nbsp; Maybe I should save this as a draft and search for related material in the blogosphere. ... You think?</p> <p>Better yet, I will post this and then figure out what to get Vicki for her holiday gift while there's a little time left.</p>  <div style="clear:both; padding-bottom:0.25em"></div>
    </p>
	<span class="byline">posted by orcmid 
       at <a href="http://orcmid.com/blog/2007/12/seven-deadly-signs-of-blogstipation.asp">12/20/2007 04:21:00 PM</a></span>
		...
		<div class="blogComments">
			...
			<div class="blogComment">
				&nbsp;<br /><a name="3892875372333414136"></a> 
				Good luck, Vicki.  Megan's in the same boat -- her husband's still pondering possibilities.<BR/><BR/>Orcmid, you are a prolific writer/thinker.  I doubt many people have blogstipation of this magnitude.  Keep 'em coming!<BR/><BR/>Being a bit of a geek about remembering dates, I happen to know I was in Tijuana the evening of your first blog post.  Among other things, I was at a bar that caught on fire, and the staff, after putting out a roaring fire in the ceiling above the bar, set up a big fan to clear the smoke and then raced around giving everyone a free round of drinks so that they wouldn't leave.  It seemed that wasn't their first fire during business hours, from the well-organized reaction.<br />
				<div class="byline">
                  <a href="http://orcmid.com/blog/2007/12/seven-deadly-signs-of-blogstipation.asp#c3892875372333414136" 
                     title="permanent link">#</a> 
                  posted by <span style="line-height:16px" class="comment-icon anon-comment-icon"><img src="http://www.blogger.com/img/anon16-rounded.gif" alt="Anonymous" style="display:inline;" /></span>&nbsp;<span class="anon-comment-author">dmahugh</span>: 
                  20 December, 2007 17:26
                </div>
				<span class="item-control blog-admin pid-222740749"><a style="border:none;" href="http://www.blogger.com/delete-comment.g?blogID=3896669&postID=3892875372333414136" title="Delete Comment" ><span class="delete-comment-icon">&nbsp;</span></a></span>
			</div>
			
	    <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=3896669&postID=7637783115363512592">Post a Comment</a>
		</div>
