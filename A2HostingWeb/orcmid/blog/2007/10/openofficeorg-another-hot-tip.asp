...
<!-- ORCMID'S LAIR BLOGGER.COM TEMPLATE
     ...
     2002-10-31 Template modification adventures.  Add a configuration-
        ...
        title into a link
   $$Header: /A2HostingWeb/orcmid/blog/2007/10/openofficeorg-another-hot-tip.asp 1     09-08-22 16:11 Orcmid $
   -->
<head>
<title>Orcmid's Lair: OpenOffice.org: Another Hot Tip!</title>
...
<link rel="alternate" type="application/atom+xml" title="Orcmid's Lair - Atom" href="http://www.blogger.com/feeds/3896669/7386159802781049936/comments/default" />
 <link rel="stylesheet" type="text/css" href="http://www.blogger.com/css/blog_controls.css"/> <link rel="stylesheet" type="text/css" href="http://www.blogger.com/dyn-css/authorization.css?targetBlogID=3896669&zx=aaf5b5c3-0233-4038-b076-73a61af01578"/><script type="text/javascript" src="http://www.blogger.com/js/backlink.js"></script>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<td bgcolor="white" colspan="2"><!-- 2004-10-02 -->
      ...
      <h3><a name="2007-10-08" href="#2007-10-08">
          <font color="#660000">2007-10-08</font></a></h3>
   	

	<div class="posts">
    <a name="7386159802781049936"></a>
	...
	<p>
    <div style="clear:both;"></div><p> [<strong>update 2008-10-13</strong> The installer bug observed here is not specific to OpenOffice.org, it seems to be specific to installers.&nbsp; I have not examined this enough to see which installers do this, but I have seen the identical problem with installers of other software.&nbsp; In all cases, the software will correctly place a single-user install under the user who is running the install.&nbsp; But the dialog identifies the wrong user, apparently always showing the User ID for the first user created on the machine.] </p> <div style="padding-bottom: 0px; margin: 0px; padding-left: 0px; padding-right: 0px; display: inline; float: none; padding-top: 0px" id="scid:0767317B-992E-4b12-91E0-4F059A8CECA8:294a59af-3a3d-45f6-ba54-080bec9b4208" class="wlWriterEditableSmartContent">Technorati Tags: <a href="http://technorati.com/tags/orcmid" rel="tag">orcmid</a>, <a href="http://technorati.com/tags/OpenOffice.org" rel="tag">OpenOffice.org</a>, <a href="http://technorati.com/tags/OO.o+Installer+Bug" rel="tag">OO.o Installer Bug</a>, <a href="http://technorati.com/tags/confirmable+experience" rel="tag">confirmable experience</a>, <a href="http://technorati.com/tags/trustworthiness" rel="tag">trustworthiness</a></div> <p></p> <p>When I <a href="http://orcmid.com/blog/2007/09/open-office-not-ready-for-just-plain.asp">installed OO.o 2.3 on my sister's computer</a>, I was disturbed that it kept offering her admin account as the single account it would install under, even though we were not running the installer under that account.&nbsp; </p> <p>At my XP SP2 system at home, I installed the same version and I did not have that problem.&nbsp; This time it did name the account I was using, even though it was not my normal administrator account.&nbsp; It was, however, the first account that had been set up on my machine, as was the case for admin on my sister's machine.</p> <p>So I tried again, this time on my Tablet PC and Windows Vista Ultimate.&nbsp; For variety, I also used the OO.o 2.1 Novell edition, installing from CD-ROM.&nbsp; There, I ran into exactly the same problem.&nbsp; I was presented with this dilemma:</p> <p align="center"><img style="display: inline" title="Installer shows incorrect User ID for &quot;me&quot; " alt="Installer shows incorrect User ID for &quot;me&quot; " src="http://orcmid.com/blog/images/OpenOffice.orgAnotherHotTip_12E97/OOoSingleUserInstall.jpg" width="504" height="380"> </p> <p align="left"><strong>Once again, me is not admin.</strong>&nbsp; I am doing this install from my standard-user account (SUA).&nbsp; But just to see what would happen, I took that option anyhow.&nbsp; <strong>Guess what: This dialog is lying.</strong>&nbsp; It will install only for the account being used.&nbsp; <strong>The bug is that it doesn't present the correct account name.&nbsp; The behavior is actually correct.</strong></p> <p align="left">So if you are attempting to install OpenOffice.org 2.3 (or the 2.1 Novell Edition) only under the account you are running in, you can ignore the incorrect account name.&nbsp; It will do the right thing.&nbsp; </p> <hr>  <p align="left">The next time I assist my sister in adding an OpenOffice.org update, I'll be sure to uninstall the current version and then install the new one only for her standard account.</p> <p align="left">Now, you might wonder what the fuss is all about.&nbsp; If you are as obsessive as I am about computer security, you might want to omit all but pure administrative applications from the administrative account, and only ever use the administrative account for essential administrative operations.</p> <p align="left">This means that to have ordinary applications install properly in the ordinary accounts where it is safest to run them I elevate my standard-user account to an administrator account just long enough to install the software and run it the first time under the standard account.&nbsp; This gyration is required because many programs expect to perform final administrative setup operations on the first execution.&nbsp; Setting of registry entries and creation of application data, plus other details, may be specific to the account that is used for the install.&nbsp; I will usually discover the firewall conditioning that is required upon the first execution.&nbsp; From then on, I can use the program as a standard user.</p> <p align="left">When certain programs (e.g., Second Life) install for all users with no other option, I will remove the shortcuts and links placed on the "All Users" desktop and startup menu and place them in the profile information of my standard user account.&nbsp; This is just a little preventative against my foolishly using recreational software from my administrative account.</p> <p align="left">[<strong>update 2008-10-13</strong> Moved this post from Orcmid’s Live Hideout to Orcmid’s Lair for better preservation and tie-in to other confirmable-experience and cybergeek topics.]</p>  <div style="clear:both; padding-bottom:0.25em"></div><p class="blogger-labels">Labels: <a rel='tag' href="http://orcmid.com/blog/labels/confirmable experience.asp">confirmable experience</a>, <a rel='tag' href="http://orcmid.com/blog/labels/cybersmith.asp">cybersmith</a>, <a rel='tag' href="http://orcmid.com/blog/labels/interoperability.asp">interoperability</a>, <a rel='tag' href="http://orcmid.com/blog/labels/software usability.asp">software usability</a></p>
    </p>
	<span class="byline">posted by orcmid 
       at <a href="http://orcmid.com/blog/2007/10/openofficeorg-another-hot-tip.asp">10/08/2007 11:14:00 AM</a></span>
	  
         <!-- 2004-05-10 -->
		<div class="blogComments">
			&nbsp;<br /><b><i>Comments:</i></b><!-- 2004-10-04 -->  
			
	    <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=3896669&postID=7386159802781049936">Post a Comment</a>
		</div>
