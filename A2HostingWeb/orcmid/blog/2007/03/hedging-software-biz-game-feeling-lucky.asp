...
<!-- ORCMID'S LAIR BLOGGER.COM TEMPLATE
     ...
     2002-10-31 Template modification adventures.  Add a configuration-
        ...
        title into a link
   $$Header: /A2HostingWeb/orcmid/blog/2007/03/hedging-software-biz-game-feeling-lucky.asp 1     08-10-07 13:12 Orcmid $
   -->
<head>
...
Stephane ...</a><br />
	...
	<div class="posts">
    <a name="6464544232752294391"></a>
    

	<p>
    <div style="clear:both;"></div><h2>Hedging&nbsp;the Software Biz Game: Feeling Lucky?</h2>
<p>According to <a href="http://stephesblog.blogs.com/my_weblog/2007/03/the_best_presen.html">Stephen Walli</a>, Brent Williams has created one of the best-ever slide decks on the nature of the software business and how open-source software business works.&nbsp; You can check out the slides (in a PDF file) on Walli&rsquo;s blog.</p>
<p><strong><em>You</em> must read this</strong>.&nbsp; If you are in Information Technology or work as an Independent Software Vendor, there are basic economic&nbsp;conditions that you need to understand about the software business, whether&nbsp;employing proprietary or open-source code.&nbsp; <strong>Everyone in Redmond</strong> and its outlying satellites should read it for sure. </p>
<p>Don&rsquo;t be confused by the promotion of the Eclipse model at the end, unless you are inclined to mount a business having Eclipse as the technical platform.&nbsp; (A&nbsp;tangential&nbsp;question is whether Eclipse can produce lock-in and will IBM Global Services have a set of master keys, but that is incidental to the powerful analysis reflected in the complete&nbsp;slide set.)</p>
<hr>
<small>
<p>I was tickled to see one of my favorite terms, &ldquo;diagonal functionality&rdquo; (exemplified by Microsoft Dynamics in its original &ldquo;Project Green&rdquo; manifestation) on page 41 of the 48 slides.&nbsp; I recently&nbsp;illustrated the same notion&nbsp;with the&nbsp;<a href="http://orcmid.com/blog/2007/03/oox-odf-woes-of-odf-emerging-discussion.asp">WOES</a> (Windows-Office-Exchange-Sharepoint) stack in a comment on Doug Mahugh&rsquo;s <a href="http://blogs.msdn.com/dmahugh/archive/2007/03/01/interoperability-what-s-in-a-name.aspx">recent article</a> on Interoperability.</p>
<dl>
<dt><strong><em>listening to:</em></strong></dt>
<dd>My <a href="http://www.pandora.com/stations/758bbd46d212ad39f69b964d52a657d7e8c7587b2172781c#">Meat Loaf Exuberance</a> station on Pandora (kicked-off with <em>Paradise by the Dashboard Light</em></dd></dl></small><div class="bjtags">Tags:  <a rel="tag" href="http://technorati.com/tag/orcmid">orcmid</a>, <a rel="tag" href="http://technorati.com/tag/open+source">open+source</a>, <a rel="tag" href="http://technorati.com/tag/software+business">software+business</a>, <a rel="tag" href="http://technorati.com/tag/Brent+Williams">Brent+Williams</a>, <a rel="tag" href="http://technorati.com/tag/Stephen+Walli">Stephen+Walli</a>, <a rel="tag" href="http://technorati.com/tag/business+models">business+models</a></div><div style="clear:both; padding-bottom:0.25em"></div>
    </p>
	<span class="byline">posted by orcmid 
       at <a href="http://orcmid.com/blog/2007/03/hedging-software-biz-game-feeling-lucky.asp">3/09/2007 12:14:00 PM</a></span>
	  
         <!-- 2004-05-10 -->
		<div class="blogComments">
			&nbsp;<br /><b><i>Comments:</i></b><!-- 2004-10-04 -->  
			
	    <a class="comment-link" href="http://www2.blogger.com/comment.g?blogID=3896669&postID=6464544232752294391">Post a Comment</a>
		</div>
