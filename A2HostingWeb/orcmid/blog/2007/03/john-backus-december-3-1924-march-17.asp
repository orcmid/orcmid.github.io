...
<!-- ORCMID'S LAIR BLOGGER.COM TEMPLATE
     ...
     2002-10-31 Template modification adventures.  Add a configuration-
        ...
        title into a link
   $$Header: /A2HostingWeb/orcmid/blog/2007/03/john-backus-december-3-1924-march-17.asp 1     08-10-07 13:12 Orcmid $
   -->
<head>
...
I couldn&#39;t help my...</a><br />
	...
	<td bgcolor="white" colspan="2"><!-- 2004-10-02 -->
      ...
      <h3><a name="2007-03-20" href="#2007-03-20">
          <font color="#660000">2007-03-20</font></a></h3>
   	

	<div class="posts">
    <a name="1105440448026648949"></a>
    

	<p>
    <div style="clear:both;"></div><h2>John Backus: December 3, 1924 &ndash; March 17, 2007</h2>
<p>I just learned about the death of John Backus from a testimonial to Fortran on the blog of programming-writer <a href="http://www.charlespetzold.com/blog/2007/03/200129.html">Charles Petzold</a>.</p>
<p>There is more about John and his career at <a href="http://www.msnbc.msn.com/id/17704662/">MSNBC</a> and <a href="http://news.com.com/2061-11199_3-6168805.html">CNet</a>.&nbsp; The <a href="http://developers.slashdot.org/article.pl?sid=07/03/20/0223234">slashdot coverage</a> is&nbsp;predictably banal.&nbsp; <a href="http://en.wikipedia.org/wiki/John_Backus">Wikipedia</a> is on top of events, although I am not clear about the sketched&nbsp;relationship of FP (the language, not the field), FL, and Iverson&rsquo;s J.&nbsp; The <a href="http://www.nytimes.com/2007/03/20/business/20backus.html">New York Times</a> account is more rounded yet skimpy-feeling.&nbsp;<a href="http://lambda-the-ultimate.org/node/2140">Λ the Ultimate</a> has a touching blurb and comment threads.&nbsp; His 1977 Turing Award Lecture (<a href="http://www.stanford.edu/class/cs242/readings/backus.pdf">PDF file</a>) is also on-line.</p>
<p>John&rsquo;s influence did not end with <a href="http://en.wikipedia.org/wiki/Fortran">Fortran</a> of course.&nbsp; He established&nbsp;a powerful form of description,&nbsp;now known as <a href="http://en.wikipedia.org/wiki/Backus%E2%80%93Naur_form">BNF</a>,&nbsp;that led to far greater regularity and expressiveness in later programming languages.&nbsp; The concrete syntax of <a href="http://www.w3.org/TR/2006/REC-xml11-20060816/#sec-notation">XML</a> is specified in a version of BNF, as are <a href="http://java.sun.com/docs/books/jls/third_edition/html/syntax.html">Java</a> and similar modern languages.&nbsp; </p>
<p>Following work on <a href="http://orcmid.com/BlunderDome/clueless/2006/03/appreciating-algol-60-launching.asp">ALGOL</a>, Backus moved on to&nbsp;consider how to liberate programming from what&nbsp;he termed the von Neumann style.&nbsp; He devised the language FP (and a formalized concrete version, FFP that is&nbsp;more like a programming language in the way that LISP is).&nbsp; FP illustrated&nbsp;higher levels of abstraction that harmonized concepts of the functional-programming community and the array-oriented APL language of Kenneth Iverson.</p>
<hr>
<small>
<p>I only saw Backus in person once, although I spoke to him on the phone another time (about functional programming, not Fortran) and I became acquainted with Ed Wimmers, who worked with John, by coincidence.</p>
<p>Fortran was my first programming language, before there was a Roman Numeral on it.&nbsp; Fortran II was in beta and we were still using the original IBM 704 compiler. My first program was an experiment with a particular mathematical formula that I discovered was unstable (lots of opportunity for division by zero) when transcribed directly into Fortran.</p>
<p>It only now struck me that I&rsquo;ve had the remarkable experience of being around at that time (I was 19 in 1958) of Fortran&rsquo;s birth, with no expectation&nbsp;that&nbsp;at the end of the&nbsp;60's I would be the Chairman of the ANSI X3J3 Fortran subcommittee.&nbsp; That was in the transition window between Fortran 66 (aka Fortran IV) &mdash;&nbsp;the first-ever ANSI Standard for a programming language&nbsp;&mdash; and initiation of work on Fortran 77. By then I was still involved with Fortran but my devotion was Algol 60, functional languages, and languages for platform software (compilers, tools&nbsp;and operating-systems) development.</p>
<p>[<strong>update 2007&ndash;03&ndash;20T21:43Z</strong> Add NYT, lambda-the-ultimate, and Turing Award links]</p></small><div class="bjtags">Tags:  <a rel="tag" href="http://technorati.com/tag/orcmid">orcmid</a>, <a rel="tag" href="http://technorati.com/tag/John+Backus">John+Backus</a>, <a rel="tag" href="http://technorati.com/tag/Charles+Petzold">Charles+Petzold</a>, <a rel="tag" href="http://technorati.com/tag/Fortran">Fortran</a>, <a rel="tag" href="http://technorati.com/tag/Algol">Algol</a>, <a rel="tag" href="http://technorati.com/tag/Functional+Programming">Functional+Programming</a></div><div style="clear:both; padding-bottom:0.25em"></div>
    </p>
	<span class="byline">posted by orcmid 
       at <a href="http://orcmid.com/blog/2007/03/john-backus-december-3-1924-march-17.asp">3/20/2007 12:57:00 PM</a></span>
	  
         <!-- 2004-05-10 -->
		<div class="blogComments">
			&nbsp;<br /><b><i>Comments:</i></b><!-- 2004-10-04 -->  
			
	    <a class="comment-link" href="http://www2.blogger.com/comment.g?blogID=3896669&postID=1105440448026648949">Post a Comment</a>
		</div>
