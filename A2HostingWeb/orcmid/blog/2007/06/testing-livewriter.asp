...
<!-- ORCMID'S LAIR BLOGGER.COM TEMPLATE
     ...
     2002-10-31 Template modification adventures.  Add a configuration-
        ...
        title into a link
   $$Header: /A2HostingWeb/orcmid/blog/2007/06/testing-livewriter.asp 1     08-10-07 13:16 Orcmid $
   -->
<head>
<title>Orcmid's Lair: Testing LiveWriter</title>
...
The oth...</a><br />
	...
	<td bgcolor="white" colspan="2"><!-- 2004-10-02 -->
      ...
      <h3><a name="2007-06-02" href="#2007-06-02">
          <font color="#660000">2007-06-02</font></a></h3>
   	

	<div class="posts">
    <a name="5269565814746206357"></a>
	...
	<p>
    <div style="clear:both;"></div><p>I am a happy user of BlogJet, but I have found that it doesn't provide correct functionality with the new Blogger system.</p> <p>So I installed LiveWriter for two reasons:</p> <ol> <li>I wanted to see how well it works and whether it provides improved functionality, with or without plug-ins.<br>&nbsp;&nbsp; </li> <li>I wanted to read the LiveWriter terms of service and EULA to fact-check a <a href="http://ayende.com/Blog/archive/2007/06/02/Arrest-that-man-He-had-built-workaround-a-technical-limitaion.aspx">silly statement</a> by Oren Eini on whether&nbsp;a procedure for executing LiveWriter with the correct language settings constitutes "working around a technical limitation,"&nbsp; something that comes up around a dispute between Microsoft and a company that severely hacked the Visual Studio Express Editions in order to inject a plug-in where there is no plug-in support.<br>&nbsp;&nbsp; </li> <ul> <li>It turns out that there is no language about overcoming technical limitations in the LiveWriter license statement.<br>&nbsp;&nbsp; </li> <li>In fact, the LiveWriter license statement is a generic one for Windows Live and MSN services, which makes it particularly weird for my use of it, which is with Blogger.&nbsp; The LiveWriter license is mostly inapplicable, but it doesn't speak to technical limitations.&nbsp; The usual language about reverse-engineering and decompiling is present, as with all Microsoft software.</li></ul></ol> <p>If this post makes it to my site, I will consider exploring LiveWriter further.&nbsp; </p> <div class="wlWriterSmartContent" id="0767317B-992E-4b12-91E0-4F059A8CECA8:278feb3f-68d2-45bc-aee2-f58049890b40" contenteditable="false" style="padding-right: 0px; display: inline; padding-left: 0px; padding-bottom: 0px; margin: 0px; padding-top: 0px">Technorati Tags: <a href="http://technorati.com/tags/orcmid" rel="tag">orcmid</a>, <a href="http://technorati.com/tags/Ayende" rel="tag">Ayende</a>, <a href="http://technorati.com/tags/LiveWriter" rel="tag">LiveWriter</a>, <a href="http://technorati.com/tags/Visual%20Studio%20hacking" rel="tag">Visual Studio hacking</a></div><div style="clear:both; padding-bottom:0.25em"></div>
    </p>
	<span class="byline">posted by orcmid 
       at <a href="http://orcmid.com/blog/2007/06/testing-livewriter.asp">6/02/2007 10:04:00 PM</a></span>
	  
         <!-- 2004-05-10 -->
		<div class="blogComments">
			&nbsp;<br /><b><i>Comments:</i></b><!-- 2004-10-04 -->  
			
	    <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=3896669&postID=5269565814746206357">Post a Comment</a>
		</div>
