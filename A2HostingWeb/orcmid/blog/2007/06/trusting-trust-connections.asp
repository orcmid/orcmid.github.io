...
<!-- ORCMID'S LAIR BLOGGER.COM TEMPLATE
     ...
     2002-10-31 Template modification adventures.  Add a configuration-
        ...
        title into a link
   $$Header: /A2HostingWeb/orcmid/blog/2007/06/trusting-trust-connections.asp 1     08-10-07 13:16 Orcmid $
   -->
<head>
<title>Orcmid's Lair: Trusting Trust: Connections</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<td bgcolor="white" colspan="2"><!-- 2004-10-02 -->
      ...
      <h3><a name="2007-06-28" href="#2007-06-28">
          <font color="#660000">2007-06-28</font></a></h3>
   	

	<div class="posts">
    <a name="4070589979173475423"></a>
	...
	<p>
    <div style="clear:both;"></div><p>On the <em><a href="http://mostlysecurity.blogspot.com/">Mostly Security Stories</a></em> blog, there is an article on "<a href="http://mostlysecurity.blogspot.com/index.html#7540322450859078894">The Myth of Provable Correctness as a Security Solution</a>&nbsp;[<a href="#1">1</a>]."&nbsp; Although the article goes overboard on what you'd have to prove correct, there is an important observation on how trust is always required (as opposed to proving that trust is unnecessary because trust can't be breached in the first place, an arrangement that is too easily confused with trust).</p> <div class="wlWriterSmartContent" id="0767317B-992E-4b12-91E0-4F059A8CECA8:e1cd1876-5246-4c5b-9006-c49378214ab9" contenteditable="false" style="padding-right: 0px; display: inline; padding-left: 0px; padding-bottom: 0px; margin: 0px; padding-top: 0px">Technorati Tags: <a href="http://technorati.com/tags/orcmid" rel="tag">orcmid</a>, <a href="http://technorati.com/tags/trust" rel="tag">trust</a>, <a href="http://technorati.com/tags/Ken%20Thompson" rel="tag">Ken Thompson</a>, <a href="http://technorati.com/tags/trusting%20trust" rel="tag">trusting trust</a>, <a href="http://technorati.com/tags/David%20Wheeler" rel="tag">David Wheeler</a>, <a href="http://technorati.com/tags/provable%20correctness" rel="tag">provable correctness</a>, <a href="http://technorati.com/tags/secure%20code" rel="tag">secure code</a></div> <p>As an example of the possibility of undetectable tampering, the article mentions Ken Thompson's 1984 Turing Award Lecture, "<a href="http://www.acm.org/classics/sep95/">Reflections on Trusting Trust</a>."&nbsp; Thompson proposed a way that a compiler or other tool could be built that held a Trojan that was not apparent in its own source code, but that would be re-injected into any recompilation of itself from a sufficiently-similar source code.&nbsp; The purpose of the Trojan would be to inject still other Trojans into other kinds of programs that might be compiled with the compiler, or it could be used to drop a payload onto any machine on which the compiler is operated.</p> <p><a href="http://www.dwheeler.com/blog/">David A. Wheeler</a> has since proposed <a href="http://www.acsa-admin.org/2005/abstracts/47.html">a technique</a> that, with two independently-developed compilers for the same language, one could determine whether or not there was some peculiar behavior in one or both of them that reflected undetected defects or even the possibility of hidden malicious code at the binary level in one or the other.&nbsp; It might not be possible to determine which is the culprit (and both could have problems), but it would be clear that there was something amiss.&nbsp; </p> <p>Wheeler's proposal is not going to bring us to a point where we can avoid trust, but it is an interesting demonstration that the businesses of finding exploitable situations and of detecting suspicious code are in an arms race.&nbsp;&nbsp; This leaves us with the not-so-satisfying but realistic conclusion that there are always exploitable conditions, and that new safeguards&nbsp;are also always being discovered.&nbsp; For&nbsp;numerous practical reasons, the culprits will always have the edge.&nbsp; </p> <hr> <small> <p>[<a id="1">1</a>] These articles don't appear to have permalinks;&nbsp;I have failed to find archive pages with the individual entries.&nbsp; "The Myth" was posted on Saturday, 2007-06-09 and you may have to scroll down for it.&nbsp; The RSS feed only provides digests.&nbsp; I have made a personal cache of the article for preservation purposes and you might want to do that too.</p> <p>The connections noted in the title have to do with the following sequence of events that demonstrate the coincidental web as a conversation.&nbsp; On 2007-06-23, <a href="http://www.blogger.com/profile/12400245912315158196">Algosome</a> posted a <a href="http://orcmid.com/blog/2007/02/peter-naur-science-for-computer-science.asp#4736429141227567301">comment</a> on my <a href="http://orcmid.com/blog/2007/02/peter-naur-science-for-computer-science.asp">blog post</a> about Peter Naur's Turing Award paper.&nbsp; I went to Algosome's blog and was delighted to see that we have a shared interest in security topics.&nbsp; When I saw the post on "The Myth" I wanted to comment, but that does not seem possible.&nbsp; I also don't see any way to contact Algosome directly.&nbsp; Instead, I am blogging here about Wheeler's paper as a way of commenting on Algosome's article.&nbsp; In this case, the conversation is hampered and asymmetrical.&nbsp; I don't normally invest this much effort in what could have been accomplished by a&nbsp;simple comment on someone else's blog.&nbsp;</p></small><div style="clear:both; padding-bottom:0.25em"></div>
    </p>
	<span class="byline">posted by orcmid 
       at <a href="http://orcmid.com/blog/2007/06/trusting-trust-connections.asp">6/28/2007 09:26:00 AM</a></span>
	  
         <!-- 2004-05-10 -->
		<div class="blogComments">
			&nbsp;<br /><b><i>Comments:</i></b><!-- 2004-10-04 -->  
			
	    <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=3896669&postID=4070589979173475423">Post a Comment</a>
		</div>
