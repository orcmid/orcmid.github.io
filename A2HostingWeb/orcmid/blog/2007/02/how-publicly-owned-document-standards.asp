...
<!-- ORCMID'S LAIR BLOGGER.COM TEMPLATE
     ...
     2002-10-31 Template modification adventures.  Add a configuration-
        ...
        title into a link
   $$Header: /A2HostingWeb/orcmid/blog/2007/02/how-publicly-owned-document-standards.asp 1     07-02-15 8:51 Orcmid $
   -->
<head>
<title>Orcmid's Lair: How Publicly-Owned Document Standards Matter</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<p>
    <div style="clear:both;"></div><p>Thanks to Bob Sutor&rsquo;s <a href="http://www.sutor.com/newsite/blog-open/?p=1407">morning link post</a>, I&nbsp;was led to <a href="http://www.theglobeandmail.com/opinions/columnists/Shane+SchickBio.html">Shane Schick</a>&rsquo;s valuable <em>Globe and Mail</em> column, &ldquo;<a href="http://www.theglobeandmail.com/servlet/story/LAC.20070208.TWINSIDER08/TPStory/Business">Will today&rsquo;s text files be tomorrow&rsquo;s stone tablets?</a>&rdquo;&nbsp; This is a very handy 30,000-foot account of current activities with regard to obtaining some sort of ISO imprimatur for document-format specifications.&nbsp; Some details are a little off (e.g., companies don&rsquo;t submit specifications directly to ISO), but&nbsp;I don&rsquo;t see anything that seriously&nbsp;detracts from this worthy overview.&nbsp; </p><p>My title is a little off too, since having document-format specifications promulgated by various standards-ratifying bodies is about as directly public as the U.S. Electoral College system.&nbsp; But it&rsquo;s what we have (that is,&nbsp;ISO and the various nation-representing bodies).&nbsp; It is always good to ask &ldquo;who owns my documents&rdquo; and &ldquo;who owns my ability to access and preserve my documents,&rdquo; and also &ldquo;who owns the format I am counting on for stability and continued usability,&rdquo; whether they are in the custody of Google or of some application (let&rsquo;s say Mind Manager for variety) on your desktop computer.</p><div style="clear:both; padding-bottom: 0.25em;"></div>
    </p>
	<span class="byline">posted by orcmid 
       at <a href="http://orcmid.com/blog/2007/02/how-publicly-owned-document-standards.asp">2/11/2007 10:36:22 AM</a></span>
	  
         <!-- 2004-05-10 -->
		<div class="blogComments">
			&nbsp;<br /><b><i>Comments:</i></b><!-- 2004-10-04 -->  
			
	    <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=3896669&amp;postID=117121898253696071">Post a Comment</a>
		</div>
