...
<!-- ORCMID'S LAIR BLOGGER.COM TEMPLATE
     ...
     2002-10-31 Template modification adventures.  Add a configuration-
        ...
        title into a link
   $$Header: /A2HostingWeb/orcmid/blog/2007/02/oox-odf-and-mystery-document-flavors.asp 1     07-02-15 8:51 Orcmid $
   -->
<head>
<title>Orcmid's Lair: OOX-ODF and the Mystery Document Flavors</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
    ...
    &#160;<br />
    <a href="http://orcmid.com/blog/2007/02/oox-odf-danger-of-finding-only-what.asp">OOX-ODF: The Danger of Finding Only What You're Looking For</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/blog/2007/02/dear-microsoft-what-trumps-security-as.asp">Dear Microsoft: What Trumps Security as Job #1?</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/blog/2007/02/opening-science.asp">Opening Science</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/blog/2007/02/office-odf-converter-regatta.asp">An Office-ODF Converter Regatta</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/blog/2007/02/latest-oox-odf-fud-spat-states-prepare.asp">Latest OOX-ODF FUD-Spat: States Prepare to Ban Zip and PDF Files</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/blog/2007/01/raymond-chen-celebrating-old-in-new.asp">Raymond Chen: Celebrating the Old in the New</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/blog/2007/01/awesome-breakthrough-lousy-estimates.asp">Awesome Breakthrough: Lousy Estimates</a><br />
	...
	<td bgcolor="white" colspan="2"><!-- 2004-10-02 -->
      ...
      <h3><a name="2007-02-11" href="#2007-02-11">
          <font color="#660000">2007-02-11</font></a></h3>
   	

	<div class="posts">
    <a name="117124578271527420"></a>
    
     <h2><font color="#000080"><!-- 2004-09-02 -->
	 
	 OOX-ODF and the Mystery Document Flavors
	 </font>
     </h2>
    

	<p>
    <div style="clear:both;"></div><p>I just posted&nbsp;an&nbsp;update to&nbsp;<a href="http://orcmid.com/blog/2007/02/oox-odf-danger-of-finding-only-what.asp">the previous post</a> where I puzzled over the republication of the 5 separate parts of the ECMA-376 specification on the ECMA site.&nbsp; I was particularly baffled about the agitation about them because those parts are closely related to the original October Final Draft parts that were submitted for ECMA approval.&nbsp; There appear to be no changes of substance or even of observable form, other than making them into the official December 2006 ECMA-376 documents.</p><p align="center">{tags: <a href="http://technorati.com/tag/orcmid" rel="tag">orcmid</a> <a href="http://technorati.com/tag/OOX" rel="tag">OOX</a> <a href="http://technorati.com/tag/ODF" rel="tag">ODF</a> <a href="http://technorati.com/tag/ISO" rel="tag">ISO</a> <a href="http://technorati.com/tag/ECMA" rel="tag">ECMA</a> <a href="http://technorati.com/tag/OASIS" rel="tag">OASIS</a> <a href="http://technorati.com/tag/open+document+standards" rel="tag">open document standards</a>}</p><p>What I didn&rsquo;t realize is that a different form of this material appears to have been used in the submission to ISO.&nbsp; Here&rsquo;s what I found, for the benefit of those who won&rsquo;t see any RSS feed for the updated earlier post:</p><p><strong>update 2007-02-12T01:50Z:</strong> <strong><em>I got it!</em></strong>&nbsp; update 2007-02-12T01:59Z tweaking the prose a little more; and 2007-02-12T07:32T for smoothing between this and the previous post:</p><p>First, there is no question in my mind that the <a href="http://www.ecma-international.org/publications/standards/Ecma-376.htm">current downloads</a> constitute the official December 2006 ECMA-376 documents, with all of the October 2006 Final Draft title pages corrected and an official, overall cover (two sheets)&nbsp;attached to the front of Part 1.&nbsp;&nbsp; I am satisfied that this is precisely the same content that was approved by ECMA and also used to form the ISO submission.</p><ul><li>Thanks to a <a href="http://web.mit.edu/~stevenj/www/ecma376.html">cache page</a> provided by <a href="http://math.mit.edu/~stevenj/">Stephen G. Johnson</a>, I see that there was apparently a special ISO-submission document prepared from the 5-part Final Draft that was balloted and approved at ECMA (and preserved in the current 5-part download, with the kind of modifications I identified in the previous post).&nbsp; <br />&nbsp;&nbsp;&nbsp; </li><li>That&rsquo;s unfortunate.&nbsp; It seems that the document that was reviewed by Rob Weir and others as the submission to ISO is a single 6,039 page, 46.9MB PDF.&nbsp; It&nbsp;has the&nbsp;five parts (without the other useful attachments,&nbsp;such as&nbsp;versions of the schemas) simply pasted together consecutively.&nbsp; Each&nbsp;part has its&nbsp;original table of content and separate on-the-page numberings&nbsp;(and sections starting with 1 each time).&nbsp;&nbsp;<br />&nbsp;&nbsp;&nbsp;&nbsp; </li><li>The only differences that I have observed in the single PDF are the addition of the ECMA cover pages (also now on the front of the current Part 1 download), along with the omission of the title page for Part 1, and no other changes:&nbsp; The titles of&nbsp;parts 2-6&nbsp;are still identified as being Final Draft.&nbsp;&nbsp;<br />&nbsp;&nbsp; </li><li>As a document to review,&nbsp;the single-file PDF document is very unsatisfactory.&nbsp; First, there is no overall table of contents.&nbsp; Each part still has its own table of contents and page numbers, but you have to find the parts on your own.&nbsp; In addition, none of the extremely-valuable hyperlinking that works in the .docx versions and the corresponding PDFs are preserved in the single-PDF version.&nbsp; </li></ul><p>Since I had been downloading the drafts as they were announced as available from ECMA TC45, I was not particularly concerned about obtaining replacements for my copies of the final drafts.&nbsp; I lucked out: I had no idea they were ever in any final form but the five parts, each in two formats (.docx and .pdf).&nbsp; When I submitted comments to ECMA, I was able to use those far-more-manageable drafts from October and earlier.&nbsp; </p><p>Although Stephen Johnson has provided a similar collation of the official December 2006&nbsp;downloads,&nbsp;I don&rsquo;t recommend using it.&nbsp;&nbsp; The five separate parts are superior in every respect.&nbsp; They&nbsp;are&nbsp;far more suitable for&nbsp;review, analysis, and&nbsp;exchange of comments.&nbsp; And if you identify the part you are referring to, using section numbers or the printed page numbers, it won&rsquo;t matter whether you are using the mother-of-all-documents or its five handier constituents.&nbsp; </p><p>I have no idea what procedural requirements led to the submission of a single PDF file.&nbsp; I hope that people were advised of the availability of the separated parts in their easier-to-review form.&nbsp; I can certainly understand how relying on the PDF-provided page-count positions would be confusing if used instead of the printed page numbers.</p><div style="clear:both; padding-bottom: 0.25em;"></div>
    </p>
	<span class="byline">posted by orcmid 
       at <a href="http://orcmid.com/blog/2007/02/oox-odf-and-mystery-document-flavors.asp">2/11/2007 06:03:02 PM</a></span>
	  
         <!-- 2004-05-10 -->
		<div class="blogComments">
			&nbsp;<br /><b><i>Comments:</i></b><!-- 2004-10-04 -->  
			
	    <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=3896669&amp;postID=117124578271527420">Post a Comment</a>
		</div>
