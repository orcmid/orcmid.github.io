...
<!-- ORCMID'S LAIR BLOGGER.COM TEMPLATE
     ...
     2002-10-31 Template modification adventures.  Add a configuration-
        ...
        title into a link
   $$Header: /A2HostingWeb/orcmid/blog/2008/01/newsgator-deja-vu-all-over-again.asp 1     08-10-07 13:21 Orcmid $
   -->
<head>
<title>Orcmid's Lair: NewsGator: Deja Vu All Over Again</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
    ...
    &#160;<br />
    <a href="http://orcmid.com/blog/2008/01/happy-birthday-cacm.asp">Happy Birthday, CACM!</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/blog/2007/12/re-video-schmideo.asp">Re: Video Schmideo</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/blog/2007/12/olpc-bring-on-how-tos.asp">OLPC: Bring on the How-Tos</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/blog/2007/12/i-will-facebook-no-more-forever.asp">I will Facebook no more Forever</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/blog/2007/12/seven-deadly-signs-of-blogstipation.asp">The Seven Deadly Signs of Blogstipation</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/blog/2007/11/publiversity-public-and-alternative.asp">Publiversity: Public and Alternative Higher Educat...</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/blog/2007/11/iiw-2007b-internet-identity-roundup.asp">IIW 2007b: Internet Identity Roundup</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/blog/2007/11/one-laptop-per-child-labor-pains.asp">One Laptop Per Child: Labor Pains</a><br />
    
    &#160;<br />
    <a href="http://orcmid.com/blog/2007/11/whs-fascination-and-social-grid.asp">WHS Fascination and the Social Grid: Distributed P...</a><br />
	...
	<td bgcolor="white" colspan="2"><!-- 2004-10-02 -->
      ...
      <h3><a name="2008-01-10" href="#2008-01-10">
          <font color="#660000">2008-01-10</font></a></h3>
   	

	<div class="posts">
    <a name="2850358337289301691"></a>
	...
	<p>
    <div style="clear:both;"></div><p> <div class="wlWriterSmartContent" id="scid:0767317B-992E-4b12-91E0-4F059A8CECA8:a3d1decd-3b7d-4ccf-b666-0a7f21589d5a" style="padding-right: 0px; display: inline; padding-left: 0px; float: none; padding-bottom: 0px; margin: 0px; padding-top: 0px">Technorati Tags: <a href="http://technorati.com/tags/orcmid" rel="tag">orcmid</a>, <a href="http://technorati.com/tags/NewsGator%20Inbox" rel="tag">NewsGator Inbox</a>, <a href="http://technorati.com/tags/Outlook" rel="tag">Outlook</a>, <a href="http://technorati.com/tags/RssBandit" rel="tag">RssBandit</a>, <a href="http://technorati.com/tags/Windows%20Desktop%20Search" rel="tag">Windows Desktop Search</a>, <a href="http://technorati.com/tags/RSS" rel="tag">RSS</a>, <a href="http://technorati.com/tags/Feeds%20as%20Archives" rel="tag">Feeds as Archives</a>, <a href="http://technorati.com/tags/toolcraft" rel="tag">toolcraft</a></div></p> <p>I'm having a strange experience.</p> <p>NewsGator just announced that their Outlook client (and all of their other personal clients) are free from now on.&nbsp; In addition, the Outlook client, now dubbed NewsGator Inbox, is at 3.0 and in beta.</p> <h3>My NewsGator Romance</h3> <p>I loved NewsGator from the first time Scoble showed it to me.&nbsp; I had some bumpy spots, especially when I needed to rebuild my subscription lists and folder organizations after hitting a bump or two.&nbsp;&nbsp; The feed association model changed out from under me a few times and I had to do some heavy manual repairs to convince the feeds to end up in the folders and subfolders where I wanted them, for organizational reasons.&nbsp; But I got it to work.</p> <p>What I really, really like about NewsGator is that it runs in Outlook (and is very speedy), I end up with copies of the post texts as if they are formatted e-mails, and the material is searchable by Windows Desktop Search.&nbsp; I can also organize the feeds into folders and subfolders, with some apprehension, and I can move the clippings and feeds around without too much difficulty.&nbsp; </p> <p>This is perfect for research and preservation of material.&nbsp; There is also backup and archiving as part of my Outlook usage procedures.&nbsp;&nbsp; Someday I might even put all of the collected feed clippings in their own Outlook PST so I can move it around, archive it differently, etc.</p> <p>A long time ago (hmm, December 2006 to be exact), NewsGator and I had a shotgun divorce.&nbsp; There was a crash of the Outlook plug-in, as would happen on occasion.&nbsp; It appeared to be some sort of .NET hiccup.&nbsp; But the final time, Outlook decided that NewsGator did not practice safe integration, and it locked-down NewsGator so the plug-in could not run.&nbsp; I think the divorce decree said how to restore the plug in, but I failed to write down the message and I didn't take a screen shot either.&nbsp; </p> <p>I even downloaded the latest updates of the NewsGator client and paid to extend my NewsGator subscription.&nbsp; No help.&nbsp; Outlook was adamant and refused to allow the plug-in even after installing newer versions of NewsGator.</p> <h3>A Fling with RssBandit</h3> <p>In desperation, I checked out a couple of aggregators that run on the desktop, and the best one that I found was RssBandit.&nbsp; I was nervous about RssBandit because I wasn't sure how much material was actually cached on my own computer, and I didn't know how to recover if (1) I ever needed to migrate away from RssBandit or (2) a blog site or its feed content disappeared.</p> <p>Nice things about RssBandit are how easily I can add a new feed, how easily I can organize feeds and, if I keep up with things, how easily I can update and, in one folder, review all of the new unread items.&nbsp; I developed a set of practices that allowed me to quickly work through unread items, marking some for later follow-up (use in my own posts, etc.).&nbsp; </p> <p>I have remained nervous about the RssBandit format being opaque and also not searchable with Windows Desktop Search, a provision that is very important to me.&nbsp; </p> <p>Now, Outlook formats are semi-opaque.&nbsp; But the Outlook PST is a well-known format and there is programmatic access to it.&nbsp; It is not part of the OOXML coverage, but I am more confident that I can access the material and also manipulate it over a long period of time.&nbsp; I can find a programmatic extraction or export mechanism too, if necessary.</p> <p>The latest problem with RssBandit is my own doing.&nbsp; My "unread items" folder has filled up with ones that I have flagged for followed-up and reset to be unread.&nbsp; There are 2830 of those at this moment.&nbsp; The problem now, is, that there is a performance glitch in RssBandit that has me not dare switch to an individual feed folder, because switching back to the gigantic (for me) Unread Items folder causes terrible things to happen, and RssBandit will hemorrhage and maybe even crash until it manages to refresh all sorts of things for those unread posts (elements that, as far as I can tell, it already has).</p> <p>So, I was stuck.&nbsp;&nbsp; RssBandit usability is in the dumper, I fear that I will never be able to leave, yet I can't use the product very well because I can't navigate among my feed collections at ease, even for the purpose of cleaning out flagged-unreads on particular topics from particular feed groups.</p> <h3>Honey, Take Me Back, Take Me Back Please! </h3> <p>With the availability of the NewsGator Inbox 3.0 beta and a free NewsGator subscription, I figured it was time to see if I could get back in its, and Outlook's, good graces.</p> <p>I uninstalled the NewsGator Inbox 2.6 that had been sitting useless on my machine.&nbsp; I looked at my C:\Program Files directory and made sure that the NewsGator Inbox directories and their content were really deleted.&nbsp; I went into regedit and searched on NewsGator, deleted all entries that should not matter now that NewsGator is really gone.&nbsp; </p> <p>I also extracted the OPML feed-list from RssBandit.&nbsp; I also instructed my latest version of RssBandit to synchronize itself with NewsGator on-line.&nbsp; (I discovered that on-line account had vanished but I was able to create a new one with the old User ID.)</p> <p>After all of those things I downloaded the new NewsGator Inbox 3.0 and installed it.&nbsp; </p> <p>Oh Happy Day, the next time I opened Outlook, NewsGator took me through the first-time setup operations for delivering its feeds.&nbsp; The first "Update All Subscriptions" was scary.&nbsp; There are 400 subscriptions (I'd lost track) and the first update down into Outlook took a long time.&nbsp; But it finished successfully.&nbsp; Outlook and NewsGator Inbox 3.0 beta are playing nice.</p> <p>There are some differences, and some feeds didn't like going back into the same folders as before, but I think I have cured all of that by letting the folder name that matches the feed name win.&nbsp;&nbsp; The feed list doesn't seem to know about all of the destination folders (but the on-line feed reader does), yet feed updates find the correct homes for new item.&nbsp; </p> <p>Not all feeds have updated into Outlook sor far.&nbsp; I am hopeful that they will all catch up after a few more refreshes and with new posts to some of my own feeds that don't seem to have fetched yet.</p> <p>There are some things I miss about RssBandit.&nbsp; The reading pane in that client provides more of the formatting along with images and enclosures.&nbsp; The Outlook pages for each post are not so spiffy.&nbsp; I'll get over that.</p> <p>I also wondered what I would do to preserve the habit of pruning everything in a single unread-items stream even though the posts have actually been segregated into separate folders based on my organization of the individual feeds.&nbsp;&nbsp; So, Outlook 2003 already handles that.&nbsp; There's already a search folder that will list Unread Mail, and I just conditioned it to show them in reverse chronological sequence, the way I process my in box too.&nbsp; There is no noticeable delay when I open the list to begin reviewing all of the items that are newly-fetched to Outlook.</p> <p>I have performed a couple of feed refreshes and have confirmed that the blazing speed of the NewsGator feed update is not a false memory.&nbsp; The ordinary updating for a day's 100-200 new posts is quite zippy.&nbsp; </p> <h3>And Making Up Is Hard To Do</h3> <p>I am heartened that I did not have to do very much work to restore the organization of my feed folders used in RssBandit to Outlook, which had a very out-of-date folder set for the RSS feeds.&nbsp; Although the NewsGator Inbox 3.0 uses a separate PST for its material, it was easy to direct those feeds to my preferred locations in my main e-mail PST.&nbsp; (And, as I said, I might want to go the other direction at some point.&nbsp; It looks like that will be easy.)</p> <p>The serious difficulty is that my 2830-item unread-and-marked list on RssBandit has grown to a 7660-item Unread Mail list on Outlook.&nbsp; Because I don't have much e-mail backlog (my GTD practices are working reasonably well there), these are mostly RSS feed items, and some of them went as far back as 2003.&nbsp; I'm working my way from oldest to front right now.&nbsp; I will also make sure that each new days unread items are processed and handled or filed while I continue pruning the old ones that NewsGator on-line found for me and sees as unread.</p> <p>We don't entirely trust each other, but I think we'll do just fine.&nbsp; I'm giving it time.</p>  <div style="clear:both; padding-bottom:0.25em"></div>
    </p>
	<span class="byline">posted by orcmid 
       at <a href="http://orcmid.com/blog/2008/01/newsgator-deja-vu-all-over-again.asp">1/10/2008 07:58:00 PM</a></span>
	  
         <!-- 2004-05-10 -->
		<div class="blogComments">
			&nbsp;<br /><b><i>Comments:</i></b><!-- 2004-10-04 -->  
			
	    <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=3896669&postID=2850358337289301691">Post a Comment</a>
		</div>
