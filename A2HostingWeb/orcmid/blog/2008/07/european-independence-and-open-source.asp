...
<!-- ORCMID'S LAIR BLOGGER.COM TEMPLATE
     ...
     2002-10-31 Template modification adventures.  Add a configuration-
        ...
        title into a link
   $$Header: /A2HostingWeb/orcmid/blog/2008/07/european-independence-and-open-source.asp 1     08-10-07 13:22 Orcmid $
   -->
<head>
<title>Orcmid's Lair: European Independence and Open-Source Development</title>
...
<link rel="alternate" type="application/atom+xml" title="Orcmid's Lair - Atom" href="http://orcmid.com/blog/lair-atom.xml" />
 <link rel="stylesheet" type="text/css" href="http://www.blogger.com/css/blog_controls.css"/> <link rel="stylesheet" type="text/css" href="http://www.blogger.com/dyn-css/authorization.css?targetBlogID=3896669&zx=397c5efa-5d6a-4b13-ac26-5aa468ed31d3"/><script type="text/javascript" src="http://www.blogger.com/js/backlink.js"></script>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<td bgcolor="white" colspan="2"><!-- 2004-10-02 -->
      ...
      <h3><a name="2008-07-15" href="#2008-07-15">
          <font color="#660000">2008-07-15</font></a></h3>
   	

	<div class="posts">
    <a name="6012655128987335272"></a>
    
     <h2><font color="#000080"><!-- 2004-09-02 -->
	 
	 European Independence and Open-Source Development
	 </font>
     </h2>
    

	<p>
    <div style="clear:both;"></div><p>Dana Blankenhorn shows a little national-identity sensitivity in his 2008-07-14 ZDnet article, <a href="http://blogs.zdnet.com/open-source/?p=2649">Europe seeks to brand open source quality</a>.</p> <p>I noticed <a href="http://orcmid.com/BlunderDome/clueless/2005/06/mddi-integrated-tool-chains-for.asp">some time ago</a> that there is a European movement that sees <a href="http://www.techworld.com/opsys/news/index.cfm?NewsID=2175">open-source development</a> as a key to the emergence of a European software industry independent of U.S. domination.&nbsp; This is indeed a focus of Commission-funded activity in the European Union.&nbsp; It is also part of the <a href="http://ec.europa.eu/information_society/istevent/2006/index_en.htm">Information Society vision</a> of the European Commission.&nbsp; For whose benefit would we expect to see <a href="http://cordis.europa.eu/fp7/ict/">EU funding for Information and Communication Technologies</a> (ICT)?</p> <p>It can be a bit startling, for those of us who are comfortably and carelessly American, to see Euro-centric homage given in reports of sponsored scientific and technical ventures, often involving government and industry partnerships (not unlike Japanese initiatives I have observed).&nbsp; It is an useful lesson to have us notice how much US-centric posturing is spewed into the world and how that lands in Europe and elsewhere.&nbsp; Look at our version of Olympic spirit, for one.&nbsp; Look at the <a href="http://phoenix.lpl.arizona.edu/">Mars Phoenix site</a> and see how the contribution of scientific groups of other nations is in the shadow of the acknowledgment of US institutions.&nbsp; (The <a href="http://en.wikipedia.org/w/index.php?title=Phoenix_%28spacecraft%29&amp;oldid=224940569">Wikipedia coverage</a> is superior in its featuring of all participants.)</p> <p>Along with this, there have been occasional descriptions of EU computer and technology projects that featured open-source development and the GPL as if that was a sufficient condition for excellence in the result.&nbsp; The oddest cases were announcements of open-source results for which the code, binary or source, was <a href="http://orcmid.com/BlunderDome/clueless/2005/03/identifying-key-elements-of-safety.asp">nowhere to be found</a>.&nbsp; Apparently, the code was locked up in the chambers of the commercial partners in the government-sponsored work.&nbsp; </p> <p>On other occasions where code was in a public place, I found it to be un-installable, fragile, and unsupported by useful documentation.&nbsp; This might be typical of too-much academic-research work done on any continent, but it tended, for me, to tarnish the glitter of open-source magic.&nbsp; It is a bit far from the European Commission goal of commercialized technology enabled by open-source development and licensing.</p> <h3>SQ-OSS Is Different</h3> <p>Yes, the focus on support for European technology capabilities is <a href="http://www.sqo-oss.org/xwiki/bin/view/Main/WebHome">clear</a>:</p> <blockquote> <p>"SQO-OSS aims to assist European software developers in improving the quality of their code, and to remove one of the key barriers to entry for Open Source software by providing scientific proof of its quality. </p> <p>"Open Source is already leading to a revival in the European SME software development sector, and advanced tools for quality assessment will underpin further enterprise adoption and assist European SMEs and projects in competing with large global corporations."</p></blockquote> <p>The difference is that the development of the quality-assessment tools is a genuine, well-conducted, and globally-visible open-source undertaking.&nbsp; There is a level of development maturity here that matches the best open-source projects I have found.&nbsp; Those of us in the US and Canada will be happy to see that the code, involving lots of Java plus JAR files from other open-source projects (with a tiny dusting of C++) is fully available with narratives in a widely-recognized dialect of English.&nbsp; The project has a <a href="http://www.sqo-oss.org/xwiki/bin/view/Main/WebHome">public Wiki</a> and the <a href="http://www.sqo-oss.org/xwiki/bin/view/Development/SVN+Access">on-line SVN repository</a> is annotated with guidance to the contents starting at the top.&nbsp; Even the MAKEFILE structure is annotated with descriptive narrative.&nbsp; Considering that the Alitheia (Greek for "truth") deliverable from the project is at an alpha-level of release (0.8.1), I find a great deal to be comfortable with in how this deliverable is developed.&nbsp; (If there is anything obviously lacking, it is test code used to confirm the builds and the units that go into it.&nbsp; I may not have looked closely enough, and this is certainly something anyone could contribute as part of learning to build, use, and adapt the package.)&nbsp; I find the project materials to be inviting and a contribution to open development. <p>Also surprising is the use of the <a href="http://www.freebsd.org/copyright/freebsd-license.html">Free BSD license</a> for that code originated as part of the project.&nbsp; The project is also careful to include the licenses for those incorporated elements that are under different licenses as well. <p>It would be nice if other open-source efforts were conducted so deliberately with attention to the usability of materials by others.   <div style="clear:both; padding-bottom:0.25em"></div>
    </p>
	<span class="byline">posted by orcmid 
       at <a href="http://orcmid.com/blog/2008/07/european-independence-and-open-source.asp">7/15/2008 01:00:00 PM</a></span>
	  
         <!-- 2004-05-10 -->
		<div class="blogComments">
			&nbsp;<br /><b><i>Comments:</i></b><!-- 2004-10-04 -->  
			
	    <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=3896669&postID=6012655128987335272">Post a Comment</a>
		</div>
