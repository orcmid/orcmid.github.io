...
<!-- ORCMID'S LAIR BLOGGER.COM TEMPLATE
     ...
     2002-10-31 Template modification adventures.  Add a configuration-
        ...
        title into a link
   $$Header: /A2HostingWeb/orcmid/blog/2008/07/help-zonealarm-users-get-back-on.asp 1     08-10-07 13:22 Orcmid $
   -->
<head>
<title>Orcmid's Lair: Help ZoneAlarm Users Get Back on the Internet</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<p>
    <div style="clear:both;"></div><div class="wlWriterSmartContent" id="scid:0767317B-992E-4b12-91E0-4F059A8CECA8:d85cb46a-6963-4be4-b061-90265d637b14" style="padding-right: 0px; display: inline; padding-left: 0px; float: none; padding-bottom: 0px; margin: 0px; padding-top: 0px">Technorati Tags: <a href="http://technorati.com/tags/interoperability" rel="tag">interoperability</a>, <a href="http://technorati.com/tags/ZoneAlarm" rel="tag">ZoneAlarm</a>, <a href="http://technorati.com/tags/Microsoft%20Update" rel="tag">Microsoft Update</a>, <a href="http://technorati.com/tags/DNS%20vulnerability" rel="tag">DNS vulnerability</a>, <a href="http://technorati.com/tags/Internet%20access" rel="tag">Internet access</a>, <a href="http://technorati.com/tags/Interoperability%20Forums" rel="tag">Interoperability Forums</a></div> <p>Although this should have blown over by now, you might have some family, friends, and colleagues who were unable to access the Internet after last week's security updates from Microsoft.</p> <p>Apparently the problem is limited to ZoneAlarm users.&nbsp; They can't see this post and the available remedies because they can't get to the Internet unless they <a href="http://forums.community.microsoft.com/en-US/interopscenarios/thread/15f0712c-a21e-43a6-946e-a971ec390d7d">figure out</a> to</p> <ul> <li>remove ZoneAlarm or at least reduce its protection level from "High" to "Medium" long enough to install an update from the ZoneAlarm site<br>&nbsp;&nbsp;&nbsp; <li>remove the Microsoft updates with the DNS vulnerability fix (although not really necessary, and removal can introduce new problems)</li></ul> <p>The basic situation is covered in the <a href="http://www.microsoft.com/technet/security/bulletin/ms08-037.mspx">Microsoft Security Bulletin</a> under the FAQ section and this <a href="http://support.microsoft.com/kb/953230">Known Issues article</a>.&nbsp; The ZoneAlarm workaround and updates can be found in <a href="http://download.zonealarm.com/bin/free/pressReleases/2008/LossOfInternetAccessIssue.html">this announcement</a>.&nbsp; <strong>Update:</strong> Joel Hruska has a <a href="http://arstechnica.com/news.ars/post/20080714-cross-industry-vendor-alliance-plugs-dns-vulnerability.html">great 2008-07-14 summary</a> of the roll-out of the DNS vulnerability fix on Ars Technica.&nbsp; There is no indication of the disconnect with ZoneAlarm's producer, Check Point Software.</p> <p>Also, if you or others are using ZoneAlarm on Windows and haven't run Microsoft Update in a while, be sure to update ZoneAlarm first.&nbsp; Then use Microsoft Update to obtain the DNS vulnerability fix and other recent security updates.</p> <hr> <small> <p>No longer using ZoneAlarm myself, I did not learn about this issue until it was raised by someone looking for information on an <a href="http://forums.community.microsoft.com/en-US/interopscenarios/threads/">Interoperability Forum</a>.&nbsp; This is an interesting interoperability case.&nbsp; The ZoneAlarm package is listed by US-CERT as not being vulnerable to the DNS vulnerability, but there was apparently a secondary dependency on the correction made to Windows itself.&nbsp; How to protect against disconnects of this kind is partly an interoperability issue, it seems to me.&nbsp; I wonder whether this is an example of the hazard discussed in <a href="http://orcmid.com/blog/2008/07/interoperability-no-code-need-apply.asp">Interoperability: No Code Need Apply?</a></p></small>  <div style="clear:both; padding-bottom:0.25em"></div>
    </p>
	<span class="byline">posted by orcmid 
       at <a href="http://orcmid.com/blog/2008/07/help-zonealarm-users-get-back-on.asp">7/13/2008 10:11:00 AM</a></span>
	  
         <!-- 2004-05-10 -->
		<div class="blogComments">
			&nbsp;<br /><b><i>Comments:</i></b><!-- 2004-10-04 -->  
			
	    <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=3896669&postID=3500406604423855255">Post a Comment</a>
		</div>
