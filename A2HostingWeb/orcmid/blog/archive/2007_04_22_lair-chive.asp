...
<!-- ORCMID'S LAIR BLOGGER.COM TEMPLATE
     ...
     2002-10-31 Template modification adventures.  Add a configuration-
        ...
        title into a link
   $$Header: /OrcmidCompagno/blog/archives/2007_04_22_lair-chive.asp 3     10-04-05 23:05 Orcmid $
   -->
<head>
<title>Orcmid's Lair: 2007-04-22</title>
...
The oth...</a><br />
	...
	<td bgcolor="white" colspan="2"><!-- 2004-10-02 -->
      ...
      <h3><a name="2007-04-22" href="#2007-04-22">
          <font color="#660000">2007-04-22</font></a></h3>
   	

	<div class="posts">
    <a name="735355300012602709"></a>
    

	<p>
    <div style="clear:both;"></div><h2><cite cite="http://www.codinghorror.com/blog/archives/000844.html">Just the Facts, Ma&rsquo;am: Integrity In Blogging</cite></h2>
<p class="citation"><cite cite="http://www.codinghorror.com/blog/archives/000844.html"><a href="http://www.codinghorror.com/blog/archives/000844.html">Coding Horror: Apparently Bloggers Aren't Journalists</a></cite>.&nbsp; Jeff Atwood has an interesting blog&nbsp;entry that contrasts a certain kind of echo chamber, &ldquo;what he said,&rdquo; approach to blogging with the ethical responsibilities of journalists.</p>
<p class="citation">It seems very easy to link to someone else&rsquo;s position and credit its validity without any fact checking and, in particular, effort to verify sources and what those sources actually provided.&nbsp;&nbsp;Atwood offers&nbsp;a great example.&nbsp;&nbsp; You can find more&nbsp;examples of fact-checking and careful verification by following <a href="http://blogs.zdnet.com/Bott/?p=241">Ed Bott&rsquo;s</a> columns.&nbsp; <a href="http://www.hanselman.com/blog/">Scott Hanselman</a> provides useful by-example fact checking too.&nbsp; The greatest thing is that you can reproduce these experiments and satisfy yourself.&nbsp; (My examples are around Microsoft technology because that is where I have most of my attention.&nbsp; Those focused on other technologies and areas of the industry doubtless have examples of their own with regard to who is careful and who isn&rsquo;t.)</p>
<p class="citation">I run into this far too frequently when I see misunderstandings and clear misrepresentations of software behavior.&nbsp; On some forums I keep my eye on, there are often helpful answers that are simply wrong or passing along of developer myths that have never been accurate and have always been poor advice.&nbsp;&nbsp;This disregard for facts&nbsp;also shows up in&nbsp;claims about file formats that no one seems to have attempted to verify.&nbsp; In fact, I have seen people pontificate at length with a tiny passage at the end about having not actually read the spec, run the software, etc.</p>
<p class="citation"><strong>Most of life is an empirical science</strong>.&nbsp; That means&nbsp;check the work&nbsp;and, if it involves someone else&rsquo;s claims, attempting to duplicate the result and, if that fails, asking the originator for more details.</p>
<p class="citation">The comment stream on Atwood's post is interesting, and there are important remarks about how, in addition to providing checked sources, it is responsible to make corrections and adjustments as further details come to light and as our own mistakes are caught by others.</p>
<p class="citation">This is not about being perfect, it is about how we care for our own veracity and are responsible for what we lend our voice to.&nbsp; It is about carefulness and follow-up.</p>
<p class="citation">When I first saw Atwood&rsquo;s post, I took this as some affirmation&nbsp;of my view of appropriate&nbsp;scholarship, another realm where something like journalistic integrity comes into play.&nbsp; It is at the bedrock of scientific exploration and investigation that there be a sufficient account that your results can be verified and observations repeated and confirmed, wherever possible.&nbsp; Likewise, for general scholarship and analysis work, we are obligated to provide sources that others can check and also determine whether our interpretations&nbsp;are sound, whether or not they meet with agreement.&nbsp; Interpretations are not facts and there is room for disagreement.&nbsp; But we should be able to agree on what the essential facts are before delineating the basis for disagreement on interpretation.</p>
<p class="citation">I <a href="http://orcmid.com/writings/2005/06/w050601b.htm">over-write</a>.&nbsp; (I think I am doing it now.)&nbsp; I always want to&nbsp;<a href="http://orcmid.com/blog/2007/04/open-standards-implementation-i.asp">provide enough information</a>&nbsp;about my sources, the claimed facts, and the derived interpretations to be easily checked.&nbsp; I want to be reliable for that, even if what I say is disagreeable.</p>
<p class="citation">&nbsp;</p>
<p class="citation">&nbsp;</p>
<p>&nbsp; </p><div class="bjtags">Tags:  <a rel="tag" href="http://technorati.com/tag/orcmid">orcmid</a>, <a rel="tag" href="http://technorati.com/tag/Coding+Horror">Coding+Horror</a>, <a rel="tag" href="http://technorati.com/tag/scholarship">scholarship</a>, <a rel="tag" href="http://technorati.com/tag/blogging+integrity">blogging+integrity</a>, <a rel="tag" href="http://technorati.com/tag/fact-checking">fact-checking</a></div><div style="clear:both; padding-bottom:0.25em"></div>
    </p>
	<span class="byline">posted by orcmid 
       at <a href="http://orcmid.com/blog/2007/04/just-facts-ma-integrity-in-blogging.asp">4/22/2007 01:59:00 PM</a></span>
	  
         <!-- 2004-05-10 -->
		<div class="blogComments">
			&nbsp;<br /><b><i>Comments:</i></b><!-- 2004-10-04 -->  
			
	    <a class="comment-link" href="http://www2.blogger.com/comment.g?blogID=3896669&postID=735355300012602709">Post a Comment</a>
		</div>
