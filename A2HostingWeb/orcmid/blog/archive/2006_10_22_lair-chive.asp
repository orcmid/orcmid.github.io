...
<!-- ORCMID'S LAIR BLOGGER.COM TEMPLATE
     ...
     2002-10-31 Template modification adventures.  Add a configuration-
        ...
        title into a link
   $$Header: /OrcmidCompagno/blog/archives/2006_10_22_lair-chive.asp 3     10-04-05 22:59 Orcmid $
   -->
<head>
<title>Orcmid's Lair: 2006-10-22</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<p>
    <div style="clear:both;"></div><p>This is the final official post that will be made to the <a href="http://nfocentrale.net/orcmid/blog">Orcmid&rsquo;s Lair blog</a> at location <a href="http://nfocentrale.net/orcmid/blog">http://nfocentrale.net/orcmid/blog</a>.</p><p>The site feed will also be interrupted.</p><p>From now on, all posts will appear at the <a href="http://orcmid.com/blog">official Orcmid&rsquo;s Lair</a> URL, <a href="http://orcmid.com/blog">http://orcmid.com/blog</a>.&nbsp; The <a href="http://orcmid.com/blog/lair-atom.xml">official site feed</a> is also the one that is assured to always work.</p><p>You will know that you are at the old blog location if you see no post more recent than this one, neither on the web page or in the site feed.</p><p><strong>PS:</strong> Sometime in the next few weeks, the old URLs will be moved atop the new, official ones and either set of URLs will work just fine.&nbsp; For a while.&nbsp; But the official ones will always work.&nbsp; You shouldn&rsquo;t be using the old ones.&nbsp; Really.</p><p>[<strong>update 2006-10-28-15:55</strong> This reposting of the post already seen on the old web page and site feed is being made to confirm that Blogger is now correctly posting to the official site and its site feed.&nbsp; There have also been some setting changes that will be developed more fully after the change-over is confirmed.]</p><p>&nbsp;</p><p>&nbsp;</p><div style="clear:both; padding-bottom: 0.25em;"></div>
    </p>
	<span class="byline">posted by orcmid 
       at <a href="http://orcmid.com/blog/2006/10/slipping-into-water.asp">10/28/2006 01:51:05 PM</a></span>
	  
         <!-- 2004-05-10 -->
		<div class="blogComments">
			&nbsp;<br /><b><i>Comments:</i></b><!-- 2004-10-04 -->  
			
	    <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=3896669&amp;postID=116206866543679835">Post a Comment</a>
		</div>
