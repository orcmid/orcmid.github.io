...
<!-- ORCMID'S LAIR BLOGGER.COM TEMPLATE
     ...
     2002-10-31 Template modification adventures.  Add a configuration-
        ...
        title into a link
   $$Header: /OrcmidCompagno/blog/archives/2006_10_08_lair-chive.asp 3     10-04-05 22:58 Orcmid $
   -->
<head>
<title>Orcmid's Lair: 2006-10-08</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<p>
    <div style="clear:both;"></div><p>I&rsquo;m consolidating all of the <a href="http://nfocentrale.com/">nfoCentrale</a> web sites (this is one of them) on a single web hosting account at <a href="http://a2hosting.com/">A2 Hosting</a>.&nbsp; I have already moved&nbsp;most of my sites to that account, with only minor breakage around Apache case sensitivity.&nbsp;&nbsp;Sites that have blogs or that have&nbsp;e-mail accounts are trickier to move and I have saved those for last.&nbsp;&nbsp; Today is moving day for orcmid.com and the Orcmid&rsquo;s Lair blog.</p><p>{tags: <a href="http://www.technorati.com/tag/orcmid" rel="tag">orcmid</a> <a href="http://www.technorati.com/tag/A2+Hosting" rel="tag">A2 Hosting</a> <a href="http://www.technorati.com/tag/nfoCentrale" rel="tag">nfoCentrale </a><a href="http://www.technorati.com/tag/web+hosting" rel="tag">web hosting</a> <a href="http://www.technorati.com/tag/Apache" rel="tag">Apache</a> <a href="http://www.technorati.com/tag/system+incoherence" rel="tag">system incoherence</a> <a href="http://www.technorati.com/tag/confirmable+experience" rel="tag">confirmable experience</a>}</p><p>What this means for the readers of this and associated blogs is that the best reception will be found at URLs like <a href="http://orcmid.com/blog">http://orcmid.com/blog</a> and <em>not</em> <a href="http://nfocentrale.net/orcmid/blog">http://nfocentrale.net/orcmid/blog</a>.&nbsp; In fact, the second URL and the&nbsp;site feed at the same location will be not see more blog updates for several&nbsp;weeks.&nbsp;&nbsp;&nbsp;</p><p>The Orcmid&rsquo;s Lair blog and feed at <a href="http://orcmid.com/blog">http://orcmid.com/blog</a> will see little or no interruption.&nbsp; There may be&nbsp;some breakage,&nbsp;with templates, links, images, and archive&nbsp;pages&nbsp;possibly having&nbsp;problems until the construction crew can straighten things out.&nbsp; In the long run, it will all become much nicer.</p><p>The long-term benefit is that URLs like <a href="http://orcmid.com/">http://orcmid.com</a>&nbsp;will not forward to a different URL.&nbsp; Instead,&nbsp;all nfoCentrale sites will&nbsp;have full-size, grown-up, first-class, independent domains with sites to match.&nbsp;&nbsp; Now bookmarks made to pages found through orcmid.com follow the site wherever it may happen to be hosted in the future.</p><p>OK, everyone, cross your fingers.</p><div style="clear:both; padding-bottom: 0.25em;"></div>
    </p>
	<span class="byline">posted by orcmid 
       at <a href="http://orcmid.com/blog/2006/10/orcmids-lair-disruption.asp">10/11/2006 12:29:05 PM</a></span>
	  
         <!-- 2004-05-10 -->
		<div class="blogComments">
			&nbsp;<br /><b><i>Comments:</i></b><!-- 2004-10-04 -->  
			
	    <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=3896669&amp;postID=116059494560326892">Post a Comment</a>
		</div>
