...
<head>
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/archive/2003_03_23_lair-chive.asp 8     26-03-22 14:12 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
    	...
    	<h2><a name="2003-03-26" href="#2003-03-26"><font color="#660000">2003-03-26</font></a></h2>
   	

	<div class="posts">
	<a name="91442876">&nbsp;</a><br>
	<a href="http://www.acm.org/ubiquity/interviews/c_benko_1.html">ACM: Ubiquity - Do You Know What's in Your Project Portfolio?</a>.&nbsp; an interview with Cathleen Beno and Warren McFarlan, authors of "Connecting the Dots: Aligning Projects with Objectives in Unpredictable Times."  Seems very applicable to developing a system evolution strategy.<br>
	<span class="byline">posted by Dennis at <a href="#91442876">Wednesday, March 26, 2003</a></span></div>
<br>
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
                2002-11-09 Tune the color and make a purplized link out of it -->
	
    	<h2><a name="2003-03-23" href="#2003-03-23"><font color="#660000">2003-03-23</font></a></h2>
   	

	<div class="posts">
	<a name="91253200">&nbsp;</a><br>
	<a href="http://www.wikipedia.org/wiki/Software_engineering">Software engineering - Wikipedia</a>.&nbsp; An interesting compilation.  One alarm bell for me is that there are no noteworthy practitioners in the computer science column of the first table, but Donald Knuth is listed in the software engineering column for development of TeX.  <br>
	<span class="byline">posted by Dennis at <a href="#91253200">Sunday, March 23, 2003</a></span></div>
<br>
