...
<!-- ORCMID'S LAIR BLOGGER.COM TEMPLATE
     ...
     $$Header: /OrcmidCompagno/blog/archives/2010_01_03_lair-chive.asp 3     10-04-05 23:18 Orcmid $
   -->
<head>
<title>Orcmid's Lair: 2010-01-03</title>
...
<link rel="EditURI" type="application/rsd+xml" title="RSD" href="http://www.blogger.com/rsd.g?blogID=3896669" />
 <link rel="stylesheet" type="text/css" href="http://www.blogger.com/static/v1/v-css/3727950723-blog_controls.css"/> <link rel="stylesheet" type="text/css" href="http://www.blogger.com/dyn-css/authorization.css?targetBlogID=3896669&zx=dd135ce3-bfb9-48e7-981f-a81f75a1e327"/><script type="text/javascript" src="http://www.blogger.com/static/v1/v-js/1188848481-backlink.js"></script>
...
--></script><script src="http://nwidget.networkedblogs.com/getnetworkwidget?bid=303763" type="text/javascript"></script>
	...
	<td bgcolor="white" colspan="2"><!-- 2004-10-02 -->
      ...
      <h3><a name="2010-01-06" href="#2010-01-06">
          <font color="#660000">2010-01-06</font></a></h3>
   	

	<div class="posts">
    <a name="6868455972823507253"></a>
       ...
       at <a href="http://orcmid.com/blog/2010/01/microsoft-office-2010-coming-to-our.asp">1/06/2010 02:16:00 PM</a></span>
		...
		<div class="blogComments">
			...
			<div class="blogComment">
				&nbsp;<br /><a name="9037570484078856275"></a> 
				I solve my laptop &quot;docking&quot; problem by only plugging it into two cords: power and network. I then use Remote Desktop from my machine with the big monitor, keyboard, and mouse to connect to the laptop.<br /><br />With gigabit Ethernet now available everywhere, the only time I notice any slowdown with this configuration is when I try to play full-screen videos on the laptop.<br /><br />But I spend all day at work and each evening at home with this setup.<br />
				<div class="byline">
                  <a href="http://orcmid.com/blog/2010/01/microsoft-office-2010-coming-to-our.asp?showComment=1262817125435#c9037570484078856275" 
                     title="permanent link">#</a> 
                  posted by <span style="line-height:16px" class="comment-icon anon-comment-icon"><img src="http://www.blogger.com/img/anon16-rounded.gif" alt="Anonymous" style="display:inline;" /></span>&nbsp;<a href="http://twwilliams.com/" rel="nofollow">Tommy Williams</a>: 
                  06 January, 2010 14:32
                </div>
				<span class="item-control blog-admin pid-1770616506"><a style="border:none;" href="http://www.blogger.com/delete-comment.g?blogID=3896669&postID=9037570484078856275" title="Delete Comment" ><span class="delete-comment-icon">&nbsp;</span></a></span>
			</div>
			
			<div class="blogComment">
				&nbsp;<br /><a name="8779939186682961130"></a> 
				Holy smokes.  That is brilliant for my situation.  It also means that I don&#39;t need my upgraded laptop/tablet-PC on my desk along with my desktop configuration and I don&#39;t have to care about laptop external-monitor limitations.<br /><br />I can put the laptop in place of the <a href="http://orcmid.com/blog/2009/03/productivity-cleaning-up-workspace.asp" rel="nofollow">venerable Compagno</a> over on my drafting table and remote desktop into it instead of walking over to it.  And unhooking for travel is easy. <br /><br />I&#39;ve learned to use Remote Desktop as part of managing my Windows Home Server and I am prepared to do more of that.<br /><br />Thanks Tommy.<br />
				<div class="byline">
                  <a href="http://orcmid.com/blog/2010/01/microsoft-office-2010-coming-to-our.asp?showComment=1262817823679#c8779939186682961130" 
                     title="permanent link">#</a> 
                  ...
                  06 January, 2010 14:43
                </div>
				<span class="item-control blog-admin pid-721112219"><a style="border:none;" href="http://www.blogger.com/delete-comment.g?blogID=3896669&postID=8779939186682961130" title="Delete Comment" ><span class="delete-comment-icon">&nbsp;</span></a></span>
			</div>
			
			<div class="blogComment">
				&nbsp;<br /><a name="4925605050904326395"></a> 
				Multi-Monitor, take a second look.<br /><br />I found a standard VGA connector on my laptop.  So I was able to use my desktop CRT from day one.<br /><br />Failing that, check out Display Link.  You install some software on computer and use a Display Link enabled monitor connected via USB cable.  If you don&#39;t have a Display Link monitor, they sell a USB to DVI connector.  Get a DVI to VGA converter and you can use any old monitor.  Check out these links: <br />http://www.pcworld.com/article/157478/multimonitor_madness.html<br />http://www.pcworld.com/article/150311-4/quadruple_your_fun_and_productivity_with_a_fourmonitor_system.html<br /><br />As for Keyboard, that is even easier.  Just plug in any USB enabled keyboard into your laptop.  I&#39;ve been using a full size MS Wave keyboard.  My mouse is plugged into the USB port on the keyboard.  If your favorite keyboard has a PS2 plug, you can buy a USB to PS2 connector for around $5.<br />
				<div class="byline">
                  <a href="http://orcmid.com/blog/2010/01/microsoft-office-2010-coming-to-our.asp?showComment=1262967283091#c4925605050904326395" 
                     title="permanent link">#</a> 
                  posted by <span style="line-height:16px" class="comment-icon blogger-comment-icon"><img src="http://www.blogger.com/img/b16-rounded.gif" alt="Blogger" style="display:inline;" /></span>&nbsp;<a href="http://www.blogger.com/profile/16780973578650341553" rel="nofollow">Ron</a>: 
                  08 January, 2010 08:14
                </div>
				<span class="item-control blog-admin pid-462862011"><a style="border:none;" href="http://www.blogger.com/delete-comment.g?blogID=3896669&postID=4925605050904326395" title="Delete Comment" ><span class="delete-comment-icon">&nbsp;</span></a></span>
			</div>
			
			<div class="blogComment">
				&nbsp;<br /><a name="4248692924153380963"></a> 
				Ron, thanks for the observations about &quot;docking&quot; a laptop to an external monitor and keyboard.  That is what is happening with the new laptop for <a href="http://www.blogger.com/profile/1584553666832384895" rel="nofollow">Vicki</a>.  We are removing her desktop machine and when her laptop is at home it will be connected to a dock that provides connection to a larger monitor, the SOHO wired LAN, great audio speakers, her printer, and a wireless keyboard and mouse.  She will also have our Windows Home Server on the LAN for backup and off-laptop extended storage.  This is in line with your suggestions and the necessary accessories are on their way to us.<br /><br />My problem, and the one Tommy solves for me, is that I will continue to have a large desktop computer <i>and</i> a (Tablet PC) laptop.  I don&#39;t want to deal with keyboard and monitor switching (been there, done that), and the laptop is unlikely to be able to drive a 30&quot; monitor when I upgrade to one.  In this case, remote desktopping into the laptop will be the easiest and smoothest solution when I want to use laptop resources while at my desktop system.  This keeps Outlook and traveling materials on the laptop but I only need to plug it into an outlet and the SOHO LAN when its at home.  The heavy duty work with virtual-machines and non-traveling writing -- I do a ton of that -- remains on the desktop.  Synchronizing other materials between my laptop and other systems (and off-line storage) can happen by using the LAN-based Windows Home Server as a repository.  I can even do version management and backup there.<br />
				<div class="byline">
                  <a href="http://orcmid.com/blog/2010/01/microsoft-office-2010-coming-to-our.asp?showComment=1262969477510#c4248692924153380963" 
                     title="permanent link">#</a> 
                  posted by <span style="line-height:16px" class="comment-icon blogger-comment-icon"><img src="http://www.blogger.com/img/b16-rounded.gif" alt="Blogger" style="display:inline;" /></span>&nbsp;<a href="http://www.blogger.com/profile/15720194709820430236" rel="nofollow">orcmid</a>: 
                  08 January, 2010 08:51
                </div>
				<span class="item-control blog-admin pid-721112219"><a style="border:none;" href="http://www.blogger.com/delete-comment.g?blogID=3896669&postID=4248692924153380963" title="Delete Comment" ><span class="delete-comment-icon">&nbsp;</span></a></span>
			</div>
			
	    <a class="comment-link" href="https://www.blogger.com/comment.g?blogID=3896669&postID=6868455972823507253">Post a Comment</a>
		</div>
