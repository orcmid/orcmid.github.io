...
<head>
	<title>Orcmid's Lair</title>
        ...
        <!--$$Header: /A2HostingWeb/orcmid/blog/archive/2003_04_13_lair-chive.asp 8     26-03-22 14:12 Orcmid $-->
        <base target="_top">
<style>
...
-->	
  ...
  <!-- 2002-11-08 Change date format to yyyy-mm-dd and bookmark it 
    	...
    	<h2><a name="2003-04-19" href="#2003-04-19"><font color="#660000">2003-04-19</font></a></h2>
   	

	<div class="posts">
	<a name="92906447">&nbsp;</a><br>
	<h1>Welcome Back, My Old Son ...</h1><h2>Miscellaneous Clippings</h2>Wow, after an initial fascination, I am here so rarely that the archive is all screwed up.  One needs to Post & Publish early and often to have things stay synchronized.&nbsp; Well, here is a compilation of snippets taken while studying intensely, traveling to New York City for a week, and then just coming off of a week on jury duty.<h3>Class clippings of some possible use</h3><a href="http://www.acm.org/ubiquity/views/k_prasad_2.html">ACM: Ubiquity - Running a Virtual Enterprise</a>.&nbsp; A fascinating look at quality processes in the terms of empowered teams that own their own results, with a compensation system to patch.<br>
	<span class="byline">posted by Dennis at <a href="#92906447">Saturday, April 19, 2003</a></span></div>
<br>
