...
<!-- ORCMID'S LAIR BLOGGER.COM TEMPLATE
     ...
     2002-10-31 Template modification adventures.  Add a configuration-
        ...
        title into a link
   $$Header: /nfoCentraleMSbCentralWeb/orcmid/blog/2005/04/good-enough-stategies-for-agile.asp 1     05-04-17 22:33 Orcmid $
   -->
<head>
<title>Orcmid's Lair: Good-Enough Stategies for Agile Courses into an Uncertain Future</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
    ...
    &#160;<br />
    <a href="http://nfocentrale.net/orcmid/blog/2005/04/trust-3-hacking-papal-election.asp">TRUST 3: Hacking the Papal Election</a><br />
    
    &#160;<br />
    <a href="http://nfocentrale.net/orcmid/blog/2005/04/rise-of-anti-social-networking.asp">The Rise of Anti-Social Networking</a><br />
	...
	<td bgcolor="white" colspan="2"><!-- 2004-10-02 -->
      ...
      <h3><a name="2005-04-16" href="#2005-04-16">
          <font color="#660000">2005-04-16</font></a></h3>
   	

	<div class="posts">
    <a name="111370485316132406"></a>
    
     <h2><font color="#000080"><!-- 2004-09-02 -->
	 <a href="http://www.acm.org/technews/articles/2005-7/0415f.html#item19" 
                     title="external link">
	...
	<p>
    <a href="http://www.acm.org/technews/articles/2005-7/0415f.html#item19">ACM News Service: Shaping the Future</a>.&nbsp; Steven Popper, Steven Bankes, and Robert Lempert expand on their <a href="http://nfocentrale.net/orcmid/blog/2005/03/agreeing-while-disagreeing.asp">Pardee Center work</a> on decision making in the face of complexity and uncertainty.&nbsp; The proposed strategies apply the same principles that individuals do in coming up with approaches that can be refined and corrected as the target is approached and more questions are resolved (along with arrival of the inevitable new questions).&nbsp; The decision process involves agreement on a near-term course that is consistent will the likely futures.&nbsp; This is in contrast with requiring agreement on which future is the expected or desired one.<br /><br />This time the work is presented in the 2005 April <a href="http://www.sciam.com/article.cfm?chanID=sa006&colID=1&articleID=000935E5-CCA0-1238-8CA083414B7FFE9F"><em>Scientific American</em> issue</a>.&nbsp; The discussion is pretty accessible.&nbsp; The team's 2003 report, "<a href="http://www.rand.org/publications/MR/MR1626/">Shaping the Next One Hundred Years: New Methods for Quantitative, Long-Term Policy Analysis</a>" can be ordered in print form or downloaded in a free set of 12 PDF files.<hr /><small>I just had the weird thought that this might provide a framework for IT project risk management and future-proofing, too.&nbsp; I remember being asked by an organization's director why he needed software architects (this was in 1972).&nbsp; I replied that it was a way of ensuring that his options were kept open.&nbsp; Now I would add, "while moving ahead, delivering results, and gaining only what experience can provide."&nbsp; What we didn't do then was apply any risk management methodology, and we made the delivery chunks too big among other sins.&nbsp; We achieved the hindsight-predictable result.</small>
    </p>
	<span class="byline">posted by orcmid 
       at <a href="http://nfocentrale.net/orcmid/blog/2005/04/good-enough-stategies-for-agile.asp">4/16/2005 07:27:33 PM</a></span>
	  
         <!-- 2004-05-10 -->
		<div class="blogComments">
			&nbsp;<br /><b><i>Comments:</i></b><!-- 2004-10-04 -->  
			
	    <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=3896669&amp;postID=111370485316132406">Post a Comment</a>
		</div>
