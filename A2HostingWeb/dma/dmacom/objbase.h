...
WINOLEAPI_(BOOL) CoHasStrongExternalConnections(IN LPUNKNOWN pUnk);
...
/* Flags for App Enumeration */

#define APPINFO_PUBLISHED       1   //         Published Only
#define APPINFO_ASSIGNED        2   //         Assigned Only
#define APPINFO_MSI             4   //         Msi Only
#define APPINFO_VISIBLE         8   //         Visible
#define APPINFO_AUTOINSTALL     16  //         Auto-Install
#define APPINFO_ALLLOCALE       32  //         All Locale
#define APPINFO_ALLPLATFORM     64  //         All Platform

WINOLEAPI CoEnumApps(
...
WINOLEAPI_(LPVOID) CoTaskMemRealloc(IN LPVOID pv, IN ULONG cb);
