...
<!-- NUMBERING PEANO BLOGGER.COM TEMPLATE
    ...
    $$Header: /nfoCentraleMSbCentralWeb/miser/astraendo/pn/2004/06/annotating-peano-numbers.asp 3     04-09-01 10:55 Orcmid $
    -->

<head>
<title>Numbering Peano: Annotating Peano Numbers</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<td bgcolor="white" valign="top" align="left">
      ...
      <h3><a name="2004-06-01" href="#2004-06-01">
          <font color="#660000">2004-06-01</font></a></h3>
   	

	<div class="posts">
	<a name="108607470012665376"></a>
    ...
    <p>
	<h3>Annotating Peano Numbers</h3>This is a new blog created specifically for a collaborative-articulation project.&nbsp; The idea is to develop an understanding of abstraction, syntax, semantics, and meaning of programming-language interfaces.&nbsp; We will undertake that using a concrete manifestation of Peano Numbers.&nbsp; This will also be revealing about the application of mathematical abstractions in connection with engineered artifacts -- computers and programs -- and their behavior.<br /><br />This post is simply to prime the pump and ensure that everything is working properly.
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://miser-theory.info/astraendo/pn/2004/06/annotating-peano-numbers.asp">6/1/2004 12:21:00 AM</a></span>
	       
 		<div class="blogComments">
			Comments:       
			
			<div class="blogComment">
				<a name="108607681184539626"></a> 
				What's not working right now is publishing of the archive index.  I need to put a placeholder there until I can figure out how to get the index published.<br />
				<div class="byline">
                  <a href="http://miser-theory.info/astraendo/pn/2004/06/annotating-peano-numbers.asp#108607681184539626" 
                     title="permanent link">#</a>
                  posted by <a href="http://www.blogger.com/profile/963786">orcmid</a>: 
                  6/1/2004 01:00:11 AM
                </div>
                <span class="item-control admin-1811622599 pid-1265515124"><a style="border:none;" href="http://www.blogger.com/delete-comment.do?blogID=7173751&postID=108607681184539626" title="Delete Comment" ><span class="delete-comment-icon">&nbsp;</span></a></span>
			</div>
			
			<div class="blogComment">
				<a name="108609761631307001"></a> 
				Problem solved, sort of.&nbsp; Blogger is dropping the separate archive-index page in favor of providing for an in-line index on the blog pages.&nbsp; You can see it in the left column of this page, below the links.&nbsp; So new blogs don't have the separate-index feature, although my older one does (fortunately).&nbsp; Fortunately, Numbering Peano will not have an extended life and I should be able to avoid the index becoming too long and undertaking whatever changes are introduced when it is discovered/remembered that the on-page index doesn't scale.<br />
				<div class="byline">
                  <a href="http://miser-theory.info/astraendo/pn/2004/06/annotating-peano-numbers.asp#108609761631307001" 
                     title="permanent link">#</a>
                  posted by <a href="http://www.blogger.com/profile/963786">orcmid</a>: 
                  6/1/2004 06:46:56 AM
                </div>
                <span class="item-control admin-1811622599 pid-1265515124"><a style="border:none;" href="http://www.blogger.com/delete-comment.do?blogID=7173751&postID=108609761631307001" title="Delete Comment" ><span class="delete-comment-icon">&nbsp;</span></a></span>
			</div>
			
        <a href="http://www.blogger.com/comment.g?blogID=7173751&postID=108607470012665376">Post a Comment</a>
		</div>
