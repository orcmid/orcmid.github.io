...
<!-- NUMBERING PEANO BLOGGER.COM TEMPLATE
    ...
    $$Header: /nfoCentraleMSbCentralWeb/miser/astraendo/pn/2004/08/deja-double-vu.asp 1     04-09-01 10:57 Orcmid $
    -->

<head>
<title>Numbering Peano: Deja Double Vu</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<td bgcolor="white" valign="top" align="left">
      ...
      <h3><a name="2004-08-31" href="#2004-08-31">
          <font color="#660000">2004-08-31</font></a></h3>
   	

	<div class="posts">
	<a name="109400926780308297"></a>
    
    <h2><font color="#000080"><!-- 2004-08-31 -->
    <a href="http://nfocentrale.net/orcmid/blog/2004_08_29_lair-chive.asp#2004-08-30"
                    title="external link">
    Deja Double Vu
    </a>
    </font></h2>
    ...
    <p>
	I have adjusted the template for <em>Numbering Peano</em> so that it works in mostly the same way as its companion, <em>Orcmid's Lair</em>.&#160; That includes a short period of doubled-up titles before some blog articles.&#160; This particular affliction will dissipate as those pages with the both old- and new-style article move into the past and only the larger, bolder, new-style titles, like the one here, remain.
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://miser-theory.info/astraendo/pn/2004/08/deja-double-vu.asp">8/31/2004 08:21:47 PM</a></span>
	       
 		<div class="blogComments">
			Comments:       
			
        <a href="http://www.blogger.com/comment.g?blogID=7173751&postID=109400926780308297">Post a Comment</a>
		</div>
