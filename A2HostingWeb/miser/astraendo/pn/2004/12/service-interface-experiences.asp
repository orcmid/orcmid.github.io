...
<!-- NUMBERING PEANO BLOGGER.COM TEMPLATE
    ...
    $$Header: /nfoCentraleMSbCentralWeb/miser/astraendo/pn/2004/12/service-interface-experiences.asp 1     05-04-18 18:55 Orcmid $
    -->

<head>
<title>Numbering Peano: Service interface experiences</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<td colspan="2" bgcolor="white" valign="top" align="left">
      ...
      <h3><a name="2004-12-09" href="#2004-12-09">
          <font color="#660000">2004-12-09</font></a></h3>
   	

	<div class="posts">
	<a name="110260172743762881"></a>
    ...
    <p>
	Jacques Distler has an <a href="http://golem.ph.utexas.edu/~distler/blog/archives/000482.html">informative post</a> about his experience in using the newly available National Weather Service XML data service.<br /><br />What's interesting in this post for the Numbering Peano exercise is the story of how Distler comes to actually get it to work. What's interesting is how expectations are set by what the NWS says it's interface is, and how the errors returned don't make it easy to fix the code. Distler summarizes two lessons:<br /><br /><blockquote><br />   1.  Well-formed, valid, input should produce well-formed output. The format parameter is declared to be of type xsd:string. If the string I send you isn&#8217;t one of the ones you were expecting, send me an error-response. Don&#8217;t let your application blow up in my face.<br />   2. As Sam Ruby notes below, it would be better to send the response as XML, rather than as an escaped string.<br /></blockquote><br /><br />Something to consider as we work through how sense is made from interface specifications.
    </p>
	<span class="byline">posted by Bill Anderson
       at <a href="http://miser-theory.info/astraendo/pn/2004/12/service-interface-experiences.asp">12/9/2004 06:15:22 AM</a></span>
	       
 		<div class="blogComments">
			&nbsp;<br /><b><i>Comments:</i></b><!-- 2004-10-04 -->       
			
        <a href="http://www.blogger.com/comment.g?blogID=7173751&postID=110260172743762881">Post a Comment</a>
		</div>
