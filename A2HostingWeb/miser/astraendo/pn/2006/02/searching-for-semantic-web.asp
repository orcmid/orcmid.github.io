...
<!-- NUMBERING PEANO BLOGGER.COM TEMPLATE
    ...
    $$Header: /nfoCentraleMSbCentralWeb/miser/astraendo/pn/2006/02/searching-for-semantic-web.asp 1     06-04-23 19:27 Orcmid $
    -->

<head>
<title>Numbering Peano: Searching for the Semantic Web</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<td colspan="2" bgcolor="white" valign="top" align="left">
      ...
      <h3><a name="2006-02-08" href="#2006-02-08">
          <font color="#660000">2006-02-08</font></a></h3>
   	

	<div class="posts">
	<a name="109841212679674862"></a>
    
    <h2><font color="#000080"><!-- 2004-08-31 -->
    <a href="http://www.acm.org/technews/articles/2004-6/1020w.html#item3"
                    title="external link">
    ...
    <p>
	<div style="clear:both;"></div><a href="http://www.acm.org/technews/articles/2004-6/1020w.html#item3">ACM News Service: Presenting Semantically Enabled Knowledge Technologies</a>. I don't spend much time thinking rapturously about the advent of the semantic web. Rather, I find the hype about it to be at best misleading, and I do agree that there is a great deal to learn about the prospect of "semantic annotation" and the conditions under which that is actually meaningful and useful.<br /><br />In that respect, the <a href="http://sekt.semanticweb.org/">SEKT project</a> has some key ingredients of good science by following this trajectory:<br /><ol><li>basic research in ontology and metadata management, including new techniques for annotation</li><li>automated extraction of metadata from natural language text</li><li>discovery and delivery of only relevant information to users</li><li>confirmation of tools in that spectrum in large-scale case studies in three language communities represented by Britain, Spain, and Germany.</li></ol>The 2004-10-20 <a href="http://istresults.cordis.lu/index.cfm/section/news/tpl/article/BrowsingType/Features/ID/70392">IST Results feature</a> reports that the full range of activities is included in reports to be made to the November International Semantic Web 2004 conference in Hiroshima. The project was begun on January 1, 2004, and will continue for 36 months. I suppose that does imply a certain expectation of rapid success. It will be valuable to watch.<br /><br />From 2004-10-21: Another old draft article.  I haven't checked to see how well the project did, or whether they fall into syntax/semantic/ontological confusions as many of these efforts seem to do.  Again, the treatment of <a href="http://orcmid.com/blog/2006/02/what-computers-know.asp">What Computers Know</a> and the progression from that point may be helpful here.<div style="clear:both; padding-bottom: 0.25em;"></div>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://miser-theory.info/astraendo/pn/2006/02/searching-for-semantic-web.asp">2/08/2006 03:20:00 PM</a></span>
	       
 		<div class="blogComments">
			&nbsp;<br /><b><i>Comments:</i></b><!-- 2004-10-04 -->       
			
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7173751&amp;postID=109841212679674862">Post a Comment</a>
		</div>
