...
<!-- NUMBERING PEANO BLOGGER.COM TEMPLATE
    ...
    $$Header: /nfoCentraleMSbCentralWeb/miser/astraendo/pn/2005/10/agile-scope-creep-and-how-to-detect-it.asp 1     06-02-04 21:19 Orcmid $
    -->

<head>
<title>Numbering Peano: Agile Scope Creep and How to Detect It</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
    ...
    <p>
	<div style="clear:both;"></div><p><a href="http://martinfowler.com/bliki/FivePoundBag.html">Martin Fowler&rsquo;s Bliki: FivePoundBag</a>.&nbsp; I had to laugh at this apt characterization of the&nbsp;danger that the operational-level, week-by-week&nbsp;planning for eXtreme Programming (and Agile methods that have followed) support containment of scope creep.&nbsp;&nbsp; First, I have seen that work on operational development (though in my case it was through preserving the weekly build and user-test schedule and not allowing last-minute changes to the code base).&nbsp; Secondly, it reminds me that my M.Sc project dissertation approach was a definite failure at scope management, one that I needed to have recognized and addressed 4&ndash;5 months earlier instead of well-beyond the point of no return.&nbsp;</p><p>I haven&rsquo;t fully internalized that lesson.&nbsp; I am currently operating week-to-week and it is still heavily randomizable activity.&nbsp; Solo processes, in my case, are not trustworthy as committed efforts.&nbsp; I am also girding up for a real development project and we&rsquo;ll see if I can manage not to do it my habitual way, but with early scope management and reality-tracking.&nbsp; Sounds good, right?&nbsp; I have no clue.&nbsp; Really.</p><p><em></em></p><div style="clear:both; padding-bottom: 0.25em;"></div>
    </p>
	<span class="byline">posted by orcmid
       at <a href="http://miser-theory.info/astraendo/pn/2005/10/agile-scope-creep-and-how-to-detect-it.asp">10/13/2005 09:43:40 AM</a></span>
	       
 		<div class="blogComments">
			&nbsp;<br /><b><i>Comments:</i></b><!-- 2004-10-04 -->       
			
			<div class="blogComment">
				&nbsp;<br /><a name="112923687631211225"></a> 
				I also have no clue how I managed to post this here rather than on Professor von Clueless where it belongs.  I shan't move it, but I will also "cross-post."<br />
				<div class="byline">
                  <a href="http://miser-theory.info/astraendo/pn/2005/10/agile-scope-creep-and-how-to-detect-it.asp#112923687631211225" 
                     title="permanent link">#</a>
                  posted by <a href="http://www.blogger.com/profile/963786">orcmid</a>: 
                  1:54 PM
                </div>
                <span class="item-control admin-1811622599 pid-1265515124"><a style="border:none;" href="http://www.blogger.com/delete-comment.g?blogID=7173751&amp;postID=112923687631211225" title="Delete Comment" ><span class="delete-comment-icon">&nbsp;</span></a></span>
			</div>
			
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7173751&amp;postID=112922182034666989">Post a Comment</a>
		</div>
