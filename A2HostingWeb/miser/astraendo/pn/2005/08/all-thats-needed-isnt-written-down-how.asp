...
<!-- NUMBERING PEANO BLOGGER.COM TEMPLATE
    ...
    $$Header: /nfoCentraleMSbCentralWeb/miser/astraendo/pn/2005/08/all-thats-needed-isnt-written-down-how.asp 2     06-02-03 22:47 Orcmid $
    -->

<head>
<title>Numbering Peano: All that's needed isn't written down; how much more might be enough?</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<td colspan="2" bgcolor="white" valign="top" align="left">
      ...
      <h3><a name="2005-08-15" href="#2005-08-15">
          <font color="#660000">2005-08-15</font></a></h3>
   	

	<div class="posts">
	<a name="112411946880796402"></a>
    ...
    <p>
	<div style="clear:both;"></div><a href="http://weblogs.java.net/blog/joconner/archive/2005/08/blog_client_api.html">"You have to know everything to understand anything"</a>, a recent post by John O'Connor on the java.net weblogs, nicely captures the essence of the Numbering Peano conversation.<br /><br />Since I choose not to remember things I can easily look up, the online availability of Java documentation definitely makes it easier to use. But as John points out in his note, most Java documentation is only helpful if I know the context in which the objects, classes, and methods can be used. And this information often comes from sources other than API or class and method documentation. Several years ago I implemented a JNDI-based directory service application. The JNDI JavaDoc was great, but I had to read general information about directory services and LDAP before I could actually use JNDI and write the code.<br /><br />Early in my career I worked on IBM mainframe systems. These systems came with detailed documentation for the subroutine libraries. But they also included a "Principles of Operation" document that explained the architecture and design rationale for the libraries. This document was invaluable in providing the context needed to write effective code.<br /><br />Maybe what John is asking for, and what Numbering Peano might illustrate, is the sort of context descriptions that can be practicably added to API documentation.<br /><br /><!-- technorati tags start --><p style="text-align:right;font-size:10px;">Technorati Tags: <a href="http://technorati.com/tag/documentation" rel="tag">documentation</a>, <a href="http://technorati.com/tag/Software Engineering" rel="tag">Software Engineering</a></p><!-- technorati tags end --><div style="clear:both; padding-bottom: 0.25em;"></div>
    </p>
	<span class="byline">posted by Bill Anderson
       at <a href="http://miser-theory.info/astraendo/pn/2005/08/all-thats-needed-isnt-written-down-how.asp">8/15/2005 08:24:34 AM</a></span>
	       
 		<div class="blogComments">
			&nbsp;<br /><b><i>Comments:</i></b><!-- 2004-10-04 -->       
			
        <a class="comment-link" href="http://www.blogger.com/comment.g?blogID=7173751&amp;postID=112411946880796402">Post a Comment</a>
		</div>
