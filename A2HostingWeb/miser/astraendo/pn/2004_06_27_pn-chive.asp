...
<!-- NUMBERING PEANO BLOGGER.COM TEMPLATE
    ...
    $$Header: /nfoCentraleMSbCentralWeb/miser/astraendo/pn/2004_06_27_pn-chive.asp 2     04-09-01 10:55 Orcmid $
    -->

<head>
<title>Numbering Peano: 2004-06-27</title>
...
<tr><!-- PAGE BODY WITH TWO COLUMNS -->
	...
	<td bgcolor="white" valign="top" align="left">
      ...
      <h3><a name="2004-06-30" href="#2004-06-30">
          <font color="#660000">2004-06-30</font></a></h3>
   	

	<div class="posts">
	<a name="108860316250813636"></a>
    ...
    <p>
	Here are a set of blog references that may be relevant to our Numbering Peano experiments. I think they're relevant because they talk about defining and establishing meaning for interfaces and API's. A more thorough evaluation _is_ required.<br /><br />1. James Robertson: Complexity of Java API's<br /><br />http://www.cincomsmalltalk.com/blog/blogView?showComments=true&entry=3265776080<br /><br />What are the issues raised here regarding complexity? Where is the complexity? Who is affected and how?<br /><br />2. Enumerating the rationals<br /><br />http://lambda-the-ultimate.org/node/view/47<br /><br />I think I'm going to learn something interesting that relates to my own inferred understanding of the Numbering Peano interface. I'm looking forward to learning.<br /><br />3. Sean McGrath: Reading, writing, APIs, GETs, POSTs and poetry <br /><br />http://seanmcgrath.blogspot.com/archives/2004_06_27_seanmcgrath_archive.html#108849749679322624<br /><br />A short piece about interface choices in OO systems.<br /><br />4. Dave Orchard: Interface Compatibility: V2<br /><br />http://www.pacificspirit.com/blog/2004/06/29/interface_compatibility_v2<br /><br />This tries to tie it all down, but I'm still confused about what it means to guarantee semantic compatibility.<br /><br />[update: 2004-07-01]<br />5. James Tauber: Enumerating rationals in python<br /><br />http://jtauber.com/blog/2004/07/01/enumerating_the_rationals_in_python<br /><br />Nota Bene: This whole enumerating rationals thread may be tangential (and irrelevant) to what we're trying to do here in Numbering Peano.
    </p>
	<span class="byline">posted by Bill Anderson
       at <a href="http://miser-theory.info/astraendo/pn/2004/06/unorganized-set-of-references-to-be.asp">6/30/2004 06:39:36 AM</a></span>
	       
 		<div class="blogComments">
			Comments:       
			
        <a href="http://www.blogger.com/comment.g?blogID=7173751&postID=108860316250813636">Post a Comment</a>
		</div>
